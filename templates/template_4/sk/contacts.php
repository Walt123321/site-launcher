...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="Kontaktujte podporu <?= $site_name ?> alebo náš obchodný tím." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="contacts.php" data-active>Kontaktujte nás</a>
    </li>
    <li>
      ...
      <div class="pt-5">
        <div class="container-base">
          ...
          >
            ...
            <span class="breadcrumb-item">Kontaktujte nás</span>
          </nav>
        </div>
      </div>
      <!-- contact -->
...
<div class="grid gap-4 text-center md:gap-6">
  <h3>Ak máte ďalšie otázky, kontaktujte nás e-mailom</h3>
</div>
            <a
