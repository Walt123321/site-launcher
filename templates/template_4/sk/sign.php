...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Registrácia | <?= $site_name ?></title>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta name="description" content="Pripojte sa k <?= $site_name ?> a vyberte si plán, ktorý zodpovedá vašim obchodným cieľom." />
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">Prihlásiť sa/Registrovať sa</span>
    </nav>
  </div>
</div>
      <!-- registration-1 -->
