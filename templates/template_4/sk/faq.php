...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Často kladené otázky (FAQ) | <?= $site_name ?></title>
    <meta name="description" content="Odpovede na otázky o obchodovaní, funkciách, bezpečnosti a poplatkoch." />
    <!-- Favicon -->
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
        <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
          ...
          <div id="content-1" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Za pár minút môžete byť pripravení. Vytvorte si účet so základnými údajmi, dokončite krátky overovací krok a vložte minimálne <?= $app_price ?> <?= $app_currency ?> Potom sa vám odomkne celá platforma — vrátane grafov v reálnom čase, obchodných nástrojov a funkcií, ktoré vám pomôžu sebavedomo začať.</p>
            </div>
          </div>
        </div>
        <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
          ...
          <div id="content-2" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Absolútne. Váš účet chránime pokročilým SSL šifrovaním, dvojfaktorovým overením (2FA) a bezpečným cold storage úložiskom pre prostriedky. Transakcie sú spracovávané prostredníctvom dôveryhodných poskytovateľov a vaše osobné údaje sú spracúvané v súlade s prísnymi bezpečnostnými zásadami. Bezpečnosť a spoľahlivosť sú pevne zakotvené v každej časti platformy.</p>
            </div>
          </div>
        </div>
        <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
          ...
          <div id="content-3" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Výber môžete požiadať kedykoľvek prostredníctvom svojho ovládacieho panela. Spracovanie zvyčajne trvá 1 – 3 pracovné dni, v závislosti od zvolenej metódy. Prípadné poplatky a časový rámec vidíte vždy vopred — žiadne prekvapenia.</p>
            </div>
          </div>
        </div>
        <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
          ...
          >
            <span class="h3 text-left transition-colors">Ako zistím, či je táto platforma vhodná pre mňa?</span>
            <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
              <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1" transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
                <rect x="19.5176" y="35.9287" width="4.62857" height="23.1428" rx="1" transform="rotate(-135 19.5176 35.9287)" fill="currentColor" />
          ...
          <div id="content-4" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Najlepším spôsobom je vyskúšať si to sami. Začnite s minimálnym vkladom a preskúmajte funkcie krok za krokom. Platforma je navrhnutá tak, aby bola užívateľsky prívetivá pre začiatočníkov a zároveň ponúkala výkonné nástroje a podporu 24/7, ktorá vám kedykoľvek pomôže. Zachovávate si plnú kontrolu.</p>
            </div>
          </div>
        </div>
        <div id="accordion-5" class="group border-primary rounded-custom border transition-all">
          ...
          <div id="content-5" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Vôbec nie. Všetko je navrhnuté tak, aby bolo prístupné od prvého dňa — s riadenou registráciou, jednoduchými návodmi a nástrojmi poháňanými AI, ktoré vám pomôžu orientovať sa v obchodovaní. Bez ohľadu na to, či práve začínate alebo už máte skúsenosti, môžete postupovať svojím vlastným tempom a podpora je tu vždy pre vás.</p>
            </div>
          </div>
        </div>
    </div>
