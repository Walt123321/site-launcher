...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 Získajte sledovanie portfólia 💸",
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Ponuka | <?= $site_name ?></title>
    <meta name="description" content="Vyberte si s <?= $site_name ?> plán, ktorý zodpovedá vašim obchodným potrebám." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="offer.php" data-active>Ponuka</a>
    </li>
    <li>
...
<span class="breadcrumb-item">Ponuka</span>
          </nav>
        </div>
      </div>
      <!-- tracker -->
      <div class="py-8 md:py-10">
        <div class="container-base grid gap-6 lg:grid-cols-2">
          ...
          >
 <h1 class="relative z-20">Získajte sledovanie portfólia</h1>
<p class="relative z-20">
  Začnite za pár minút: zaregistrujte sa, vložte prostriedky a začnite obchodovať už za 5 minút. Začnite teraz.
</p>
          </div>
