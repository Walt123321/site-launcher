...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Zásady ochrany osobných údajov | <?= $site_name ?></title>
    <meta name="description" content="Prečítajte si, ako <?= $site_name ?> zhromažďuje a chráni vaše údaje." />
    <!-- Favicon -->
...
>
  ...
  <span class="breadcrumb-item">Zásady ochrany osobných údajov</span>
</nav>
...
<div class="grid gap-6 md:gap-8">
  ...
  <div class="grid gap-2">
    <p class="text-sm">Posledná aktualizácia: <?= $privacy_last_update ?></p>
    <p>My ("My", "Nás") rešpektujeme vaše súkromie a zaväzujeme sa chrániť vaše osobné údaje. Tieto zásady ochrany osobných údajov vysvetľujú, ako <?= $site_name ?> zhromažďuje, používa a chráni vaše informácie.</p>
  </div>
  <!-- PRINCIPLES -->
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Transparentnosť</p>
    <p>
      Jasne vysvetľujeme, ako sa vaše údaje používajú. Kontaktujte nás na 
      <a href="mailto:info@<?= $site_domain ?>">info@<?= $site_domain ?></a>
    </p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Používanie údajov</p>
    <p>Vaše údaje sa používajú na poskytovanie služieb, zlepšovanie platformy a plnenie zákonných povinností.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Vaše práva</p>
    <p>Kedykoľvek môžete požiadať o informácie o svojich údajoch, ako aj o ich opravu alebo vymazanie.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Bezpečnosť</p>
    <p>Chránime vaše údaje, no nemôžeme zaručiť absolútnu bezpečnosť.</p>
  </div>
  <!-- SECTIONS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Zber údajov</h2>
    <p>Zbierame údaje o používaní (IP adresa, zariadenie, prehliadač) a všetky údaje, ktoré nám poskytnete.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Právny základ</h2>
    <p>Spracúvanie je založené na vašom súhlase, oprávnených záujmoch a zákonných povinnostiach.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Poskytovanie údajov</h2>
    <p>V prípade potreby môžeme poskytnúť údaje partnerom, poskytovateľom služieb a orgánom.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Cookies</h2>
    <p>Používame cookies na funkčnosť a analýzy. Môžete ich deaktivovať.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Uchovávanie údajov</h2>
    <p>Údaje sa uchovávajú iba tak dlho, ako je to absolútne nevyhnutné.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Medzinárodné prenosy</h2>
    <p>Údaje môžu byť prenášané s primeranými zárukami.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Odkazy tretích strán</h2>
    <p>Nezodpovedáme za externé webové stránky.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Aktualizácie</h2>
    <p>Tieto zásady ochrany osobných údajov môžu byť aktualizované.</p>
  </div>
  <!-- RIGHTS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">Vaše práva</h2>
    <p>Máte právo na prístup, opravu, vymazanie, obmedzenie alebo prenosnosť svojich údajov, na odvolanie súhlasu a na podanie sťažnosti.</p>
  </div>
</div>
          </div>
        </div>
