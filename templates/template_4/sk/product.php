...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 <?= $site_name ?> Digitálna analýza ™ 💸",
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Produkt | <?= $site_name ?></title>
    <meta name="description" content="Nástroje na správu kryptomien a aktív s analýzami a automatizáciou." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/sk/">Domov</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="product.php" data-active>Produkt</a>
    </li>
    <li>
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/sk/" class="breadcrumb-item">Domov</a>
      <span class="breadcrumb-item">Produkt</span>
    </nav>
  </div>
</div>
      <!-- analytics -->
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20"><?= $site_name ?> Digitálna analýza ™</h1>
      <p class="relative z-20">
        Získajte cenné poznatky a podporte rast s naším pokročilým analytickým nástrojom. Robte podložené, na dátach založené rozhodnutia s dôverou. Zdokonaľte svoju stratégiu a dosiahnite merateľné výsledky.
      </p>
    </div>
    <div class="relative grid min-h-[230px] content-end">
      ...
      <div class="relative z-20 grid grid-cols-2 gap-3 md:gap-6">
        <a class="btn btn-black col-span-full" href="sign.php">Registrácia</a>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Digitálna webová aplikácia</h2>
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Kapitálový trh</p>
            <p>Všetko na stlačenie tlačidla</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Štatistiky</p>
            <p>Prístup ku všetkým vašim údajom</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Mobilné zobrazenie</p>
            <p>Prístup cez váš mobilný telefón</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            ...
            <p>Získajte prístup ku každému aktívu</p>
          </div>
        </div>
      </div>
    </div>
    <div class="flex items-center justify-center">
      <img
        ...
        alt="Mobilné rozhranie na sledovanie portfólia"
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Tu prezentujem svoju profesionálnu kariéru prostredníctvom pôsobivých projektov a kreatívnych riešení.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Kúpiť kryptomenu</p>
          <p>Bezpečná a jednoduchá platforma na nákup kryptomien. Rýchle transakcie s minimálnymi poplatkami. Začnite obchodovať už dnes.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Analýza kryptomien</p>
          <p>Zistite viac o trhových hodnotách a trendoch, aby ste mohli robiť podložené investičné a obchodné rozhodnutia.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Kryptoaktíva</p>
          <p>Objavte budúcnosť financií s poprednými kryptomenami. Objavujte, investujte, rastite.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">Poďme na to!</p>
<p>
  Objavte svet kryptomien s <?= $site_name ?>. Obchodníci môžu pristupovať k obchodnej platforme, ktorá spája inovácie, efektivitu a ziskové príležitosti.
</p>
          </div>
          ...
          <div class="grid gap-6">
            <div class="grid gap-2 md:gap-3.5">
              <label class="grid gap-1.5">
                <span class="label text-white">Krstné meno</span>
                <input class="input" type="text" name="fname" placeholder="Zadajte svoje krstné meno" required />
              </label>
              <label class="grid gap-1.5">
            ...
            <div class="grid gap-3">
              ...
              <p class="text-xs text-white">
                Zadaním svojich osobných údajov a kliknutím na tlačidlo súhlasíte s
                <a class="link-underline" href="privacy.php">Zásady ochrany osobných údajov</a>
                a
                <a class="link-underline" href="conditions.php">Zmluvné podmienky</a>
        ...
        <div class="grid gap-5">
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p>Váš dôveryhodný obchodný partner</p>
  ...
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ja/product.php" hreflang="ja" title="日本語">
    🇯🇵
        ...
        <div class="grid gap-2.5 text-sm text-gray-500">
            <p>
                <?= $site_name ?> nenesie zodpovednosť za straty alebo škody vzniknuté spoliehaním sa na informácie poskytnuté na tejto webovej stránke, vrátane vzdelávacieho obsahu, cenových kotácií, grafov a analýz. Obchodovanie na finančných trhoch je spojené s rizikami. Preto je dôležité pred začatím zvážiť svoje osobné okolnosti a v prípade potreby vyhľadať radu kvalifikovaného odborníka. Mali by ste investovať iba peniaze, ktorých stratu si môžete dovoliť, a majte na pamäti, že nástroje ako devízy (FX), CFD a kryptomeny nie sú vhodné pre každého.
            </p>
        </div>
