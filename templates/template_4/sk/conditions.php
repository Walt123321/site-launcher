...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Zmluvné podmienky | <?= $site_name ?></title>
    <meta name="description" content="Prečítajte si zmluvné podmienky <?= $site_name ?>." />
    <meta charset="UTF-8" />
  ...
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <div class="grid gap-5 md:gap-7">
        <nav aria-label="breadcrumb" class="flex flex-wrap items-center text-sm text-gray-500 md:text-lg">
            ...
            <span class="breadcrumb-item">Zmluvné podmienky</span>
        </nav>
        <h1>Zmluvné podmienky</h1>
    </div>
<div class="grid gap-6 md:gap-8">
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Všeobecné ustanovenia</h2>
    <p>Táto webová stránka poskytuje informácie o obchodných platformách tretích strán a súvisiacich službách. Používaním tejto webovej stránky súhlasíte s týmito podmienkami a našimi zásadami ochrany osobných údajov. Podmienky môžu byť kedykoľvek aktualizované.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Oprávnenosť</h2>
    <p>Musíte mať aspoň 18 rokov, byť schopní akceptovať tieto podmienky a nesmiete byť obmedzení miestnymi zákonmi. Nezodpovedáme za nezákonné používanie tejto webovej stránky.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Obmedzený prístup</h2>
    <p>Môžeme obmedziť prístup pre používateľov z určitých regiónov alebo tam, kde existujú právne alebo regulačné riziká. Služby nemusia byť dostupné v obmedzených oblastiach.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Neprípustné používanie</h2>
    <p>Nesmiete zneužívať webovú stránku, vrátane porušovania zákonov, porušovania práv, šírenia škodlivého obsahu alebo používania automatizovaných systémov. V prípade porušenia môžeme obmedziť prístup.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Duševné vlastníctvo</h2>
    <p>Všetok obsah, ochranné známky a materiály patria nám alebo tretím stranám. Webovú stránku môžete používať iba na osobné účely a nesmiete kopírovať ani upravovať obsah.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Zodpovednosť</h2>
    <p>Webová stránka a služby sú poskytované "tak, ako sú". Nezodpovedáme za chyby, straty alebo škody vzniknuté používaním tejto webovej stránky.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Služby tretích strán</h2>
    <p>Môžeme zobrazovať obsah alebo odkazy tretích strán. Nezodpovedáme za ich presnosť ani služby. Pred rozhodnutím si overte informácie.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Odkazy</h2>
    <p>Odkazy na externé webové stránky sú poskytované iba ako služba. Nepodporujeme ani nekontrolujeme ich a nezodpovedáme za ich obsah.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">9. Rôzne</h2>
    <p>Môžeme kedykoľvek aktualizovať alebo zmeniť služby a podmienky. Tieto podmienky predstavujú úplnú dohodu medzi vami a nami. Nevymáhanie práv neznamená ich vzdanie sa.</p>
  </div>
</div>
      </div>
    </main>
