...
>
  <a href="<?= $site_url ?>" class="breadcrumb-item"><?= $privacy_breadcrumb_home ?></a>
  <span class="breadcrumb-item"><?= $privacy_breadcrumb_current ?></span>
</nav>
...
<div class="grid gap-6 md:gap-8">
  ...
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc"><?= $privacy_transparency_title ?></p>
    <p>
  ...
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc"><?= $privacy_usage_title ?></p>
    <p><?= $privacy_usage_text ?></p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc"><?= $privacy_rights_short_title ?></p>
    <p><?= $privacy_rights_short_text ?></p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc"><?= $privacy_security_title ?></p>
    <p><?= $privacy_security_text ?></p>
  </div>
  <!-- SECTIONS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3"><?= $privacy_s1_title ?></h2>
    <p><?= $privacy_s1_text ?></p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3"><?= $privacy_s2_title ?></h2>
    <p><?= $privacy_s2_text ?></p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3"><?= $privacy_s3_title ?></h2>
    <p><?= $privacy_s3_text ?></p>
  </div>
  <div class="grid gap-2 md:gap-4">
  ...
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3"><?= $privacy_s6_title ?></h2>
    <p><?= $privacy_s6_text ?></p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3"><?= $privacy_s7_title ?></h2>
    <p><?= $privacy_s7_text ?></p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3"><?= $privacy_s8_title ?></h2>
    <p><?= $privacy_s8_text ?></p>
  </div>
  <!-- RIGHTS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3"><?= $privacy_rights_title ?></h2>
