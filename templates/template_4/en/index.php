...
?>
<!DOCTYPE html>
<html class="scroll-smooth" lang="en" data-theme="orange">
<!-- head -->
<head>
  ...
  "itemListElement": [
    {
      ...
      "position": 1,
      "name": "<?= $site_name ?>",
      "item": "<?= $site_url ?>/lander/<?= $site_domain ?>/en/"
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 <?= $site_name ?> 💸",
      "item": "<?= $site_url ?>/lander/<?= $site_domain ?>/en/#heading-style-h1"
    }
  ]
}
</script>
<script type="application/ld+json">
{
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css" />
    <title><?= $site_name ?> | AI Trading Platform</title>
    <meta name="description" content="<?= $site_name ?> ⭐ — intelligent AI trading platform for real-time market analysis and clear trading signals ⚡ Try smart tools & insights with a guided tour." />
        ...
        "mainEntity": [
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "You can get up and running in just a few minutes. Create an account with your basic details, complete a short verification step, and fund your account with a minimum of <?= $app_price ?> <?= $app_currency ?>. After that, you’ll unlock the full platform — including live charts, trading tools, and features to help you start confidently."
            }
          },
          {
            "@type": "Question",
            "name": "Is my money and data safe? Is <?= $site_name ?> reliable?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Absolutely. We protect your account with advanced SSL encryption, 2FA verification, and secure cold storage for funds. Transactions are processed through trusted providers, and your personal data is handled under strict security policies. Safety and reliability are built into every part of the platform."
            }
          },
          {
            "@type": "Question",
            "name": "When can I withdraw my profits?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Withdrawals can be requested at any time through your account dashboard. Processing usually takes between 1–3 business days, depending on the selected method. You’ll always see any applicable fees and timing in advance — no surprises."
            }
          },
          {
            "@type": "Question",
            "name": "How do I know if this platform is right for me?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "The best way is to try it yourself. Start with the minimum deposit and explore the features step by step. The platform is designed to be beginner-friendly while still offering powerful tools, along with 24/7 support to help whenever needed. You stay in control the entire time."
            }
          },
          {
            "@type": "Question",
            "name": "Do I need trading experience to get started?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Not at all. Everything is built to be accessible from day one — with onboarding guidance, simple tutorials, and AI-assisted tools that help you navigate trading. Whether you're just starting out or already have experience, you can progress at your own pace with support always available."
            }
          }
        ]
      }
  ...
  <header class="relative z-50 pt-3.5 md:pt-6">
    <div class="container-base">
      <div
        ...
        <a class="font-special inline-flex max-w-60 gap-1.5 text-xl leading-none uppercase header-nav-logo" href="<?= $site_url ?>/lander/<?= $site_domain ?>/en/">
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/en/" data-active>Home</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="product.php">Product</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="offer.php">Offer</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="contacts.php">Contact us</a>
    </li>
    <li>
    ...
    <nav class="mobile-menu" data-mobile-menu>
      <ul class="flex flex-col flex-wrap items-center justify-center gap-y-8">
        <li>
          <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/en/">Home</a>
        </li>
        <li>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h1><?= $site_name ?></h1>
            <p>Experience a new era of trading with our advanced crypto trading platform. With <?= $site_name ?> AI technology, you can optimise your returns and make informed investment decisions.</p>
        </div>
        <form name="form" method="post"
          ...
          <input type="hidden" name="phone_country" value="gb">
          <input type="hidden" name="only_countries" value='["gb"]'>
          ...
          <div class="grid gap-6">
            <div class="grid gap-2 md:gap-3.5">
              <label class="grid gap-1.5">
                <span class="label text-white">First Name</span>
                <input class="input" type="text" name="fname" placeholder="Enter your First Name" required />
              </label>
              <label class="grid gap-1.5">
                <span class="label text-white">Last Name</span>
                <input class="input" type="text" name="lname" placeholder="Enter your Last Name" required />
              </label>
              <label class="grid gap-1.5">
              ...
              <label class="grid gap-1.5">
                <span class="label text-white">Phone</span>
            ...
            <div class="grid gap-3">
              ...
              <p class="text-xs text-white">
                ...
                <a class="link-underline" href="privacy.php">Privacy Policy</a>
                and
                <a class="link-underline" href="conditions.php">Terms of Use</a>
                of the website.
              </p>
            </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-3 md:grid-cols-2 md:gap-6 xl:grid-cols-4">
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      ...
      <p class="h3">Currencies available</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
    ...
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      ...
      <p class="h3">Trading volume</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">100+</p>
      <p class="h3">Supported countries</p>
    </div>
  </div>
</div>
    <!-- features -->
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 max-lg:order-2 md:gap-10">
      ...
      <p class="md:text-lg">
        Trusted by modern crypto traders, this platform sets a new standard. We blend powerful security, complete transparency, advanced algorithms, and a seamless interface to give you everything you need to trade with confidence and succeed.
      </p>
        ...
        <div class="grid grid-cols-2 gap-x-8 gap-y-6 max-sm:flex">
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Security You Can Trust</p>
              <p>Top-tier protection for your data and investments at every step.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Tailored Experience</p>
              <p>Customize your trading strategies to fit your unique goals and style.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Smart AI Strategies</p>
              <p>Accurate trading insights to help you make confident decisions.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Automated Trading</p>
              <p>AI-driven bots working around the clock for efficient, profit-focused trades.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Effortless Interface</p>
              <p>Clean, intuitive design that makes trading simple from the very start.</p>
            </div>
          </div>
        </div>
      </div>
      <p class="h3">
        Transform your financial experience with <?= $site_name ?> ™.
      </p>
      <a class="btn btn-black" href="sign.php">Register</a>
    </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Efficient trading!</h2>
      <p class="text-lg">
        Trade cryptocurrencies such as Bitcoin, Ethereum, and Dogecoin with ease and confidence.
      </p>
      <a class="btn btn-black max-md:hidden" href="sign.php">Get Started</a>
    </div>
    <div class="grid gap-3 md:gap-6" data-trading></div>
    <a class="btn btn-black md:hidden" href="sign.php">Get Started</a>
  </div>
</div>
<section class="feature-section">
  <div class="container">
    <div class="feature-header">
      <h2>
        Global trading platform <span>built for scale</span>
      </h2>
      <p>
        Access multiple financial markets through a unified infrastructure designed for performance, precision, and global reliability.
      </p>
    </div>
    <div class="feature-grid">
      <div class="feature-card">
        ...
        <p>
          Trade cryptocurrencies, forex, equities, and commodities from a single integrated environment without switching between platforms.
        </p>
      </div>
      <div class="feature-card featured">
        ...
        <p>
          Optimized infrastructure ensures minimal latency and stable order execution across global markets.
        </p>
      </div>
      <div class="feature-card">
        <div class="accent"></div>
        ...
        <p>
          Live data, advanced indicators, and market insights help you respond faster and make more informed trading decisions.
        </p>
      </div>
    </div>
  </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10">
    <div class="grid items-center gap-6 lg:grid-cols-2">
      <h2>How <?= $site_name ?> works: your quick start guide</h2>
      <p class="rounded-custom sm:border sm:p-8">
        Begin your crypto trading journey effortlessly on our platform. We’ll guide you step by step — from fast registration to your first deposit and opening your first trade.
      </p>
    </div>
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Sign up in minutes, fill in your details, and get secure access to the official platform.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Confirm your access</p>
          <p>Verify your email and unlock full access so you can start trading right away.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Open your trading account with a minimum deposit of <?= $app_price ?> <?= $app_currency ?>. Higher investments can increase potential returns, but also involve greater risk.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Fund your account</p>
          <p>Choose your preferred method — bank transfer, e-wallet, or credit card — and get started instantly.*</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Set your strategy</p>
          <p>Adjust your account to match your goals. Define your risk level, set trading preferences, and configure your strategy. Our expert brokers are here to support you — automated or manual, it’s your call.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Start trading</p>
          <p>You’re all set. Step into the crypto market with confidence and start exploring new opportunities today.</p>
        </div>
      </div>
    </div>
    <div class="grid gap-6 md:grid-cols-2">
      <a class="btn btn-black" href="sign.php">Start Trading</a>
    </div>
  </div>
</div>
    <!-- payments -->
    <div class="py-8 md:py-10">
      <div class="container-base grid items-center gap-6 lg:grid-cols-2">
        <p class="text-lg">
          <?= $site_name ?> accepts a range of payment methods globally.
        </p>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
            <p>
              <?= $site_name ?> pleasantly surprised me. Sign-up was quick, fees are clear, and the support team actually responds and helps. The whole experience feels smooth and reliable — definitely a platform I’m happy to stick with.
            </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials($review_1_author) ?></div>
              <p class="font-bold">Private Investor</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  I finally gave crypto a try and went with <?= $site_name ?> — no regrets so far. Getting started took just a few minutes, and everything was explained clearly. It feels like a solid option, especially if you're new to trading.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials($review_2_author) ?></div>
              <p class="font-bold">Independent Trader</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  <?= $site_name ?> feels like a stable and trustworthy platform. Account setup was easy, conditions are clear, and support knows what they’re doing. Trading here has been a surprisingly comfortable experience.
                </p>
            <div class="flex items-center gap-4">
        ...
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  With <?= $site_name ?>, crypto trading doesn’t feel overwhelming anymore. Registration was simple, fees are transparent, and I like that there’s support when you need it. As a beginner, that really makes a difference.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials($review_4_author) ?></div>
              <p class="font-bold">Passive Income Seeker</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
      <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">How do I get started?</span>
        ...
        <div id="content-1" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>You can get up and running in just a few minutes. Create an account with your basic details, complete a short verification step, and fund your account with a minimum of <?= $app_price ?> <?= $app_currency ?>. After that, you’ll unlock the full platform — including live charts, trading tools, and features to help you start confidently.</p>
          </div>
        </div>
      </div>
      <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Is my money and data safe? Is <?= $site_name ?> reliable?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-2" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Absolutely. We protect your account with advanced SSL encryption, 2FA verification, and secure cold storage for funds. Transactions are processed through trusted providers, and your personal data is handled under strict security policies. Safety and reliability are built into every part of the platform.</p>
          </div>
        </div>
      </div>
      <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">When can I withdraw my profits?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-3" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Withdrawals can be requested at any time through your account dashboard. Processing usually takes between 1–3 business days, depending on the selected method. You’ll always see any applicable fees and timing in advance — no surprises.</p>
          </div>
        </div>
      </div>
      <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">How do I know if this platform is right for me?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-4" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>The best way is to try it yourself. Start with the minimum deposit and explore the features step by step. The platform is designed to be beginner-friendly while still offering powerful tools, along with 24/7 support to help whenever needed. You stay in control the entire time.</p>
          </div>
        </div>
      </div>
      <div id="accordion-5" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Do I need trading experience to get started?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-5" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Not at all. Everything is built to be accessible from day one — with onboarding guidance, simple tutorials, and AI-assisted tools that help you navigate trading. Whether you're just starting out or already have experience, you can progress at your own pace with support always available.</p>
          </div>
        </div>
      </div>
      <div id="accordion-6" class="group border-primary rounded-custom border transition-all">
        ...
        <div id="content-6" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p style="margin-bottom:16px;"><?= $site_name ?> is a global trading platform built for users who expect consistent performance, fast execution, and full control over their trading environment. Instead of relying on multiple disconnected tools or region-specific services, the platform provides a single structured system where all core functions are integrated into one workflow.</p>
            <p style="margin-bottom:16px;">From market access to order execution and analytics, every component is designed to work together without unnecessary friction. This allows users to focus on decision-making rather than navigating complex systems or switching between platforms.</p>
            <p style="margin-bottom:10px; font-weight:500;">Within a single interface, users can operate across multiple financial markets:</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Cryptocurrencies, including major and emerging digital assets</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Foreign exchange markets with real-time pricing</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Global equities and stock instruments</li>
              <li><span style="color:#6D5DF6;">•</span> Commodities for broader portfolio diversification</li>
            </ul>
            <p style="margin-bottom:16px;">Performance is a core priority of the platform. The infrastructure is optimized to deliver low-latency execution and stable operation even during periods of high market activity. This ensures that users can respond to price movements without delays or technical interruptions.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Fast and consistent order execution across markets</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Continuous real-time data and price updates</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Built-in analytical tools and market indicators</li>
              <li><span style="color:#6D5DF6;">•</span> Support for both manual and automated strategies</li>
            </ul>
            <p style="margin-bottom:16px;">Security and operational reliability are integrated into every layer of the system. The platform follows established industry standards and applies internal safeguards to ensure that both user data and financial operations remain protected at all times.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Encrypted data transmission across all interactions</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Multi-layer account verification and authentication</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Verified transaction processing and monitoring systems</li>
              <li><span style="color:#6D5DF6;">•</span> Infrastructure designed for stable global accessibility</li>
            </ul>
            <p style="margin-bottom:16px;">At the same time, usability remains a key focus. The interface is intentionally designed to stay clean and predictable, reducing unnecessary complexity and allowing users to focus on trading strategies rather than system interaction.</p>
            <p style="margin-bottom:16px;">This balance between performance and simplicity makes the platform suitable for both new users and experienced traders. Beginners can adapt quickly without a steep learning curve, while advanced users retain the flexibility needed to manage more complex strategies.</p>
            <p><?= $site_name ?> combines scalability, reliability, and efficiency into a single environment, providing a structured and dependable way to access global financial markets with confidence.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h2>This is trading with the official platform™</h2>
          <p>
            We're the trusted platform for individuals and businesses to buy, sell, and manage cryptocurrency.
          </p>
        </div>
        <form name="form" method="post"
          class="leadform rf-form js-rf-form group bg-primary rounded-custom relative overflow-hidden px-4 py-8 md:px-8" action="../integration/send.php" data-form>
  ...
  <section style="padding:60px 0;" class="md:!py-[100px]">
    ...
    ">
      ...
      ">
        ...
        ">
          Core capabilities of the <span style='color:#6B5FA7;'><?= $site_name ?> trading platform</span>
        </h2>
      <p style="margin-top:14px;color:#6b7280;font-size:17px;">
        Everything you need to trade smarter, faster, and with confidence.
      </p>
    </div>
    <div style="
      border-radius:16px;
    ...
    ">
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Forex, stocks, crypto, commodities and more
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
  ...
  <div class="border-primary-light grid justify-items-center gap-6 rounded-[20px] border px-4 py-5 md:gap-4 md:px-8 md:py-6 text-center md:text-left">
    ...
    <div class="flex flex-wrap items-center justify-center md:justify-start gap-2.5 text-center md:text-left">
      ...
      <span class="leading-none text-amber-500" role="img"
        aria-label="<?= $rating_value ?> Score out of 5">
        <?= $stars ?>
      </span>
      <span class="flex flex-wrap justify-center md:justify-start gap-1 text-sm text-gray-400">
        ...
        <span>
          Based on <strong><?= $rating_count ?></strong> ratings ·
        </span>
        <span>
          Score out of 5
        </span>
    ...
    <p class="text-center md:text-left">
      A powerful and user-friendly trading platform with robust automation and comprehensive educational resources.
    </p>
  </div>
</div>
      </div>
        ...
        <div class="grid gap-5">
          <nav class="flex flex-col flex-wrap justify-between gap-x-10 gap-y-5 text-white md:flex-row">
            <a class="font-special inline-flex max-w-60 gap-1.5 text-xl leading-none text-white uppercase max-md:pr-[120px] footer-nav-logo"
              href="<?= $site_url ?>/lander/<?= $site_domain ?>/en/">
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p style="color:#6B5FA7;">Your trusted trading partner</p>
  ...
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ja/" hreflang="ja" title="日本語">
    🇯🇵
        ...
        <div class="grid gap-2.5 text-sm text-gray-500">
            <p>
                <?= $site_name ?> is not responsible for any losses or damages that may result from using the information provided on this website, including educational content, price quotes, charts, and analysis. Trading in financial markets involves risk, so it’s important to consider your personal circumstances and, if needed, seek advice from a qualified professional before getting started. You should only invest money you can afford to lose, and keep in mind that instruments such as FX, CFDs, and cryptocurrencies may not be suitable for everyone.
            </p>
        </div>
