...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Offer | <?= $site_name ?></title>
    <meta name="description" content="Choose a plan with <?= $site_name ?> that matches your trading needs." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="offer.php" data-active>Offer</a>
    </li>
    <li>
...
<span class="breadcrumb-item">Offer</span>
          </nav>
        </div>
      </div>
      <!-- tracker -->
      <div class="py-8 md:py-10">
        <div class="container-base grid gap-6 lg:grid-cols-2">
          ...
          >
 <h1 class="relative z-20">Get Portfolio Tracker</h1>
<p class="relative z-20">
  Get started in minutes: sign up, deposit, and begin trading in just 5 minutes. Start now.
</p>
          </div>
