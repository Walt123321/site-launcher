...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="Learn how <?= $site_name ?> collects and protects your data." />
    <!-- Favicon -->
...
<div class="grid gap-6 md:gap-8">
  ...
  <div class="grid gap-2">
    ...
    <p>We ("We", "Us") respect your privacy and are committed to protecting your personal data. This policy explains how <?= $site_name ?> collects, uses, and protects your information.</p>
  </div>
  <!-- PRINCIPLES -->
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Transparency</p>
    <p>
      We clearly explain how your data is used. Contact us at 
      <a href="mailto:info@<?= $site_domain ?>">info@<?= $site_domain ?></a>
    </p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Data usage</p>
    <p>Your data is used to provide services, improve the platform, and meet legal obligations.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Your rights</p>
    <p>You can request access, correction, or deletion of your data at any time.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Security</p>
    <p>We protect your data but cannot guarantee absolute security.</p>
  </div>
  <!-- SECTIONS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Data Collection</h2>
    <p>We collect usage data (IP, device, browser) and any data you provide.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Legal Basis</h2>
    <p>Processing is based on consent, legitimate interest, and legal obligations.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Data Sharing</h2>
    <p>We may share data with partners, providers, and authorities if required.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Cookies</h2>
    <p>We use cookies for functionality and analytics. You can disable them.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Data Retention</h2>
    <p>Data is stored only as long as necessary.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. International Transfers</h2>
    <p>Data may be transferred with appropriate safeguards.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Third-Party Links</h2>
    <p>We are not responsible for external websites.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Updates</h2>
    <p>This policy may be updated.</p>
  </div>
  <!-- RIGHTS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">Your Rights</h2>
    <p>You have the right to access, correct, delete, restrict, or transfer your data, withdraw consent, and file a complaint.</p>
  </div>
</div>
          </div>
        </div>
