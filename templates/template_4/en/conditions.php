...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="Read the terms and conditions of using <?= $site_name ?>." />
    <meta charset="UTF-8" />
  ...
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <div class="grid gap-5 md:gap-7">
        <nav aria-label="breadcrumb" class="flex flex-wrap items-center text-sm text-gray-500 md:text-lg">
            ...
            <span class="breadcrumb-item">Conditions of Use</span>
        </nav>
...
<div class="grid gap-6 md:gap-8">
  <div class="grid gap-2 md:gap-4">
    ...
    <p>This Website provides information about third-party trading platforms and related services. By using the Website, you agree to these Terms and our Privacy Policy. Terms may be updated at any time.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Eligibility</h2>
    <p>You must be at least 18 years old, able to accept these Terms, and not restricted by your local laws. We are not responsible for unlawful use of the Website.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Restricted Access</h2>
    <p>We may restrict access to users from certain regions or where legal or regulatory risks apply. Services may be unavailable in restricted locations.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Prohibited Use</h2>
    <p>You must not misuse the Website, including violating laws, infringing rights, spreading harmful content, or using automated systems. We may restrict access if Terms are violated.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Intellectual Property</h2>
    <p>All content, trademarks, and materials belong to us or third parties. You may use the Website for personal use only and must not copy or modify any content.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Liability</h2>
    <p>The Website and Services are provided 'as is'. We are not responsible for errors, losses, or damages resulting from use of the Website.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Third-Party Services</h2>
    <p>We may display third-party content or links. We are not responsible for their accuracy or services. Verify information before making decisions.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Links</h2>
    <p>Links to external websites are provided for convenience only. We do not endorse or control them and are not responsible for their content.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">9. Miscellaneous</h2>
    <p>We may update or modify the Services and Terms at any time. These Terms form the full agreement between you and us. Rights not exercised are not waived.</p>
  </div>
</div>
      </div>
    </main>
