...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Personvernregler | <?= $site_name ?></title>
    <meta name="description" content="Lær hvordan <?= $site_name ?> samler inn og beskytter dataene dine." />
    <!-- Favicon -->
...
>
  ...
  <span class="breadcrumb-item">Personvernregler</span>
</nav>
...
<div class="grid gap-6 md:gap-8">
  ...
  <div class="grid gap-2">
    ...
    <p>Vi («Vi») respekterer personvernet ditt og er forpliktet til å beskytte personopplysningene dine. Disse reglene forklarer hvordan <?= $site_name ?> samler inn, bruker og beskytter informasjonen din.</p>
  </div>
  <!-- PRINCIPLES -->
  ...
  <div class="grid gap-2 md:gap-4">
    ...
    <p>Dataene dine brukes til å levere tjenester, forbedre plattformen og oppfylle juridiske forpliktelser.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Dine rettigheter</p>
    <p>Du kan når som helst be om innsyn, retting eller sletting av dataene dine.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
  ...
  <div class="grid gap-2 md:gap-4">
    ...
    <p>Vi samler inn bruksdata (IP, enhet, nettleser) og alle data du oppgir.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Rettslig grunnlag</h2>
    <p>Behandlingen er basert på samtykke, legitim interesse og juridiske forpliktelser.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Datadeling</h2>
    <p>Vi kan dele data med partnere, leverandører og myndigheter ved behov.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Informasjonskapsler</h2>
    <p>Vi bruker informasjonskapsler for funksjonalitet og analyse. Du kan deaktivere dem.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Datalagring</h2>
    <p>Data lagres bare så lenge det er nødvendig.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Internasjonale overføringer</h2>
    <p>Data kan overføres med passende sikringstiltak.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Tredjepartslenker</h2>
    <p>Vi er ikke ansvarlige for eksterne nettsteder.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Oppdateringer</h2>
    <p>Disse reglene kan oppdateres.</p>
  </div>
  <!-- RIGHTS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">Dine rettigheter</h2>
    <p>Du har rett til innsyn, retting, sletting, begrensning eller overføring av data, tilbakekalling av samtykke og innsending av klage.</p>
  </div>
</div>
          </div>
        </div>
