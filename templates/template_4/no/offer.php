...
<span class="breadcrumb-item">Tilbud</span>
      ...
      <div class="py-8 md:py-10">
        <div class="container-base grid gap-6 lg:grid-cols-2">
          ...
          >
 <h1 class="relative z-20">Få Portfolio Tracker</h1>
<p class="relative z-20">
  Kom i gang på minutter: registrer deg, sett inn penger og begynn å handle på bare 5 minutter. Start nå.
</p>
          </div>
