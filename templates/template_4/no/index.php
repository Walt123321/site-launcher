...
?>
<!DOCTYPE html>
<html class="scroll-smooth" lang="no" data-theme="orange">
<!-- head -->
<head>
  ...
  "itemListElement": [
    {
      ...
      "position": 1,
      "name": "<?= $site_name ?>",
      "item": "<?= $site_url ?>/lander/<?= $site_domain ?>/no/"
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 <?= $site_name ?> 💸",
      "item": "<?= $site_url ?>/lander/<?= $site_domain ?>/no/#heading-style-h1"
    }
  ]
}
</script>
<script type="application/ld+json">
{
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css" />
    ...
    <meta name="description" content="<?= $site_name ?> ⭐ — intelligent AI-handelsplattform for sanntids markedsanalyse og tydelige handelssignaler ⚡ Prøv smarte verktøy og veiledede innsikter." />
        ...
        "mainEntity": [
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Du kan være operativ på bare noen minutter. Opprett en konto med grunnleggende opplysninger, fullfør et kort verifikasjonstrinn og sett inn minimum <?= $app_price ?> <?= $app_currency ?>. Deretter låser du opp hele plattformen — live grafer, handelsverktøy og funksjoner for en trygg start."
            }
          },
          {
            "@type": "Question",
            "name": "Er pengene og dataene mine trygge? Er <?= $site_name ?> pålitelig?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Absolutt. Vi beskytter kontoen din med avansert SSL-kryptering, 2FA-verifisering og sikker kaldlagring av midler. Transaksjoner behandles via pålitelige leverandører, og personopplysninger håndteres etter strenge sikkerhetsregler. Sikkerhet og pålitelighet er innebygd i hele plattformen."
            }
          },
          {
            "@type": "Question",
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Uttak kan be om når som helst via kontodashbordet ditt. Behandling tar vanligvis 1–3 virkedager, avhengig av valgt metode. Du ser alltid gebyrer og tidsrammer på forhånd — ingen overraskelser."
            }
          },
          {
            "@type": "Question",
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Den beste måten er å prøve selv. Start med minimumsinnskuddet og utforsk funksjonene trinn for trinn. Plattformen er laget for nybegynnere, men tilbyr kraftige verktøy, med support døgnet rundt når du trenger det. Du beholder kontrollen hele veien."
            }
          },
          {
            "@type": "Question",
            "name": "Trenger jeg tradingerfaring for å starte?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Ikke i det hele tatt. Alt er bygget for å være tilgjengelig fra dag én — med onboarding, enkle veiledninger og AI-assisterte verktøy. Enten du nettopp starter eller har erfaring, kan du gå videre i ditt eget tempo med support alltid tilgjengelig."
            }
          }
        ]
      }
  ...
  <header class="relative z-50 pt-3.5 md:pt-6">
    <div class="container-base">
      <div
        ...
        <a class="font-special inline-flex max-w-60 gap-1.5 text-xl leading-none uppercase header-nav-logo" href="<?= $site_url ?>/lander/<?= $site_domain ?>/no/">
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/no/" data-active>Hjem</a>
    </li>
    <li>
    ...
    <nav class="mobile-menu" data-mobile-menu>
      <ul class="flex flex-col flex-wrap items-center justify-center gap-y-8">
        <li>
          <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/no/">Hjem</a>
        </li>
        <li>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h1><?= $site_name ?></h1>
            <p>Opplev en ny æra av trading med vår avanserte kryptohandelsplattform. Med AI-teknologien fra <?= $site_name ?> kan du optimalisere avkastningen og ta informerte investeringsbeslutninger.</p>
        </div>
          ...
          <div class="grid gap-6">
            ...
            <div class="grid gap-3">
              ...
              <p class="text-xs text-white">
                Ved å oppgi personopplysningene dine og klikke på knappen, godtar du
                <a class="link-underline" href="privacy.php">Personvernregler</a>
                og
                <a class="link-underline" href="conditions.php">Bruksvilkår</a>
                for nettstedet.
              </p>
            </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 max-lg:order-2 md:gap-10">
      ...
      <p class="md:text-lg">
        Stolt brukt av moderne kryptotradere setter denne plattformen en ny standard. Vi kombinerer sterk sikkerhet, full åpenhet, avanserte algoritmer og et sømløst grensesnitt — alt du trenger for å handle trygt og lykkes.
      </p>
        ...
        <div class="grid grid-cols-2 gap-x-8 gap-y-6 max-sm:flex">
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            ...
            <div class="grid gap-2 md:gap-3">
              ...
              <p>Toppbeskyttelse for dataene og investeringene dine i hvert trinn.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Skreddersydd opplevelse</p>
              <p>Tilpass handelsstrategiene dine til dine unike mål og stil.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              ...
              <p>Nøyaktige tradinginnsikter som hjelper deg å ta beslutninger med trygghet.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Automatisert trading</p>
              <p>AI-drevne botter som jobber døgnet rundt for effektiv, profitfokusert handel.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Enkelt grensesnitt</p>
              <p>Rent, intuitivt design som gjør trading enkelt fra starten av.</p>
            </div>
          </div>
        </div>
      </div>
      <p class="h3">
        Transformer din økonomiske opplevelse med <?= $site_name ?> ™.
      </p>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Effektiv trading!</h2>
      <p class="text-lg">
        Handle kryptovaluta som Bitcoin, Ethereum og Dogecoin med letthet og trygghet.
      </p>
      <a class="btn btn-black max-md:hidden" href="sign.php">Kom i gang</a>
    </div>
    <div class="grid gap-3 md:gap-6" data-trading></div>
    <a class="btn btn-black md:hidden" href="sign.php">Kom i gang</a>
  </div>
</div>
<section class="feature-section">
  <div class="container">
    <div class="feature-header">
      <h2>
        Global handelsplattform <span>bygget for skala</span>
      </h2>
      <p>
        Få tilgang til flere finansmarkeder gjennom én samlet infrastruktur designet for ytelse, presisjon og global pålitelighet.
      </p>
    </div>
    <div class="feature-grid">
      <div class="feature-card">
        ...
        <p>
          Handle krypto, forex, aksjer og råvarer fra ett integrert miljø uten å bytte plattform.
        </p>
      </div>
      <div class="feature-card featured">
        ...
        <p>
          Optimalisert infrastruktur sikrer minimal latens og stabil ordreutførelse på globale markeder.
        </p>
      </div>
      <div class="feature-card">
        <div class="accent"></div>
        ...
        <p>
          Live data, avanserte indikatorer og markedsinnsikt hjelper deg å reagere raskere og ta bedre informerte beslutninger.
        </p>
      </div>
    </div>
  </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10">
    <div class="grid items-center gap-6 lg:grid-cols-2">
      <h2>Slik fungerer <?= $site_name ?>: din hurtigstartguide</h2>
      <p class="rounded-custom sm:border sm:p-8">
        Start din kryptoreise enkelt på plattformen vår. Vi veileder deg trinn for trinn — fra rask registrering til første innskudd og første handel.
      </p>
    </div>
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Registrer deg på få minutter, fyll inn opplysningene dine og få sikker tilgang til den offisielle plattformen.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Bekreft tilgangen din</p>
          <p>Verifiser e-posten din og lås opp full tilgang slik at du kan begynne å handle med én gang.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3"><?= $site_name ?>-innlogging</p>
          <p>Åpne handelskontoen din med et minimumsinnskudd på <?= $app_price ?> <?= $app_currency ?>. Høyere investeringer kan øke potensiell avkastning, men også risikoen.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Sett inn penger på kontoen</p>
          <p>Velg foretrukket metode — bankoverføring, e-lommebok eller kredittkort — og kom i gang med én gang.*</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Sett strategien din</p>
          <p>Tilpass kontoen til målene dine. Definer risikonivå, handelspreferanser og konfigurer strategien. Våre ekspertmeglere er her for å hjelpe — automatisert eller manuelt, du bestemmer.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Begynn å handle</p>
          <p>Du er klar. Gå inn i kryptomarkedet med trygghet og utforsk nye muligheter allerede i dag.</p>
        </div>
      </div>
    </div>
    <div class="grid gap-6 md:grid-cols-2">
      <a class="btn btn-black" href="sign.php">Begynn å handle</a>
    </div>
  </div>
</div>
    <!-- payments -->
    <div class="py-8 md:py-10">
      <div class="container-base grid items-center gap-6 lg:grid-cols-2">
        <p class="text-lg">
          <?= $site_name ?> aksepterer en rekke betalingsmetoder globalt.
        </p>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
            <p>
              <?= $site_name ?> overrasket meg positivt. Registreringen gikk raskt, gebyrene er tydelige, og supportteamet svarer faktisk og hjelper. Hele opplevelsen føles smidig og pålitelig — definitivt en plattform jeg blir hos.
            </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Privatinvestor') ?></div>
              <p class="font-bold">Privatinvestor</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Jeg prøvde endelig krypto og valgte <?= $site_name ?> — så langt ingen anger. Oppstarten tok bare noen minutter, og alt ble forklart tydelig. Det føles som et solid valg, spesielt hvis du er ny i trading.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Uavhengig trader') ?></div>
        ...
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  <?= $site_name ?> føles som en stabil og pålitelig plattform. Kontooppsettet var enkelt, vilkårene er klare, og support vet hva de gjør. Å handle her har vært en overraskende komfortabel opplevelse.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Digital aktivatrader') ?></div>
              <p class="font-bold">Digital aktivatrader</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Med <?= $site_name ?> føles ikke kryptotrading overveldende lenger. Registreringen var enkel, gebyrene er transparente, og det er support når du trenger det. Som nybegynner betyr det mye.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Søker passiv inntekt') ?></div>
              <p class="font-bold">Søker passiv inntekt</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
      <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
        ...
        <div id="content-1" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Du kan være operativ på bare noen minutter. Opprett en konto med grunnleggende opplysninger, fullfør et kort verifikasjonstrinn og sett inn minimum <?= $app_price ?> <?= $app_currency ?>. Deretter låser du opp hele plattformen — live grafer, handelsverktøy og funksjoner for en trygg start.</p>
          </div>
        </div>
      </div>
      <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Er pengene og dataene mine trygge? Er <?= $site_name ?> pålitelig?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-2" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Absolutt. Vi beskytter kontoen din med avansert SSL-kryptering, 2FA-verifisering og sikker kaldlagring av midler. Transaksjoner behandles via pålitelige leverandører, og personopplysninger håndteres etter strenge sikkerhetsregler. Sikkerhet og pålitelighet er innebygd i hele plattformen.</p>
          </div>
        </div>
      </div>
      <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
        ...
        <div id="content-3" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Uttak kan be om når som helst via kontodashbordet ditt. Behandling tar vanligvis 1–3 virkedager, avhengig av valgt metode. Du ser alltid gebyrer og tidsrammer på forhånd — ingen overraskelser.</p>
          </div>
        </div>
      </div>
      <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
        ...
        <div id="content-4" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Den beste måten er å prøve selv. Start med minimumsinnskuddet og utforsk funksjonene trinn for trinn. Plattformen er laget for nybegynnere, men tilbyr kraftige verktøy, med support døgnet rundt når du trenger det. Du beholder kontrollen hele veien.</p>
          </div>
        </div>
      </div>
      <div id="accordion-5" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Trenger jeg tradingerfaring for å starte?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-5" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Ikke i det hele tatt. Alt er bygget for å være tilgjengelig fra dag én — med onboarding, enkle veiledninger og AI-assisterte verktøy. Enten du nettopp starter eller har erfaring, kan du gå videre i ditt eget tempo med support alltid tilgjengelig.</p>
          </div>
        </div>
      </div>
      <div id="accordion-6" class="group border-primary rounded-custom border transition-all">
        ...
        <div id="content-6" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p style="margin-bottom:16px;"><?= $site_name ?> er en global handelsplattform bygget for brukere som forventer jevn ytelse, rask utførelse og full kontroll over handelsmiljøet sitt. I stedet for flere frakoblede verktøy eller regionale tjenester tilbyr plattformen ett strukturert system der alle kjernefunksjoner er integrert i én arbeidsflyt.</p>
            <p style="margin-bottom:16px;">Fra markedstilgang til ordreutførelse og analyse er hver komponent designet for å fungere sammen uten unødvendig friksjon. Brukere kan fokusere på beslutninger i stedet for komplekse systemer eller plattformbytte.</p>
            <p style="margin-bottom:10px; font-weight:500;">I ett grensesnitt kan brukere operere på flere finansmarkeder:</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Kryptovaluta, inkludert store og nye digitale aktiva</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Valutamarkeder med sanntidsprising</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Globale aksjer og børsinstrumenter</li>
              <li><span style="color:#6D5DF6;">•</span> Råvarer for bredere porteføljediversifisering</li>
            </ul>
            <p style="margin-bottom:16px;">Ytelse er en kjerneprioritet. Infrastrukturen er optimalisert for lav latens og stabil drift også i perioder med høy markedsaktivitet.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Rask og jevn ordreutførelse på tvers av markeder</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Kontinuerlige sanntidsdata og prisoppdateringer</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Innebygde analytiske verktøy og markedsindikatorer</li>
              <li><span style="color:#6D5DF6;">•</span> Støtte for manuelle og automatiserte strategier</li>
            </ul>
            <p style="margin-bottom:16px;">Sikkerhet og operativ pålitelighet er integrert i hvert lag av systemet. Plattformen følger bransjestandarder og bruker interne sikringstiltak slik at brukerdata og finansielle operasjoner forblir beskyttet.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Kryptert dataoverføring i alle interaksjoner</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Flerlags kontoverifisering og autentisering</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Verifisert transaksjonsbehandling og overvåking</li>
              <li><span style="color:#6D5DF6;">•</span> Infrastruktur designet for stabil global tilgjengelighet</li>
            </ul>
            <p style="margin-bottom:16px;">Samtidig er brukervennlighet et viktig fokus. Grensesnittet er bevisst rent og forutsigbart, med mindre unødvendig kompleksitet slik at du kan fokusere på handelsstrategier.</p>
            <p style="margin-bottom:16px;">Denne balansen mellom ytelse og enkelhet gjør plattformen egnet for både nye og erfarne tradere.</p>
            <p><?= $site_name ?> kombinerer skalerbarhet, pålitelighet og effektivitet i ett miljø og gir strukturert, pålitelig tilgang til globale finansmarkeder med trygghet.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h2>Dette er trading med den offisielle plattformen™</h2>
          <p>
            Vi er den pålitelige plattformen for privatpersoner og bedrifter som kjøper, selger og administrerer kryptovaluta.
          </p>
        </div>
        <form name="form" method="post"
          class="leadform rf-form js-rf-form group bg-primary rounded-custom relative overflow-hidden px-4 py-8 md:px-8" action="../integration/send.php" data-form>
  ...
  <section style="padding:60px 0;" class="md:!py-[100px]">
    ...
    ">
      ...
      ">
        ...
        ">
          Kjernefunksjoner i <span style='color:#6B5FA7;'>handelsplattformen <?= $site_name ?></span>
        </h2>
      <p style="margin-top:14px;color:#6b7280;font-size:17px;">
        Alt du trenger for å handle smartere, raskere og med trygghet.
      </p>
    </div>
    <div style="
      border-radius:16px;
    ...
    ">
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Kompatibilitet på flere enheter
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Forex, aksjer, krypto, råvarer og mer
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
  ...
  <div class="border-primary-light grid justify-items-center gap-6 rounded-[20px] border px-4 py-5 md:gap-4 md:px-8 md:py-6 text-center md:text-left">
    ...
    <div class="flex flex-wrap items-center justify-center md:justify-start gap-2.5 text-center md:text-left">
      ...
      <span class="leading-none text-amber-500" role="img"
        aria-label="<?= $rating_value ?> Poengsum av 5">
        <?= $stars ?>
      </span>
      <span class="flex flex-wrap justify-center md:justify-start gap-1 text-sm text-gray-400">
        ...
        <span>
          Basert på <strong><?= $rating_count ?></strong> vurderinger ·
        </span>
        <span>
          Poengsum av 5
        </span>
    ...
    <p class="text-center md:text-left">
      En kraftig og brukervennlig handelsplattform med robust automatisering og omfattende læringsressurser.
    </p>
  </div>
</div>
      </div>
        ...
        <div class="grid gap-5">
          <nav class="flex flex-col flex-wrap justify-between gap-x-10 gap-y-5 text-white md:flex-row">
            <a class="font-special inline-flex max-w-60 gap-1.5 text-xl leading-none text-white uppercase max-md:pr-[120px] footer-nav-logo"
              href="<?= $site_url ?>/lander/<?= $site_domain ?>/no/">
            ...
            <ul class="flex flex-col gap-x-5 gap-y-4 md:flex-row">
              <li>
                <a href="privacy.php">Personvernregler</a>
              </li>
              <li>
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p style="color:#6B5FA7;">Din pålitelige tradingpartner</p>
  ...
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ja/" hreflang="ja" title="日本語">
    🇯🇵
        ...
        <div class="grid gap-2.5 text-sm text-gray-500">
            <p>
                <?= $site_name ?> er ikke ansvarlig for tap eller skade som kan følge av bruk av informasjonen på dette nettstedet, inkludert opplæringsinnhold, kurser, grafer og analyser. Handel på finansmarkeder innebærer risiko; det er viktig å vurdere dine personlige forhold og ved behov søke råd fra en kvalifisert fagperson før du starter. Invester bare penger du har råd til å tape, og husk at instrumenter som FX, CFD-er og kryptovaluta kanskje ikke passer for alle.
            </p>
        </div>
        <div class="text-center text-white">
          Copyright 2026 © <?= $site_name ?>, Alle rettigheter reservert
        </div>
      </div>
    </div>
  </footer>
