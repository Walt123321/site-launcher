...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 Digital analyse <?= $site_name ?> ™ 💸",
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="Verktøy for å administrere krypto og aktiva med analyse og automatisering." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/no/">Hjem</a>
    </li>
    <li>
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/no/" class="breadcrumb-item">Hjem</a>
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20">Digital analyse <?= $site_name ?> ™</h1>
      <p class="relative z-20">
        Få verdifulle innsikter og driv vekst med vår avanserte analyseplattform. Ta informerte, datadrevne beslutninger med trygghet. Finjuster strategien og oppnå målbare resultater.
      </p>
    </div>
    ...
    <div class="grid gap-6 md:gap-10">
      ...
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        ...
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Kryptoadministrasjon</p>
            <p>Tilgang til hvert aktivum</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Portefølje</p>
          <p>Her viser jeg min profesjonelle karriere gjennom imponerende prosjekter og kreative løsninger.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Kjøp kryptovaluta</p>
          <p>En sikker og enkel plattform for å kjøpe kryptovaluta. Raske transaksjoner med minimale gebyrer. Begynn å handle i dag.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Lær mer om markedsverdier og trender for informerte investerings- og forretningsbeslutninger.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Kryptoaktiva</p>
          <p>Utforsk fremtiden for finans med ledende kryptovaluta. Oppdag, invester, voks.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">La oss kjøre!</p>
<p>
  Utforsk kryptovalutaens verden med <?= $site_name ?>. Norske tradere får tilgang til en plattform som kombinerer innovasjon, effektivitet og profittmuligheter.
</p>
          </div>
        ...
        <div class="grid gap-5">
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p>Din pålitelige tradingpartner</p>
