...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Bruksvilkår | <?= $site_name ?></title>
    <meta name="description" content="Les bruksvilkårene for <?= $site_name ?>." />
    <meta charset="UTF-8" />
  ...
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <div class="grid gap-5 md:gap-7">
        <nav aria-label="breadcrumb" class="flex flex-wrap items-center text-sm text-gray-500 md:text-lg">
            ...
            <span class="breadcrumb-item">Bruksvilkår</span>
        </nav>
        <h1>Bruksvilkår</h1>
    </div>
<div class="grid gap-6 md:gap-8">
  <div class="grid gap-2 md:gap-4">
    ...
    <p>Dette nettstedet gir informasjon om tredjeparts handelsplattformer og relaterte tjenester. Ved å bruke nettstedet godtar du disse vilkårene og våre personvernregler. Vilkårene kan oppdateres når som helst.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Kvalifikasjon</h2>
    <p>Du må være minst 18 år, kunne godta disse vilkårene og ikke være begrenset av lokale lover. Vi er ikke ansvarlige for ulovlig bruk av nettstedet.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Begrenset tilgang</h2>
    <p>Vi kan begrense tilgang for brukere fra visse regioner eller der det gjelder juridiske eller regulatoriske risikoer. Tjenester kan være utilgjengelige på begrensede steder.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Forbudt bruk</h2>
    <p>Du må ikke misbruke nettstedet, inkludert brudd på lover, krenkelse av rettigheter, spredning av skadelig innhold eller bruk av automatiserte systemer. Vi kan begrense tilgang ved brudd på vilkårene.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Immaterielle rettigheter</h2>
    <p>Alt innhold, varemerker og materiale tilhører oss eller tredjeparter. Du kan bare bruke nettstedet til personlig bruk og må ikke kopiere eller endre innhold.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Ansvar</h2>
    <p>Nettstedet og tjenestene leveres «som de er». Vi er ikke ansvarlige for feil, tap eller skade som følge av bruk av nettstedet.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Tredjepartstjenester</h2>
    <p>Vi kan vise innhold eller lenker fra tredjeparter. Vi er ikke ansvarlige for nøyaktighet eller tjenester. Verifiser informasjon før du tar beslutninger.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Lenker</h2>
    <p>Lenker til eksterne nettsteder er kun for enkelhets skyld. Vi støtter eller kontrollerer dem ikke og er ikke ansvarlige for innholdet.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">9. Diverse</h2>
    <p>Vi kan oppdatere eller endre tjenester og vilkår når som helst. Disse vilkårene utgjør hele avtalen mellom deg og oss. Ikke-utøvede rettigheter anses ikke frafalt.</p>
  </div>
</div>
      </div>
    </main>
