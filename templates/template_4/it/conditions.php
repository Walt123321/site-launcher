...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Condizioni d'uso | <?= $site_name ?></title>
    <meta name="description" content="Leggi i termini e le condizioni d'uso di <?= $site_name ?>." />
    <meta charset="UTF-8" />
  ...
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <div class="grid gap-5 md:gap-7">
        <nav aria-label="breadcrumb" class="flex flex-wrap items-center text-sm text-gray-500 md:text-lg">
            ...
            <span class="breadcrumb-item">Condizioni d'uso</span>
        </nav>
        <h1>Condizioni d'uso</h1>
    </div>
<div class="grid gap-6 md:gap-8">
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Generale</h2>
    <p>Questo sito web fornisce informazioni su piattaforme di trading di terze parti e servizi correlati. Utilizzando il sito, accetti questi Termini e la nostra Informativa sulla privacy. I termini possono essere aggiornati in qualsiasi momento.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Idoneità</h2>
    <p>Devi avere almeno 18 anni, poter accettare questi Termini e non essere limitato dalle leggi locali. Non siamo responsabili dell'uso illecito del sito web.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Accesso limitato</h2>
    <p>Possiamo limitare l'accesso agli utenti di determinate regioni o dove si applicano rischi legali o normativi. I servizi potrebbero non essere disponibili in aree limitate.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Uso vietato</h2>
    <p>Non devi fare un uso improprio del sito web, inclusa la violazione di leggi, la lesione di diritti, la diffusione di contenuti dannosi o l'uso di sistemi automatizzati. Possiamo limitare l'accesso in caso di violazione dei Termini.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Proprietà intellettuale</h2>
    <p>Tutti i contenuti, marchi e materiali appartengono a noi o a terze parti. Puoi usare il sito solo per uso personale e non devi copiare o modificare i contenuti.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Responsabilità</h2>
    <p>Il sito web e i servizi sono forniti «così come sono». Non siamo responsabili per errori, perdite o danni derivanti dall'uso del sito web.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Servizi di terze parti</h2>
    <p>Possiamo mostrare contenuti o link di terze parti. Non siamo responsabili della loro accuratezza o dei loro servizi. Verifica le informazioni prima di prendere decisioni.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Link</h2>
    <p>I link a siti esterni sono forniti solo per comodità. Non li approviamo né li controlliamo e non siamo responsabili dei loro contenuti.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">9. Varie</h2>
    <p>Possiamo aggiornare o modificare servizi e Termini in qualsiasi momento. Questi Termini costituiscono l'accordo completo tra te e noi. I diritti non esercitati non costituiscono rinuncia.</p>
  </div>
</div>
      </div>
    </main>
