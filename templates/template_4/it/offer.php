...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 Ottieni Portfolio Tracker 💸",
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Offerta | <?= $site_name ?></title>
    <meta name="description" content="Scegli un piano con <?= $site_name ?> adatto alle tue esigenze di trading." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="offer.php" data-active>Offerta</a>
    </li>
    <li>
...
<span class="breadcrumb-item">Offerta</span>
          </nav>
        </div>
      </div>
      <!-- tracker -->
      <div class="py-8 md:py-10">
        <div class="container-base grid gap-6 lg:grid-cols-2">
          ...
          >
 <h1 class="relative z-20">Ottieni Portfolio Tracker</h1>
<p class="relative z-20">
  Inizia in pochi minuti: registrati, deposita e comincia a operare in soli 5 minuti. Inizia ora.
</p>
          </div>
