...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Informativa sulla privacy | <?= $site_name ?></title>
    <meta name="description" content="Scopri come <?= $site_name ?> raccoglie e protegge i tuoi dati." />
    <!-- Favicon -->
...
<div class="grid gap-6 md:gap-8">
  ...
  <div class="grid gap-2">
    <p class="text-sm">Ultimo aggiornamento: <?= $privacy_last_update ?></p>
    <p>Noi («Noi») rispettiamo la tua privacy e ci impegniamo a proteggere i tuoi dati personali. Questa informativa spiega come <?= $site_name ?> raccoglie, utilizza e protegge le tue informazioni.</p>
  </div>
  <!-- PRINCIPLES -->
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Trasparenza</p>
    <p>
      Spieghiamo chiaramente come vengono utilizzati i tuoi dati. Contattaci a 
      <a href="mailto:info@<?= $site_domain ?>">info@<?= $site_domain ?></a>
    </p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Utilizzo dei dati</p>
    <p>I tuoi dati sono utilizzati per fornire servizi, migliorare la piattaforma e adempiere agli obblighi legali.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">I tuoi diritti</p>
    <p>Puoi richiedere accesso, rettifica o cancellazione dei tuoi dati in qualsiasi momento.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Sicurezza</p>
    <p>Proteggiamo i tuoi dati ma non possiamo garantire sicurezza assoluta.</p>
  </div>
  <!-- SECTIONS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Raccolta dati</h2>
    <p>Raccogliamo dati di utilizzo (IP, dispositivo, browser) e tutti i dati che fornisci.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Base legale</h2>
    <p>Il trattamento si basa su consenso, interesse legittimo e obblighi legali.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Condivisione dati</h2>
    <p>Possiamo condividere dati con partner, fornitori e autorità se necessario.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Cookie</h2>
    <p>Utilizziamo cookie per funzionalità e analisi. Puoi disabilitarli.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Conservazione dati</h2>
    <p>I dati sono conservati solo per il tempo necessario.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Trasferimenti internazionali</h2>
    <p>I dati possono essere trasferiti con garanzie appropriate.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Link di terze parti</h2>
    <p>Non siamo responsabili dei siti web esterni.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Aggiornamenti</h2>
    <p>Questa informativa può essere aggiornata.</p>
  </div>
  <!-- RIGHTS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">I tuoi diritti</h2>
    <p>Hai il diritto di accedere, rettificare, cancellare, limitare o trasferire i tuoi dati, revocare il consenso e presentare un reclamo.</p>
  </div>
</div>
          </div>
        </div>
