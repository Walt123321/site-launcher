...
?>
<!DOCTYPE html>
<html class="scroll-smooth" lang="it" data-theme="orange">
<!-- head -->
<head>
  ...
  "itemListElement": [
    {
      ...
      "position": 1,
      "name": "<?= $site_name ?>",
      "item": "<?= $site_url ?>/lander/<?= $site_domain ?>/it/"
    },
    {
      "@type": "ListItem",
      "position": 2,
        ...
        "mainEntity": [
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Puoi essere operativo in pochi minuti. Crea un account con i dati di base, completa un breve passaggio di verifica e deposita un minimo di <?= $app_price ?> <?= $app_currency ?>. Dopo sbloccherai l'intera piattaforma — grafici live, strumenti di trading e funzionalità per iniziare con fiducia."
            }
          },
          {
            "@type": "Question",
            "name": "I miei soldi e i miei dati sono al sicuro? <?= $site_name ?> è affidabile?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Assolutamente. Proteggiamo il tuo account con crittografia SSL avanzata, verifica 2FA e cold storage sicuro per i fondi. Le transazioni passano tramite provider affidabili e i dati personali sono gestiti con rigide policy di sicurezza. Sicurezza e affidabilità sono integrate in ogni parte della piattaforma."
            }
          },
          {
            "@type": "Question",
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "I prelievi possono essere richiesti in qualsiasi momento dalla dashboard del conto. L'elaborazione richiede di solito 1–3 giorni lavorativi, a seconda del metodo scelto. Vedrai sempre commissioni e tempi applicabili in anticipo — nessuna sorpresa."
            }
          },
          {
            "@type": "Question",
            "name": "Come faccio a sapere se questa piattaforma fa per me?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Il modo migliore è provarla tu stesso. Inizia con il deposito minimo ed esplora le funzionalità passo dopo passo. La piattaforma è pensata per i principianti ma offre strumenti potenti, con supporto 24/7 quando serve. Mantieni il controllo in ogni momento."
            }
          },
          {
            "@type": "Question",
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Per niente. Tutto è progettato per essere accessibile dal primo giorno — con guida all'onboarding, tutorial semplici e strumenti assistiti dall'AI. Che tu stia iniziando ora o abbia già esperienza, puoi procedere al tuo ritmo con supporto sempre disponibile."
            }
          }
        ]
      }
  ...
  <header class="relative z-50 pt-3.5 md:pt-6">
    <div class="container-base">
      <div
        ...
        <a class="font-special inline-flex max-w-60 gap-1.5 text-xl leading-none uppercase header-nav-logo" href="<?= $site_url ?>/lander/<?= $site_domain ?>/it/">
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/it/" data-active>Home</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="product.php">Prodotto</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="offer.php">Offerta</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="contacts.php">Contatti</a>
    </li>
    <li>
    ...
    <nav class="mobile-menu" data-mobile-menu>
      <ul class="flex flex-col flex-wrap items-center justify-center gap-y-8">
        <li>
          <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/it/">Home</a>
        </li>
        <li>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h1><?= $site_name ?></h1>
            <p>Vivi una nuova era del trading con la nostra piattaforma avanzata per il trading di criptovalute. Con la tecnologia AI di <?= $site_name ?>, puoi ottimizzare i rendimenti e prendere decisioni di investimento informate.</p>
        </div>
        <form name="form" method="post"
          ...
          <input type="hidden" name="phone_country" value="it">
          <input type="hidden" name="only_countries" value='["it"]'>
          ...
          <div class="grid gap-6">
            <div class="grid gap-2 md:gap-3.5">
              <label class="grid gap-1.5">
                ...
                <input class="input" type="text" name="fname" placeholder="Inserisci il tuo nome" required />
              </label>
              <label class="grid gap-1.5">
                <span class="label text-white">Cognome</span>
                <input class="input" type="text" name="lname" placeholder="Inserisci il tuo cognome" required />
              </label>
              <label class="grid gap-1.5">
              ...
              <label class="grid gap-1.5">
                <span class="label text-white">Telefono</span>
            ...
            <div class="grid gap-3">
              ...
              <p class="text-xs text-white">
                Inserendo i tuoi dati personali e cliccando il pulsante, accetti l'
                <a class="link-underline" href="privacy.php">Informativa sulla privacy</a>
                e le
                <a class="link-underline" href="conditions.php">Condizioni d'uso</a>
                del sito web.
              </p>
            </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-3 md:grid-cols-2 md:gap-6 xl:grid-cols-4">
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      ...
      <p class="h3">Valute disponibili</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
    ...
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      ...
      <p class="h3">Volume di trading</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">100+</p>
      <p class="h3">Paesi supportati</p>
    </div>
  </div>
</div>
    <!-- features -->
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 max-lg:order-2 md:gap-10">
      <h2>Perché scegliere <?= $site_name ?>?</h2>
      <p class="md:text-lg">
        Affidata dai trader crypto moderni, questa piattaforma stabilisce un nuovo standard. Combiniamo sicurezza robusta, totale trasparenza, algoritmi avanzati e un'interfaccia fluida per offrirti tutto ciò che serve per operare con fiducia e avere successo.
      </p>
        ...
        <div class="grid grid-cols-2 gap-x-8 gap-y-6 max-sm:flex">
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Sicurezza di cui puoi fidarti</p>
              <p>Protezione di alto livello per i tuoi dati e investimenti in ogni fase.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Esperienza su misura</p>
              <p>Personalizza le strategie di trading in base ai tuoi obiettivi e al tuo stile.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Strategie AI intelligenti</p>
              <p>Approfondimenti di trading accurati per aiutarti a prendere decisioni con fiducia.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Trading automatizzato</p>
              <p>Bot guidati dall'AI attivi 24 ore su 24 per operazioni efficienti orientate al profitto.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              ...
              <p>Design pulito e intuitivo che rende il trading semplice fin dal primo giorno.</p>
            </div>
          </div>
        </div>
      </div>
      <p class="h3">
        Trasforma la tua esperienza finanziaria con <?= $site_name ?> ™.
      </p>
      <a class="btn btn-black" href="sign.php">Registrati</a>
    </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Trading efficiente!</h2>
      <p class="text-lg">
        Opera su criptovalute come Bitcoin, Ethereum e Dogecoin con facilità e fiducia.
      </p>
      <a class="btn btn-black max-md:hidden" href="sign.php">Inizia</a>
    </div>
    <div class="grid gap-3 md:gap-6" data-trading></div>
    <a class="btn btn-black md:hidden" href="sign.php">Inizia</a>
  </div>
</div>
<section class="feature-section">
  <div class="container">
    <div class="feature-header">
      <h2>
        Piattaforma di trading globale <span>progettata per scalare</span>
      </h2>
      <p>
        Accedi a più mercati finanziari tramite un'infrastruttura unificata pensata per performance, precisione e affidabilità globale.
      </p>
    </div>
    <div class="feature-grid">
      <div class="feature-card">
        ...
        <p>
          Opera su criptovalute, forex, azioni e materie prime da un unico ambiente integrato senza cambiare piattaforma.
        </p>
      </div>
      <div class="feature-card featured">
        <div class="accent"></div>
        <h3>Esecuzione rapida</h3>
        <p>
          Infrastruttura ottimizzata che garantisce latenza minima ed esecuzione stabile degli ordini sui mercati globali.
        </p>
      </div>
      <div class="feature-card">
        <div class="accent"></div>
        ...
        <p>
          Dati live, indicatori avanzati e insight di mercato ti aiutano a reagire più velocemente e a prendere decisioni più informate.
        </p>
      </div>
    </div>
  </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10">
    <div class="grid items-center gap-6 lg:grid-cols-2">
      <h2>Come funziona <?= $site_name ?>: la tua guida rapida</h2>
      <p class="rounded-custom sm:border sm:p-8">
        Inizia il tuo percorso nel trading crypto senza sforzo sulla nostra piattaforma. Ti guidiamo passo dopo passo — dalla registrazione rapida al primo deposito e alla prima operazione.
      </p>
    </div>
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Registrati in pochi minuti, inserisci i tuoi dati e ottieni accesso sicuro alla piattaforma ufficiale.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Conferma l'accesso</p>
          <p>Verifica la tua e-mail e sblocca l'accesso completo per iniziare a operare subito.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Accesso <?= $site_name ?></p>
          <p>Apri il tuo conto di trading con un deposito minimo di <?= $app_price ?> <?= $app_currency ?>. Investimenti maggiori possono aumentare i rendimenti potenziali, ma anche il rischio.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Deposita fondi sul conto</p>
          <p>Scegli il metodo preferito — bonifico bancario, e-wallet o carta di credito — e inizia subito.*</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Imposta la strategia</p>
          <p>Adatta il conto ai tuoi obiettivi. Definisci il livello di rischio, le preferenze di trading e configura la strategia. I nostri broker esperti sono qui per supportarti — automatico o manuale, decidi tu.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Inizia a operare</p>
          <p>Tutto pronto. Entra nel mercato crypto con fiducia ed esplora nuove opportunità già oggi.</p>
        </div>
      </div>
    </div>
    <div class="grid gap-6 md:grid-cols-2">
      <a class="btn btn-black" href="sign.php">Inizia a operare</a>
    </div>
  </div>
</div>
    <!-- payments -->
    <div class="py-8 md:py-10">
      <div class="container-base grid items-center gap-6 lg:grid-cols-2">
        <p class="text-lg">
          <?= $site_name ?> accetta diverse modalità di pagamento in tutto il mondo.
        </p>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
    <div class="flex items-center justify-between gap-6 mb-6 reviews-flex-block">
      <h2 class="text-2xl font-bold">Recensioni <?= $site_name ?> ™</h2>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
            <p>
              <?= $site_name ?> mi ha piacevolmente sorpreso. La registrazione è stata rapida, le commissioni sono chiare e il team di supporto risponde e aiuta davvero. L'esperienza complessiva è fluida e affidabile — una piattaforma su cui resto volentieri.
            </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Investitore privato') ?></div>
              <p class="font-bold">Investitore privato</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Finalmente ho provato le criptovalute con <?= $site_name ?> — per ora nessun rimpianto. Iniziare ha richiesto solo pochi minuti e tutto è stato spiegato chiaramente. Sembra un'opzione solida, soprattutto se sei nuovo nel trading.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Trader indipendente') ?></div>
              <p class="font-bold">Trader indipendente</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  <?= $site_name ?> sembra una piattaforma stabile e affidabile. L'apertura del conto è stata semplice, le condizioni sono chiare e il supporto sa il fatto suo. Operare qui è stata un'esperienza sorprendentemente confortevole.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Trader di asset digitali') ?></div>
              <p class="font-bold">Trader di asset digitali</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Con <?= $site_name ?>, il trading crypto non è più opprimente. La registrazione è stata semplice, le commissioni sono trasparenti e c'è supporto quando serve. Da principiante, fa davvero la differenza.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Cercatore di reddito passivo') ?></div>
              <p class="font-bold">Cercatore di reddito passivo</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
      <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Come inizio?</span>
        ...
        <div id="content-1" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Puoi essere operativo in pochi minuti. Crea un account con i dati di base, completa un breve passaggio di verifica e deposita un minimo di <?= $app_price ?> <?= $app_currency ?>. Dopo sbloccherai l'intera piattaforma — grafici live, strumenti di trading e funzionalità per iniziare con fiducia.</p>
          </div>
        </div>
      </div>
      <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">I miei soldi e i miei dati sono al sicuro? <?= $site_name ?> è affidabile?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-2" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Assolutamente. Proteggiamo il tuo account con crittografia SSL avanzata, verifica 2FA e cold storage sicuro per i fondi. Le transazioni passano tramite provider affidabili e i dati personali sono gestiti con rigide policy di sicurezza. Sicurezza e affidabilità sono integrate in ogni parte della piattaforma.</p>
          </div>
        </div>
      </div>
      <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Quando posso prelevare i profitti?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-3" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>I prelievi possono essere richiesti in qualsiasi momento dalla dashboard del conto. L'elaborazione richiede di solito 1–3 giorni lavorativi, a seconda del metodo scelto. Vedrai sempre commissioni e tempi applicabili in anticipo — nessuna sorpresa.</p>
          </div>
        </div>
      </div>
      <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Come faccio a sapere se questa piattaforma fa per me?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-4" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Il modo migliore è provarla tu stesso. Inizia con il deposito minimo ed esplora le funzionalità passo dopo passo. La piattaforma è pensata per i principianti ma offre strumenti potenti, con supporto 24/7 quando serve. Mantieni il controllo in ogni momento.</p>
          </div>
        </div>
      </div>
      <div id="accordion-5" class="group border-primary rounded-custom border transition-all">
        ...
        <div id="content-5" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Per niente. Tutto è progettato per essere accessibile dal primo giorno — con guida all'onboarding, tutorial semplici e strumenti assistiti dall'AI. Che tu stia iniziando ora o abbia già esperienza, puoi procedere al tuo ritmo con supporto sempre disponibile.</p>
          </div>
        </div>
      </div>
      <div id="accordion-6" class="group border-primary rounded-custom border transition-all">
        ...
        <div id="content-6" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p style="margin-bottom:16px;"><?= $site_name ?> è una piattaforma di trading globale costruita per utenti che si aspettano prestazioni costanti, esecuzione rapida e pieno controllo sull'ambiente di trading. Invece di affidarsi a più strumenti scollegati o servizi regionali, la piattaforma offre un unico sistema strutturato in cui tutte le funzioni principali sono integrate in un flusso di lavoro.</p>
            <p style="margin-bottom:16px;">Dall'accesso al mercato all'esecuzione degli ordini e all'analisi, ogni componente è progettato per funzionare insieme senza attriti inutili. Gli utenti possono concentrarsi sulle decisioni invece che su sistemi complessi o cambi di piattaforma.</p>
            <p style="margin-bottom:10px; font-weight:500;">In un'unica interfaccia, gli utenti possono operare su più mercati finanziari:</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Criptovalute, inclusi asset digitali principali ed emergenti</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Mercati valutari con prezzi in tempo reale</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Azioni e strumenti azionari globali</li>
              <li><span style="color:#6D5DF6;">•</span> Materie prime per una maggiore diversificazione del portafoglio</li>
            </ul>
            <p style="margin-bottom:16px;">Le prestazioni sono una priorità centrale della piattaforma. L'infrastruttura è ottimizzata per esecuzioni a bassa latenza e funzionamento stabile anche in periodi di alta attività di mercato.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Esecuzione rapida e coerente degli ordini su tutti i mercati</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Dati e aggiornamenti dei prezzi in tempo reale continui</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Strumenti analitici e indicatori di mercato integrati</li>
              <li><span style="color:#6D5DF6;">•</span> Supporto per strategie manuali e automatizzate</li>
            </ul>
            <p style="margin-bottom:16px;">Sicurezza e affidabilità operativa sono integrate in ogni livello del sistema. La piattaforma segue standard di settore e applica salvaguardie interne per mantenere protetti dati utente e operazioni finanziarie.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Trasmissione dati crittografata in tutte le interazioni</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Verifica e autenticazione dell'account su più livelli</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Elaborazione e monitoraggio delle transazioni verificati</li>
              <li><span style="color:#6D5DF6;">•</span> Infrastruttura progettata per accessibilità globale stabile</li>
            </ul>
            <p style="margin-bottom:16px;">Al contempo, l'usabilità resta un focus chiave. L'interfaccia è volutamente pulita e prevedibile, riducendo la complessità inutile per concentrarsi sulle strategie di trading.</p>
            <p style="margin-bottom:16px;">Questo equilibrio tra prestazioni e semplicità rende la piattaforma adatta sia ai nuovi utenti sia ai trader esperti.</p>
            <p><?= $site_name ?> combina scalabilità, affidabilità ed efficienza in un unico ambiente, offrendo un accesso strutturato e affidabile ai mercati finanziari globali con fiducia.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h2>Questo è il trading con la piattaforma ufficiale™</h2>
          <p>
            Siamo la piattaforma di fiducia per privati e aziende che acquistano, vendono e gestiscono criptovalute.
          </p>
        </div>
        <form name="form" method="post"
          class="leadform rf-form js-rf-form group bg-primary rounded-custom relative overflow-hidden px-4 py-8 md:px-8" action="../integration/send.php" data-form>
  ...
  <section style="padding:60px 0;" class="md:!py-[100px]">
    ...
    ">
      ...
      ">
        ...
        ">
          Funzionalità principali della <span style='color:#6B5FA7;'>piattaforma di trading <?= $site_name ?></span>
        </h2>
      <p style="margin-top:14px;color:#6b7280;font-size:17px;">
        Tutto ciò che ti serve per operare in modo più intelligente, veloce e con fiducia.
      </p>
    </div>
    <div style="
      border-radius:16px;
    ...
    ">
      ...
      " onmouseover="this.style.background='#f9f9fb'" class="row-block" onmouseout="this.style.background='transparent'">
        ...
        <div class="row-text" style="color:#6b7280;">
          Motore di trading avanzato con AI
        </div>
      </div>
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Carte di credito, bonifici bancari, PayPal
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Forex, azioni, crypto, materie prime e altro
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Onboarding rapido ed efficiente
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
  ...
  <div class="border-primary-light grid justify-items-center gap-6 rounded-[20px] border px-4 py-5 md:gap-4 md:px-8 md:py-6 text-center md:text-left">
    ...
    <div class="flex flex-wrap items-center justify-center md:justify-start gap-2.5 text-center md:text-left">
      ...
      <span class="leading-none text-amber-500" role="img"
        aria-label="<?= $rating_value ?> Punteggio su 5">
        <?= $stars ?>
      </span>
      <span class="flex flex-wrap justify-center md:justify-start gap-1 text-sm text-gray-400">
        <span>
          <strong>318</strong> recensioni ·
        </span>
        <span>
          Basato su <strong><?= $rating_count ?></strong> valutazioni ·
        </span>
        <span>
          Punteggio su 5
        </span>
    ...
    <p class="text-center md:text-left">
      Piattaforma di trading potente e facile da usare, con automazione robusta e risorse educative complete.
    </p>
  </div>
</div>
      </div>
        ...
        <div class="grid gap-5">
          <nav class="flex flex-col flex-wrap justify-between gap-x-10 gap-y-5 text-white md:flex-row">
            <a class="font-special inline-flex max-w-60 gap-1.5 text-xl leading-none text-white uppercase max-md:pr-[120px] footer-nav-logo"
              href="<?= $site_url ?>/lander/<?= $site_domain ?>/it/">
            ...
            <ul class="flex flex-col gap-x-5 gap-y-4 md:flex-row">
              ...
              <li>
                <a href="conditions.php">Condizioni d'uso</a>
              </li>
              <li>
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p style="color:#6B5FA7;">Il tuo partner di trading di fiducia</p>
  ...
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ja/" hreflang="ja" title="日本語">
    🇯🇵
        ...
        <div class="grid gap-2.5 text-sm text-gray-500">
            <p>
                <?= $site_name ?> non è responsabile per perdite o danni derivanti dall'uso delle informazioni fornite su questo sito web, inclusi contenuti educativi, quotazioni, grafici e analisi. Il trading sui mercati finanziari comporta rischi: è importante considerare le proprie circostanze personali e, se necessario, chiedere il parere di un professionista qualificato prima di iniziare. Investi solo denaro che puoi permetterti di perdere e ricorda che strumenti come FX, CFD e criptovalute potrebbero non essere adatti a tutti.
            </p>
        </div>
        <div class="text-center text-white">
          Copyright 2026 © <?= $site_name ?>, Tutti i diritti riservati
        </div>
      </div>
    </div>
  </footer>
