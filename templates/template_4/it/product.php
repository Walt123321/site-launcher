...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 Analisi digitale <?= $site_name ?> ™ 💸",
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Prodotto | <?= $site_name ?></title>
    <meta name="description" content="Strumenti per gestire crypto e asset con analisi e automazione." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/it/">Home</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="product.php" data-active>Prodotto</a>
    </li>
    <li>
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/it/" class="breadcrumb-item">Home</a>
      <span class="breadcrumb-item">Prodotto</span>
    </nav>
  </div>
</div>
      <!-- analytics -->
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20">Analisi digitale <?= $site_name ?> ™</h1>
      <p class="relative z-20">
        Ottieni insight preziosi e favorisci la crescita con la nostra piattaforma di analisi avanzata. Prendi decisioni informate basate sui dati con fiducia. Affina la strategia e ottieni risultati misurabili.
      </p>
    </div>
    <div class="relative grid min-h-[230px] content-end">
      ...
      <div class="relative z-20 grid grid-cols-2 gap-3 md:gap-6">
        <a class="btn btn-black col-span-full" href="sign.php">Registrati</a>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Applicazione web digitale</h2>
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Mercato dei capitali</p>
            <p>Tutto a portata di clic</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Statistiche</p>
            <p>Accedi a tutti i tuoi dati</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Vista mobile</p>
            <p>Accesso dal telefono</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Gestione criptovalute</p>
            <p>Accedi a ogni asset</p>
          </div>
        </div>
      </div>
    </div>
    <div class="flex items-center justify-center">
      <img
        ...
        alt="Interfaccia mobile per il tracking del portafoglio"
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Portafoglio</p>
          <p>Qui presento la mia carriera professionale attraverso progetti di rilievo e soluzioni creative.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Acquista criptovalute</p>
          <p>Piattaforma sicura e semplice per acquistare criptovalute. Transazioni rapide con commissioni minime. Inizia a operare oggi.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Analisi crypto</p>
          <p>Scopri di più su valori e trend di mercato per decisioni di investimento e business informate.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Asset crypto</p>
          <p>Esplora il futuro della finanza con le principali criptovalute. Scopri, investi, cresci.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">Andiamo!</p>
<p>
  Esplora il mondo delle criptovalute con <?= $site_name ?>. I trader italiani possono accedere a una piattaforma che unisce innovazione, efficienza e opportunità di profitto.
</p>
          </div>
        ...
        <div class="grid gap-5">
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p>Il tuo partner di trading di fiducia</p>
