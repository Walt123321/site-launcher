...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="Contatta il supporto <?= $site_name ?> o il nostro team commerciale." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="contacts.php" data-active>Contatti</a>
    </li>
    <li>
      ...
      <div class="pt-5">
        <div class="container-base">
          ...
          >
            ...
            <span class="breadcrumb-item">Contatti</span>
          </nav>
        </div>
      </div>
      <!-- contact -->
...
<div class="grid gap-4 text-center md:gap-6">
  <h3>Per ulteriori domande, contattaci via e-mail</h3>
</div>
            <a
