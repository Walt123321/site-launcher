...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="Lisez les conditions d'utilisation de <?= $site_name ?>." />
    <meta charset="UTF-8" />
  ...
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <div class="grid gap-5 md:gap-7">
        <nav aria-label="breadcrumb" class="flex flex-wrap items-center text-sm text-gray-500 md:text-lg">
            ...
            <span class="breadcrumb-item">Conditions d'utilisation</span>
        </nav>
        <h1>Conditions d'utilisation</h1>
    </div>
<div class="grid gap-6 md:gap-8">
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Généralités</h2>
    <p>Ce site web fournit des informations sur des plateformes de trading tierces et des services associés. En utilisant le site, vous acceptez les présentes conditions et notre Politique de confidentialité. Les conditions peuvent être mises à jour à tout moment.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Admissibilité</h2>
    <p>Vous devez avoir au moins 18 ans, être capable d'accepter ces conditions et ne pas être restreint par les lois locales. Nous ne sommes pas responsables d'une utilisation illicite du site web.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Accès restreint</h2>
    <p>Nous pouvons restreindre l'accès pour certains territoires ou lorsque des risques juridiques ou réglementaires s'appliquent. Les services peuvent être indisponibles dans les zones restreintes.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Utilisation interdite</h2>
    <p>Vous ne devez pas faire un usage abusif du site web, notamment en violant les lois, en portant atteinte aux droits, en diffusant du contenu nuisible ou en utilisant des systèmes automatisés. Nous pouvons restreindre l'accès en cas de violation des conditions.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Propriété intellectuelle</h2>
    <p>Tout le contenu, les marques et les éléments nous appartiennent ou appartiennent à des tiers. Vous ne pouvez utiliser le site qu'à des fins personnelles et ne devez pas copier ou modifier le contenu.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Responsabilité</h2>
    <p>Le site web et les services sont fournis « en l'état ». Nous ne sommes pas responsables des erreurs, pertes ou dommages résultant de l'utilisation du site web.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Services tiers</h2>
    <p>Nous pouvons afficher du contenu ou des liens tiers. Nous ne garantissons pas leur exactitude ni leurs services. Vérifiez les informations avant de prendre des décisions.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Liens</h2>
    <p>Les liens vers des sites externes sont fournis pour convenance uniquement. Nous ne les approuvons pas ni ne les contrôlons et ne sommes pas responsables de leur contenu.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">9. Divers</h2>
    <p>Nous pouvons mettre à jour ou modifier les services et les conditions à tout moment. Les présentes conditions constituent l'intégralité de l'accord entre vous et nous. L'absence d'exercice d'un droit ne constitue pas une renonciation.</p>
  </div>
</div>
      </div>
    </main>
