...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="Découvrez comment <?= $site_name ?> collecte et protège vos données." />
    <!-- Favicon -->
...
<div class="grid gap-6 md:gap-8">
  ...
  <div class="grid gap-2">
    <p class="text-sm">Dernière mise à jour : <?= $privacy_last_update ?></p>
    <p>Nous (« Nous ») respectons votre vie privée et nous engageons à protéger vos données personnelles. Cette politique explique comment <?= $site_name ?> collecte, utilise et protège vos informations.</p>
  </div>
  <!-- PRINCIPLES -->
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Transparence</p>
    <p>
      Nous expliquons clairement comment vos données sont utilisées. Contactez-nous à 
      <a href="mailto:info@<?= $site_domain ?>">info@<?= $site_domain ?></a>
    </p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Utilisation des données</p>
    <p>Vos données sont utilisées pour fournir les services, améliorer la plateforme et respecter les obligations légales.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Vos droits</p>
    <p>Vous pouvez demander l'accès, la rectification ou la suppression de vos données à tout moment.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Sécurité</p>
    <p>Nous protégeons vos données mais ne pouvons garantir une sécurité absolue.</p>
  </div>
  <!-- SECTIONS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Collecte des données</h2>
    <p>Nous collectons des données d'utilisation (IP, appareil, navigateur) et toute donnée que vous fournissez.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Base légale</h2>
    <p>Le traitement repose sur le consentement, l'intérêt légitime et les obligations légales.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Partage des données</h2>
    <p>Nous pouvons partager des données avec des partenaires, des prestataires et les autorités si la loi l'exige.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Cookies</h2>
    <p>Nous utilisons des cookies pour la fonctionnalité et l'analytique. Vous pouvez les désactiver.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Conservation des données</h2>
    <p>Les données ne sont conservées que le temps nécessaire.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Transferts internationaux</h2>
    <p>Les données peuvent être transférées avec des garanties appropriées.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Liens tiers</h2>
    <p>Nous ne sommes pas responsables des sites web externes.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Mises à jour</h2>
    <p>Cette politique peut être mise à jour.</p>
  </div>
  <!-- RIGHTS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">Vos droits</h2>
    <p>Vous avez le droit d'accéder, de rectifier, de supprimer, de limiter ou de transférer vos données, de retirer votre consentement et d'introduire une réclamation.</p>
  </div>
</div>
          </div>
        </div>
