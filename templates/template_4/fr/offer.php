...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 Obtenez Portfolio Tracker 💸",
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Offre | <?= $site_name ?></title>
    <meta name="description" content="Choisissez une offre <?= $site_name ?> adaptée à vos besoins de trading." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="offer.php" data-active>Offre</a>
    </li>
    <li>
...
<span class="breadcrumb-item">Offre</span>
          </nav>
        </div>
      </div>
      <!-- tracker -->
      <div class="py-8 md:py-10">
        <div class="container-base grid gap-6 lg:grid-cols-2">
          ...
          >
 <h1 class="relative z-20">Obtenez Portfolio Tracker</h1>
<p class="relative z-20">
  Démarrez en quelques minutes : inscrivez-vous, déposez des fonds et commencez à trader en seulement 5 minutes. Commencez maintenant.
</p>
          </div>
