...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 Analytique numérique <?= $site_name ?> ™ 💸",
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Produit | <?= $site_name ?></title>
    <meta name="description" content="Des outils pour gérer les cryptomonnaies et les actifs avec analytique et automatisation." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/fr/">Accueil</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="product.php" data-active>Produit</a>
    </li>
    <li>
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/fr/" class="breadcrumb-item">Accueil</a>
      <span class="breadcrumb-item">Produit</span>
    </nav>
  </div>
</div>
      <!-- analytics -->
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20">Analytique numérique <?= $site_name ?> ™</h1>
      <p class="relative z-20">
        Obtenez des informations précieuses et stimulez la croissance avec notre plateforme d'analytique avancée. Prenez des décisions éclairées basées sur les données en toute confiance. Affinez votre stratégie et obtenez des résultats mesurables.
      </p>
    </div>
    <div class="relative grid min-h-[230px] content-end">
      ...
      <div class="relative z-20 grid grid-cols-2 gap-3 md:gap-6">
        <a class="btn btn-black col-span-full" href="sign.php">S'inscrire</a>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Application web numérique</h2>
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Marché des capitaux</p>
            <p>Tout au bout des doigts</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            ...
            <p>Accédez à toutes vos données</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Vue mobile</p>
            <p>Accès depuis votre téléphone</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
    ...
    <div class="flex items-center justify-center">
      <img
        ...
        alt="Interface mobile de suivi de portefeuille"
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Portefeuille</p>
          <p>Ici je présente mon parcours professionnel à travers des projets marquants et des solutions créatives.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Acheter des cryptomonnaies</p>
          <p>Une plateforme sécurisée et simple pour acheter des cryptomonnaies. Transactions rapides avec des frais minimes. Commencez à trader dès aujourd'hui.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Analytique crypto</p>
          <p>En savoir plus sur les valorisations et tendances du marché pour des décisions d'investissement et d'affaires éclairées.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Actifs crypto</p>
          <p>Explorez l'avenir de la finance avec les principales cryptomonnaies. Découvrez, investissez, développez-vous.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">C'est parti !</p>
<p>
  Explorez l'univers des cryptomonnaies avec <?= $site_name ?>. Les traders français peuvent accéder à une plateforme qui allie innovation, efficacité et opportunités de gains.
</p>
          </div>
        ...
        <div class="grid gap-5">
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p>Votre partenaire de trading de confiance</p>
