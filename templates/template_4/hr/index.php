...
?>
<!DOCTYPE html>
<html class="scroll-smooth" lang="hr" data-theme="orange">
<!-- head -->
<head>
  ...
  "itemListElement": [
    {
      ...
      "position": 1,
      "name": "<?= $site_name ?>",
      "item": "<?= $site_url ?>/lander/<?= $site_domain ?>/hr/"
    },
    {
      "@type": "ListItem",
      "position": 2,
...
<script type="application/ld+json">
{
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css" />
    <title><?= $site_name ?> | AI platforma za trgovanje</title>
    <meta name="description" content="<?= $site_name ?> ⭐ — inteligentna AI platforma za trgovanje za analizu tržišta u stvarnom vremenu i jasne signale za trgovanje ⚡ Isprobajte pametne alate i vođene uvide." />
        ...
        "mainEntity": [
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Možete biti spremni za rad u samo nekoliko minuta. Stvorite račun s osnovnim podacima, dovršite kratki korak verifikacije i uplatite minimalno <?= $app_price ?> <?= $app_currency ?>. Nakon toga otključat ćete punu platformu — grafikone uživo, alate za trgovanje i značajke za samopouzdan početak."
            }
          },
          {
            "@type": "Question",
            "name": "Jesu li moj novac i podaci sigurni? Je li <?= $site_name ?> pouzdan?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Apsolutno. Štitimo vaš račun naprednim SSL šifriranjem, 2FA verifikacijom i sigurnim hladnim skladištem sredstava. Transakcije se obrađuju putem pouzdanih pružatelja usluga, a osobni podaci se obrađuju prema strogim sigurnosnim pravilima. Sigurnost i pouzdanost ugrađeni su u svaki dio platforme."
            }
          },
          {
            "@type": "Question",
            "name": "Kada mogu podići svoj profit?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Isplate možete zatražiti u bilo kojem trenutku putem nadzorne ploče računa. Obrada obično traje 1–3 radna dana, ovisno o odabranom načinu. Uvijek ćete unaprijed vidjeti primjenjive naknade i rokove — bez iznenađenja."
            }
          },
          {
            "@type": "Question",
            "name": "Kako znam je li ova platforma prava za mene?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Najbolji način je isprobati je sami. Započnite s minimalnim depozitom i istražite značajke korak po korak. Platforma je dizajnirana da bude jednostavna za početnike, a istovremeno nudi moćne alate, uz podršku 24/7 kad god zatreba. Vi zadržavate kontrolu cijelo vrijeme."
            }
          },
          {
            "@type": "Question",
            "name": "Trebam li iskustvo u trgovanju za početak?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Uopće ne. Sve je izgrađeno da bude dostupno od prvog dana — s vodičem za uključivanje, jednostavnim tutorijalima i AI alatima koji pomažu u trgovanju. Bilo da tek počinjete ili već imate iskustva, napredujete vlastitim tempom uz stalno dostupnu podršku."
            }
          }
        ]
      }
  ...
  <header class="relative z-50 pt-3.5 md:pt-6">
    <div class="container-base">
      <div
        ...
        <a class="font-special inline-flex max-w-60 gap-1.5 text-xl leading-none uppercase header-nav-logo" href="<?= $site_url ?>/lander/<?= $site_domain ?>/hr/">
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/hr/" data-active>Početna</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="product.php">Proizvod</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="offer.php">Ponuda</a>
    </li>
    <li>
    ...
    <nav class="mobile-menu" data-mobile-menu>
      <ul class="flex flex-col flex-wrap items-center justify-center gap-y-8">
        <li>
          <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/hr/">Početna</a>
        </li>
        <li>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h1><?= $site_name ?></h1>
            <p>Doživite novu eru trgovanja s našom naprednom platformom za trgovanje kriptovalutama. Uz AI tehnologiju <?= $site_name ?>, možete optimizirati povrate i donositi informirane investicijske odluke.</p>
        </div>
        <form name="form" method="post"
          ...
          <input type="hidden" name="phone_country" value="hr">
          <input type="hidden" name="only_countries" value='["hr"]'>
          ...
          <div class="grid gap-6">
            <div class="grid gap-2 md:gap-3.5">
              <label class="grid gap-1.5">
                <span class="label text-white">Ime</span>
                <input class="input" type="text" name="fname" placeholder="Unesite svoje ime" required />
              </label>
              <label class="grid gap-1.5">
                <span class="label text-white">Prezime</span>
                <input class="input" type="text" name="lname" placeholder="Unesite svoje prezime" required />
              </label>
              <label class="grid gap-1.5">
                <span class="label text-white">E-pošta</span>
                <input class="input" type="email" name="email" placeholder="Unesite svoju e-poštu" required />
              </label>
              <label class="grid gap-1.5">
            ...
            <div class="grid gap-3">
              ...
              <p class="text-xs text-white">
                Unosom osobnih podataka i klikom na gumb prihvaćate
                <a class="link-underline" href="privacy.php">Pravila privatnosti</a>
                i
                <a class="link-underline" href="conditions.php">Uvjete korištenja</a>
                web stranice.
              </p>
            </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-3 md:grid-cols-2 md:gap-6 xl:grid-cols-4">
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      ...
      <p class="h3">Dostupnih valuta</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">42m</p>
      <p class="h3">Provjerenih korisnika</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">440 M€</p>
      <p class="h3">Obujam trgovanja</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">100+</p>
      <p class="h3">Podržanih zemalja</p>
    </div>
  </div>
</div>
    <!-- features -->
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 max-lg:order-2 md:gap-10">
      <h2>Zašto odabrati <?= $site_name ?>?</h2>
      <p class="md:text-lg">
        Platformi kojoj vjeruju moderni kripto trgovci postavlja novi standard. Spajamo snažnu sigurnost, potpunu transparentnost, napredne algoritme i besprijekorno sučelje kako bismo vam dali sve što trebate za samopouzdano i uspješno trgovanje.
      </p>
        ...
        <div class="grid grid-cols-2 gap-x-8 gap-y-6 max-sm:flex">
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Sigurnost kojoj možete vjerovati</p>
              <p>Zaštita vrhunske razine za vaše podatke i ulaganja na svakom koraku.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Prilagođeno iskustvo</p>
              <p>Prilagodite strategije trgovanja svojim jedinstvenim ciljevima i stilu.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Pametne AI strategije</p>
              <p>Točni uvidi u trgovanje koji vam pomažu donositi odluke s povjerenjem.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Automatizirano trgovanje</p>
              <p>AI botovi rade non-stop za učinkovito trgovanje usmjereno na profit.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Jednostavno sučelje</p>
              <p>Čist, intuitivan dizajn koji trgovanje čini jednostavnim od samog početka.</p>
            </div>
          </div>
        </div>
      </div>
      <p class="h3">
        Transformirajte svoje financijsko iskustvo uz <?= $site_name ?> ™.
      </p>
      <a class="btn btn-black" href="sign.php">Registracija</a>
    </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Učinkovito trgovanje!</h2>
      <p class="text-lg">
        Trgujte kriptovalutama poput Bitcoina, Ethereuma i Dogecoina s lakoćom i povjerenjem.
      </p>
      <a class="btn btn-black max-md:hidden" href="sign.php">Započnite</a>
    </div>
    <div class="grid gap-3 md:gap-6" data-trading></div>
    <a class="btn btn-black md:hidden" href="sign.php">Započnite</a>
  </div>
</div>
<section class="feature-section">
  <div class="container">
    <div class="feature-header">
      <h2>
        Globalna platforma za trgovanje <span>izgrađena za rast</span>
      </h2>
      <p>
        Pristupite više financijskim tržištima kroz jedinstvenu infrastrukturu dizajniranu za performanse, preciznost i globalnu pouzdanost.
      </p>
    </div>
    <div class="feature-grid">
      <div class="feature-card">
        ...
        <p>
          Trgujte kriptovalutama, forexom, dionicama i robama iz jednog integriranog okruženja bez prebacivanja između platformi.
        </p>
      </div>
      <div class="feature-card featured">
        <div class="accent"></div>
        <h3>Brza izvršenja</h3>
        <p>
          Optimizirana infrastruktura osigurava minimalnu latenciju i stabilno izvršavanje naloga na globalnim tržištima.
        </p>
      </div>
      <div class="feature-card">
        <div class="accent"></div>
        ...
        <p>
          Podaci uživo, napredni indikatori i tržišni uvidi pomažu vam brže reagirati i donositi informiranije odluke.
        </p>
      </div>
    </div>
  </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10">
    <div class="grid items-center gap-6 lg:grid-cols-2">
      <h2>Kako <?= $site_name ?> radi: vaš vodič za brzi početak</h2>
      <p class="rounded-custom sm:border sm:p-8">
        Započnite svoje kripto trgovanje bez napora na našoj platformi. Vodit ćemo vas korak po korak — od brze registracije do prvog depozita i prve trgovine.
      </p>
    </div>
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Registrirajte se u nekoliko minuta, unesite podatke i dobijte siguran pristup službenoj platformi.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Potvrdite pristup</p>
          <p>Potvrdite e-poštu i otključajte puni pristup kako biste odmah mogli početi trgovati.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Prijava na <?= $site_name ?></p>
          <p>Otvorite trgovački račun s minimalnim depozitom od <?= $app_price ?> <?= $app_currency ?>. Veća ulaganja mogu povećati potencijalne povrate, ali i veći rizik.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Uplatite sredstva na račun</p>
          <p>Odaberite željeni način — bankovni transfer, e-novčanik ili kreditna kartica — i započnite odmah.*</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Postavite strategiju</p>
          <p>Prilagodite račun svojim ciljevima. Odredite razinu rizika, postavke trgovanja i konfigurirajte strategiju. Naši stručni brokeri su tu za podršku — automatizirano ili ručno, vi odlučujete.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Počnite trgovati</p>
          <p>Sve je spremno. Uđite na kripto tržište s povjerenjem i istražite nove prilike već danas.</p>
        </div>
      </div>
    </div>
    <div class="grid gap-6 md:grid-cols-2">
      <a class="btn btn-black" href="sign.php">Počnite trgovati</a>
    </div>
  </div>
</div>
    <!-- payments -->
    <div class="py-8 md:py-10">
      <div class="container-base grid items-center gap-6 lg:grid-cols-2">
        <p class="text-lg">
          <?= $site_name ?> prihvaća niz načina plaćanja diljem svijeta.
        </p>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
    <div class="flex items-center justify-between gap-6 mb-6 reviews-flex-block">
      <h2 class="text-2xl font-bold">Recenzije <?= $site_name ?> ™</h2>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
            <p>
              <?= $site_name ?> me je ugodno iznenadio. Registracija je bila brza, naknade su jasne, a tim podrške stvarno odgovara i pomaže. Cijelo iskustvo je glatko i pouzdano — platforma na kojoj ostajem.
            </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Privatni investitor') ?></div>
              <p class="font-bold">Privatni investitor</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Konačno sam probao kripto i odabrao <?= $site_name ?> — zasad bez žaljenja. Početak je trajao samo nekoliko minuta, a sve je jasno objašnjeno. Čini se kao solidna opcija, posebno ako ste novi u trgovanju.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Neovisni trgovac') ?></div>
              <p class="font-bold">Neovisni trgovac</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  <?= $site_name ?> djeluje kao stabilna i pouzdana platforma. Postavljanje računa bilo je jednostavno, uvjeti su jasni, a podrška zna što radi. Trgovanje ovdje bilo je iznenađujuće ugodno iskustvo.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Trgovac digitalnim imovinama') ?></div>
              <p class="font-bold">Trgovac digitalnim imovinama</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Uz <?= $site_name ?>, kripto trgovanje više nije preplavljujuće. Registracija je bila jednostavna, naknade su transparentne, a podrška je dostupna kad zatreba. Kao početniku, to stvarno znači puno.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Tragač pasivnog prihoda') ?></div>
              <p class="font-bold">Tragač pasivnog prihoda</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
      <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Kako započeti?</span>
        ...
        <div id="content-1" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Možete biti spremni za rad u samo nekoliko minuta. Stvorite račun s osnovnim podacima, dovršite kratki korak verifikacije i uplatite minimalno <?= $app_price ?> <?= $app_currency ?>. Nakon toga otključat ćete punu platformu — grafikone uživo, alate za trgovanje i značajke za samopouzdan početak.</p>
          </div>
        </div>
      </div>
      <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Jesu li moj novac i podaci sigurni? Je li <?= $site_name ?> pouzdan?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-2" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Apsolutno. Štitimo vaš račun naprednim SSL šifriranjem, 2FA verifikacijom i sigurnim hladnim skladištem sredstava. Transakcije se obrađuju putem pouzdanih pružatelja usluga, a osobni podaci se obrađuju prema strogim sigurnosnim pravilima. Sigurnost i pouzdanost ugrađeni su u svaki dio platforme.</p>
          </div>
        </div>
      </div>
      <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Kada mogu podići svoj profit?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-3" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Isplate možete zatražiti u bilo kojem trenutku putem nadzorne ploče računa. Obrada obično traje 1–3 radna dana, ovisno o odabranom načinu. Uvijek ćete unaprijed vidjeti primjenjive naknade i rokove — bez iznenađenja.</p>
          </div>
        </div>
      </div>
      <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Kako znam je li ova platforma prava za mene?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-4" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Najbolji način je isprobati je sami. Započnite s minimalnim depozitom i istražite značajke korak po korak. Platforma je dizajnirana da bude jednostavna za početnike, a istovremeno nudi moćne alate, uz podršku 24/7 kad god zatreba. Vi zadržavate kontrolu cijelo vrijeme.</p>
          </div>
        </div>
      </div>
      <div id="accordion-5" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Trebam li iskustvo u trgovanju za početak?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-5" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Uopće ne. Sve je izgrađeno da bude dostupno od prvog dana — s vodičem za uključivanje, jednostavnim tutorijalima i AI alatima koji pomažu u trgovanju. Bilo da tek počinjete ili već imate iskustva, napredujete vlastitim tempom uz stalno dostupnu podršku.</p>
          </div>
        </div>
      </div>
      <div id="accordion-6" class="group border-primary rounded-custom border transition-all">
        ...
        <div id="content-6" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p style="margin-bottom:16px;"><?= $site_name ?> je globalna platforma za trgovanje izgrađena za korisnike koji očekuju dosljedne performanse, brzu izvršenja i punu kontrolu nad okruženjem za trgovanje. Umjesto oslanjanja na više nepovezanih alata ili regionalnih usluga, platforma pruža jedan strukturirani sustav u kojem su sve glavne funkcije integrirane u jedan tijek rada.</p>
            <p style="margin-bottom:16px;">Od pristupa tržištu do izvršenja naloga i analitike, svaka komponenta dizajnirana je da radi zajedno bez nepotrebnog trenja. Korisnici se mogu usredotočiti na donošenje odluka umjesto na složene sustave ili prebacivanje platformi.</p>
            <p style="margin-bottom:10px; font-weight:500;">Unutar jednog sučelja korisnici mogu djelovati na više financijskih tržišta:</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Kriptovalute, uključujući glavne i nove digitalne imovine</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Devizna tržišta s cijenama u stvarnom vremenu</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Globalne dionice i burzovne instrumente</li>
              <li><span style="color:#6D5DF6;">•</span> Robe za širu diverzifikaciju portfelja</li>
            </ul>
            <p style="margin-bottom:16px;">Performanse su ključni prioritet platforme. Infrastruktura je optimizirana za izvršenja s niskom latencijom i stabilan rad čak i u razdobljima visoke tržišne aktivnosti.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Brza i dosljedna izvršenja naloga na svim tržištima</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Kontinuirani podaci i ažuriranja cijena u stvarnom vremenu</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Ugrađeni analitički alati i tržišni indikatori</li>
              <li><span style="color:#6D5DF6;">•</span> Podrška za ručne i automatizirane strategije</li>
            </ul>
            <p style="margin-bottom:16px;">Sigurnost i operativna pouzdanost ugrađene su u svaki sloj sustava. Platforma slijedi industrijske standarde i primjenjuje interne zaštite kako bi korisnički podaci i financijske operacije ostali zaštićeni u svakom trenutku.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Šifrirani prijenos podataka u svim interakcijama</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Višeslojna verifikacija i autentifikacija računa</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Provjerena obrada i nadzor transakcija</li>
              <li><span style="color:#6D5DF6;">•</span> Infrastruktura dizajnirana za stabilnu globalnu dostupnost</li>
            </ul>
            <p style="margin-bottom:16px;">Istovremeno, upotrebljivost ostaje ključan fokus. Sučelje je namjerno čisto i predvidljivo, smanjujući nepotrebnu složenost kako bi se korisnici mogli usredotočiti na strategije trgovanja.</p>
            <p style="margin-bottom:16px;">Ova ravnoteža između performansi i jednostavnosti čini platformu prikladnom i za nove korisnike i za iskusne trgovce.</p>
            <p><?= $site_name ?> spaja skalabilnost, pouzdanost i učinkovitost u jedno okruženje, pružajući strukturiran i pouzdan pristup globalnim financijskim tržištima s povjerenjem.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h2>Ovo je trgovanje sa službenom platformom™</h2>
          <p>
            Mi smo pouzdana platforma za pojedince i tvrtke za kupnju, prodaju i upravljanje kriptovalutama.
          </p>
        </div>
        <form name="form" method="post"
          class="leadform rf-form js-rf-form group bg-primary rounded-custom relative overflow-hidden px-4 py-8 md:px-8" action="../integration/send.php" data-form>
  ...
  <section style="padding:60px 0;" class="md:!py-[100px]">
    ...
    ">
      ...
      ">
        ...
        ">
          Ključne mogućnosti <span style='color:#6B5FA7;'>platforme za trgovanje <?= $site_name ?></span>
        </h2>
      <p style="margin-top:14px;color:#6b7280;font-size:17px;">
        Sve što vam treba za pametnije, brže i sigurnije trgovanje.
      </p>
    </div>
    <div style="
      border-radius:16px;
    ...
    ">
      ...
      " onmouseover="this.style.background='#f9f9fb'" class="row-block" onmouseout="this.style.background='transparent'">
        ...
        <div class="row-text" style="color:#6b7280;">
          Napredni AI motor za trgovanje
        </div>
      </div>
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Kreditne kartice, bankovni transferi, PayPal
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Forex, dionice, kripto, robe i više
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Brzo i učinkovito uključivanje
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
  ...
  <div class="border-primary-light grid justify-items-center gap-6 rounded-[20px] border px-4 py-5 md:gap-4 md:px-8 md:py-6 text-center md:text-left">
    ...
    <div class="flex flex-wrap items-center justify-center md:justify-start gap-2.5 text-center md:text-left">
      ...
      <span class="leading-none text-amber-500" role="img"
        aria-label="<?= $rating_value ?> Ocjena od 5">
        <?= $stars ?>
      </span>
      <span class="flex flex-wrap justify-center md:justify-start gap-1 text-sm text-gray-400">
        <span>
          <strong>318</strong> recenzija ·
        </span>
        <span>
          Na temelju <strong><?= $rating_count ?></strong> ocjena ·
        </span>
        <span>
          Ocjena od 5
        </span>
    ...
    <p class="text-center md:text-left">
      Moćna i jednostavna platforma za trgovanje s robusnom automatizacijom i opsežnim edukativnim resursima.
    </p>
  </div>
</div>
      </div>
        ...
        <div class="grid gap-5">
          <nav class="flex flex-col flex-wrap justify-between gap-x-10 gap-y-5 text-white md:flex-row">
            <a class="font-special inline-flex max-w-60 gap-1.5 text-xl leading-none text-white uppercase max-md:pr-[120px] footer-nav-logo"
              href="<?= $site_url ?>/lander/<?= $site_domain ?>/hr/">
            ...
            <ul class="flex flex-col gap-x-5 gap-y-4 md:flex-row">
              <li>
                <a href="privacy.php">Pravila privatnosti</a>
              </li>
              <li>
                <a href="conditions.php">Uvjeti korištenja</a>
              </li>
              <li>
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p style="color:#6B5FA7;">Vaš pouzdani partner za trgovanje</p>
  ...
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ja/" hreflang="ja" title="日本語">
    🇯🇵
        ...
        <div class="grid gap-2.5 text-sm text-gray-500">
            <p>
                <?= $site_name ?> nije odgovoran za gubitke ili štetu koja može nastati korištenjem informacija na ovoj web stranici, uključujući edukativni sadržaj, kotacije, grafikone i analize. Trgovanje na financijskim tržištima uključuje rizik, stoga je važno uzeti u obzir osobne okolnosti i po potrebi potražiti savjet kvalificiranog stručnjaka prije početka. Ulažite samo novac koji si možete priuštiti izgubiti i imajte na umu da instrumenti poput FX-a, CFD-ova i kriptovaluta možda nisu prikladni za sve.
            </p>
        </div>
        <div class="text-center text-white">
          Copyright 2026 © <?= $site_name ?>, Sva prava pridržana
        </div>
      </div>
    </div>
  </footer>
