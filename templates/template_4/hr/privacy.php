...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Pravila privatnosti | <?= $site_name ?></title>
    <meta name="description" content="Saznajte kako <?= $site_name ?> prikuplja i štiti vaše podatke." />
    <!-- Favicon -->
...
>
  ...
  <span class="breadcrumb-item">Pravila privatnosti</span>
</nav>
...
<div class="grid gap-6 md:gap-8">
  ...
  <div class="grid gap-2">
    <p class="text-sm">Zadnje ažuriranje: <?= $privacy_last_update ?></p>
    <p>Mi («Mi») poštujemo vašu privatnost i predani smo zaštiti vaših osobnih podataka. Ova pravila objašnjavaju kako <?= $site_name ?> prikuplja, koristi i štiti vaše informacije.</p>
  </div>
  <!-- PRINCIPLES -->
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Transparentnost</p>
    <p>
      Jasno objašnjavamo kako se koriste vaši podaci. Kontaktirajte nas na 
      <a href="mailto:info@<?= $site_domain ?>">info@<?= $site_domain ?></a>
    </p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Korištenje podataka</p>
    <p>Vaši se podaci koriste za pružanje usluga, poboljšanje platforme i ispunjavanje zakonskih obveza.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Vaša prava</p>
    <p>Možete zatražiti pristup, ispravak ili brisanje svojih podataka u bilo kojem trenutku.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Sigurnost</p>
    <p>Štitimo vaše podatke, ali ne možemo jamčiti apsolutnu sigurnost.</p>
  </div>
  <!-- SECTIONS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Prikupljanje podataka</h2>
    <p>Prikupljamo podatke o korištenju (IP, uređaj, preglednik) i sve podatke koje nam dostavite.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Pravna osnova</h2>
    <p>Obrada temelji se na privoli, legitimnom interesu i zakonskim obvezama.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Dijeljenje podataka</h2>
    <p>Podatke možemo dijeliti s partnerima, pružateljima usluga i tijelima ako je potrebno.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Kolačići</h2>
    <p>Koristimo kolačiće za funkcionalnost i analitiku. Možete ih onemogućiti.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Zadržavanje podataka</h2>
    <p>Podaci se pohranjuju samo onoliko dugo koliko je potrebno.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Međunarodni prijenosi</h2>
    <p>Podaci se mogu prenositi uz odgovarajuće zaštite.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Poveznice trećih strana</h2>
    <p>Nismo odgovorni za vanjske web stranice.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Ažuriranja</h2>
    <p>Ova se pravila mogu ažurirati.</p>
  </div>
  <!-- RIGHTS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">Vaša prava</h2>
    <p>Imate pravo na pristup, ispravak, brisanje, ograničenje ili prijenos podataka, povlačenje privole i podnošenje pritužbe.</p>
  </div>
</div>
          </div>
        </div>
