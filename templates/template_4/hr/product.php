...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 Digitalna analitika <?= $site_name ?> ™ 💸",
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Proizvod | <?= $site_name ?></title>
    <meta name="description" content="Alati za upravljanje kriptovalutama i imovinom uz analitiku i automatizaciju." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/hr/">Početna</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="product.php" data-active>Proizvod</a>
    </li>
    <li>
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/hr/" class="breadcrumb-item">Početna</a>
      <span class="breadcrumb-item">Proizvod</span>
    </nav>
  </div>
</div>
      <!-- analytics -->
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20">Digitalna analitika <?= $site_name ?> ™</h1>
      <p class="relative z-20">
        Steknite vrijedne uvide i potaknite rast uz našu naprednu analitičku platformu. Donosite informirane odluke temeljene na podacima s povjerenjem. Usavršite strategiju i postignite mjerljive rezultate.
      </p>
    </div>
    <div class="relative grid min-h-[230px] content-end">
      ...
      <div class="relative z-20 grid grid-cols-2 gap-3 md:gap-6">
        <a class="btn btn-black col-span-full" href="sign.php">Registracija</a>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Digitalna web aplikacija</h2>
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Tržište kapitala</p>
            <p>Sve na pritisak gumba</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Statistika</p>
            <p>Pristup svim svojim podacima</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Mobilni prikaz</p>
            <p>Pristup putem mobitela</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
    ...
    <div class="flex items-center justify-center">
      <img
        ...
        alt="Mobilno sučelje za praćenje portfelja"
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Portfelj</p>
          <p>Ovdje predstavljam svoju profesionalnu karijeru kroz impresivne projekte i kreativna rješenja.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Sigurna i jednostavna platforma za kupnju kriptovaluta. Brze transakcije s minimalnim naknadama. Počnite trgovati danas.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Kripto analitika</p>
          <p>Saznajte više o tržišnim vrijednostima i trendovima za informirane investicijske i poslovne odluke.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Kripto imovina</p>
          <p>Istražite budućnost financija s vodećim kriptovalutama. Otkrijte, uložite, rastite.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">Krenimo!</p>
<p>
  Istražite svijet kriptovaluta uz <?= $site_name ?>. Hrvatski trgovci mogu pristupiti platformi koja spaja inovacije, učinkovitost i prilike za profit.
</p>
          </div>
        ...
        <div class="grid gap-5">
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p>Vaš pouzdani partner za trgovanje</p>
