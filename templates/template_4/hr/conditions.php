...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Uvjeti korištenja | <?= $site_name ?></title>
    <meta name="description" content="Pročitajte uvjete korištenja <?= $site_name ?>." />
    <meta charset="UTF-8" />
  ...
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <div class="grid gap-5 md:gap-7">
        <nav aria-label="breadcrumb" class="flex flex-wrap items-center text-sm text-gray-500 md:text-lg">
            ...
            <span class="breadcrumb-item">Uvjeti korištenja</span>
        </nav>
        <h1>Uvjeti korištenja</h1>
    </div>
<div class="grid gap-6 md:gap-8">
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Opće odredbe</h2>
    <p>Ova web stranica pruža informacije o platformama za trgovanje trećih strana i povezanim uslugama. Korištenjem web stranice prihvaćate ove Uvjete i naša Pravila privatnosti. Uvjeti se mogu ažurirati u bilo kojem trenutku.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Podobnost</h2>
    <p>Morate imati najmanje 18 godina, moći prihvatiti ove Uvjete i ne smijete biti ograničeni lokalnim zakonima. Nismo odgovorni za nezakonito korištenje web stranice.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Ograničen pristup</h2>
    <p>Možemo ograničiti pristup korisnicima iz određenih regija ili gdje postoje pravni ili regulatorni rizici. Usluge možda nisu dostupne na ograničenim lokacijama.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Zabranjena upotreba</h2>
    <p>Ne smijete zloupotrebljavati web stranicu, uključujući kršenje zakona, povredu prava, širenje štetnog sadržaja ili korištenje automatiziranih sustava. Možemo ograničiti pristup ako se Uvjeti prekrše.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Intelektualno vlasništvo</h2>
    <p>Sav sadržaj, zaštitni znakovi i materijali pripadaju nama ili trećim stranama. Web stranicu smijete koristiti samo za osobnu upotrebu i ne smijete kopirati ili mijenjati sadržaj.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Odgovornost</h2>
    <p>Web stranica i usluge pružaju se «kakve jesu». Nismo odgovorni za pogreške, gubitke ili štetu nastalu korištenjem web stranice.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Usluge trećih strana</h2>
    <p>Možemo prikazivati sadržaj ili poveznice trećih strana. Nismo odgovorni za njihovu točnost ili usluge. Provjerite informacije prije donošenja odluka.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Poveznice</h2>
    <p>Poveznice na vanjske web stranice pružaju se samo radi praktičnosti. Ne podržavamo ih niti kontroliramo i nismo odgovorni za njihov sadržaj.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">9. Razno</h2>
    <p>Možemo ažurirati ili izmijeniti usluge i Uvjete u bilo kojem trenutku. Ovi Uvjeti čine cjelokupan sporazum između vas i nas. Neiskorištena prava ne predstavljaju odricanje.</p>
  </div>
</div>
      </div>
    </main>
