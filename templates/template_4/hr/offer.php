...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Ponuda | <?= $site_name ?></title>
    <meta name="description" content="Odaberite plan s <?= $site_name ?> koji odgovara vašim potrebama za trgovanje." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="offer.php" data-active>Ponuda</a>
    </li>
    <li>
...
<span class="breadcrumb-item">Ponuda</span>
          </nav>
        </div>
      </div>
      <!-- tracker -->
      <div class="py-8 md:py-10">
        <div class="container-base grid gap-6 lg:grid-cols-2">
          ...
          >
 <h1 class="relative z-20">Nabavite Portfolio Tracker</h1>
<p class="relative z-20">
  Započnite za nekoliko minuta: registrirajte se, uplatite sredstva i počnite trgovati za samo 5 minuta. Krenite sada.
</p>
          </div>
...
<div class="relative z-40 py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10">
    ...
    <div class="border-primary h3 rounded-custom relative z-10 flex items-center justify-center border bg-white p-4 text-center md:p-6">
      Dodajte sredstva na račun
    </div>
    <div class="border-primary h3 rounded-custom relative z-10 flex items-center justify-center border bg-white p-4 text-center md:p-6">
      Počnite kupovati i prodavati
    </div>
        </div>
      </div>
    </div>
