...
<svg style="position:absolute;width:0;height:0;overflow:hidden;" aria-hidden="true" focusable="false"><symbol id="icon-sprite-0" viewBox="0 0 105 39">
...
</symbol><symbol id="icon-sprite-1" viewBox="0 0 58 39">
...
</symbol><symbol id="icon-sprite-2" viewBox="0 0 58 39">
...
</symbol><symbol id="icon-sprite-3" viewBox="0 0 58 39">
  ...
  <path d="M9.357 11.354h-6.65l-.053.315c5.174 1.253 8.598 4.28 10.02 7.917l-1.447-6.954c-.25-.958-.974-1.244-1.87-1.277" fill="#F2AE14"></path>
</symbol><symbol id="icon-sprite-4" viewBox="0 0 65 65">
              ...
              </symbol><symbol id="icon-sprite-5" viewBox="0 0 39 39">
            ...
            </symbol><symbol id="icon-sprite-6" viewBox="0 0 76 75">
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>" data-active><?= $mobnav_home ?></a>
    </li>
    <li>
...
<div class="flex flex-wrap justify-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="58" height="39" viewBox="0 0 58 39" fill="none"><use href="#icon-sprite-3"></use></svg>
<svg xmlns="http://www.w3.org/2000/svg" width="58" height="39" viewBox="0 0 58 39" fill="none"><use href="#icon-sprite-2"></use></svg>
<svg xmlns="http://www.w3.org/2000/svg" width="58" height="39" viewBox="0 0 58 39" fill="none"><use href="#icon-sprite-1"></use></svg>
<svg width="105" height="39" viewBox="0 0 105 39" fill="none" xmlns="http://www.w3.org/2000/svg"><use href="#icon-sprite-0"></use></svg>
</div>
          </div>
        </form>
      </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-3 md:grid-cols-2 md:gap-6 xl:grid-cols-4">
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase"><?= $stats_currencies_val ?></p>
      <p class="h3"><?= $stats_currencies_text ?></p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase"><?= $stats_users_val ?></p>
      <p class="h3"><?= $stats_users_text ?></p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase"><?= $stats_volume_val ?></p>
      <p class="h3"><?= $stats_volume_text ?></p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase"><?= $stats_countries_val ?></p>
      <p class="h3"><?= $stats_countries_text ?></p>
    </div>
  </div>
</div>
    <!-- features -->
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 max-lg:order-2 md:gap-10">
        ...
        <div class="grid grid-cols-2 gap-x-8 gap-y-6 max-sm:flex">
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3"><?= $feat_surety_title ?></p>
              <p><?= $feat_surety_text ?></p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3"><?= $feat_personal_title ?></p>
              <p><?= $feat_personal_text ?></p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3"><?= $feat_interface_title ?></p>
              <p><?= $feat_interface_text ?></p>
            </div>
          </div>
        </div>
      </div>
      ...
      <a class="btn btn-black" href="sign.php"><?= $choice_btn_signup ?></a>
    </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      ...
      <a class="btn btn-black max-md:hidden" href="sign.php"><?= $trade_btn_start ?></a>
    </div>
    <div class="grid gap-3 md:gap-6" data-trading></div>
    <a class="btn btn-black md:hidden" href="sign.php"><?= $trade_btn_start ?></a>
  </div>
</div>
  ...
  <div class="container-base grid gap-6 md:gap-10">
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      ...
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3"><?= $step_6_title ?></p>
          <p><?= $step_6_text ?></p>
        </div>
      </div>
    </div>
    <div class="grid gap-6 md:grid-cols-2">
      <a class="btn btn-black" href="sign.php"><?= $steps_btn_start ?></a>
    </div>
  </div>
</div>
    <!-- payments -->
        ...
        <div class="grid items-end gap-6 md:grid-cols-2">
          ...
          <div class="inline-flex justify-end gap-8 max-md:hidden">
            <button class="text-primary hover:text-primary-dark -scale-x-100 cursor-pointer transition-colors"
              ...
              <svg width="65" height="65" viewBox="0 0 65 65" fill="none" xmlns="http://www.w3.org/2000/svg"><use href="#icon-sprite-4"></use></svg>
            </button>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
    <div class="flex items-center justify-between gap-6 mb-6 reviews-flex-block">
      <h2 class="text-2xl font-bold"><?= $rev_heading ?></h2>
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
      <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors"><?= $faq_1_q ?></span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg"><use href="#icon-sprite-5"></use></svg>
          </span>
        </button>
      ...
      <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors"><?= $faq_2_q ?></span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg"><use href="#icon-sprite-5"></use></svg>
          </span>
        </button>
      ...
      <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors"><?= $faq_3_q ?></span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg"><use href="#icon-sprite-5"></use></svg>
          </span>
        </button>
      ...
      <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors"><?= $faq_4_q ?></span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg"><use href="#icon-sprite-5"></use></svg>
          </span>
        </button>
      ...
      <div id="accordion-5" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors"><?= $faq_5_q ?></span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg"><use href="#icon-sprite-5"></use></svg>
          </span>
        </button>
      ...
      <div id="accordion-6" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors"><?= $faq_6_q ?></span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg"><use href="#icon-sprite-5"></use></svg>
          </span>
        </button>
...
<div style="width:100%;max-width:1100px;margin:40px auto;padding:0 24px;box-sizing:border-box;text-align:center;">
  <img
    src="./cryptocurrency-platform.webp"
  ...
  <div class="border-primary-light grid justify-items-center gap-6 rounded-[20px] border px-4 py-5 md:gap-4 md:px-8 md:py-6 text-center md:text-left">
    ...
    <div class="flex flex-wrap items-center justify-center md:justify-start gap-2.5 text-center md:text-left">
      ...
      <span class="leading-none text-amber-500" role="img"
        aria-label="<?= $rating_value ?> <?= $trust_stat_score ?>">
        <?= $stars ?>
      </span>
      <span class="flex flex-wrap justify-center md:justify-start gap-1 text-sm text-gray-400">
        ...
        <span>
          <?= $trust_stat_based ?> <strong><?= $rating_count ?></strong> <?= $trust_stat_ratings ?> ·
        </span>
        <span>
          <?= $trust_stat_score ?>
        </span>
