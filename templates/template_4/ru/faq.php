...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Часто задаваемые вопросы (FAQ) | <?= $site_name ?></title>
    <meta name="description" content="Ответы на вопросы о торговле, функциях, безопасности и комиссиях." />
    <!-- Favicon -->
  ...
  <div class="container-base grid gap-6 md:gap-10">
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
        <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
          ...
          <div id="content-1" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Вы можете быть готовы за считанные минуты. Создайте аккаунт с основными данными, пройдите краткий шаг верификации и внесите минимум <?= $app_price ?> <?= $app_currency ?> . После этого вам откроется вся платформа — включая графики в реальном времени, торговые инструменты и функции, которые помогут вам начать уверенно.</p>
            </div>
          </div>
        </div>
        <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
          ...
          >
            <span class="h3 text-left transition-colors">В безопасности ли мои деньги и данные? Надёжен ли <?= $site_name ?> надёжен?</span>
            <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
              <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1" transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
                <rect x="19.5176" y="35.9287" width="4.62857" height="23.1428" rx="1" transform="rotate(-135 19.5176 35.9287)" fill="currentColor" />
          ...
          <div id="content-2" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Безусловно. Мы защищаем ваш аккаунт с помощью продвинутого SSL-шифрования, двухфакторной аутентификации (2FA) и безопасного холодного хранения средств. Транзакции обрабатываются через надёжных поставщиков, а ваши персональные данные обрабатываются в соответствии со строгими политиками безопасности. Безопасность и надёжность прочно заложены в каждой части платформы.</p>
            </div>
          </div>
        </div>
        <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
          ...
          <div id="content-3" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Вы можете запросить вывод средств в любое время через свою панель управления. Обработка обычно занимает 1–3 рабочих дня, в зависимости от выбранного метода. Возможные комиссии и сроки всегда видны заранее — никаких сюрпризов.</p>
            </div>
          </div>
        </div>
        <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
          ...
          <div id="content-4" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Лучший способ — попробовать самостоятельно. Начните с минимального депозита и изучите функции шаг за шагом. Платформа разработана так, чтобы быть удобной для новичков, предлагая при этом мощные инструменты и поддержку 24/7, которая поможет вам в любое время. Вы сохраняете полный контроль.</p>
            </div>
          </div>
        </div>
        <div id="accordion-5" class="group border-primary rounded-custom border transition-all">
          ...
          >
            <span class="h3 text-left transition-colors">Нужен ли мне торговый опыт, чтобы начать?</span>
            <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
              <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1" transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
                <rect x="19.5176" y="35.9287" width="4.62857" height="23.1428" rx="1" transform="rotate(-135 19.5176 35.9287)" fill="currentColor" />
          ...
          <div id="content-5" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Совсем нет. Всё устроено так, чтобы быть доступным с первого дня — с пошаговой регистрацией, простыми инструкциями и инструментами на базе ИИ, которые помогут вам разобраться в торговле. Начинаете ли вы только сейчас или уже имеете опыт, вы можете двигаться в своём собственном темпе, а поддержка всегда рядом.</p>
            </div>
          </div>
        </div>
    </div>
