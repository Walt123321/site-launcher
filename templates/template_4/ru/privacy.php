...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="Узнайте, как <?= $site_name ?> собирает и защищает ваши данные." />
    <!-- Favicon -->
...
>
  ...
  <span class="breadcrumb-item">Политика конфиденциальности</span>
</nav>
...
<div class="grid gap-6 md:gap-8">
  ...
  <div class="grid gap-2">
    <p class="text-sm">Последнее обновление: <?= $privacy_last_update ?></p>
    <p>Мы («Мы», «Нас») уважаем вашу конфиденциальность и обязуемся защищать ваши персональные данные. Настоящая политика конфиденциальности объясняет, как <?= $site_name ?> собирает, использует и защищает вашу информацию.</p>
  </div>
  <!-- PRINCIPLES -->
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Прозрачность</p>
    <p>
      Мы чётко объясняем, как используются ваши данные. Свяжитесь с нами по адресу 
      <a href="mailto:info@<?= $site_domain ?>">info@<?= $site_domain ?></a>
    </p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Использование данных</p>
    <p>Ваши данные используются для предоставления услуг, улучшения платформы и выполнения юридических обязательств.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Ваши права</p>
    <p>Вы можете в любое время запросить информацию о своих данных, а также потребовать их исправления или удаления.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Безопасность</p>
    <p>Мы защищаем ваши данные, но не можем гарантировать абсолютную безопасность.</p>
  </div>
  <!-- SECTIONS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Сбор данных</h2>
    <p>Мы собираем данные об использовании (IP-адрес, устройство, браузер) и все данные, которые вы нам предоставляете.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Правовая основа</h2>
    <p>Обработка данных основывается на вашем согласии, законных интересах и юридических обязательствах.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Передача данных</h2>
    <p>При необходимости мы можем передавать данные партнёрам, поставщикам услуг и государственным органам.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Файлы cookie</h2>
    <p>Мы используем файлы cookie для обеспечения функциональности и аналитики. Вы можете отключить их.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Хранение данных</h2>
    <p>Данные хранятся только столько, сколько это абсолютно необходимо.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Международная передача данных</h2>
    <p>Данные могут передаваться при наличии надлежащих гарантий.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Ссылки третьих сторон</h2>
    <p>Мы не несём ответственности за внешние сайты.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Обновления</h2>
    <p>Настоящая политика конфиденциальности может обновляться.</p>
  </div>
  <!-- RIGHTS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">Ваши права</h2>
    <p>Вы имеете право на доступ, исправление, удаление, ограничение или перенос ваших данных, на отзыв согласия и на подачу жалобы.</p>
  </div>
</div>
          </div>
        </div>
...
<div class="lang-switcher">
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/es/privacy.php" hreflang="es" title="Español">
    🇪🇸
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/cs/privacy.php" hreflang="cs" title="Čeština">
    🇨🇿
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/de/privacy.php" hreflang="de" title="Deutsch">
    🇩🇪
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/en/privacy.php" hreflang="en" title="English">
    🇬🇧
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/it/privacy.php" hreflang="it" title="Italiano">
    🇮🇹
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/fr/privacy.php" hreflang="fr" title="Français">
    🇫🇷
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/nl/privacy.php" hreflang="nl" title="Nederlands">
    🇳🇱
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/pl/privacy.php" hreflang="pl" title="Polski">
    🇵🇱
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/pt/privacy.php" hreflang="pt" title="Português">
    🇵🇹
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ro/privacy.php" hreflang="ro" title="Română">
    🇷🇴
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/sv/privacy.php" hreflang="sv" title="Svenska">
    🇸🇪
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/tr/privacy.php" hreflang="tr" title="Türkçe">
    🇹🇷
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/hr/privacy.php" hreflang="hr" title="Hrvatski">
    🇭🇷
  </a>
