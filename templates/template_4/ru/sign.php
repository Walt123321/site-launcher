...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="Присоединяйтесь к <?= $site_name ?> и выберите план, соответствующий вашим торговым целям." />
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">Войти/Зарегистрироваться</span>
    </nav>
  </div>
</div>
      <!-- registration-1 -->
...
<p>
  Мы являемся надёжной платформой для частных лиц и компаний по покупке, продаже и управлению криптовалютами.
</p>
          </div>
