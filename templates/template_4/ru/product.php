...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 <?= $site_name ?> Цифровая аналитика ™ 💸",
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="Инструменты для управления криптовалютами и активами с аналитикой и автоматизацией." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/ru/">Главная</a>
    </li>
    <li>
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ru/" class="breadcrumb-item">Главная</a>
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20"><?= $site_name ?> Цифровая аналитика ™</h1>
      <p class="relative z-20">
        Получайте ценные аналитические данные и стимулируйте рост с нашей продвинутой аналитической платформой. Принимайте обоснованные решения на основе данных с уверенностью. Совершенствуйте свою стратегию и достигайте измеримых результатов.
      </p>
    </div>
  ...
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
      ...
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Рынок капитала</p>
            <p>Всё одним нажатием кнопки</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Статистика</p>
            <p>Доступ ко всем вашим данным</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Мобильный вид</p>
            <p>Доступ с вашего мобильного телефона</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Управление криптовалютой</p>
            <p>Доступ к любому активу</p>
          </div>
        </div>
      </div>
    </div>
    <div class="flex items-center justify-center">
      <img
        ...
        alt="Мобильный интерфейс для отслеживания портфеля"
...
<div class="py-8 md:py-10">
  ...
  >
    ...
    >
      ...
      <p class="h3">Верифицированные пользователи</p>
    </div>
    <div
      class="rounded-custom grid content-start gap-5 border p-4 md:p-6"
    >
    ...
    >
      ...
      <p class="h3">Поддерживаемые страны</p>
    </div>
  </div>
</div>
      <!-- capabilities -->
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Здесь я представляю свой профессиональный путь через впечатляющие проекты и креативные решения.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Купить крипто</p>
          <p>Безопасная и простая платформа для покупки криптовалют. Быстрые транзакции с минимальными комиссиями. Начните торговать уже сегодня.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Крипто-аналитика</p>
          <p>Узнайте больше о рыночных ценностях и тенденциях, чтобы принимать обоснованные инвестиционные и торговые решения.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Криптоактивы</p>
          <p>Откройте будущее финансов с ведущими криптовалютами. Открывайте, инвестируйте, растите.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">Начнём!</p>
<p>
  Откройте мир криптовалют с <?= $site_name ?>. Трейдеры получают доступ к торговой платформе, объединяющей инновации, эффективность и возможности для прибыли.
</p>
          </div>
        <form name="form" method="post"
          ...
          <div class="grid gap-6">
            <div class="grid gap-2 md:gap-3.5">
              ...
              <label class="grid gap-1.5">
                <span class="label text-white">Эл. почта</span>
                <input class="input" type="email" name="email" placeholder="Введите ваш адрес эл. почты" required />
              </label>
              <label class="grid gap-1.5">
            ...
            <div class="grid gap-3">
              ...
              <p class="text-xs text-white">
                Вводя свои личные данные и нажимая на кнопку, вы соглашаетесь с
                <a class="link-underline" href="privacy.php">Политика конфиденциальности</a>
                и
                <a class="link-underline" href="conditions.php">Условия использования</a>
                данного сайта.
              </p>
            </div>
        ...
        <div class="grid gap-5">
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p>Ваш надёжный торговый партнёр</p>
