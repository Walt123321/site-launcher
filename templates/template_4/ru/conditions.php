...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="Ознакомьтесь с условиями использования <?= $site_name ?>." />
    <meta charset="UTF-8" />
  ...
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <div class="grid gap-5 md:gap-7">
        <nav aria-label="breadcrumb" class="flex flex-wrap items-center text-sm text-gray-500 md:text-lg">
            ...
            <span class="breadcrumb-item">Условия использования</span>
        </nav>
...
<div class="grid gap-6 md:gap-8">
  <div class="grid gap-2 md:gap-4">
    ...
    <p>Этот сайт предоставляет информацию о торговых платформах третьих сторон и связанных услугах. Используя этот сайт, вы соглашаетесь с настоящими условиями и нашей политикой конфиденциальности. Условия могут быть обновлены в любое время.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Право на участие</h2>
    <p>Вам должно быть не менее 18 лет, вы должны быть способны принять настоящие условия и не должны быть ограничены местным законодательством. Мы не несём ответственности за незаконное использование данного сайта.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Ограниченный доступ</h2>
    <p>Мы можем ограничить доступ для пользователей из определённых регионов или там, где существуют юридические или регуляторные риски. Услуги могут быть недоступны в ограниченных зонах.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Недопустимое использование</h2>
    <p>Вы не должны злоупотреблять сайтом, включая нарушение законов, нарушение прав, распространение вредоносного контента или использование автоматизированных систем. В случае нарушений мы можем ограничить доступ.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Интеллектуальная собственность</h2>
    <p>Весь контент, товарные знаки и материалы принадлежат нам или третьим лицам. Вы можете использовать сайт только в личных целях и не можете копировать или изменять контент.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Ответственность</h2>
    <p>Сайт и услуги предоставляются «как есть». Мы не несём ответственности за ошибки, убытки или ущерб, возникшие в результате использования данного сайта.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Услуги третьих сторон</h2>
    <p>Мы можем отображать контент или ссылки третьих сторон. Мы не несём ответственности за их точность или услуги. Проверяйте информацию перед принятием решения.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Ссылки</h2>
    <p>Ссылки на внешние сайты предоставляются только в качестве услуги. Мы не поддерживаем и не контролируем их и не несём ответственности за их содержание.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">9. Прочие положения</h2>
    <p>Мы можем обновлять или изменять услуги и условия в любое время. Настоящие условия представляют собой полное соглашение между вами и нами. Отказ от применения прав не означает отказ от них.</p>
  </div>
</div>
      </div>
    </main>
