...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="Свяжитесь со службой поддержки <?= $site_name ?> или нашим отделом продаж." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="contacts.php" data-active>Свяжитесь с нами</a>
    </li>
    <li>
      ...
      <div class="pt-5">
        <div class="container-base">
          ...
          >
            ...
            <span class="breadcrumb-item">Свяжитесь с нами</span>
          </nav>
        </div>
      </div>
      <!-- contact -->
...
<div class="grid gap-4 text-center md:gap-6">
  <h3>Если у вас есть дополнительные вопросы, свяжитесь с нами по электронной почте</h3>
</div>
            <a
