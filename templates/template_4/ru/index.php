...
?>
<!DOCTYPE html>
<html class="scroll-smooth" lang="ru" data-theme="orange">
<!-- head -->
<head>
  ...
  "itemListElement": [
    {
      ...
      "position": 1,
      "name": "<?= $site_name ?>",
      "item": "<?= $site_url ?>/lander/<?= $site_domain ?>/ru/"
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 <?= $site_name ?> 💸",
      "item": "<?= $site_url ?>/lander/<?= $site_domain ?>/ru/#heading-style-h1"
    }
  ]
}
</script>
<script type="application/ld+json">
{
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css" />
    <title><?= $site_name ?> | AI-платформа для трейдинга</title>
    <meta name="description" content="<?= $site_name ?> ⭐ — умная AI-платформа для трейдинга с анализом рынка в реальном времени и понятными торговыми сигналами ⚡ Попробуйте умные инструменты и персональные рекомендации." />
        ...
        "mainEntity": [
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Начать можно всего за несколько минут. Создайте аккаунт, указав основные данные, пройдите короткую проверку и внесите депозит от <?= $app_price ?> <?= $app_currency ?>. После этого вам откроется доступ ко всей платформе — включая графики в реальном времени, торговые инструменты и функции, которые помогут уверенно начать."
            }
          },
          {
            "@type": "Question",
            "name": "Безопасны ли мои деньги и данные? Можно ли доверять <?= $site_name ?>?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Безусловно. Мы защищаем ваш аккаунт с помощью современного SSL-шифрования, двухфакторной аутентификации (2FA) и надёжного холодного хранения средств. Транзакции обрабатываются через проверенных поставщиков услуг, а ваши личные данные обрабатываются в соответствии со строгими стандартами безопасности. Безопасность и надёжность заложены в каждую часть платформы."
            }
          },
          {
            "@type": "Question",
            "name": "Когда я могу вывести свою прибыль?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Вы можете запросить вывод средств в любое время через личный кабинет. Обработка обычно занимает 1–3 рабочих дня в зависимости от выбранного способа. Все комиссии и сроки всегда видны заранее — никаких сюрпризов."
            }
          },
          {
            "@type": "Question",
            "name": "Как понять, подходит ли мне эта платформа?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Лучший способ — попробовать самому. Начните с минимального депозита и постепенно изучайте функции. Платформа создана так, чтобы быть понятной новичкам и при этом предлагать мощные инструменты и поддержку 24/7, которая всегда готова помочь. Полный контроль остаётся за вами."
            }
          },
          {
            "@type": "Question",
            "name": "Нужен ли мне опыт трейдинга, чтобы начать?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Совершенно не нужен. Всё устроено так, чтобы быть доступным с первого дня — с пошаговой регистрацией, простыми инструкциями и AI-инструментами, которые помогут разобраться в трейдинге. Независимо от того, только вы начинаете или уже имеете опыт, вы можете двигаться в своём темпе, а поддержка всегда рядом."
            }
          }
        ]
      }
  ...
  <header class="relative z-50 pt-3.5 md:pt-6">
    <div class="container-base">
      <div
        ...
        <a class="font-special inline-flex max-w-60 gap-1.5 text-xl leading-none uppercase header-nav-logo" href="<?= $site_url ?>/lander/<?= $site_domain ?>/ru/">
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/ru/" data-active>Главная</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="product.php">Продукт</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="offer.php">Предложение</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="contacts.php">Свяжитесь с нами</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="faq.php">FAQ</a>
        ...
        <div class="flex items-center gap-4 max-md:hidden mobmenu">
          ...
          <a class="inline-flex h-[50px] w-[50px] shrink-0 items-center justify-center rounded-full border-2"
            href="sign.php" aria-label="Войти">
        ...
        <button class="menu-icon" data-menu-icon aria-label="открыть меню">
    ...
    <nav class="mobile-menu" data-mobile-menu>
      <ul class="flex flex-col flex-wrap items-center justify-center gap-y-8">
        <li>
          <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ru/">Главная</a>
        </li>
        <li>
          <a href="product.php">Продукт</a>
        </li>
        <li>
          <a href="offer.php">Предложение</a>
        </li>
        <!-- <li>
      <a href="/team">Our team</a>
    </li> -->
        <li>
          <a href="contacts.php">Свяжитесь с нами</a>
        </li>
        <li>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h1><?= $site_name ?></h1>
            <p>Откройте для себя новую эру трейдинга с нашей продвинутой платформой для торговли криптовалютой. Благодаря технологии AI от <?= $site_name ?> вы сможете оптимизировать доходность и принимать взвешенные инвестиционные решения.</p>
        </div>
        <form name="form" method="post"
          ...
          <input type="hidden" name="only_countries" value='["ru"]'>
          ...
          <div class="grid gap-6">
            <div class="grid gap-2 md:gap-3.5">
              <label class="grid gap-1.5">
                <span class="label text-white">Имя</span>
                <input class="input" type="text" name="fname" placeholder="Введите ваше имя" required />
              </label>
              <label class="grid gap-1.5">
                <span class="label text-white">Фамилия</span>
                <input class="input" type="text" name="lname" placeholder="Введите вашу фамилию" required />
              </label>
              <label class="grid gap-1.5">
              ...
              <label class="grid gap-1.5">
                <span class="label text-white">Номер телефона</span>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-3 md:grid-cols-2 md:gap-6 xl:grid-cols-4">
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      ...
      <p class="h3">Доступные валюты</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">42 млн</p>
      <p class="h3">Проверенных пользователей</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">$440M</p>
      <p class="h3">Объём торгов</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">100+</p>
      <p class="h3">Поддерживаемых стран</p>
    </div>
  </div>
</div>
    <!-- features -->
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 max-lg:order-2 md:gap-10">
      <h2>Почему стоит выбрать <?= $site_name ?>?</h2>
      <p class="md:text-lg">
        Эта платформа, которой доверяют криптотрейдеры, задаёт новые стандарты. Мы объединяем надёжную защиту, полную прозрачность, продвинутые алгоритмы и удобный интерфейс, чтобы дать вам всё необходимое для уверенного и успешного трейдинга.
      </p>
        ...
        <div class="grid grid-cols-2 gap-x-8 gap-y-6 max-sm:flex">
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Безопасность, которой можно доверять</p>
              <p>Первоклассная защита ваших данных и инвестиций на каждом шаге.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Персонализированный подход</p>
              <p>Настройте торговые стратегии под свои уникальные цели и стиль.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Умные AI-стратегии</p>
              <p>Точная торговая аналитика, которая помогает принимать уверенные решения.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Автоматизированный трейдинг</p>
              <p>Боты на базе искусственного интеллекта работают круглосуточно ради эффективных и прибыльных сделок.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Простой интерфейс</p>
              <p>Понятный, интуитивный дизайн, который облегчает старт в трейдинге с первых шагов.</p>
            </div>
          </div>
        </div>
      </div>
      <p class="h3">
        Измените свой финансовый опыт вместе с <?= $site_name ?> ™.
      </p>
      <a class="btn btn-black" href="sign.php">Зарегистрироваться</a>
    </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Эффективная торговля!</h2>
      <p class="text-lg">
        Торгуйте криптовалютами — Bitcoin, Ethereum и Dogecoin — легко и уверенно.
      </p>
      <a class="btn btn-black max-md:hidden" href="sign.php">Начать</a>
    </div>
    <div class="grid gap-3 md:gap-6" data-trading></div>
    <a class="btn btn-black md:hidden" href="sign.php">Начать</a>
  </div>
</div>
<section class="feature-section">
  <div class="container">
    <div class="feature-header">
      <h2>
        Глобальная торговая платформа, <span>созданная для роста</span>
      </h2>
      <p>
        Получите доступ к нескольким финансовым рынкам через единую инфраструктуру, созданную для производительности, точности и глобальной надёжности.
      </p>
    </div>
    <div class="feature-grid">
      <div class="feature-card">
        <div class="accent"></div>
        <h3>Доступ к нескольким рынкам</h3>
        <p>
          Торгуйте криптовалютами, Forex, акциями и сырьевыми товарами в единой интегрированной среде без необходимости переключаться между платформами.
        </p>
      </div>
      <div class="feature-card featured">
        ...
        <p>
          Оптимизированная инфраструктура обеспечивает минимальные задержки и стабильное исполнение ордеров на мировых рынках.
        </p>
      </div>
      <div class="feature-card">
        <div class="accent"></div>
        ...
        <p>
          Актуальные данные, продвинутые индикаторы и рыночная аналитика помогают быстрее реагировать и принимать более взвешенные торговые решения.
        </p>
      </div>
    </div>
  </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10">
    <div class="grid items-center gap-6 lg:grid-cols-2">
      <h2>Как работает <?= $site_name ?>: быстрый старт</h2>
      <p class="rounded-custom sm:border sm:p-8">
        Начните свой путь в криптотрейдинге легко и без усилий на нашей платформе. Мы сопровождаем вас на каждом шаге — от быстрой регистрации и первого депозита до открытия вашей первой сделки.
      </p>
    </div>
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Создать аккаунт</p>
          <p>Зарегистрируйтесь за несколько минут, укажите свои данные и получите безопасный доступ к официальной платформе.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Подтвердить доступ</p>
          <p>Подтвердите свой email, чтобы открыть полный доступ и сразу начать торговать.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Войти в <?= $site_name ?></p>
          <p>Откройте торговый счёт с минимальным депозитом от <?= $app_price ?> <?= $app_currency ?>. Более крупные вложения могут повысить потенциальную доходность, но также несут больший риск.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Пополнить счёт</p>
          <p>Выберите удобный способ — банковский перевод, электронный кошелёк или банковскую карту — и начните сразу же.*</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Настроить стратегию</p>
          <p>Настройте счёт под свои цели. Определите уровень риска, задайте торговые предпочтения и настройте стратегию. Наши профессиональные брокеры помогут вам в этом — выбирайте автоматический или ручной режим на своё усмотрение.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Начать торговлю</p>
          <p>Всё готово. Уверенно выходите на рынок криптовалют и открывайте новые возможности уже сегодня.</p>
        </div>
      </div>
    </div>
    <div class="grid gap-6 md:grid-cols-2">
      <a class="btn btn-black" href="sign.php">Начать торговлю</a>
    </div>
  </div>
</div>
    <!-- payments -->
    <div class="py-8 md:py-10">
      <div class="container-base grid items-center gap-6 lg:grid-cols-2">
        <p class="text-lg">
          <?= $site_name ?> принимает широкий спектр способов оплаты по всему миру.
        </p>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
    <div class="flex items-center justify-between gap-6 mb-6 reviews-flex-block">
      <h2 class="text-2xl font-bold"><?= $site_name ?> ™ Отзывы</h2>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
            <p>
              <?= $site_name ?> приятно меня удивила. Регистрация прошла быстро, комиссии прозрачны, а служба поддержки действительно отвечает и помогает. Весь опыт ощущается гладким и надёжным — платформа, на которой я точно останусь.
            </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials($review_1_author) ?></div>
              <p class="font-bold">Частный инвестор</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Я наконец решился попробовать крипту и выбрал <?= $site_name ?> — пока ни разу не пожалел. Регистрация заняла всего несколько минут, и всё было понятно объяснено. Платформа кажется надёжным выбором, особенно для тех, кто только начинает торговать.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials($review_2_author) ?></div>
              <p class="font-bold">Независимый трейдер</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  <?= $site_name ?> производит впечатление стабильной и надёжной платформы. Открыть счёт было просто, условия понятны, а поддержка знает своё дело. Торговля здесь оказалась для меня на удивление комфортным опытом.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials($review_3_author) ?></div>
              <p class="font-bold">Трейдер цифровых активов</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  С <?= $site_name ?> криптотрейдинг больше не кажется таким сложным. Регистрация была простой, комиссии прозрачны, и мне нравится, что поддержка доступна тогда, когда она нужна. Для новичка это действительно имеет большое значение.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials($review_4_author) ?></div>
              <p class="font-bold">В поисках пассивного дохода</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
      <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Как мне начать?</span>
        ...
        <div id="content-1" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Начать можно всего за несколько минут. Создайте аккаунт, указав основные данные, пройдите короткую проверку и внесите депозит от <?= $app_price ?> <?= $app_currency ?>. После этого вам откроется доступ ко всей платформе — включая графики в реальном времени, торговые инструменты и функции, которые помогут уверенно начать.</p>
          </div>
        </div>
      </div>
      <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Безопасны ли мои деньги и данные? Можно ли доверять <?= $site_name ?>?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-2" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Безусловно. Мы защищаем ваш аккаунт с помощью современного SSL-шифрования, двухфакторной аутентификации (2FA) и надёжного холодного хранения средств. Транзакции обрабатываются через проверенных поставщиков услуг, а ваши личные данные обрабатываются в соответствии со строгими стандартами безопасности. Безопасность и надёжность заложены в каждую часть платформы.</p>
          </div>
        </div>
      </div>
      <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Когда я могу вывести свою прибыль?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-3" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Вы можете запросить вывод средств в любое время через личный кабинет. Обработка обычно занимает 1–3 рабочих дня в зависимости от выбранного способа. Все комиссии и сроки всегда видны заранее — никаких сюрпризов.</p>
          </div>
        </div>
      </div>
      <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Как понять, подходит ли мне эта платформа?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-4" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Лучший способ — попробовать самому. Начните с минимального депозита и постепенно изучайте функции. Платформа создана так, чтобы быть понятной новичкам и при этом предлагать мощные инструменты и поддержку 24/7, которая всегда готова помочь. Полный контроль остаётся за вами.</p>
          </div>
        </div>
      </div>
      <div id="accordion-5" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Нужен ли мне опыт трейдинга, чтобы начать?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-5" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Совершенно не нужен. Всё устроено так, чтобы быть доступным с первого дня — с пошаговой регистрацией, простыми инструкциями и AI-инструментами, которые помогут разобраться в трейдинге. Независимо от того, только вы начинаете или уже имеете опыт, вы можете двигаться в своём темпе, а поддержка всегда рядом.</p>
          </div>
        </div>
      </div>
      <div id="accordion-6" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">О платформе</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-6" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p style="margin-bottom:16px;"><?= $site_name ?> — это глобальная торговая платформа, созданная для пользователей, которые ожидают стабильной производительности, быстрого исполнения ордеров и полного контроля над своей торговой средой. Вместо того чтобы полагаться на несколько разрозненных инструментов или региональные сервисы, платформа предлагает единую структурированную систему, где все основные функции объединены в одном рабочем процессе.</p>
            <p style="margin-bottom:16px;">От доступа к рынку и исполнения ордеров до аналитики — каждый компонент создан для слаженной совместной работы. Это позволяет пользователям сосредоточиться на принятии решений, а не на навигации по сложным системам или переключении между платформами.</p>
            <p style="margin-bottom:10px; font-weight:500;">В рамках единого интерфейса пользователи могут работать сразу на нескольких финансовых рынках:</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Криптовалюты, включая ведущие и перспективные цифровые активы</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Валютный рынок (Forex) с ценами в реальном времени</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Глобальные акции и фондовые инструменты</li>
              <li><span style="color:#6D5DF6;">•</span> Сырьевые товары для более широкой диверсификации портфеля</li>
            </ul>
            <p style="margin-bottom:16px;">Производительность — главный приоритет платформы. Инфраструктура оптимизирована для исполнения с минимальной задержкой и стабильной работы даже в периоды высокой активности рынка. Это гарантирует, что пользователи могут реагировать на движения цен без задержек и технических сбоев.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Быстрое и стабильное исполнение ордеров на всех рынках</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Непрерывные данные и обновления цен в реальном времени</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Встроенные инструменты аналитики и рыночные индикаторы</li>
              <li><span style="color:#6D5DF6;">•</span> Поддержка как ручных, так и автоматизированных стратегий</li>
            </ul>
            <p style="margin-bottom:16px;">Безопасность и надёжность работы заложены в каждый уровень системы. Платформа соответствует установленным отраслевым стандартам и применяет внутренние меры защиты, чтобы данные пользователей и финансовые транзакции были защищены в любое время.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Шифрование данных при любом взаимодействии</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Многоуровневая проверка и аутентификация аккаунта</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Проверенные системы обработки транзакций и мониторинг</li>
              <li><span style="color:#6D5DF6;">•</span> Инфраструктура, рассчитанная на стабильную работу по всему миру</li>
            </ul>
            <p style="margin-bottom:16px;">При этом удобство использования остаётся в центре внимания. Интерфейс намеренно сделан понятным и предсказуемым, что снижает лишнюю сложность и позволяет пользователям сосредоточиться на своих торговых стратегиях, а не на изучении системы.</p>
            <p style="margin-bottom:16px;">Такой баланс между производительностью и простотой делает платформу подходящей как для новых пользователей, так и для опытных трейдеров. Новички могут быстро освоиться без крутой кривой обучения, а продвинутые пользователи сохраняют гибкость, необходимую для управления более сложными стратегиями.</p>
            <p><?= $site_name ?> объединяет масштабируемость, надёжность и эффективность в единой среде, предлагая структурированный и надёжный способ уверенно работать на мировых финансовых рынках.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h2>Это торговля на официальной платформе™</h2>
          <p>
            Мы — надёжная платформа для частных лиц и компаний, которая позволяет покупать, продавать и управлять криптовалютой.
          </p>
        </div>
        <form name="form" method="post"
          class="leadform rf-form js-rf-form group bg-primary rounded-custom relative overflow-hidden px-4 py-8 md:px-8" action="../integration/send.php" data-form>
  ...
  <section style="padding:60px 0;" class="md:!py-[100px]">
    ...
    ">
      ...
      ">
        ...
        ">
          Основные особенности <span style='color:#6B5FA7;'>торговой платформы <?= $site_name ?></span>
        </h2>
      <p style="margin-top:14px;color:#6b7280;font-size:17px;">
        Всё, что нужно для более разумной, быстрой и уверенной торговли.
      </p>
    </div>
    <div style="
      border-radius:16px;
    ...
    ">
      ...
      " onmouseover="this.style.background='#f9f9fb'" class="row-block" onmouseout="this.style.background='transparent'">
        ...
        <div class="row-text" style="color:#6b7280;">
          Продвинутый торговый движок на базе AI
        </div>
      </div>
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Банковские карты, банковские переводы, PayPal
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Forex, акции, криптовалюты, сырьевые товары и другое
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Быстрая и эффективная регистрация
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
  ...
  <div class="border-primary-light grid justify-items-center gap-6 rounded-[20px] border px-4 py-5 md:gap-4 md:px-8 md:py-6 text-center md:text-left">
    ...
    <div class="flex flex-wrap items-center justify-center md:justify-start gap-2.5 text-center md:text-left">
      ...
      <span class="leading-none text-amber-500" role="img"
        aria-label="<?= $rating_value ?> из 5">
        <?= $stars ?>
      </span>
      <span class="flex flex-wrap justify-center md:justify-start gap-1 text-sm text-gray-400">
        <span>
          <strong>318</strong> отзывов ·
        </span>
        <span>
          На основе <strong><?= $rating_count ?></strong> отзывов ·
        </span>
        <span>
          из 5
        </span>
    ...
    <p class="text-center md:text-left">
      Мощная и удобная торговая платформа с надёжной автоматизацией и обширными обучающими материалами.
    </p>
  </div>
</div>
      </div>
        ...
        <div class="grid gap-5">
          <nav class="flex flex-col flex-wrap justify-between gap-x-10 gap-y-5 text-white md:flex-row">
            <a class="font-special inline-flex max-w-60 gap-1.5 text-xl leading-none text-white uppercase max-md:pr-[120px] footer-nav-logo"
              href="<?= $site_url ?>/lander/<?= $site_domain ?>/ru/">
            ...
            <ul class="flex flex-col gap-x-5 gap-y-4 md:flex-row">
              ...
              <li>
                <a href="conditions.php">Условия использования</a>
              </li>
              <li>
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p style="color:#6B5FA7;">Ваш надёжный торговый партнёр</p>
  ...
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ja/" hreflang="ja" title="日本語">
    🇯🇵
        ...
        <div class="grid gap-2.5 text-sm text-gray-500">
            <p>
                <?= $site_name ?> не несёт ответственности за убытки или ущерб, возникшие в результате доверия к информации, предоставленной на данном сайте, включая обучающие материалы, котировки, графики и аналитику. Торговля на финансовых рынках сопряжена с рисками. Поэтому важно учитывать свои личные обстоятельства перед началом и при необходимости обратиться за советом к квалифицированному специалисту. Вам следует инвестировать только те деньги, потерю которых вы можете себе позволить, и учитывать, что такие инструменты, как валюта (FX), CFD и криптовалюты, подходят не всем.
            </p>
        </div>
        <div class="text-center text-white">
          Copyright 2026 © <?= $site_name ?>, Все права защищены
        </div>
      </div>
    </div>
  </footer>
