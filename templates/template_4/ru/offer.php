...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 Получите отслеживание портфеля 💸",
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Предложение | <?= $site_name ?></title>
    <meta name="description" content="Выберите с <?= $site_name ?> план, соответствующий вашим торговым потребностям." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="offer.php" data-active>Предложение</a>
    </li>
    <li>
...
<span class="breadcrumb-item">Предложение</span>
          </nav>
        </div>
      </div>
      <!-- tracker -->
      <div class="py-8 md:py-10">
        <div class="container-base grid gap-6 lg:grid-cols-2">
          ...
          >
 <h1 class="relative z-20">Получите отслеживание портфеля</h1>
<p class="relative z-20">
  Начните за считанные минуты: зарегистрируйтесь, внесите средства и начните торговлю всего за 5 минут. Начните прямо сейчас.
</p>
          </div>
