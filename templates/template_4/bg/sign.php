...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="Присъединете се към <?= $site_name ?> и изберете план, който отговаря на вашите търговски цели." />
...
<link rel="alternate" hreflang="x-default" href="<?= $site_url ?>/sign.php" />
...
<link rel="alternate" hreflang="en" href="<?= $site_url ?>/lander/<?= $site_domain ?>/en/sign.php" />
...
<p>
  Ние сме надеждна платформа за физически лица и компании за покупка, продажба и управление на криптовалути.
</p>
          </div>
...
<div class="lang-switcher">
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/es/sign.php" hreflang="es" title="Español">
    🇪🇸
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/cs/sign.php" hreflang="cs" title="Čeština">
    🇨🇿
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/de/sign.php" hreflang="de" title="Deutsch">
    🇩🇪
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/en/sign.php" hreflang="en" title="English">
    🇬🇧
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/it/sign.php" hreflang="it" title="Italiano">
    🇮🇹
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/fr/sign.php" hreflang="fr" title="Français">
    🇫🇷
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/nl/sign.php" hreflang="nl" title="Nederlands">
    🇳🇱
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/pl/sign.php" hreflang="pl" title="Polski">
    🇵🇱
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/pt/sign.php" hreflang="pt" title="Português">
    🇵🇹
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ro/sign.php" hreflang="ro" title="Română">
    🇷🇴
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/sv/sign.php" hreflang="sv" title="Svenska">
    🇸🇪
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/tr/sign.php" hreflang="tr" title="Türkçe">
    🇹🇷
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/hr/sign.php" hreflang="hr" title="Hrvatski">
    🇭🇷
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/no/sign.php" hreflang="no" title="Norsk">
    🇳🇴
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/da/sign.php" hreflang="da" title="Dansk">
    🇩🇰
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/fi/sign.php" hreflang="fi" title="Suomi">
    🇫🇮
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/hu/sign.php" hreflang="hu" title="Magyar">
    🇭🇺
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/sk/sign.php" hreflang="sk" title="Slovenčina">
    🇸🇰
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/bg/sign.php" hreflang="bg" title="Български">
    🇧🇬
  </a>
  ...
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/el/sign.php" hreflang="el" title="Ελληνικά">
    🇬🇷
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ja/sign.php" hreflang="ja" title="日本語">
    🇯🇵
  </a>
</div>
</div>
