...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Политика за поверителност | <?= $site_name ?></title>
    <meta name="description" content="Прочетете как <?= $site_name ?> събира и защитава вашите данни." />
    <!-- Favicon -->
...
>
  ...
  <span class="breadcrumb-item">Политика за поверителност</span>
</nav>
...
<div class="grid gap-6 md:gap-8">
  ...
  <div class="grid gap-2">
    <p class="text-sm">Последна актуализация: <?= $privacy_last_update ?></p>
    <p>Ние ("Ние", "Нас") уважаваме вашата поверителност и се ангажираме да защитаваме личните ви данни. Тази политика за поверителност обяснява как <?= $site_name ?> събира, използва и защитава вашата информация.</p>
  </div>
  <!-- PRINCIPLES -->
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Прозрачност</p>
    <p>
      Ясно обясняваме как се използват вашите данни. Свържете се с нас на 
      <a href="mailto:info@<?= $site_domain ?>">info@<?= $site_domain ?></a>
    </p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Използване на данни</p>
    <p>Вашите данни се използват за предоставяне на услуги, подобряване на платформата и изпълнение на законови задължения.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Вашите права</p>
    <p>По всяко време можете да поискате информация за вашите данни, както и тяхната корекция или изтриване.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Сигурност</p>
    <p>Ние защитаваме вашите данни, но не можем да гарантираме абсолютна сигурност.</p>
  </div>
  <!-- SECTIONS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Събиране на данни</h2>
    <p>Ние събираме данни за използване (IP адрес, устройство, браузър) и всички данни, които ни предоставяте.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Правно основание</h2>
    <p>Обработката се основава на вашето съгласие, законни интереси и правни задължения.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Предоставяне на данни</h2>
    <p>При необходимост можем да предоставим данни на партньори, доставчици на услуги и органи.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Бисквитки</h2>
    <p>Използваме бисквитки за функционалност и анализи. Можете да ги деактивирате.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Съхранение на данни</h2>
    <p>Данните се съхраняват само толкова дълго, колкото е абсолютно необходимо.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Международни трансфери</h2>
    <p>Данните могат да бъдат прехвърляни с подходящи гаранции.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Връзки от трети страни</h2>
    <p>Ние не носим отговорност за външни уебсайтове.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Актуализации</h2>
    <p>Тази политика за поверителност може да бъде актуализирана.</p>
  </div>
  <!-- RIGHTS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">Вашите права</h2>
    <p>Имате право на достъп, корекция, изтриване, ограничаване или преносимост на вашите данни, на оттегляне на съгласието и на подаване на жалба.</p>
  </div>
</div>
          </div>
        </div>
