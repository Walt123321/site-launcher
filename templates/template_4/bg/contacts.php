...
if ($extractLang === $currentLang) {
    ...
    header('Location: ' . $site_url . "/lander/" . $site_domain . "/contacts.php");
    exit();
}
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Контакт | <?= $site_name ?></title>
    <meta name="description" content="Свържете се с поддръжката на <?= $site_name ?> или нашия търговски екип." />
    <!-- Favicon -->
...
<link rel="alternate" hreflang="en" href="<?= $site_url ?>/lander/<?= $site_domain ?>/en/contacts.php" />
<link rel="alternate" hreflang="it" href="<?= $site_url ?>/lander/<?= $site_domain ?>/it/contacts.php" />
<link rel="alternate" hreflang="fr" href="<?= $site_url ?>/lander/<?= $site_domain ?>/fr/contacts.php" />
<link rel="alternate" hreflang="nl" href="<?= $site_url ?>/lander/<?= $site_domain ?>/nl/contacts.php" />
<link rel="alternate" hreflang="pl" href="<?= $site_url ?>/lander/<?= $site_domain ?>/pl/contacts.php" />
<link rel="alternate" hreflang="pt" href="<?= $site_url ?>/lander/<?= $site_domain ?>/pt/contacts.php" />
<link rel="alternate" hreflang="ro" href="<?= $site_url ?>/lander/<?= $site_domain ?>/ro/contacts.php" />
<link rel="alternate" hreflang="sv" href="<?= $site_url ?>/lander/<?= $site_domain ?>/sv/contacts.php" />
<link rel="alternate" hreflang="tr" href="<?= $site_url ?>/lander/<?= $site_domain ?>/tr/contacts.php" />
<link rel="alternate" hreflang="hr" href="<?= $site_url ?>/lander/<?= $site_domain ?>/hr/contacts.php" />
<link rel="alternate" hreflang="no" href="<?= $site_url ?>/lander/<?= $site_domain ?>/no/contacts.php" />
<link rel="alternate" hreflang="da" href="<?= $site_url ?>/lander/<?= $site_domain ?>/da/contacts.php" />
<link rel="alternate" hreflang="fi" href="<?= $site_url ?>/lander/<?= $site_domain ?>/fi/contacts.php" />
<link rel="alternate" hreflang="hu" href="<?= $site_url ?>/lander/<?= $site_domain ?>/hu/contacts.php" />
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="contacts.php" data-active>Свържете се с нас</a>
    </li>
    <li>
      ...
      <div class="pt-5">
        <div class="container-base">
          ...
          >
            ...
            <span class="breadcrumb-item">Свържете се с нас</span>
          </nav>
        </div>
      </div>
      <!-- contact -->
...
<h1>Контакт</h1>
<div class="grid gap-4 text-center md:gap-6">
  <h3>Ако имате допълнителни въпроси, моля свържете се с нас по имейл</h3>
</div>
            <a
              class="h3 inline-flex flex-wrap items-center justify-center gap-4 justify-self-center text-center"
              href="mailto:info@<?= $site_domain ?>"
            >
              <svg
      ...
      <div class="py-8 md:py-10">
        <div class="container-base grid gap-6 lg:grid-cols-2">
          ...
          >
            ...
            <h2>Как можем да ви помогнем?</h2>
          </div>
...
<div class="lang-switcher">
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/es/contacts.php" hreflang="es" title="Español">
    🇪🇸
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/cs/contacts.php" hreflang="cs" title="Čeština">
    🇨🇿
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/de/contacts.php" hreflang="de" title="Deutsch">
    🇩🇪
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/en/contacts.php" hreflang="en" title="English">
    🇬🇧
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/it/contacts.php" hreflang="it" title="Italiano">
    🇮🇹
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/fr/contacts.php" hreflang="fr" title="Français">
    🇫🇷
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/nl/contacts.php" hreflang="nl" title="Nederlands">
    🇳🇱
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/pl/contacts.php" hreflang="pl" title="Polski">
    🇵🇱
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/pt/contacts.php" hreflang="pt" title="Português">
    🇵🇹
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ro/contacts.php" hreflang="ro" title="Română">
    🇷🇴
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/sv/contacts.php" hreflang="sv" title="Svenska">
    🇸🇪
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/tr/contacts.php" hreflang="tr" title="Türkçe">
    🇹🇷
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/hr/contacts.php" hreflang="hr" title="Hrvatski">
    🇭🇷
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/no/contacts.php" hreflang="no" title="Norsk">
    🇳🇴
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/da/contacts.php" hreflang="da" title="Dansk">
    🇩🇰
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/fi/contacts.php" hreflang="fi" title="Suomi">
    🇫🇮
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/hu/contacts.php" hreflang="hu" title="Magyar">
    🇭🇺
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/sk/contacts.php" hreflang="sk" title="Slovenčina">
    🇸🇰
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/bg/contacts.php" hreflang="bg" title="Български">
    🇧🇬
  </a>
  ...
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/el/contacts.php" hreflang="el" title="Ελληνικά">
    🇬🇷
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ja/contacts.php" hreflang="ja" title="日本語">
    🇯🇵
  </a>
</div>
</div>
