...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 <?= $site_name ?> Дигитален анализ ™ 💸",
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Продукт | <?= $site_name ?></title>
    <meta name="description" content="Инструменти за управление на криптовалути и активи с анализи и автоматизация." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/bg/">Начало</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="product.php" data-active>Продукт</a>
    </li>
    <li>
    ...
    <li>
      <a class="data-active:text-primary" href="faq.php">FAQ</a>
        ...
        <button class="menu-icon" data-menu-icon aria-label="отвори менюто">
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/bg/" class="breadcrumb-item">Начало</a>
      <span class="breadcrumb-item">Продукт</span>
    </nav>
  </div>
</div>
      <!-- analytics -->
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20"><?= $site_name ?> Дигитален анализ ™</h1>
      <p class="relative z-20">
        Получете ценни прозрения и стимулирайте растежа с нашата усъвършенствана аналитична платформа. Вземайте информирани, базирани на данни решения с увереност. Усъвършенствайте стратегията си и постигнете измерими резултати.
      </p>
    </div>
    <div class="relative grid min-h-[230px] content-end">
      ...
      <div class="relative z-20 grid grid-cols-2 gap-3 md:gap-6">
        <a class="btn btn-black col-span-full" href="sign.php">Регистрация</a>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Дигитално уеб приложение</h2>
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Капиталов пазар</p>
            <p>Всичко с едно натискане на бутон</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Статистики</p>
            <p>Достъп до всичките ви данни</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Мобилен изглед</p>
            <p>Достъп чрез вашия мобилен телефон</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Управление на криптовалути</p>
            <p>Достъп до всеки актив</p>
          </div>
        </div>
      </div>
    </div>
    <div class="flex items-center justify-center">
      <img
        ...
        alt="Мобилен интерфейс за проследяване на портфолио"
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Тук представям професионалния си път чрез впечатляващи проекти и креативни решения.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Купете крипто</p>
          <p>Сигурна и лесна платформа за покупка на криптовалути. Бързи транзакции с минимални такси. Започнете да търгувате още днес.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Крипто анализ</p>
          <p>Научете повече за пазарните стойности и тенденции, за да вземате информирани инвестиционни и търговски решения.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Крипто активи</p>
          <p>Открийте бъдещето на финансите с водещи криптовалути. Открийте, инвестирайте, растете.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">Да започваме!</p>
<p>
  Открийте света на криптовалутите с <?= $site_name ?>. Търговците имат достъп до търговска платформа, която обединява иновации, ефективност и възможности за печалба.
</p>
          </div>
          ...
          <div class="grid gap-6">
            <div class="grid gap-2 md:gap-3.5">
              <label class="grid gap-1.5">
                <span class="label text-white">Собствено име</span>
                <input class="input" type="text" name="fname" placeholder="Въведете собственото си име" required />
              </label>
              <label class="grid gap-1.5">
                <span class="label text-white">Фамилия</span>
                <input class="input" type="text" name="lname" placeholder="Въведете фамилията си" required />
              </label>
              <label class="grid gap-1.5">
                <span class="label text-white">Имейл</span>
                <input class="input" type="email" name="email" placeholder="Въведете имейл адреса си" required />
              </label>
              <label class="grid gap-1.5">
            ...
            <div class="grid gap-3">
              ...
              <p class="text-xs text-white">
                С въвеждането на личните си данни и щракването върху бутона вие се съгласявате с
                <a class="link-underline" href="privacy.php">Политика за поверителност</a>
                и
                <a class="link-underline" href="conditions.php">Общи условия</a>
                на този уебсайт.
              </p>
            </div>
        ...
        <div class="grid gap-5">
          <nav class="flex flex-col flex-wrap justify-between gap-x-10 gap-y-5 text-white md:flex-row">
            ...
            <ul class="flex flex-col gap-x-5 gap-y-4 md:flex-row">
              ...
              <li>
                <a href="conditions.php">Общи условия</a>
              </li>
              <li>
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p>Вашият надежден търговски партньор</p>
  ...
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ja/product.php" hreflang="ja" title="日本語">
    🇯🇵
        ...
        <div class="grid gap-2.5 text-sm text-gray-500">
            <p>
                <?= $site_name ?> не носи отговорност за загуби или щети, произтичащи от разчитане на информацията, предоставена на този уебсайт, включително обучително съдържание, ценови котировки, графики и анализи. Търговията на финансовите пазари е свързана с рискове. Затова е важно да вземете предвид личните си обстоятелства, преди да започнете, и при необходимост да потърсите съвет от квалифициран специалист. Трябва да инвестирате само пари, чиято загуба можете да си позволите, и имайте предвид, че инструменти като валута (FX), CFD и криптовалути не са подходящи за всеки.
            </p>
        </div>
