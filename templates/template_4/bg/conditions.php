...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Общи условия | <?= $site_name ?></title>
    <meta name="description" content="Прочетете общите условия на <?= $site_name ?>." />
    <meta charset="UTF-8" />
  ...
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <div class="grid gap-5 md:gap-7">
        <nav aria-label="breadcrumb" class="flex flex-wrap items-center text-sm text-gray-500 md:text-lg">
            ...
            <span class="breadcrumb-item">Общи условия</span>
        </nav>
        <h1>Общи условия</h1>
    </div>
<div class="grid gap-6 md:gap-8">
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Общи положения</h2>
    <p>Този уебсайт предоставя информация за търговски платформи на трети страни и свързани услуги. Използвайки този уебсайт, вие се съгласявате с тези условия и нашата политика за поверителност. Условията могат да бъдат актуализирани по всяко време.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Допустимост</h2>
    <p>Трябва да сте на поне 18 години, да можете да приемете тези условия и да не сте ограничени от местните закони. Ние не носим отговорност за незаконно използване на този уебсайт.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Ограничен достъп</h2>
    <p>Можем да ограничим достъпа за потребители от определени региони или там, където съществуват правни или регулаторни рискове. Услугите може да не са налични в ограничени зони.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Недопустима употреба</h2>
    <p>Не трябва да злоупотребявате с уебсайта, включително нарушаване на закони, нарушаване на права, разпространение на вреден съдържание или използване на автоматизирани системи. При нарушения можем да ограничим достъпа.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Интелектуална собственост</h2>
    <p>Цялото съдържание, търговски марки и материали принадлежат на нас или на трети страни. Можете да използвате уебсайта само за лични цели и не можете да копирате или променяте съдържанието.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Отговорност</h2>
    <p>Уебсайтът и услугите се предоставят „както са“. Не носим отговорност за грешки, загуби или щети, произтичащи от използването на този уебсайт.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Услуги от трети страни</h2>
    <p>Можем да показваме съдържание или връзки от трети страни. Не носим отговорност за тяхната точност или услуги. Проверете информацията, преди да вземете решение.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Връзки</h2>
    <p>Връзките към външни уебсайтове се предоставят само като услуга. Ние не ги подкрепяме или контролираме и не носим отговорност за тяхното съдържание.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">9. Разни</h2>
    <p>Можем да актуализираме или променяме услугите и условията по всяко време. Тези условия представляват цялото споразумение между вас и нас. Неприлагането на права не означава отказ от тях.</p>
  </div>
</div>
      </div>
    </main>
