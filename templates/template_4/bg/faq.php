...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Често задавани въпроси (ЧЗВ) | <?= $site_name ?></title>
    <meta name="description" content="Отговори на въпроси за търговията, функциите, сигурността и таксите." />
    <!-- Favicon -->
  ...
  <div class="container-base grid gap-6 md:gap-10">
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
        <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
          ...
          <div id="content-1" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Можете да сте готови за минути. Създайте акаунт с основните си данни, завършете кратката стъпка за верификация и депозирайте поне <?= $app_price ?> <?= $app_currency ?> След това цялата платформа ще се отключи за вас — включително графики в реално време, търговски инструменти и функции, които ви помагат да започнете уверено.</p>
            </div>
          </div>
        </div>
        <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
          ...
          >
            <span class="h3 text-left transition-colors">В безопасност ли са парите и данните ми? Надежден ли е <?= $site_name ?> надежден?</span>
            <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
              <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1" transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
                <rect x="19.5176" y="35.9287" width="4.62857" height="23.1428" rx="1" transform="rotate(-135 19.5176 35.9287)" fill="currentColor" />
          ...
          <div id="content-2" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Абсолютно. Защитаваме акаунта ви с усъвършенствано SSL криптиране, двуфакторна автентикация (2FA) и сигурно cold storage съхранение на средства. Транзакциите се обработват чрез доверени доставчици, а личните ви данни се обработват съгласно строги политики за сигурност. Сигурността и надеждността са здраво вградени във всяка част от платформата.</p>
            </div>
          </div>
        </div>
        <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
          ...
          <div id="content-3" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Можете да поискате теглене по всяко време чрез вашето табло. Обработката обикновено отнема 1–3 работни дни, в зависимост от избрания метод. Всички такси и срокове винаги виждате предварително — без изненади.</p>
            </div>
          </div>
        </div>
        <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
          ...
          <div id="content-4" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Най-добрият начин е да опитате сами. Започнете с минималния депозит и разгледайте функциите стъпка по стъпка. Платформата е проектирана да бъде удобна за начинаещи, като същевременно предлага мощни инструменти и поддръжка 24/7, която ви помага по всяко време. Вие запазвате пълен контрол.</p>
            </div>
          </div>
        </div>
        <div id="accordion-5" class="group border-primary rounded-custom border transition-all">
          ...
          >
            <span class="h3 text-left transition-colors">Необходим ли ми е търговски опит, за да започна?</span>
            <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
              <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1" transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
                <rect x="19.5176" y="35.9287" width="4.62857" height="23.1428" rx="1" transform="rotate(-135 19.5176 35.9287)" fill="currentColor" />
          ...
          <div id="content-5" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Изобщо не. Всичко е проектирано да бъде достъпно от първия ден — с водена регистрация, прости ръководства и инструменти с изкуствен интелект, които ви помагат да се ориентирате в търговията. Независимо дали тепърва започвате или вече имате опит, можете да напредвате със собствено темпо, а поддръжката винаги е на разположение.</p>
            </div>
          </div>
        </div>
    </div>
