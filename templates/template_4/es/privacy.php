...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="Descubre cómo <?= $site_name ?> recopila y protege tus datos." />
    <!-- Favicon -->
...
<div class="grid gap-6 md:gap-8">
  ...
  <div class="grid gap-2">
    <p class="text-sm">Última actualización: <?= $privacy_last_update ?></p>
    <p>Nosotros («Nosotros», «Nos») respetamos tu privacidad y nos comprometemos a proteger tus datos personales. Esta política explica cómo <?= $site_name ?> recopila, utiliza y protege tu información.</p>
  </div>
  <!-- PRINCIPLES -->
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Transparencia</p>
    <p>
      Explicamos con claridad cómo se utilizan tus datos. Contáctanos en 
      <a href="mailto:info@<?= $site_domain ?>">info@<?= $site_domain ?></a>
    </p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Uso de datos</p>
    <p>Tus datos se utilizan para prestar servicios, mejorar la plataforma y cumplir obligaciones legales.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Tus derechos</p>
    <p>Puedes solicitar acceso, rectificación o supresión de tus datos en cualquier momento.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Seguridad</p>
    <p>Protegemos tus datos, pero no podemos garantizar una seguridad absoluta.</p>
  </div>
  <!-- SECTIONS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Recopilación de datos</h2>
    <p>Recopilamos datos de uso (IP, dispositivo, navegador) y cualquier dato que nos facilites.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Base legal</h2>
    <p>El tratamiento se basa en el consentimiento, el interés legítimo y las obligaciones legales.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Compartición de datos</h2>
    <p>Podemos compartir datos con socios, proveedores y autoridades si es necesario.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Cookies</h2>
    <p>Utilizamos cookies para funcionalidad y analítica. Puedes desactivarlas.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Conservación de datos</h2>
    <p>Los datos se almacenan solo el tiempo necesario.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Transferencias internacionales</h2>
    <p>Los datos pueden transferirse con las garantías adecuadas.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Enlaces de terceros</h2>
    <p>No somos responsables de sitios web externos.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Actualizaciones</h2>
    <p>Esta política puede actualizarse.</p>
  </div>
  <!-- RIGHTS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">Tus derechos</h2>
    <p>Tienes derecho a acceder, rectificar, suprimir, limitar o transferir tus datos, retirar el consentimiento y presentar una reclamación.</p>
  </div>
</div>
          </div>
        </div>
