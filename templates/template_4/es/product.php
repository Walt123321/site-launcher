...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 Analítica digital <?= $site_name ?> ™ 💸",
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Producto | <?= $site_name ?></title>
    <meta name="description" content="Herramientas para gestionar criptomonedas y activos con analítica y automatización." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/es/">Inicio</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="product.php" data-active>Producto</a>
    </li>
    <li>
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/es/" class="breadcrumb-item">Inicio</a>
      <span class="breadcrumb-item">Producto</span>
    </nav>
  </div>
</div>
      <!-- analytics -->
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20">Analítica digital <?= $site_name ?> ™</h1>
      <p class="relative z-20">
        Obtén información valiosa e impulsa el crecimiento con nuestra plataforma de analítica avanzada. Toma decisiones informadas basadas en datos con confianza. Refina tu estrategia y consigue resultados medibles.
      </p>
    </div>
    <div class="relative grid min-h-[230px] content-end">
      ...
      <div class="relative z-20 grid grid-cols-2 gap-3 md:gap-6">
        <a class="btn btn-black col-span-full" href="sign.php">Registrarse</a>
  ...
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
      ...
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Mercado de capitales</p>
            <p>Todo al alcance de un botón</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Estadísticas</p>
            <p>Accede a todos tus datos</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Vista móvil</p>
            <p>Acceso desde tu móvil</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            ...
            <p>Accede a todos los activos</p>
          </div>
        </div>
      </div>
    </div>
    <div class="flex items-center justify-center">
      <img
        ...
        alt="Interfaz móvil de seguimiento de cartera"
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Cartera</p>
          <p>Aquí muestro mi trayectoria profesional a través de proyectos destacados y soluciones creativas.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Comprar criptomonedas</p>
          <p>Una plataforma segura y sencilla para comprar criptomonedas. Transacciones rápidas con comisiones mínimas. Empieza a operar hoy.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Analítica de cripto</p>
          <p>Conoce mejor los valores y tendencias del mercado para tomar decisiones de inversión y negocio informadas.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Activos cripto</p>
          <p>Explora el futuro de las finanzas con las principales criptomonedas. Descubre, invierte, crece.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">¡Vamos!</p>
<p>
  Explora el mundo de las criptomonedas con <?= $site_name ?>. Los traders españoles pueden acceder a una plataforma que combina innovación, eficiencia y oportunidades de beneficio.
</p>
          </div>
        ...
        <div class="grid gap-5">
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p>Tu socio de trading de confianza</p>
