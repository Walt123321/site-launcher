...
?>
<!DOCTYPE html>
<html class="scroll-smooth" lang="es" data-theme="orange">
<!-- head -->
<head>
  ...
  "itemListElement": [
    {
      ...
      "position": 1,
      "name": "<?= $site_name ?>",
      "item": "<?= $site_url ?>/lander/<?= $site_domain ?>/es/"
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 <?= $site_name ?> 💸",
      "item": "<?= $site_url ?>/lander/<?= $site_domain ?>/es/#heading-style-h1"
    }
  ]
}
</script>
<script type="application/ld+json">
{
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css" />
    <title><?= $site_name ?> | Plataforma de trading con IA</title>
    <meta name="description" content="<?= $site_name ?> ⭐ — plataforma de trading con IA inteligente para análisis de mercado en tiempo real y señales de trading claras ⚡ Prueba herramientas inteligentes e información guiada." />
        ...
        "mainEntity": [
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Puedes estar operativo en solo unos minutos. Crea una cuenta con tus datos básicos, completa un breve paso de verificación y deposita un mínimo de <?= $app_price ?> <?= $app_currency ?>. Después desbloquearás la plataforma completa: gráficos en tiempo real, herramientas de trading y funciones para empezar con confianza."
            }
          },
          {
            "@type": "Question",
            "name": "¿Están seguros mi dinero y mis datos? ¿Es fiable <?= $site_name ?>?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Por supuesto. Protegemos tu cuenta con cifrado SSL avanzado, verificación 2FA y almacenamiento en frío seguro para los fondos. Las transacciones se procesan a través de proveedores de confianza y tus datos personales se tratan bajo políticas de seguridad estrictas. La seguridad y la fiabilidad están integradas en cada parte de la plataforma."
            }
          },
          {
            "@type": "Question",
            "name": "¿Cuándo puedo retirar mis beneficios?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Puedes solicitar retiros en cualquier momento desde el panel de tu cuenta. El procesamiento suele tardar entre 1 y 3 días laborables, según el método elegido. Siempre verás las comisiones y plazos aplicables por adelantado — sin sorpresas."
            }
          },
          {
            "@type": "Question",
            "name": "¿Cómo sé si esta plataforma es adecuada para mí?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "La mejor forma es probarla tú mismo. Empieza con el depósito mínimo y explora las funciones paso a paso. La plataforma está pensada para ser accesible para principiantes y ofrecer herramientas potentes, con soporte 24/7 cuando lo necesites. Tú mantienes el control en todo momento."
            }
          },
          {
            "@type": "Question",
            "name": "¿Necesito experiencia en trading para empezar?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Para nada. Todo está diseñado para ser accesible desde el primer día: guía de incorporación, tutoriales sencillos y herramientas asistidas por IA. Tanto si empiezas ahora como si ya tienes experiencia, puedes avanzar a tu ritmo con soporte siempre disponible."
            }
          }
        ]
      }
  ...
  <header class="relative z-50 pt-3.5 md:pt-6">
    <div class="container-base">
      <div
        ...
        <a class="font-special inline-flex max-w-60 gap-1.5 text-xl leading-none uppercase header-nav-logo" href="<?= $site_url ?>/lander/<?= $site_domain ?>/es/">
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/es/" data-active>Inicio</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="product.php">Producto</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="offer.php">Oferta</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="contacts.php">Contacto</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="faq.php">Preguntas frecuentes</a>
    </li>
  </ul>
</nav>
        <div class="flex items-center gap-4 max-md:hidden mobmenu">
          <a class="group inline-flex h-[50px] items-center justify-between rounded-full border-2" href="sign.php">
            <span class="inline-block p-3.5 text-sm">Registro</span>
            <span
    ...
    <nav class="mobile-menu" data-mobile-menu>
      <ul class="flex flex-col flex-wrap items-center justify-center gap-y-8">
        <li>
          <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/es/">Inicio</a>
        </li>
        <li>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h1><?= $site_name ?></h1>
            <p>Vive una nueva era del trading con nuestra avanzada plataforma de trading de criptomonedas. Con la tecnología de IA de <?= $site_name ?>, puedes optimizar tus rendimientos y tomar decisiones de inversión informadas.</p>
        </div>
        <form name="form" method="post"
          ...
          <input type="hidden" name="phone_country" value="es">
          <input type="hidden" name="only_countries" value='["es"]'>
          ...
          <div class="grid gap-6">
            <div class="grid gap-2 md:gap-3.5">
              <label class="grid gap-1.5">
                <span class="label text-white">Nombre</span>
                <input class="input" type="text" name="fname" placeholder="Introduce tu nombre" required />
              </label>
              <label class="grid gap-1.5">
                <span class="label text-white">Apellidos</span>
                <input class="input" type="text" name="lname" placeholder="Introduce tus apellidos" required />
              </label>
              <label class="grid gap-1.5">
                <span class="label text-white">Correo electrónico</span>
                <input class="input" type="email" name="email" placeholder="Introduce tu correo electrónico" required />
              </label>
              <label class="grid gap-1.5">
                <span class="label text-white">Teléfono</span>
            ...
            <div class="grid gap-3">
              ...
              <p class="text-xs text-white">
                Al introducir tus datos personales y hacer clic en el botón, aceptas la
                <a class="link-underline" href="privacy.php">Política de privacidad</a>
                y las
                <a class="link-underline" href="conditions.php">Condiciones de uso</a>
                del sitio web.
              </p>
            </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-3 md:grid-cols-2 md:gap-6 xl:grid-cols-4">
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      ...
      <p class="h3">Divisas disponibles</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
    ...
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      ...
      <p class="h3">Volumen de trading</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 max-lg:order-2 md:gap-10">
      <h2>¿Por qué elegir <?= $site_name ?>?</h2>
      <p class="md:text-lg">
        Con la confianza de traders modernos de criptomonedas, esta plataforma marca un nuevo estándar. Combinamos seguridad robusta, transparencia total, algoritmos avanzados y una interfaz fluida para darte todo lo que necesitas para operar con confianza y tener éxito.
      </p>
        ...
        <div class="grid grid-cols-2 gap-x-8 gap-y-6 max-sm:flex">
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Seguridad en la que puedes confiar</p>
              <p>Protección de primer nivel para tus datos e inversiones en cada paso.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Experiencia personalizada</p>
              <p>Adapta tus estrategias de trading a tus objetivos y estilo únicos.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Estrategias inteligentes con IA</p>
              <p>Información de trading precisa para ayudarte a tomar decisiones con confianza.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Trading automatizado</p>
              <p>Bots impulsados por IA que trabajan las 24 horas para operaciones eficientes y orientadas al beneficio.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              ...
              <p>Diseño limpio e intuitivo que hace el trading sencillo desde el primer momento.</p>
            </div>
          </div>
        </div>
      </div>
      <p class="h3">
        Transforma tu experiencia financiera con <?= $site_name ?> ™.
      </p>
      <a class="btn btn-black" href="sign.php">Registrarse</a>
    </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>¡Trading eficiente!</h2>
      <p class="text-lg">
        Opera criptomonedas como Bitcoin, Ethereum y Dogecoin con facilidad y confianza.
      </p>
      <a class="btn btn-black max-md:hidden" href="sign.php">Empezar</a>
    </div>
    <div class="grid gap-3 md:gap-6" data-trading></div>
    <a class="btn btn-black md:hidden" href="sign.php">Empezar</a>
  </div>
</div>
<section class="feature-section">
  <div class="container">
    <div class="feature-header">
      <h2>
        Plataforma de trading global <span>diseñada para escalar</span>
      </h2>
      <p>
        Accede a varios mercados financieros a través de una infraestructura unificada diseñada para rendimiento, precisión y fiabilidad global.
      </p>
    </div>
    <div class="feature-grid">
      <div class="feature-card">
        ...
        <p>
          Opera criptomonedas, forex, acciones y materias primas desde un único entorno integrado sin cambiar de plataforma.
        </p>
      </div>
      <div class="feature-card featured">
        <div class="accent"></div>
        <h3>Ejecución rápida</h3>
        <p>
          Infraestructura optimizada que garantiza latencia mínima y ejecución estable de órdenes en mercados globales.
        </p>
      </div>
      <div class="feature-card">
        <div class="accent"></div>
        ...
        <p>
          Datos en vivo, indicadores avanzados e información de mercado te ayudan a responder más rápido y tomar decisiones más informadas.
        </p>
      </div>
    </div>
  </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10">
    <div class="grid items-center gap-6 lg:grid-cols-2">
      <h2>Cómo funciona <?= $site_name ?>: tu guía de inicio rápido</h2>
      <p class="rounded-custom sm:border sm:p-8">
        Comienza tu viaje en el trading de criptomonedas sin complicaciones en nuestra plataforma. Te guiaremos paso a paso: desde el registro rápido hasta tu primer depósito y tu primera operación.
      </p>
    </div>
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Regístrate en minutos, completa tus datos y obtén acceso seguro a la plataforma oficial.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Confirma tu acceso</p>
          <p>Verifica tu correo electrónico y desbloquea el acceso completo para empezar a operar de inmediato.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Inicio de sesión en <?= $site_name ?></p>
          <p>Abre tu cuenta de trading con un depósito mínimo de <?= $app_price ?> <?= $app_currency ?>. Inversiones mayores pueden aumentar los rendimientos potenciales, pero también implican mayor riesgo.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Deposita fondos en tu cuenta</p>
          <p>Elige tu método preferido — transferencia bancaria, monedero electrónico o tarjeta de crédito — y empieza al instante.*</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Ajusta tu cuenta según tus objetivos. Define tu nivel de riesgo, preferencias de trading y configura tu estrategia. Nuestros brokers expertos están aquí para ayudarte — automatizado o manual, tú decides.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Empieza a operar</p>
          <p>Ya está todo listo. Entra en el mercado de criptomonedas con confianza y empieza a explorar nuevas oportunidades hoy.</p>
        </div>
      </div>
    </div>
    <div class="grid gap-6 md:grid-cols-2">
      <a class="btn btn-black" href="sign.php">Empezar a operar</a>
    </div>
  </div>
</div>
    <!-- payments -->
    <div class="py-8 md:py-10">
      <div class="container-base grid items-center gap-6 lg:grid-cols-2">
        <p class="text-lg">
          <?= $site_name ?> acepta diversos métodos de pago a nivel mundial.
        </p>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
    <div class="flex items-center justify-between gap-6 mb-6 reviews-flex-block">
      <h2 class="text-2xl font-bold">Opiniones de <?= $site_name ?> ™</h2>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
            <p>
              <?= $site_name ?> me ha sorprendido gratamente. El registro fue rápido, las comisiones son claras y el equipo de soporte responde y ayuda de verdad. Toda la experiencia es fluida y fiable — sin duda una plataforma con la que me quedo.
            </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Inversor privado') ?></div>
              <p class="font-bold">Inversor privado</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Por fin probé las criptomonedas y elegí <?= $site_name ?> — de momento sin arrepentimientos. Empezar tardó solo unos minutos y todo se explicó con claridad. Parece una opción sólida, sobre todo si eres nuevo en el trading.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Trader independiente') ?></div>
              <p class="font-bold">Trader independiente</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  <?= $site_name ?> se siente como una plataforma estable y fiable. Configurar la cuenta fue fácil, las condiciones son claras y el soporte sabe lo que hace. Operar aquí ha sido una experiencia sorprendentemente cómoda.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Trader de activos digitales') ?></div>
              <p class="font-bold">Trader de activos digitales</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Con <?= $site_name ?>, el trading de criptomonedas ya no resulta abrumador. El registro fue sencillo, las comisiones son transparentes y me gusta que haya soporte cuando lo necesitas. Como principiante, eso marca la diferencia.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Buscador de ingresos pasivos') ?></div>
              <p class="font-bold">Buscador de ingresos pasivos</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
      <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">¿Cómo empiezo?</span>
        ...
        <div id="content-1" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Puedes estar operativo en solo unos minutos. Crea una cuenta con tus datos básicos, completa un breve paso de verificación y deposita un mínimo de <?= $app_price ?> <?= $app_currency ?>. Después desbloquearás la plataforma completa: gráficos en tiempo real, herramientas de trading y funciones para empezar con confianza.</p>
          </div>
        </div>
      </div>
      <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">¿Están seguros mi dinero y mis datos? ¿Es fiable <?= $site_name ?>?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-2" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Por supuesto. Protegemos tu cuenta con cifrado SSL avanzado, verificación 2FA y almacenamiento en frío seguro para los fondos. Las transacciones se procesan a través de proveedores de confianza y tus datos personales se tratan bajo políticas de seguridad estrictas. La seguridad y la fiabilidad están integradas en cada parte de la plataforma.</p>
          </div>
        </div>
      </div>
      <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">¿Cuándo puedo retirar mis beneficios?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-3" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Puedes solicitar retiros en cualquier momento desde el panel de tu cuenta. El procesamiento suele tardar entre 1 y 3 días laborables, según el método elegido. Siempre verás las comisiones y plazos aplicables por adelantado — sin sorpresas.</p>
          </div>
        </div>
      </div>
      <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">¿Cómo sé si esta plataforma es adecuada para mí?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-4" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>La mejor forma es probarla tú mismo. Empieza con el depósito mínimo y explora las funciones paso a paso. La plataforma está pensada para ser accesible para principiantes y ofrecer herramientas potentes, con soporte 24/7 cuando lo necesites. Tú mantienes el control en todo momento.</p>
          </div>
        </div>
      </div>
      <div id="accordion-5" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">¿Necesito experiencia en trading para empezar?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-5" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Para nada. Todo está diseñado para ser accesible desde el primer día: guía de incorporación, tutoriales sencillos y herramientas asistidas por IA. Tanto si empiezas ahora como si ya tienes experiencia, puedes avanzar a tu ritmo con soporte siempre disponible.</p>
          </div>
        </div>
      </div>
      <div id="accordion-6" class="group border-primary rounded-custom border transition-all">
        ...
        <div id="content-6" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p style="margin-bottom:16px;"><?= $site_name ?> es una plataforma de trading global pensada para usuarios que exigen rendimiento constante, ejecución rápida y control total sobre su entorno de trading. En lugar de depender de varias herramientas desconectadas o servicios regionales, la plataforma ofrece un único sistema estructurado donde todas las funciones principales están integradas en un solo flujo de trabajo.</p>
            <p style="margin-bottom:16px;">Desde el acceso al mercado hasta la ejecución de órdenes y la analítica, cada componente está diseñado para funcionar junto sin fricción innecesaria. Así puedes centrarte en tomar decisiones en lugar de navegar sistemas complejos o cambiar de plataforma.</p>
            <p style="margin-bottom:10px; font-weight:500;">En una sola interfaz, los usuarios pueden operar en varios mercados financieros:</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Criptomonedas, incluidos activos digitales principales y emergentes</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Mercados de divisas con precios en tiempo real</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Acciones e instrumentos bursátiles globales</li>
              <li><span style="color:#6D5DF6;">•</span> Materias primas para una mayor diversificación de cartera</li>
            </ul>
            <p style="margin-bottom:16px;">El rendimiento es una prioridad central de la plataforma. La infraestructura está optimizada para ofrecer ejecución de baja latencia y operación estable incluso en periodos de alta actividad del mercado.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Ejecución de órdenes rápida y consistente en todos los mercados</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Datos y actualizaciones de precios en tiempo real continuos</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Herramientas analíticas e indicadores de mercado integrados</li>
              <li><span style="color:#6D5DF6;">•</span> Soporte para estrategias manuales y automatizadas</li>
            </ul>
            <p style="margin-bottom:16px;">La seguridad y la fiabilidad operativa están integradas en cada capa del sistema. La plataforma sigue estándares del sector y aplica salvaguardas internas para que los datos de los usuarios y las operaciones financieras permanezcan protegidos en todo momento.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Transmisión de datos cifrada en todas las interacciones</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Verificación y autenticación de cuenta en varias capas</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Procesamiento y supervisión de transacciones verificados</li>
              <li><span style="color:#6D5DF6;">•</span> Infraestructura diseñada para accesibilidad global estable</li>
            </ul>
            <p style="margin-bottom:16px;">Al mismo tiempo, la usabilidad sigue siendo clave. La interfaz está diseñada para ser limpia y predecible, reduciendo la complejidad innecesaria para que los usuarios se centren en las estrategias de trading.</p>
            <p style="margin-bottom:16px;">Este equilibrio entre rendimiento y simplicidad hace que la plataforma sea adecuada tanto para usuarios nuevos como para traders experimentados.</p>
            <p><?= $site_name ?> combina escalabilidad, fiabilidad y eficiencia en un solo entorno, ofreciendo una forma estructurada y fiable de acceder a los mercados financieros globales con confianza.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h2>Esto es trading con la plataforma oficial™</h2>
          <p>
            Somos la plataforma de confianza para particulares y empresas que compran, venden y gestionan criptomonedas.
          </p>
        </div>
        <form name="form" method="post"
          class="leadform rf-form js-rf-form group bg-primary rounded-custom relative overflow-hidden px-4 py-8 md:px-8" action="../integration/send.php" data-form>
  ...
  <section style="padding:60px 0;" class="md:!py-[100px]">
    ...
    ">
      ...
      ">
        ...
        ">
          Capacidades principales de la <span style='color:#6B5FA7;'>plataforma de trading <?= $site_name ?></span>
        </h2>
      <p style="margin-top:14px;color:#6b7280;font-size:17px;">
        Todo lo que necesitas para operar de forma más inteligente, rápida y con confianza.
      </p>
    </div>
    <div style="
      border-radius:16px;
    ...
    ">
      ...
      " onmouseover="this.style.background='#f9f9fb'" class="row-block" onmouseout="this.style.background='transparent'">
        ...
        <div class="row-text" style="color:#6b7280;">
          Motor de trading avanzado con IA
        </div>
      </div>
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Tarjetas de crédito, transferencias bancarias, PayPal
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Forex, acciones, cripto, materias primas y más
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
  ...
  <div class="border-primary-light grid justify-items-center gap-6 rounded-[20px] border px-4 py-5 md:gap-4 md:px-8 md:py-6 text-center md:text-left">
    ...
    <div class="flex flex-wrap items-center justify-center md:justify-start gap-2.5 text-center md:text-left">
      ...
      <span class="leading-none text-amber-500" role="img"
        aria-label="<?= $rating_value ?> Puntuación sobre 5">
        <?= $stars ?>
      </span>
      <span class="flex flex-wrap justify-center md:justify-start gap-1 text-sm text-gray-400">
        <span>
          <strong>318</strong> opiniones ·
        </span>
        <span>
          Basado en <strong><?= $rating_count ?></strong> valoraciones ·
        </span>
        <span>
          Puntuación sobre 5
        </span>
    ...
    <p class="text-center md:text-left">
      Una plataforma de trading potente y fácil de usar, con automatización robusta y recursos educativos completos.
    </p>
  </div>
</div>
      </div>
        ...
        <div class="grid gap-5">
          <nav class="flex flex-col flex-wrap justify-between gap-x-10 gap-y-5 text-white md:flex-row">
            <a class="font-special inline-flex max-w-60 gap-1.5 text-xl leading-none text-white uppercase max-md:pr-[120px] footer-nav-logo"
              href="<?= $site_url ?>/lander/<?= $site_domain ?>/es/">
            ...
            <ul class="flex flex-col gap-x-5 gap-y-4 md:flex-row">
              ...
              <li>
                <a href="conditions.php">Condiciones de uso</a>
              </li>
              <li>
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p style="color:#6B5FA7;">Tu socio de trading de confianza</p>
  ...
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ja/" hreflang="ja" title="日本語">
    🇯🇵
        ...
        <div class="grid gap-2.5 text-sm text-gray-500">
            <p>
                <?= $site_name ?> no se hace responsable de pérdidas o daños que puedan derivarse del uso de la información proporcionada en este sitio web, incluidos contenidos educativos, cotizaciones, gráficos y análisis. Operar en los mercados financieros conlleva riesgo; conviene tener en cuenta tu situación personal y, si es necesario, buscar el consejo de un profesional cualificado antes de empezar. Solo debes invertir dinero que puedas permitirte perder, y ten en cuenta que instrumentos como divisas (FX), CFD y criptomonedas pueden no ser adecuados para todos.
            </p>
        </div>
        <div class="text-center text-white">
          Copyright 2026 © <?= $site_name ?>, Todos los derechos reservados
        </div>
      </div>
    </div>
  </footer>
