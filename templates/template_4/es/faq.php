...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="Respuestas sobre trading, funciones, seguridad y comisiones." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="faq.php" data-active>Preguntas frecuentes</a>
    </li>
  </ul>
</nav>
...
<span class="breadcrumb-item">Preguntas frecuentes</span>
          </nav>
        </div>
      </div>
      <!-- contact -->
