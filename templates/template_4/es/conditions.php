...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Condiciones de uso | <?= $site_name ?></title>
    <meta name="description" content="Lee los términos y condiciones de uso de <?= $site_name ?>." />
    <meta charset="UTF-8" />
  ...
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <div class="grid gap-5 md:gap-7">
        <nav aria-label="breadcrumb" class="flex flex-wrap items-center text-sm text-gray-500 md:text-lg">
            ...
            <span class="breadcrumb-item">Condiciones de uso</span>
        </nav>
...
<div class="grid gap-6 md:gap-8">
  <div class="grid gap-2 md:gap-4">
    ...
    <p>Este sitio web ofrece información sobre plataformas de trading de terceros y servicios relacionados. Al usar el sitio, aceptas estos Términos y nuestra Política de privacidad. Los términos pueden actualizarse en cualquier momento.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Elegibilidad</h2>
    <p>Debes tener al menos 18 años, poder aceptar estos Términos y no estar restringido por las leyes locales. No somos responsables del uso ilícito del sitio web.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Acceso restringido</h2>
    <p>Podemos restringir el acceso a usuarios de determinadas regiones o donde existan riesgos legales o regulatorios. Los servicios pueden no estar disponibles en ubicaciones restringidas.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Uso prohibido</h2>
    <p>No debes hacer un uso indebido del sitio web, incluido infringir leyes, vulnerar derechos, difundir contenido dañino o usar sistemas automatizados. Podemos restringir el acceso si se infringen los Términos.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Propiedad intelectual</h2>
    <p>Todo el contenido, marcas y materiales nos pertenecen a nosotros o a terceros. Solo puedes usar el sitio web para uso personal y no debes copiar ni modificar ningún contenido.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Responsabilidad</h2>
    <p>El sitio web y los servicios se proporcionan «tal cual». No somos responsables de errores, pérdidas o daños derivados del uso del sitio web.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Servicios de terceros</h2>
    <p>Podemos mostrar contenido o enlaces de terceros. No somos responsables de su exactitud ni de sus servicios. Verifica la información antes de tomar decisiones.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Enlaces</h2>
    <p>Los enlaces a sitios externos se ofrecen solo por comodidad. No los respaldamos ni los controlamos y no somos responsables de su contenido.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">9. Disposiciones varias</h2>
    <p>Podemos actualizar o modificar los servicios y los Términos en cualquier momento. Estos Términos constituyen el acuerdo completo entre tú y nosotros. Los derechos no ejercidos no se renuncian.</p>
  </div>
</div>
      </div>
    </main>
