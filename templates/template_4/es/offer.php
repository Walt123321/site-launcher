...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="Elige un plan con <?= $site_name ?> que se adapte a tus necesidades de trading." />
    <!-- Favicon -->
...
<span class="breadcrumb-item">Oferta</span>
      ...
      <div class="py-8 md:py-10">
        <div class="container-base grid gap-6 lg:grid-cols-2">
          ...
          >
 <h1 class="relative z-20">Obtén Portfolio Tracker</h1>
<p class="relative z-20">
  Empieza en minutos: regístrate, deposita y comienza a operar en solo 5 minutos. Empieza ahora.
</p>
          </div>
          <div class="relative grid min-h-[355px] content-end">
            ...
            >
              <a class="btn btn-black col-span-full" href="sign.php">Registro</a>
