...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="Contacta con el soporte de <?= $site_name ?> o con nuestro equipo comercial." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="contacts.php" data-active>Contacto</a>
    </li>
    <li>
...
<div class="grid gap-4 text-center md:gap-6">
  <h3>Si tienes más preguntas, ponte en contacto por correo electrónico</h3>
</div>
            <a
