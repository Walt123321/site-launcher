...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Polityka prywatności | <?= $site_name ?></title>
    <meta name="description" content="Dowiedz się, jak <?= $site_name ?> zbiera i chroni Twoje dane." />
    <!-- Favicon -->
...
<div class="grid gap-6 md:gap-8">
  ...
  <div class="grid gap-2">
    <p class="text-sm">Ostatnia aktualizacja: <?= $privacy_last_update ?></p>
    <p>My («My») szanujemy Twoją prywatność i zobowiązujemy się chronić Twoje dane osobowe. Niniejsza polityka wyjaśnia, jak <?= $site_name ?> zbiera, wykorzystuje i chroni Twoje informacje.</p>
  </div>
  <!-- PRINCIPLES -->
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Przejrzystość</p>
    <p>
      Jasno wyjaśniamy, jak wykorzystywane są Twoje dane. Skontaktuj się z nami pod adresem 
      <a href="mailto:info@<?= $site_domain ?>">info@<?= $site_domain ?></a>
    </p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Wykorzystanie danych</p>
    <p>Twoje dane są wykorzystywane do świadczenia usług, ulepszania platformy i spełniania obowiązków prawnych.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Twoje prawa</p>
    <p>Możesz w dowolnym momencie zażądać dostępu, sprostowania lub usunięcia swoich danych.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Bezpieczeństwo</p>
    <p>Chronimy Twoje dane, ale nie możemy zagwarantować absolutnego bezpieczeństwa.</p>
  </div>
  <!-- SECTIONS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Zbieranie danych</h2>
    <p>Zbieramy dane o użytkowaniu (IP, urządzenie, przeglądarka) oraz wszelkie dane, które podajesz.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Podstawa prawna</h2>
    <p>Przetwarzanie opiera się na zgodzie, prawnie uzasadnionym interesie i obowiązkach prawnych.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Udostępnianie danych</h2>
    <p>Możemy udostępniać dane partnerom, dostawcom i organom, jeśli jest to wymagane.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Pliki cookie</h2>
    <p>Używamy plików cookie do funkcjonalności i analityki. Możesz je wyłączyć.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Przechowywanie danych</h2>
    <p>Dane są przechowywane tylko tak długo, jak to konieczne.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Transfery międzynarodowe</h2>
    <p>Dane mogą być przekazywane z odpowiednimi zabezpieczeniami.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Linki stron trzecich</h2>
    <p>Nie ponosimy odpowiedzialności za zewnętrzne witryny.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Aktualizacje</h2>
    <p>Niniejsza polityka może być aktualizowana.</p>
  </div>
  <!-- RIGHTS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">Twoje prawa</h2>
    <p>Masz prawo do dostępu, sprostowania, usunięcia, ograniczenia lub przeniesienia danych, wycofania zgody i złożenia skargi.</p>
  </div>
</div>
          </div>
        </div>
