...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Warunki użytkowania | <?= $site_name ?></title>
    <meta name="description" content="Przeczytaj warunki użytkowania <?= $site_name ?>." />
    <meta charset="UTF-8" />
  ...
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <div class="grid gap-5 md:gap-7">
        <nav aria-label="breadcrumb" class="flex flex-wrap items-center text-sm text-gray-500 md:text-lg">
            ...
            <span class="breadcrumb-item">Warunki użytkowania</span>
        </nav>
        <h1>Warunki użytkowania</h1>
    </div>
<div class="grid gap-6 md:gap-8">
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Postanowienia ogólne</h2>
    <p>Ta witryna dostarcza informacji o platformach tradingowych stron trzecich i powiązanych usługach. Korzystając z witryny, akceptujesz niniejsze Warunki oraz naszą Politykę prywatności. Warunki mogą być aktualizowane w dowolnym momencie.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Kwalifikacja</h2>
    <p>Musisz mieć co najmniej 18 lat, móc zaakceptować niniejsze Warunki i nie być ograniczony przez lokalne przepisy. Nie ponosimy odpowiedzialności za nielegalne korzystanie z witryny.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Ograniczony dostęp</h2>
    <p>Możemy ograniczyć dostęp użytkownikom z określonych regionów lub tam, gdzie występują ryzyka prawne lub regulacyjne. Usługi mogą być niedostępne w ograniczonych lokalizacjach.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Zakazane użycie</h2>
    <p>Nie wolno nadużywać witryny, w tym łamać prawa, naruszać prawa, rozpowszechniać szkodliwe treści lub używać systemów automatycznych. Możemy ograniczyć dostęp w razie naruszenia Warunków.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Własność intelektualna</h2>
    <p>Cała treść, znaki towarowe i materiały należą do nas lub stron trzecich. Możesz korzystać z witryny wyłącznie do użytku osobistego i nie wolno kopiować ani modyfikować treści.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Odpowiedzialność</h2>
    <p>Witryna i usługi są świadczone «tak jak są». Nie ponosimy odpowiedzialności za błędy, straty lub szkody wynikające z korzystania z witryny.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Usługi stron trzecich</h2>
    <p>Możemy wyświetlać treści lub linki stron trzecich. Nie ponosimy odpowiedzialności za ich dokładność ani usługi. Zweryfikuj informacje przed podjęciem decyzji.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Linki</h2>
    <p>Linki do zewnętrznych witryn są podawane wyłącznie dla wygody. Nie popieramy ich ani nie kontrolujemy i nie ponosimy odpowiedzialności za ich treść.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">9. Postanowienia końcowe</h2>
    <p>Możemy aktualizować lub modyfikować usługi i Warunki w dowolnym momencie. Niniejsze Warunki stanowią całość umowy między Tobą a nami. Niewykonanie praw nie oznacza ich zrzeczenia.</p>
  </div>
</div>
      </div>
    </main>
