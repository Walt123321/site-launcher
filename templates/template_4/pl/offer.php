...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 Zdobądź Portfolio Tracker 💸",
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="Wybierz plan z <?= $site_name ?> dopasowany do Twoich potrzeb tradingowych." />
    <!-- Favicon -->
...
<span class="breadcrumb-item">Oferta</span>
      ...
      <div class="py-8 md:py-10">
        <div class="container-base grid gap-6 lg:grid-cols-2">
          ...
          >
 <h1 class="relative z-20">Zdobądź Portfolio Tracker</h1>
<p class="relative z-20">
  Zacznij w kilka minut: zarejestruj się, wpłać środki i rozpocznij handel w zaledwie 5 minut. Zacznij teraz.
</p>
          </div>
          <div class="relative grid min-h-[355px] content-end">
            ...
            >
              <a class="btn btn-black col-span-full" href="sign.php">Rejestracja</a>
