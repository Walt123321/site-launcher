...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="Skontaktuj się z supportem <?= $site_name ?> lub naszym zespołem biznesowym." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="contacts.php" data-active>Kontakt</a>
    </li>
    <li>
...
<div class="grid gap-4 text-center md:gap-6">
  <h3>Jeśli masz dodatkowe pytania, skontaktuj się z nami e-mailem</h3>
</div>
            <a
