...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Erbjudande | <?= $site_name ?></title>
    <meta name="description" content="Välj en plan med <?= $site_name ?> som passar dina handelsbehov." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="offer.php" data-active>Erbjudande</a>
    </li>
    <li>
...
<span class="breadcrumb-item">Erbjudande</span>
          </nav>
        </div>
      </div>
      <!-- tracker -->
      <div class="py-8 md:py-10">
        <div class="container-base grid gap-6 lg:grid-cols-2">
          ...
          >
 <h1 class="relative z-20">Skaffa Portfolio Tracker</h1>
<p class="relative z-20">
  Kom igång på några minuter: registrera dig, sätt in pengar och börja handla på bara 5 minuter. Börja nu.
</p>
          </div>
