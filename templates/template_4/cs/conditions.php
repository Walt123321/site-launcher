...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Podmínky použití | <?= $site_name ?></title>
    <meta name="description" content="Přečtěte si podmínky použití <?= $site_name ?>." />
    <meta charset="UTF-8" />
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="../cs/product.php">Produkt</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="../cs/offer.php">Nabídka</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="../cs/contacts.php">Kontaktujte nás</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="../cs/faq.php">FAQ</a>
    </li>
  </ul>
</nav>
    ...
    <div class="grid gap-5 md:gap-7">
        <nav aria-label="breadcrumb" class="flex flex-wrap items-center text-sm text-gray-500 md:text-lg">
            ...
            <span class="breadcrumb-item">Podmínky použití</span>
        </nav>
        <h1>Podmínky použití</h1>
    </div>
<div class="grid gap-6 md:gap-8">
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Obecné</h2>
    <p>Tento web poskytuje informace o obchodních platformách třetích stran a souvisejících službách. Používáním tohoto webu souhlasíte s těmito podmínkami a našimi zásadami ochrany osobních údajů. Podmínky mohou být kdykoli aktualizovány.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Způsobilost</h2>
    <p>Musí vám být alespoň 18 let, musíte být schopni přijmout tyto podmínky a nesmíte být omezeni místními zákony. Nejsme zodpovědní za nezákonné používání tohoto webu.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Omezený přístup</h2>
    <p>Můžeme omezit přístup uživatelům z určitých regionů nebo tam, kde platí právní či regulační rizika. Služby mohou být v omezených oblastech nedostupné.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Zakázané použití</h2>
    <p>Nesmíte web zneužívat, včetně porušování zákonů, porušování práv, šíření škodlivého obsahu nebo používání automatizovaných systémů. V případě porušení podmínek můžeme přístup omezit.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Duševní vlastnictví</h2>
    <p>Veškerý obsah, ochranné známky a materiály patří nám nebo třetím stranám. Web můžete používat pouze pro osobní účely a nesmíte kopírovat ani upravovat žádný obsah.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Odpovědnost</h2>
    <p>Web a služby jsou poskytovány „tak, jak jsou“. Nejsme zodpovědní za chyby, ztráty nebo škody vzniklé v důsledku používání tohoto webu.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Služby třetích stran</h2>
    <p>Můžeme zobrazovat obsah nebo odkazy třetích stran. Nejsme zodpovědní za jejich přesnost nebo služby. Před rozhodnutím si informace ověřte.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Odkazy</h2>
    <p>Odkazy na externí webové stránky jsou poskytovány pouze pro pohodlí. Neschvalujeme je ani nekontrolujeme a nejsme zodpovědní za jejich obsah.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">9. Různé</h2>
    <p>Služby a podmínky můžeme kdykoli aktualizovat nebo upravit. Tyto podmínky tvoří úplnou dohodu mezi vámi a námi. Neuplatnění práv neznamená jejich vzdání se.</p>
  </div>
</div>
      </div>
    </main>
