...
?>
<!DOCTYPE html>
<html class="scroll-smooth" lang="cs" data-theme="orange">
<!-- head -->
<head>
  ...
  "itemListElement": [
    {
      ...
      "position": 1,
      "name": "<?= $site_name ?>",
      "item": "<?= $site_url ?>/lander/<?= $site_domain ?>/cs/"
    },
    {
      "@type": "ListItem",
      "position": 2,
...
<script type="application/ld+json">
{
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css" />
    <title><?= $site_name ?> | AI obchodní platforma</title>
    <meta name="description" content="<?= $site_name ?> ⭐ — inteligentní AI obchodní platforma pro analýzu trhu v reálném čase a jasné obchodní signály ⚡ Vyzkoušejte chytré nástroje a postřehy s průvodcem." />
        ...
        "mainEntity": [
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Můžete začít fungovat během několika minut. Vytvořte si účet se základními údaji, dokončete krátký krok ověření a vložte na svůj účet minimálně <?= $app_price ?> <?= $app_currency ?>. Poté se vám odemkne celá platforma — včetně aktuálních grafů, obchodních nástrojů a funkcí, které vám pomohou začít s důvěrou."
            }
          },
          {
            "@type": "Question",
            "name": "Jsou mé peníze a data v bezpečí? Je <?= $site_name ?> spolehlivý?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Absolutně. Váš účet chráníme pokročilým SSL šifrováním, dvoufaktorovým ověřením (2FA) a bezpečným studeným úložištěm pro finanční prostředky. Transakce jsou zpracovávány prostřednictvím důvěryhodných poskytovatelů a s vašimi osobními údaji se nakládá podle přísných bezpečnostních zásad. Bezpečnost a spolehlivost jsou integrovány do každé části platformy."
            }
          },
          {
            "@type": "Question",
            "name": "Kdy si mohu vybrat své zisky?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "O výběr můžete požádat kdykoli prostřednictvím ovládacího panelu svého účtu. Zpracování obvykle trvá 1–3 pracovní dny v závislosti na zvolené metodě. Veškeré případné poplatky a časový rámec uvidíte vždy předem — žádná překvapení."
            }
          },
          {
            "@type": "Question",
            "name": "Jak poznám, zda je tato platforma pro mě ta pravá?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Nejlepším způsobem je vyzkoušet to sami. Začněte s minimálním vkladem a prozkoumejte funkce krok za krokem. Platforma je navržena tak, aby byla uživatelsky přívětivá pro začátečníky a zároveň nabízela výkonné nástroje spolu s nepřetržitou podporou 24/7, která vám pomůže, kdykoli je to potřeba. Celou dobu máte plnou kontrolu."
            }
          },
          {
            "@type": "Question",
            "name": "Potřebuji k začátku obchodní zkušenosti?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Vůbec ne. Vše je postaveno tak, aby to bylo dostupné od prvního dne — s průvodcem při registraci, jednoduchými návody a nástroji s podporou AI, které vám pomouhou orientovat se v obchodování. Ať už teprve začínáte, nebo již máte zkušenosti, můžete postupovat vlastním tempem a podpora je vám vždy k dispozici."
            }
          }
        ]
      }
  ...
  <header class="relative z-50 pt-3.5 md:pt-6">
    <div class="container-base">
      <div
        ...
        <a class="font-special inline-flex max-w-60 gap-1.5 text-xl leading-none uppercase header-nav-logo" href="<?= $site_url ?>/lander/<?= $site_domain ?>/cs/">
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/cs/" data-active>Domů</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="product.php">Produkt</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="offer.php">Nabídka</a>
    </li>
    <li>
    ...
    <nav class="mobile-menu" data-mobile-menu>
      <ul class="flex flex-col flex-wrap items-center justify-center gap-y-8">
        <li>
          <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/cs/">Domů</a>
        </li>
        <li>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h1><?= $site_name ?></h1>
            <p>Zažijte novou éru obchodování s naší pokročilou platformou pro obchodování s kryptoměnami. S AI technologií <?= $site_name ?> můžete optimalizovat své výnosy a činit informovaná investiční rozhodnutí.</p>
        </div>
        <form name="form" method="post"
          ...
          <input type="hidden" name="phone_country" value="cz">
          <input type="hidden" name="only_countries" value='["cz"]'>
          ...
          <div class="grid gap-6">
            <div class="grid gap-2 md:gap-3.5">
              <label class="grid gap-1.5">
                <span class="label text-white">Jméno</span>
                <input class="input" type="text" name="fname" placeholder="Zadejte své jméno" required />
              </label>
              <label class="grid gap-1.5">
                <span class="label text-white">Příjmení</span>
                <input class="input" type="text" name="lname" placeholder="Zadejte své příjmení" required />
              </label>
              <label class="grid gap-1.5">
                <span class="label text-white">E-mail</span>
                <input class="input" type="email" name="email" placeholder="Zadejte svůj e-mail" required />
              </label>
              <label class="grid gap-1.5">
            ...
            <div class="grid gap-3">
              ...
              <p class="text-xs text-white">
                Zadáním svých osobních údajů a kliknutím na tlačítko souhlasíte se
                <a class="link-underline" href="privacy.php">Zásadami ochrany osobních údajů</a>
                a
                <a class="link-underline" href="conditions.php">Podmínkami použití</a>
                tohoto webu.
              </p>
            </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-3 md:grid-cols-2 md:gap-6 xl:grid-cols-4">
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      ...
      <p class="h3">Dostupných měn</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">42 mil.</p>
      <p class="h3">Ověřených uživatelů</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">$440m</p>
      <p class="h3">Objem obchodování</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">100+</p>
      <p class="h3">Podporovaných zemí</p>
    </div>
  </div>
</div>
    <!-- features -->
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 max-lg:order-2 md:gap-10">
      <h2>Proč si vybrat <?= $site_name ?>?</h2>
      <p class="md:text-lg">
        Tato platforma, které důvěří obchodníci s kryptoměnami, nastavuje nový standard. Spojujeme silné zabezpečení, úplnou transparentnost, pokročilé algoritmy a bezproblémové rozhraní, abychom vám poskytli vše, co potřebujete k sebevědomému obchodování a úspěchu.
      </p>
        ...
        <div class="grid grid-cols-2 gap-x-8 gap-y-6 max-sm:flex">
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Bezpečnost, které můžete věřit</p>
              <p>Špičková ochrana vašich dat a investic na každém kroku.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Zkušenost na míru</p>
              <p>Přizpůsobte své obchodní strategie svým jedinečným cílům a stylu.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Chytré AI strategie</p>
              <p>Přesné obchodní postřehy, které vám pomohou činit sebevědomá rozhodnutí.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Automatizované obchodování</p>
              <p>Boti pohánění umělou inteligencí pracující nepřetržitě pro efektivní obchody zaměřené na zisk.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Jednoduché rozhraní</p>
              <p>Čistý, intuitivní design, který usnadňuje obchodování hned od začátku.</p>
            </div>
          </div>
        </div>
      </div>
      <p class="h3">
        Transformujte své finanční zkušenosti s <?= $site_name ?> ™.
      </p>
      <a class="btn btn-black" href="sign.php">Registrovat se</a>
    </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Efektivní obchodování!</h2>
      <p class="text-lg">
        Obchodujte s kryptoměnami jako Bitcoin, Ethereum a Dogecoin s lehkostí a jistotou.
      </p>
      <a class="btn btn-black max-md:hidden" href="sign.php">Začít</a>
    </div>
    <div class="grid gap-3 md:gap-6" data-trading></div>
    <a class="btn btn-black md:hidden" href="sign.php">Začít</a>
  </div>
</div>
<section class="feature-section">
  <div class="container">
    <div class="feature-header">
      <h2>
        Globální obchodní platforma <span>vytvořená pro růst</span>
      </h2>
      <p>
        Získejte přístup k více finančním trhům prostřednictvím sjednocené infrastruktury navržené pro výkon, přesnost a globální spolehlivost.
      </p>
    </div>
    <div class="feature-grid">
      <div class="feature-card">
        ...
        <p>
          Obchodujte s kryptoměnami, forexem, akciemi a komoditami z jednoho integrovaného prostředí bez přepínání mezi platformami.
        </p>
      </div>
      <div class="feature-card featured">
        <div class="accent"></div>
        <h3>Rychlé provádění</h3>
        <p>
          Optimalizovaná infrastruktura zajišťuje minimální latenci a stabilní provádění objednávek na globálních trzích.
        </p>
      </div>
      <div class="feature-card">
        <div class="accent"></div>
        ...
        <p>
          Aktuální data, pokročilé ukazatele a tržní analýzy vám pomohou reagovat rychleji a činit informovanější obchodní rozhodnutí.
        </p>
      </div>
    </div>
  </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10">
    <div class="grid items-center gap-6 lg:grid-cols-2">
      <h2>Jak <?= $site_name ?> funguje: váš rychlý průvodce začátkem</h2>
      <p class="rounded-custom sm:border sm:p-8">
        Začněte svou cestu obchodování s kryptoměnami bez námahy na naší platformě. Povedeme vás krok za krokem — od rychlé registrace až po váš první vklad a otevření prvního obchodu.
      </p>
    </div>
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Zaregistrujte se během několika minut, vyplňte své údaje a získejte bezpečný přístup k oficiální platformě.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Potvrďte svůj přístup</p>
          <p>Ověřte svůj e-mail a odemkněte plný přístup, abyste mohli okamžitě začít obchodovat.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Přihlášení do <?= $site_name ?></p>
          <p>Otevřete si obchodní účet s minimálním vkladem <?= $app_price ?> <?= $app_currency ?>. Vyšší investice mohou zvýšit potenciální výnosy, ale také s sebou nesou větší riziko.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Vložte prostředky na svůj účet</p>
          <p>Vyberte si preferovaný způsob — bankovní převod, elektronickou peněženku nebo kreditní kartu — a začněte okamžitě.*</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Nastavte svou strategii</p>
          <p>Upravte svůj účet tak, aby odpovídal vašim cílům. Definujte úroveň rizika, nastavte obchodní preference a nakonfigurujte svou strategii. Naši odborní makléři jsou zde, aby vás podpořili — automatizovaně nebo manuálně, volba je na vás.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Začněte obchodovat</p>
          <p>Vše je připraveno. Vstupte na trh s kryptoměnami s důvěrou a začněte zkoumat nové příležitosti ještě dnes.</p>
        </div>
      </div>
    </div>
    <div class="grid gap-6 md:grid-cols-2">
      <a class="btn btn-black" href="sign.php">Začít obchodovat</a>
    </div>
  </div>
</div>
    <!-- payments -->
    <div class="py-8 md:py-10">
      <div class="container-base grid items-center gap-6 lg:grid-cols-2">
        <p class="text-lg">
          <?= $site_name ?> globálně přijímá širokou škálu platebních metod.
        </p>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
    <div class="flex items-center justify-between gap-6 mb-6 reviews-flex-block">
      <h2 class="text-2xl font-bold">Recenze <?= $site_name ?> ™</h2>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
            <p>
              <?= $site_name ?> mě příjemně překvapil. Registrace byla rychlá, poplatky jsou jasné a tým podpory skutečně odpovídá a pomáhá. Celá zkušenost působí hladce a spolehlivě — rozhodně platforma, u které rád zůstanu.
            </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials($review_1_author) ?></div>
              <p class="font-bold">Soukromý investor</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Konečně jsem vyzkoušel krypto a zvolil <?= $site_name ?> — zatím bez litování. Začít trvalo jen několik minut a vše bylo jasně vysvětleno. Působí to jako solidní volba, zvláště pokud jste v obchodování nováčky.
                </p>
            <div class="flex items-center gap-4">
        ...
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  <?= $site_name ?> působí jako stabilní a důvěryhodná platforma. Nastavení účtu bylo snadné, podmínky jsou srozumitelné a podpora ví, co dělá. Obchodování zde pro mě bylo překvapivě pohodlným zážitkem.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials($review_3_author) ?></div>
              <p class="font-bold">Obchodník s digitálními aktivy</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  S platformou <?= $site_name ?> už obchodování s kryptoměnami nepůsobí tak složitě. Registrace byla jednoduchá, poplatky jsou transparentní a líbí se mi, že je k dispozici podpora, když ji potřebujete. Jako pro začátečníka to opravdu hraje velkou roli.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials($review_4_author) ?></div>
              <p class="font-bold">Hledač pasivního příjmu</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
      <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Jak mohu začít?</span>
        ...
        <div id="content-1" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Můžete začít fungovat během několika minut. Vytvořte si účet se základními údaji, dokončete krátký krok ověření a vložte na svůj účet minimálně <?= $app_price ?> <?= $app_currency ?>. Poté se vám odemkne celá platforma — včetně aktuálních grafů, obchodních nástrojů a funkcí, které vám pomohou začít s důvěrou.</p>
          </div>
        </div>
      </div>
      <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Jsou mé peníze a data v bezpečí? Je <?= $site_name ?> spolehlivý?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-2" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Absolutně. Váš účet chráníme pokročilým SSL šifrováním, dvoufaktorovým ověřením (2FA) a bezpečným studeným úložištěm pro finanční prostředky. Transakce jsou zpracovávány prostřednictvím důvěryhodných poskytovatelů a s vašimi osobními údaji se nakládá podle přísných bezpečnostních zásad. Bezpečnost a spolehlivost jsou integrovány do každé části platformy.</p>
          </div>
        </div>
      </div>
      <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Kdy si mohu vybrat své zisky?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-3" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>O výběr můžete požádat kdykoli prostřednictvím ovládacího panelu svého účtu. Zpracování obvykle trvá 1–3 pracovní dny v závislosti na zvolené metodě. Veškeré případné poplatky a časový rámec uvidíte vždy předem — žádná překvapení.</p>
          </div>
        </div>
      </div>
      <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Jak poznám, zda je tato platforma pro mě ta pravá?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-4" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Nejlepším způsobem je vyzkoušet to sami. Začněte s minimálním vkladem a prozkoumejte funkce krok za krokem. Platforma je navržena tak, aby byla uživatelsky přívětivá pro začátečníky a zároveň nabízela výkonné nástroje spolu s nepřetržitou podporou 24/7, která vám pomůže, kdykoli je to potřeba. Celou dobu máte plnou kontrolu.</p>
          </div>
        </div>
      </div>
      <div id="accordion-5" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Potřebuji k začátku obchodní zkušenosti?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-5" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Vůbec ne. Vše je postaveno tak, aby to bylo dostupné od prvního dne — s průvodcem při registraci, jednoduchými návody a nástroji s podporou AI, které vám pomouhou orientovat se v obchodování. Ať už teprve začínáte, nebo již máte zkušenosti, můžete postupovat vlastním tempem a podpora je vám vždy k dispozici.</p>
          </div>
        </div>
      </div>
      <div id="accordion-6" class="group border-primary rounded-custom border transition-all">
        ...
        <div id="content-6" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p style="margin-bottom:16px;"><?= $site_name ?> je globální obchodní platforma vytvořená pro uživatele, kteří očekávají konzistentní výkon, rychlé provádění a plnou kontrolu nad svým obchodním prostředím. Namísto spoléhání se na více nesouvisejících nástrojů nebo regionálně specifických služeb poskytuje platforma jediný strukturovaný systém, kde jsou všechny hlavní funkce integrovány do jednoho pracovního postupu.</p>
            <p style="margin-bottom:16px;">Od přístupu na trh až po provádění objednávek a analytiku — každý komponent je navržen tak, aby fungoval společně bez zbytečného tření. To uživatelům umožňuje soustředit se na rozhodování, namísto navigace v komplexních systémech nebo přepínání mezi platformami.</p>
            <p style="margin-bottom:10px; font-weight:500;">V rámci jednoho rozhraní mohou uživatelé působit na více finančních trzích:</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Kryptoměny, včetně hlavních a vznikajících digitálních aktiv</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Devizové trhy (forex) s tvorbou cen v reálném čase</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Globální akcie a akciové nástroje</li>
              <li><span style="color:#6D5DF6;">•</span> Komodity pro širší diverzifikaci portfolia</li>
            </ul>
            <p style="margin-bottom:16px;">Výkon je hlavní prioritou platformy. Infrastruktura je optimalizována tak, aby poskytovala provádění s nízkou latencí a stabilní provoz i v obdobích vysoké aktivity na trhu. To zajišťuje, že uživatelé mohou reagovat na pohyby cen bez zpoždění nebo technických přerušení.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Rychlé a konzistentní provádění objednávek napříč trhy</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Nepřetržitá data v reálném čase a aktualizace cen</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Vestavěné analytické nástroje a tržní indikátory</li>
              <li><span style="color:#6D5DF6;">•</span> Podpora jak pro manuální, tak pro automatizované strategie</li>
            </ul>
            <p style="margin-bottom:16px;">Bezpečnost a provozní spolehlivost jsou integrovány do každé vrstvy systému. Platforma se řídí zavedenými průmyslovými standardy a uplatňuje interní záruky, aby zajistila, že uživatelská data i finanční operace zůstanou po celou dobu chráněny.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Šifrovaný přenos dat při všech interakcích</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Vícevrstvé ověřování a autentizace účtu</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Ověřené systémy zpracování transakcí a monitorování</li>
              <li><span style="color:#6D5DF6;">•</span> Infrastruktura navržená pro stabilní globální dostupnost</li>
            </ul>
            <p style="margin-bottom:16px;">Zároveň zůstává klíčovým zaměřením použitelnost. Rozhraní je záměrně navrženo tak, aby zůstalo čisté a předvídatelné, což snižuje zbytečnou složitost a umožňuje uživatelům soustředit se na obchodní strategie spíše než na interakci se systémem.</p>
            <p style="margin-bottom:16px;">Tento rovnováha mezi výkonem a jednoduchostí činí platformu vhodnou jak pro nové uživatele, tak pro zkušené obchodníky. Začátečníci se mohou rychle přizpůsobit bez strmé křivky učení, zatímco pokročilí uživatelé si zachovávají flexibilitu potřebnou k řízení složitějších strategií.</p>
            <p><?= $site_name ?> spojuje škálovatelnost, spolehlivost a efektivitu do jediného prostředí a poskytuje strukturovaný a spolehlivý způsob, jak s důvěrou přistupovat na globální finanční trhy.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h2>Toto je obchodování s oficiální platformou™</h2>
          <p>
            Jsme důvěryhodná platforma pro jednotlivce i firmy k nákupu, prodeji a správě kryptoměn.
          </p>
        </div>
        <form name="form" method="post"
          class="leadform rf-form js-rf-form group bg-primary rounded-custom relative overflow-hidden px-4 py-8 md:px-8" action="../integration/send.php" data-form>
  ...
  <section style="padding:60px 0;" class="md:!py-[100px]">
    ...
    ">
      ...
      ">
        ...
        ">
          Hlavní funkce <span style='color:#6B5FA7;'>obchodní platformy <?= $site_name ?></span>
        </h2>
      <p style="margin-top:14px;color:#6b7280;font-size:17px;">
        Vše, co potřebujete k chytřejšímu, rychlejšímu a sebevědomějšímu obchodování.
      </p>
    </div>
    <div style="
      border-radius:16px;
    ...
    ">
      ...
      " onmouseover="this.style.background='#f9f9fb'" class="row-block" onmouseout="this.style.background='transparent'">
        ...
        <div class="row-text" style="color:#6b7280;">
          Pokročilý obchodní engine poháněný umělou inteligencí
        </div>
      </div>
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Kreditní karty, bankovní převody, PayPal
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Forex, akcie, kryptoměny, komodity a další
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
  ...
  <div class="border-primary-light grid justify-items-center gap-6 rounded-[20px] border px-4 py-5 md:gap-4 md:px-8 md:py-6 text-center md:text-left">
    ...
    <div class="flex flex-wrap items-center justify-center md:justify-start gap-2.5 text-center md:text-left">
      ...
      <span class="flex flex-wrap justify-center md:justify-start gap-1 text-sm text-gray-400">
        <span>
          <strong>318</strong> recenzí ·
        </span>
        <span>
          Na základě <strong><?= $rating_count ?></strong> hodnocení ·
        </span>
        <span>
          Skóre z 5
        </span>
    ...
    <p class="text-center md:text-left">
      Výkonná a uživatelsky přívětivá obchodní platforma s robustní automatizací a komplexními vzdělávacími zdroji.
    </p>
  </div>
</div>
      </div>
        ...
        <div class="grid gap-5">
          <nav class="flex flex-col flex-wrap justify-between gap-x-10 gap-y-5 text-white md:flex-row">
            <a class="font-special inline-flex max-w-60 gap-1.5 text-xl leading-none text-white uppercase max-md:pr-[120px] footer-nav-logo"
              href="<?= $site_url ?>/lander/<?= $site_domain ?>/cs/">
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p style="color:#6B5FA7;">Váš důvěryhodný obchodní partner</p>
  ...
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ja/" hreflang="ja" title="日本語">
    🇯🇵
        ...
        <div class="grid gap-2.5 text-sm text-gray-500">
            <p>
                <?= $site_name ?> nenese odpovědnost za jakékoli ztráty nebo škody vzniklé v důsledku použití informací uvedených na tomto webu, včetně vzdělávacího obsahu, cenových nabídek, grafů a analýz. Obchodování na finančních trzích zahrnuje riziko, proto je důležité před začátkem zvážit své osobní okolnosti a v případě potřeby vyhledat radu kvalifikovaného odborníka. Měli byste investovat pouze peníze, které si můžete dovolit ztratit, a mějte na paměti, že nástroje jako FX, CFD a kryptoměny nemusí být vhodné pro každého.
            </p>
        </div>
        <div class="text-center text-white">
          Copyright 2026 © <?= $site_name ?>, Všechna práva vyhrazena
        </div>
      </div>
    </div>
  </footer>
