...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Zásady ochrany osobních údajů | <?= $site_name ?></title>
    <meta name="description" content="Přečtěte si, jak <?= $site_name ?> shromažďuje a chrání vaše údaje." />
    <!-- Favicon -->
...
>
  ...
  <span class="breadcrumb-item">Zásady ochrany osobních údajů</span>
</nav>
...
<div class="grid gap-6 md:gap-8">
  ...
  <div class="grid gap-2">
    <p class="text-sm">Poslední aktualizace: <?= $privacy_last_update ?></p>
    <p>My („My“, „Nás“) respektujeme vaše soukromí a jsme odhodláni chránit vaše osobní údaje. Tyto zásady vysvětlují, jak <?= $site_name ?> shromažďuje, používá a chrání vaše informace.</p>
  </div>
  <!-- PRINCIPLES -->
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Transparentnost</p>
    <p>
      Jasně vysvětlujeme, jak jsou vaše údaje používány. Kontaktujte nás na 
      <a href="mailto:info@<?= $site_domain ?>">info@<?= $site_domain ?></a>
    </p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Využití dat</p>
    <p>Vaše údaje jsou používány k poskytování služeb, zlepšování platformy a plnění zákonných povinností.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Vaše práva</p>
    <p>Kdykoli můžete požádat o přístup ke svým údajům, jejich opravu nebo vymazání.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Zabezpečení</p>
    <p>Chráníme vaše údaje, ale nemůžeme zaručit absolutní bezpečnost.</p>
  </div>
  <!-- SECTIONS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Shromažďování dat</h2>
    <p>Shromažďujeme údaje o používání (IP adresa, zařízení, prohlížeč) a veškerá data, která nám poskytnete.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Právní základ</h2>
    <p>Zpracování je založeno na souhlasu, oprávněném zájmu a zákonných povinnostech.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Sdílení dat</h2>
    <p>V případě potřeby můžeme data sdílet s partnery, poskytovateli a úřady.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Soubory cookies</h2>
    <p>Používáme soubory cookies pro funkčnost a analytiku. Můžete je zakázat.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Uchovávání dat</h2>
    <p>Data jsou uchovávána pouze po nezbytně nutnou dobu.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Mezinárodní přenosy</h2>
    <p>Data mohou být přenášena s odpovídajícími zárukami.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Odkazy třetích stran</h2>
    <p>Nejsme zodpovědní za externí webové stránky.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Aktualizace</h2>
    <p>Tyto zásady mohou být aktualizovány.</p>
  </div>
  <!-- RIGHTS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">Vaše práva</h2>
    <p>Máte právo na přístup ke svým údajům, jejich opravu, vymazání, omezení nebo přenos, odvolání souhlasu a podání stížnosti.</p>
  </div>
</div>
          </div>
        </div>
