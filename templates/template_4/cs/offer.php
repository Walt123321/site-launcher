...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 Získejte sledování portfolia 💸",
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Nabídka | <?= $site_name ?></title>
    <meta name="description" content="Vyberte si s <?= $site_name ?> plán, který odpovídá vašim obchodním potřebám." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="offer.php" data-active>Nabídka</a>
    </li>
    <li>
...
<span class="breadcrumb-item">Nabídka</span>
          </nav>
        </div>
      </div>
      <!-- tracker -->
      <div class="py-8 md:py-10">
        <div class="container-base grid gap-6 lg:grid-cols-2">
          ...
          >
 <h1 class="relative z-20">Získejte sledování portfolia</h1>
<p class="relative z-20">
  Začněte během několika minut: zaregistrujte se, vložte prostředky a začněte obchodovat za pouhých 5 minut. Začněte nyní.
</p>
          </div>
...
<div class="relative z-40 py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10">
    ...
    <div class="border-primary h3 rounded-custom relative z-10 flex items-center justify-center border bg-white p-4 text-center md:p-6">
      Vložte prostředky na svůj účet
    </div>
    <div class="border-primary h3 rounded-custom relative z-10 flex items-center justify-center border bg-white p-4 text-center md:p-6">
      Začněte nakupovat a prodávat
    </div>
        </div>
      </div>
    </div>
