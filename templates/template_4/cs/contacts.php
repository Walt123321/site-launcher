...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="Kontaktujte podporu <?= $site_name ?> nebo náš obchodní tým." />
    <!-- Favicon -->
    ...
    <main class="flex grow flex-col overflow-hidden">
      ...
      <div class="pt-5">
        <div class="container-base">
          ...
          >
            <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/cs/" class="breadcrumb-item">Home</a>
...
<div class="grid gap-4 text-center md:gap-6">
  <h3>Pokud máte další otázky, kontaktujte nás e-mailem</h3>
</div>
            <a
