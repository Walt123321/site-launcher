...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 Digitální analytika <?= $site_name ?> ™ 💸",
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="Nástroje pro správu kryptoměn a aktiv s analýzou a automatizací." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/cs/">Domů</a>
    </li>
    <li>
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/cs/" class="breadcrumb-item">Domů</a>
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20">Digitální analytika <?= $site_name ?> ™</h1>
      <p class="relative z-20">
        Získejte cenné postřehy a podpořte růst s naší pokročilou analytickou platformou. Čiňte informovaná rozhodnutí založená na datech s důvěrou. Zpřesněte svou strategii a dosáhněte měřitelných výsledků.
      </p>
    </div>
    <div class="relative grid min-h-[230px] content-end">
      ...
      <div class="relative z-20 grid grid-cols-2 gap-3 md:gap-6">
        <a class="btn btn-black col-span-full" href="sign.php">Registrace</a>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Digitální webová aplikace</h2>
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        ...
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Statistiky</p>
            <p>Přístup ke všem vašim datům</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Mobilní zobrazení</p>
            <p>Přístup prostřednictvím mobilního telefonu</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            ...
            <p>Získejte přístup ke každému aktivu</p>
          </div>
        </div>
      </div>
    </div>
    <div class="flex items-center justify-center">
      <img
        ...
        alt="Mobilní rozhraní pro sledování portfolia"
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Zde prezentuji svou profesionální kariéru prostřednictvím působivých projektů a kreativních řešení.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Koupit kryptoměnu</p>
          <p>Bezpečná a jednoduchá platforma pro nákup kryptoměn. Rychlé transakce s minimálními poplatky. Začněte obchodovat ještě dnes.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Kryptoanalytika</p>
          <p>Zjistěte více o tržních hodnotách a trendech, abyste mohli činit informovaná investiční a obchodní rozhodnutí.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Kryptoměnová aktiva</p>
          <p>Objevujte budoucnost financí s předními kryptoměnami. Objevujte, investujte, roste.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">Jdeme na to!</p>
<p>
  Prozkoumejte svět kryptoměn s platformou <?= $site_name ?>. Obchodníci mohou získat přístup k obchodní platformě, která kombinuje inovace, efektivitu a příležitosti k zisku.
</p>
          </div>
        ...
        <div class="grid gap-5">
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p>Váš důvěryhodný obchodní partner</p>
