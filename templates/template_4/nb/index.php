...
?>
<!DOCTYPE html>
<html class="scroll-smooth" lang="nb" data-theme="orange">
<!-- head -->
<head>
  ...
  "itemListElement": [
    {
      ...
      "position": 1,
      "name": "<?= $site_name ?>",
      "item": "<?= $site_url ?>/lander/<?= $site_domain ?>/nb/"
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 <?= $site_name ?> 💸",
      "item": "<?= $site_url ?>/lander/<?= $site_domain ?>/nb/#heading-style-h1"
    }
  ]
}
</script>
<script type="application/ld+json">
{
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css" />
    ...
    <meta name="description" content="<?= $site_name ?> ⭐ — smart AI-handelsplattform med markedsanalyse i sanntid og tydelige handelssignaler ⚡ Prøv smarte verktøy og veiledet innsikt." />
        ...
        "mainEntity": [
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Du kan være klar til å starte på bare noen minutter. Opprett en konto med grunnleggende opplysninger, fullfør den korte verifiseringen og sett inn minst <?= $app_price ?> <?= $app_currency ?>. Deretter får du tilgang til hele plattformen — inkludert sanntidsdiagrammer, handelsverktøy og funksjoner som hjelper deg i gang med trygghet."
            }
          },
          {
            "@type": "Question",
            "name": "Er pengene og dataene mine trygge? Kan jeg stole på <?= $site_name ?>?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Absolutt. Vi beskytter kontoen din med avansert SSL-kryptering, tofaktorautentisering (2FA) og sikker cold storage for midler. Transaksjoner behandles gjennom pålitelige leverandører, og personopplysningene dine håndteres i tråd med strenge sikkerhetsstandarder. Sikkerhet og pålitelighet er en fast del av hele plattformen."
            }
          },
          {
            "@type": "Question",
            "name": "Når kan jeg ta ut gevinsten min?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Du kan når som helst be om uttak via dashbordet ditt. Behandlingen tar vanligvis 1–3 virkedager, avhengig av valgt metode. Eventuelle gebyrer og tidsramme vises alltid på forhånd — ingen overraskelser."
            }
          },
          {
            "@type": "Question",
            "name": "Hvordan vet jeg om denne plattformen passer for meg?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Den beste måten er å prøve selv. Start med minsteinnskuddet og utforsk funksjonene steg for steg. Plattformen er utviklet for å være brukervennlig for nybegynnere, samtidig som den tilbyr kraftige verktøy og 24/7-support som hjelper deg når som helst. Du beholder full kontroll."
            }
          },
          {
            "@type": "Question",
            "name": "Trenger jeg handelserfaring for å komme i gang?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Overhodet ikke. Alt er bygget for å være tilgjengelig fra dag én — med veiledet registrering, enkle instruksjoner og AI-drevne verktøy som hjelper deg å finne deg til rette i handel. Enten du er helt ny eller har erfaring fra før, kan du gå frem i ditt eget tempo, og support er alltid tilgjengelig."
            }
          }
        ]
      }
  ...
  <header class="relative z-50 pt-3.5 md:pt-6">
    <div class="container-base">
      <div
        ...
        <a class="font-special inline-flex max-w-60 gap-1.5 text-xl leading-none uppercase header-nav-logo" href="<?= $site_url ?>/lander/<?= $site_domain ?>/nb/">
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/nb/" data-active>Hjem</a>
    </li>
    <li>
    ...
    <li>
      <a class="data-active:text-primary" href="contacts.php">Kontakt oss</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="faq.php">FAQ</a>
        ...
        <div class="flex items-center gap-4 max-md:hidden mobmenu">
          ...
          <a class="inline-flex h-[50px] w-[50px] shrink-0 items-center justify-center rounded-full border-2"
            href="sign.php" aria-label="Logg inn">
    ...
    <nav class="mobile-menu" data-mobile-menu>
      <ul class="flex flex-col flex-wrap items-center justify-center gap-y-8">
        <li>
          <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/nb/">Hjem</a>
        </li>
        <li>
      ...
      <a href="/team">Our team</a>
        ...
        <li>
          <a href="contacts.php">Kontakt oss</a>
        </li>
        <li>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h1><?= $site_name ?></h1>
            <p>Opplev en ny æra innen handel med vår avanserte plattform for kryptovalutahandel. Med AI-teknologien fra <?= $site_name ?> kan du optimalisere avkastningen din og ta velinformerte investeringsbeslutninger.</p>
        </div>
        <form name="form" method="post"
          ...
          <input type="hidden" name="phone_country" value="no">
          <input type="hidden" name="only_countries" value='["no"]'>
          ...
          <div class="grid gap-6">
            <div class="grid gap-2 md:gap-3.5">
              <label class="grid gap-1.5">
                ...
                <input class="input" type="text" name="fname" placeholder="Skriv inn fornavnet ditt" required />
              </label>
              <label class="grid gap-1.5">
                <span class="label text-white">Etternavn</span>
                <input class="input" type="text" name="lname" placeholder="Skriv inn etternavnet ditt" required />
              </label>
              <label class="grid gap-1.5">
                <span class="label text-white">E-post</span>
                <input class="input" type="email" name="email" placeholder="Skriv inn e-postadressen din" required />
              </label>
              <label class="grid gap-1.5">
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-3 md:grid-cols-2 md:gap-6 xl:grid-cols-4">
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      ...
      <p class="h3">Tilgjengelige valutaer</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">42 mill.</p>
      <p class="h3">Verifiserte brukere</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">$440M</p>
      <p class="h3">Handelsvolum</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 max-lg:order-2 md:gap-10">
      <h2>Hvorfor velge <?= $site_name ?>?</h2>
      <p class="md:text-lg">
        Denne plattformen, som kryptohandlere stoler på, setter en ny standard. Vi kombinerer sterk sikkerhet, full åpenhet, avanserte algoritmer og et sømløst brukergrensesnitt for å gi deg alt du trenger for trygg og vellykket handel.
      </p>
        ...
        <div class="grid grid-cols-2 gap-x-8 gap-y-6 max-sm:flex">
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Sikkerhet du kan stole på</p>
              <p>Førsteklasses beskyttelse av dataene og investeringene dine i hvert steg.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Personlig tilpasset opplevelse</p>
              <p>Tilpass handelsstrategiene dine til dine egne mål og din egen stil.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              ...
              <p>Presis handelsinnsikt som hjelper deg å ta trygge beslutninger.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Automatisert handel</p>
              <p>KI-drevne roboter jobber døgnet rundt for effektive, lønnsomme handler.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Enkelt brukergrensesnitt</p>
              <p>Et klart, intuitivt design som gjør det enkelt å komme i gang med handel fra start.</p>
            </div>
          </div>
        </div>
      </div>
      <p class="h3">
        Transformer din økonomiske hverdag med <?= $site_name ?> ™.
      </p>
      <a class="btn btn-black" href="sign.php">Registrer deg</a>
    </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      ...
      <p class="text-lg">
        Handle kryptovaluta som Bitcoin, Ethereum og Dogecoin med letthet og trygghet.
      </p>
...
<section class="feature-section">
  <div class="container">
    <div class="feature-header">
      <h2>
        Global handelsplattform, <span>utviklet for vekst</span>
      </h2>
      <p>
        Få tilgang til flere finansmarkeder gjennom én samlet infrastruktur, utviklet for ytelse, presisjon og global pålitelighet.
      </p>
    </div>
    <div class="feature-grid">
      <div class="feature-card">
        ...
        <p>
          Handle kryptovaluta, Forex, aksjer og råvarer i ett samlet miljø, uten å måtte bytte mellom plattformer.
        </p>
      </div>
      <div class="feature-card featured">
        <div class="accent"></div>
        <h3>Rask utførelse</h3>
        <p>
          Den optimaliserte infrastrukturen sikrer minimal latens og stabil ordreutførelse i de globale markedene.
        </p>
      </div>
      <div class="feature-card">
        <div class="accent"></div>
        ...
        <p>
          Oppdaterte data, avanserte indikatorer og markedsanalyser hjelper deg med å reagere raskere og ta bedre informerte handelsbeslutninger.
        </p>
      </div>
    </div>
  </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10">
    <div class="grid items-center gap-6 lg:grid-cols-2">
      <h2>Slik fungerer <?= $site_name ?>: kom raskt i gang</h2>
      <p class="rounded-custom sm:border sm:p-8">
        Start din kryptohandel-reise uten problemer på vår plattform. Vi følger deg steg for steg — fra rask registrering og ditt første innskudd til din første handel.
      </p>
    </div>
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Opprette konto</p>
          <p>Registrer deg på få minutter, oppgi opplysningene dine og få sikker tilgang til den offisielle plattformen.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Bekrefte tilgang</p>
          <p>Verifiser e-postadressen din for å låse opp full tilgang og begynne å handle med en gang.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Logg inn hos <?= $site_name ?></p>
          <p>Åpne handelskontoen din med et minsteinnskudd på <?= $app_price ?> <?= $app_currency ?>. Høyere investeringer kan øke potensiell avkastning, men medfører også høyere risiko.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Fylle på konto</p>
          <p>Velg din foretrukne metode — bankoverføring, e-lommebok eller kredittkort — og kom i gang med en gang.*</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Sette opp strategi</p>
          <p>Tilpass kontoen din til dine mål. Definer risikonivået ditt, angi handelspreferanser og konfigurer strategien din. Våre profesjonelle meglere hjelper deg underveis — enten automatisert eller manuelt, valget er ditt.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Starte handel</p>
          <p>Alt er klart. Gå inn i kryptovalutamarkedet med trygghet og utforsk nye muligheter allerede i dag.</p>
        </div>
      </div>
    </div>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid items-center gap-6 lg:grid-cols-2">
        <p class="text-lg">
          <?= $site_name ?> aksepterer et bredt utvalg betalingsmetoder over hele verden.
        </p>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
            <p>
              <?= $site_name ?> overrasket meg positivt. Registreringen gikk raskt, gebyrene er tydelige, og supportteamet svarer og hjelper faktisk. Hele opplevelsen føles smidig og pålitelig — definitivt en plattform jeg blir værende på.
            </p>
        ...
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Jeg prøvde endelig krypto og valgte <?= $site_name ?> — ingen anger så langt. Det tok bare noen minutter å komme i gang, og alt ble tydelig forklart. Det føles som et solid valg, spesielt hvis du er ny innen handel.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials($review_2_author) ?></div>
              <p class="font-bold">Uavhengig trader</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  <?= $site_name ?> virker som en stabil og pålitelig plattform. Det var enkelt å opprette konto, vilkårene er forståelige, og supporten vet hva de gjør. Å handle her har vært en overraskende komfortabel opplevelse for meg.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials($review_3_author) ?></div>
              <p class="font-bold">Handler av digitale eiendeler</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Med <?= $site_name ?> føles ikke krypto-handel like komplisert lenger. Registreringen var enkel, gebyrene er tydelige, og jeg liker at support er tilgjengelig når man trenger det. Som nybegynner utgjør det virkelig en stor forskjell.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials($review_4_author) ?></div>
              <p class="font-bold">På jakt etter passiv inntekt</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
      <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
        ...
        <div id="content-1" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Du kan være klar til å starte på bare noen minutter. Opprett en konto med grunnleggende opplysninger, fullfør den korte verifiseringen og sett inn minst <?= $app_price ?> <?= $app_currency ?>. Deretter får du tilgang til hele plattformen — inkludert sanntidsdiagrammer, handelsverktøy og funksjoner som hjelper deg i gang med trygghet.</p>
          </div>
        </div>
      </div>
      <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Er pengene og dataene mine trygge? Kan jeg stole på <?= $site_name ?>?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-2" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Absolutt. Vi beskytter kontoen din med avansert SSL-kryptering, tofaktorautentisering (2FA) og sikker cold storage for midler. Transaksjoner behandles gjennom pålitelige leverandører, og personopplysningene dine håndteres i tråd med strenge sikkerhetsstandarder. Sikkerhet og pålitelighet er en fast del av hele plattformen.</p>
          </div>
        </div>
      </div>
      <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Når kan jeg ta ut gevinsten min?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-3" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Du kan når som helst be om uttak via dashbordet ditt. Behandlingen tar vanligvis 1–3 virkedager, avhengig av valgt metode. Eventuelle gebyrer og tidsramme vises alltid på forhånd — ingen overraskelser.</p>
          </div>
        </div>
      </div>
      <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Hvordan vet jeg om denne plattformen passer for meg?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-4" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Den beste måten er å prøve selv. Start med minsteinnskuddet og utforsk funksjonene steg for steg. Plattformen er utviklet for å være brukervennlig for nybegynnere, samtidig som den tilbyr kraftige verktøy og 24/7-support som hjelper deg når som helst. Du beholder full kontroll.</p>
          </div>
        </div>
      </div>
      <div id="accordion-5" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Trenger jeg handelserfaring for å komme i gang?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-5" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Overhodet ikke. Alt er bygget for å være tilgjengelig fra dag én — med veiledet registrering, enkle instruksjoner og AI-drevne verktøy som hjelper deg å finne deg til rette i handel. Enten du er helt ny eller har erfaring fra før, kan du gå frem i ditt eget tempo, og support er alltid tilgjengelig.</p>
          </div>
        </div>
      </div>
      <div id="accordion-6" class="group border-primary rounded-custom border transition-all">
        ...
        <div id="content-6" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p style="margin-bottom:16px;"><?= $site_name ?> er en global handelsplattform utviklet for brukere som forventer jevn ytelse, rask utførelse og full kontroll over sitt handelsmiljø. I stedet for å være avhengig av flere usammenhengende verktøy eller regionspesifikke tjenester, tilbyr plattformen ett samlet, strukturert system der alle hovedfunksjoner er integrert i én arbeidsflyt.</p>
            <p style="margin-bottom:16px;">Fra markedstilgang og ordreutførelse til analyse — hver komponent er utviklet for å fungere sømløst sammen. Dette gjør at brukerne kan fokusere på beslutningstaking i stedet for å navigere i kompliserte systemer eller bytte mellom plattformer.</p>
            <p style="margin-bottom:10px; font-weight:500;">Innenfor ett enkelt grensesnitt kan brukere handle i flere finansmarkeder:</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Kryptovaluta, inkludert ledende og fremvoksende digitale eiendeler</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Valutamarkedet (Forex) med prising i sanntid</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Globale aksjer og aksjeinstrumenter</li>
              <li><span style="color:#6D5DF6;">•</span> Råvarer for bredere porteføljediversifisering</li>
            </ul>
            <p style="margin-bottom:16px;">Ytelse er plattformens høyeste prioritet. Infrastrukturen er optimalisert for utførelse med lav latens og stabil drift, selv i perioder med høy markedsaktivitet. Dette sikrer at brukerne kan reagere på prisbevegelser uten forsinkelser eller tekniske avbrudd.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Rask og konsistent ordreutførelse på tvers av alle markeder</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Kontinuerlige sanntidsdata og prisoppdateringer</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Innebygde analyseverktøy og markedsindikatorer</li>
              <li><span style="color:#6D5DF6;">•</span> Støtte for både manuelle og automatiserte strategier</li>
            </ul>
            <p style="margin-bottom:16px;">Sikkerhet og driftssikkerhet er innebygd i hvert lag av systemet. Plattformen følger etablerte bransjestandarder og bruker interne sikkerhetstiltak for å sikre at både brukerdata og finansielle transaksjoner er beskyttet til enhver tid.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Kryptert dataoverføring ved all interaksjon</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Flertrinns verifisering og kontoautentisering</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Verifiserte systemer for transaksjonsbehandling og overvåking</li>
              <li><span style="color:#6D5DF6;">•</span> Infrastruktur utviklet for stabil, global tilgjengelighet</li>
            </ul>
            <p style="margin-bottom:16px;">Samtidig er brukervennlighet fortsatt et sentralt fokus. Grensesnittet er bevisst utformet for å være klart og forutsigbart, noe som reduserer unødvendig kompleksitet og lar brukerne fokusere på handelsstrategiene sine i stedet for å måtte sette seg inn i systemet.</p>
            <p style="margin-bottom:16px;">Denne balansen mellom ytelse og enkelhet gjør plattformen egnet både for nye brukere og erfarne tradere. Nybegynnere kan raskt tilpasse seg uten en bratt læringskurve, mens erfarne brukere beholder fleksibiliteten som trengs for å administrere mer komplekse strategier.</p>
            <p><?= $site_name ?> forener skalerbarhet, pålitelighet og effektivitet i ett samlet miljø, og tilbyr en strukturert og pålitelig måte å få tilgang til de globale finansmarkedene på med trygghet.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h2>Dette er handel på den offisielle plattformen™</h2>
          <p>
            Vi er en pålitelig plattform for privatpersoner og bedrifter som ønsker å kjøpe, selge og forvalte kryptovaluta.
          </p>
        </div>
        <form name="form" method="post"
          class="leadform rf-form js-rf-form group bg-primary rounded-custom relative overflow-hidden px-4 py-8 md:px-8" action="../integration/send.php" data-form>
  ...
  <section style="padding:60px 0;" class="md:!py-[100px]">
    ...
    ">
      ...
      ">
        ...
        ">
          Hovedfunksjoner i <span style='color:#6B5FA7;'>handelsplattformen <?= $site_name ?></span>
        </h2>
      <p style="margin-top:14px;color:#6b7280;font-size:17px;">
        Alt du trenger for smartere, raskere og tryggere handel.
      </p>
    </div>
    <div style="
      border-radius:16px;
    ...
    ">
      ...
      " onmouseover="this.style.background='#f9f9fb'" class="row-block" onmouseout="this.style.background='transparent'">
        ...
        <div class="row-text" style="color:#6b7280;">
          Avansert, AI-drevet handelsmotor
        </div>
      </div>
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Kredittkort, bankoverføringer, PayPal
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Forex, aksjer, kryptovaluta, råvarer og mer
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
  ...
  <div class="border-primary-light grid justify-items-center gap-6 rounded-[20px] border px-4 py-5 md:gap-4 md:px-8 md:py-6 text-center md:text-left">
    ...
    <div class="flex flex-wrap items-center justify-center md:justify-start gap-2.5 text-center md:text-left">
      ...
      <span class="flex flex-wrap justify-center md:justify-start gap-1 text-sm text-gray-400">
        ...
        <span>
          Basert på <strong><?= $rating_count ?></strong> anmeldelser ·
        </span>
        <span>
          av 5
        </span>
    ...
    <p class="text-center md:text-left">
      En kraftig og brukervennlig handelsplattform med robust automatisering og omfattende opplæringsressurser.
    </p>
  </div>
</div>
      </div>
        ...
        <div class="grid gap-5">
          <nav class="flex flex-col flex-wrap justify-between gap-x-10 gap-y-5 text-white md:flex-row">
            <a class="font-special inline-flex max-w-60 gap-1.5 text-xl leading-none text-white uppercase max-md:pr-[120px] footer-nav-logo"
              href="<?= $site_url ?>/lander/<?= $site_domain ?>/nb/">
            ...
            <ul class="flex flex-col gap-x-5 gap-y-4 md:flex-row">
              <li>
                <a href="privacy.php">Personvernerklæring</a>
              </li>
              <li>
                <a href="conditions.php">Vilkår og betingelser</a>
              </li>
              <li>
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p style="color:#6B5FA7;">Din pålitelige handelspartner</p>
  ...
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ja/" hreflang="ja" title="日本語">
    🇯🇵
        ...
        <div class="grid gap-2.5 text-sm text-gray-500">
            <p>
                <?= $site_name ?> påtar seg intet ansvar for tap eller skader som oppstår som følge av tillit til informasjonen som gis på denne nettsiden, inkludert opplæringsinnhold, prisnoteringer, diagrammer og analyser. Handel i finansmarkedene innebærer risiko. Det er derfor viktig å vurdere dine personlige forhold før du starter, og om nødvendig innhente råd fra en kvalifisert fagperson. Du bør kun investere penger du har råd til å tape, og vær oppmerksom på at instrumenter som valuta (FX), CFD-er og kryptovalutaer ikke passer for alle.
            </p>
        </div>
        <div class="text-center text-white">
          Copyright 2026 © <?= $site_name ?>, Alle rettigheter forbeholdt
        </div>
      </div>
    </div>
  </footer>
