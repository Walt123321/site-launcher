...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="Verktøy for å administrere kryptovaluta og eiendeler med analyser og automatisering." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/nb/">Hjem</a>
    </li>
    <li>
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/nb/" class="breadcrumb-item">Hjem</a>
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      ...
      <p class="relative z-20">
        Få verdifull innsikt og driv vekst med vår avanserte analyseplattform. Ta velbegrunnede, datadrevne beslutninger med selvtillit. Foredle strategien din og oppnå målbare resultater.
      </p>
    </div>
    <div class="relative grid min-h-[230px] content-end">
      ...
      <div class="relative z-20 grid grid-cols-2 gap-3 md:gap-6">
        <a class="btn btn-black col-span-full" href="sign.php">Registrer deg</a>
  ...
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      ...
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        ...
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Statistikk</p>
            <p>Tilgang til alle dataene dine</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            ...
            <p>Tilgang via mobiltelefonen din</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Kryptostyring</p>
            <p>Få tilgang til enhver eiendel</p>
          </div>
        </div>
      </div>
    </div>
    <div class="flex items-center justify-center">
      <img
        ...
        alt="Mobilgrensesnitt for porteføljesporing"
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Her presenterer jeg min karriere gjennom imponerende prosjekter og kreative løsninger.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Kjøp krypto</p>
          <p>Sikker og enkel plattform for å kjøpe kryptovaluta. Raske transaksjoner med minimale gebyrer. Start handelen i dag.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Lær mer om markedsverdier og trender for å ta velbegrunnede investerings- og handelsbeslutninger.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Kryptoeiendeler</p>
          <p>Oppdag fremtidens finans med ledende kryptovalutaer. Oppdag, invester, voks.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">Sett i gang!</p>
<p>
  Oppdag kryptovalutaenes verden med <?= $site_name ?>. Handlere får tilgang til en handelsplattform som forener innovasjon, effektivitet og fortjenestemuligheter.
</p>
          </div>
          ...
          <div class="grid gap-6">
            ...
            <div class="grid gap-3">
              ...
              <p class="text-xs text-white">
                ...
                <a class="link-underline" href="privacy.php">Personvernerklæring</a>
                og
                <a class="link-underline" href="conditions.php">Vilkår og betingelser</a>
                for denne nettsiden.
              </p>
            </div>
        ...
        <div class="grid gap-5">
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p>Din pålitelige handelspartner</p>
