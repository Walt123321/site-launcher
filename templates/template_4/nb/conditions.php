...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Vilkår og betingelser | <?= $site_name ?></title>
    <meta name="description" content="Les vilkårene og betingelsene for <?= $site_name ?>." />
    <meta charset="UTF-8" />
...
<div class="grid gap-6 md:gap-8">
  <div class="grid gap-2 md:gap-4">
    ...
    <p>Denne nettsiden gir informasjon om tredjeparts handelsplattformer og relaterte tjenester. Ved å bruke denne nettsiden godtar du disse vilkårene og vår personvernerklæring. Vilkårene kan oppdateres når som helst.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Kvalifisering</h2>
    <p>Du må være minst 18 år gammel, kunne akseptere disse vilkårene og ikke være begrenset av lokale lover. Vi er ikke ansvarlige for ulovlig bruk av denne nettsiden.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Begrenset tilgang</h2>
    <p>Vi kan begrense tilgangen for brukere fra bestemte regioner eller der det foreligger juridiske eller regulatoriske risikoer. Tjenester kan være utilgjengelige i begrensede områder.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Ikke-tillatt bruk</h2>
    <p>Du kan ikke misbruke nettsiden, inkludert brudd på lover, krenkelse av rettigheter, spredning av skadelig innhold eller bruk av automatiserte systemer. Ved brudd kan vi begrense tilgangen.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Immaterielle rettigheter</h2>
    <p>Alt innhold, varemerker og materialer tilhører oss eller tredjeparter. Du kan bare bruke nettsiden til personlige formål og kan ikke kopiere eller endre innhold.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Ansvar</h2>
    <p>Nettsiden og tjenestene tilbys "som de er". Vi er ikke ansvarlige for feil, tap eller skader som oppstår som følge av bruk av denne nettsiden.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Tredjepartstjenester</h2>
    <p>Vi kan vise innhold eller lenker fra tredjeparter. Vi er ikke ansvarlige for deres nøyaktighet eller tjenester. Kontroller informasjonen før du tar en beslutning.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Lenker</h2>
    <p>Lenker til eksterne nettsider tilbys kun som en tjeneste. Vi støtter eller kontrollerer dem ikke, og er ikke ansvarlige for innholdet deres.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">9. Diverse</h2>
    <p>Vi kan oppdatere eller endre tjenestene og vilkårene når som helst. Disse vilkårene utgjør hele avtalen mellom deg og oss. Manglende håndhevelse av rettigheter betyr ikke at man gir avkall på dem.</p>
  </div>
</div>
      </div>
    </main>
