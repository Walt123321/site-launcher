...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Registrer deg | <?= $site_name ?></title>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta name="description" content="Bli med i <?= $site_name ?> og velg en plan som passer dine handelsmål." />
...
<p>
  Vi er en pålitelig plattform for privatpersoner og bedrifter for å kjøpe, selge og administrere kryptovaluta.
</p>
          </div>
