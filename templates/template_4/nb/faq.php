...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Ofte stilte spørsmål (FAQ) | <?= $site_name ?></title>
    <meta name="description" content="Svar på spørsmål om handel, funksjoner, sikkerhet og gebyrer." />
    <!-- Favicon -->
  ...
  <div class="container-base grid gap-6 md:gap-10">
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
        <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
          ...
          >
            <span class="h3 text-left transition-colors">Hvordan kan jeg komme i gang?</span>
          ...
          <div id="content-1" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Du kan være klar på noen minutter. Opprett en konto med grunnleggende data, fullfør det korte verifiseringstrinnet og sett inn minst <?= $app_price ?> <?= $app_currency ?> . Deretter låses hele plattformen opp for deg — inkludert sanntidsdiagrammer, handelsverktøy og funksjoner som hjelper deg med å starte med selvtillit.</p>
            </div>
          </div>
        </div>
        <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
          ...
          <div id="content-2" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Absolutt. Vi beskytter kontoen din med avansert SSL-kryptering, tofaktorautentisering (2FA) og sikker cold storage-oppbevaring for midler. Transaksjoner håndteres via pålitelige leverandører, og personopplysningene dine behandles i henhold til strenge sikkerhetsretningslinjer. Sikkerhet og pålitelighet er godt forankret i hver del av plattformen.</p>
            </div>
          </div>
        </div>
        <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
          ...
          >
            <span class="h3 text-left transition-colors">Når kan jeg ta ut gevinstene mine?</span>
            <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
              <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1" transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
                <rect x="19.5176" y="35.9287" width="4.62857" height="23.1428" rx="1" transform="rotate(-135 19.5176 35.9287)" fill="currentColor" />
          ...
          <div id="content-3" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Du kan be om et uttak når som helst via dashbordet ditt. Behandlingen tar vanligvis 1–3 virkedager, avhengig av valgt metode. Eventuelle gebyrer og tidsramme ser du alltid på forhånd — ingen overraskelser.</p>
            </div>
          </div>
        </div>
        <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
          ...
          >
            <span class="h3 text-left transition-colors">Hvordan vet jeg om denne plattformen er riktig for meg?</span>
            <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
              <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1" transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
                <rect x="19.5176" y="35.9287" width="4.62857" height="23.1428" rx="1" transform="rotate(-135 19.5176 35.9287)" fill="currentColor" />
          ...
          <div id="content-4" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Den beste måten er å prøve selv. Start med minimumsinnskuddet og utforsk funksjonene steg for steg. Plattformen er designet for å være brukervennlig for nybegynnere samtidig som den tilbyr kraftige verktøy og 24/7-støtte som hjelper deg når som helst. Du beholder full kontroll.</p>
            </div>
          </div>
        </div>
        <div id="accordion-5" class="group border-primary rounded-custom border transition-all">
          ...
          >
            <span class="h3 text-left transition-colors">Trenger jeg handelserfaring for å starte?</span>
            <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
              <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1" transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
                <rect x="19.5176" y="35.9287" width="4.62857" height="23.1428" rx="1" transform="rotate(-135 19.5176 35.9287)" fill="currentColor" />
          ...
          <div id="content-5" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Overhodet ikke. Alt er utformet for å være tilgjengelig fra første dag — med veiledet registrering, enkle instruksjoner og AI-drevne verktøy som hjelper deg med å navigere i handel. Enten du akkurat har begynt eller allerede har erfaring, kan du gå frem i ditt eget tempo, og støtten er alltid der for deg.</p>
            </div>
          </div>
        </div>
    </div>
