...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Privatlivspolitik | <?= $site_name ?></title>
    <meta name="description" content="Læs, hvordan <?= $site_name ?> indsamler og beskytter dine data." />
    <!-- Favicon -->
...
<div class="grid gap-6 md:gap-8">
  ...
  <div class="grid gap-2">
    <p class="text-sm">Sidst opdateret: <?= $privacy_last_update ?></p>
    <p>Vi ("Vi", "Os") respekterer dit privatliv og forpligter os til at beskytte dine personoplysninger. Denne privatlivspolitik forklarer, hvordan <?= $site_name ?> indsamler, bruger og beskytter dine oplysninger.</p>
  </div>
  <!-- PRINCIPLES -->
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Gennemsigtighed</p>
    <p>
      Vi forklarer tydeligt, hvordan dine data bruges. Kontakt os på 
      <a href="mailto:info@<?= $site_domain ?>">info@<?= $site_domain ?></a>
    </p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Databrug</p>
    <p>Dine data bruges til at levere tjenester, forbedre platformen og opfylde juridiske forpligtelser.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Dine rettigheder</p>
    <p>Du kan til enhver tid anmode om indsigt i dine data samt kræve rettelse eller sletning heraf.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Sikkerhed</p>
    <p>Vi beskytter dine data, men kan ikke garantere absolut sikkerhed.</p>
  </div>
  <!-- SECTIONS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Dataindsamling</h2>
    <p>Vi indsamler brugsdata (IP-adresse, enhed, browser) og alle data, du stiller til rådighed for os.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Retsgrundlag</h2>
    <p>Behandlingen er baseret på dit samtykke, legitime interesser og juridiske forpligtelser.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Videregivelse af data</h2>
    <p>Om nødvendigt kan vi videregive data til partnere, tjenesteudbydere og myndigheder.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Cookies</h2>
    <p>Vi bruger cookies til funktionalitet og analyser. Du kan deaktivere disse.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Dataopbevaring</h2>
    <p>Data opbevares kun så længe det er absolut nødvendigt.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Internationale overførsler</h2>
    <p>Data kan overføres med passende garantier.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Tredjepartslinks</h2>
    <p>Vi er ikke ansvarlige for eksterne hjemmesider.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Opdateringer</h2>
    <p>Denne privatlivspolitik kan blive opdateret.</p>
  </div>
  <!-- RIGHTS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">Dine rettigheder</h2>
    <p>Du har ret til indsigt, berigtigelse, sletning, begrænsning eller overførsel af dine data, til at trække samtykke tilbage og til at indgive en klage.</p>
  </div>
</div>
          </div>
        </div>
