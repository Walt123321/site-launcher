...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Brugsbetingelser | <?= $site_name ?></title>
    <meta name="description" content="Læs brugsbetingelserne for <?= $site_name ?>." />
    <meta charset="UTF-8" />
  ...
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <div class="grid gap-5 md:gap-7">
        <nav aria-label="breadcrumb" class="flex flex-wrap items-center text-sm text-gray-500 md:text-lg">
            ...
            <span class="breadcrumb-item">Brugsbetingelser</span>
        </nav>
        <h1>Brugsbetingelser</h1>
    </div>
<div class="grid gap-6 md:gap-8">
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Generelt</h2>
    <p>Denne hjemmeside giver information om tredjeparts handelsplatforme og relaterede tjenester. Ved at bruge denne hjemmeside accepterer du disse betingelser og vores privatlivspolitik. Betingelserne kan opdateres når som helst.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Berettigelse</h2>
    <p>Du skal være mindst 18 år, kunne acceptere disse betingelser og må ikke være begrænset af lokale love. Vi er ikke ansvarlige for ulovlig brug af denne hjemmeside.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Begrænset adgang</h2>
    <p>Vi kan begrænse adgangen for brugere fra visse regioner, eller hvor der er juridiske eller regulatoriske risici. Tjenester er muligvis ikke tilgængelige i begrænsede områder.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Ulovlig brug</h2>
    <p>Du må ikke misbruge hjemmesiden, herunder overtrædelse af love, krænkelse af rettigheder, spredning af skadeligt indhold eller brug af automatiserede systemer. Ved overtrædelser kan vi begrænse adgangen.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Immaterielle rettigheder</h2>
    <p>Alt indhold, varemærker og materialer tilhører os eller tredjeparter. Du må kun bruge hjemmesiden til personlige formål og må ikke kopiere eller ændre indhold.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Ansvar</h2>
    <p>Hjemmesiden og tjenesterne leveres "som de er". Vi er ikke ansvarlige for fejl, tab eller skader, der opstår som følge af brugen af denne hjemmeside.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Tredjepartstjenester</h2>
    <p>Vi kan vise indhold eller links fra tredjeparter. Vi er ikke ansvarlige for deres nøjagtighed eller tjenester. Kontroller oplysningerne, før du træffer en beslutning.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Links</h2>
    <p>Links til eksterne hjemmesider stilles kun til rådighed som en service. Vi støtter eller kontrollerer dem ikke og er ikke ansvarlige for deres indhold.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">9. Diverse</h2>
    <p>Vi kan opdatere eller ændre tjenesterne og betingelserne når som helst. Disse betingelser udgør hele aftalen mellem dig og os. Manglende håndhævelse af rettigheder betyder ikke, at man giver afkald på dem.</p>
  </div>
</div>
      </div>
    </main>
