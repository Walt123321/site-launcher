...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Tilbud | <?= $site_name ?></title>
    <meta name="description" content="Vælg en plan hos <?= $site_name ?>, der passer til dine handelsbehov." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="offer.php" data-active>Tilbud</a>
    </li>
    <li>
...
<span class="breadcrumb-item">Tilbud</span>
          </nav>
        </div>
      </div>
      <!-- tracker -->
      <div class="py-8 md:py-10">
        <div class="container-base grid gap-6 lg:grid-cols-2">
          ...
          >
 <h1 class="relative z-20">Få porteføljesporing</h1>
<p class="relative z-20">
  Kom i gang på få minutter: Tilmeld dig, indbetal saldo, og begynd at handle på blot 5 minutter. Start nu.
</p>
          </div>
