...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 Obtenha o Portfolio Tracker 💸",
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Oferta | <?= $site_name ?></title>
    <meta name="description" content="Escolha um plano com a <?= $site_name ?> adequado às suas necessidades de trading." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="offer.php" data-active>Oferta</a>
    </li>
    <li>
...
<span class="breadcrumb-item">Oferta</span>
          </nav>
        </div>
      </div>
      <!-- tracker -->
      <div class="py-8 md:py-10">
        <div class="container-base grid gap-6 lg:grid-cols-2">
          ...
          >
 <h1 class="relative z-20">Obtenha o Portfolio Tracker</h1>
<p class="relative z-20">
  Comece em minutos: registe-se, deposite e comece a negociar em apenas 5 minutos. Comece agora.
</p>
          </div>
