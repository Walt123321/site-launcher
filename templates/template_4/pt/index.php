...
?>
<!DOCTYPE html>
<html class="scroll-smooth" lang="pt" data-theme="orange">
<!-- head -->
<head>
  ...
  "itemListElement": [
    {
      ...
      "position": 1,
      "name": "<?= $site_name ?>",
      "item": "<?= $site_url ?>/lander/<?= $site_domain ?>/pt/"
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 <?= $site_name ?> 💸",
      "item": "<?= $site_url ?>/lander/<?= $site_domain ?>/pt/#heading-style-h1"
    }
  ]
}
</script>
<script type="application/ld+json">
{
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css" />
    <title><?= $site_name ?> | Plataforma de trading com IA</title>
    <meta name="description" content="<?= $site_name ?> ⭐ — plataforma de trading com IA inteligente para análise de mercado em tempo real e sinais de trading claros ⚡ Experimente ferramentas inteligentes e informação guiada." />
        ...
        "mainEntity": [
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Pode estar operacional em apenas alguns minutos. Crie uma conta com os seus dados básicos, complete um breve passo de verificação e deposite um mínimo de <?= $app_price ?> <?= $app_currency ?>. Depois desbloqueia a plataforma completa — gráficos em tempo real, ferramentas de trading e funcionalidades para começar com confiança."
            }
          },
          {
            "@type": "Question",
            "name": "O meu dinheiro e os meus dados estão seguros? A <?= $site_name ?> é fiável?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Sem dúvida. Protegemos a sua conta com encriptação SSL avançada, verificação 2FA e armazenamento a frio seguro para fundos. As transacções são processadas através de fornecedores de confiança e os dados pessoais são tratados com políticas de segurança rigorosas. Segurança e fiabilidade estão integradas em cada parte da plataforma."
            }
          },
          {
            "@type": "Question",
            "name": "Quando posso levantar os meus lucros?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Os levantamentos podem ser solicitados a qualquer momento através do painel da conta. O processamento demora normalmente 1–3 dias úteis, consoante o método escolhido. Verá sempre comissões e prazos aplicáveis antecipadamente — sem surpresas."
            }
          },
          {
            "@type": "Question",
            "name": "Como sei se esta plataforma é adequada para mim?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "A melhor forma é experimentar. Comece com o depósito mínimo e explore as funcionalidades passo a passo. A plataforma é pensada para principiantes e oferece ferramentas potentes, com suporte 24/7 quando necessário. Mantém o controlo em todo o momento."
            }
          },
          {
            "@type": "Question",
            "name": "Preciso de experiência em trading para começar?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "De todo. Tudo é concebido para ser acessível desde o primeiro dia — com orientação de integração, tutoriais simples e ferramentas assistidas por IA. Quer esteja a começar agora ou já tenha experiência, pode avançar ao seu ritmo com suporte sempre disponível."
            }
          }
        ]
      }
  ...
  <header class="relative z-50 pt-3.5 md:pt-6">
    <div class="container-base">
      <div
        ...
        <a class="font-special inline-flex max-w-60 gap-1.5 text-xl leading-none uppercase header-nav-logo" href="<?= $site_url ?>/lander/<?= $site_domain ?>/pt/">
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/pt/" data-active>Início</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="product.php">Produto</a>
    </li>
    <li>
    ...
    <nav class="mobile-menu" data-mobile-menu>
      <ul class="flex flex-col flex-wrap items-center justify-center gap-y-8">
        <li>
          <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/pt/">Início</a>
        </li>
        <li>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h1><?= $site_name ?></h1>
            <p>Viva uma nova era de trading com a nossa plataforma avançada de negociação de criptomoedas. Com a tecnologia de IA da <?= $site_name ?>, pode optimizar os seus rendimentos e tomar decisões de investimento informadas.</p>
        </div>
        <form name="form" method="post"
          ...
          <input type="hidden" name="phone_country" value="pt">
          <input type="hidden" name="only_countries" value='["pt"]'>
          ...
          <div class="grid gap-6">
            <div class="grid gap-2 md:gap-3.5">
              <label class="grid gap-1.5">
                <span class="label text-white">Nome</span>
                <input class="input" type="text" name="fname" placeholder="Introduza o seu nome" required />
              </label>
              <label class="grid gap-1.5">
                <span class="label text-white">Apelido</span>
                <input class="input" type="text" name="lname" placeholder="Introduza o seu apelido" required />
              </label>
              <label class="grid gap-1.5">
                <span class="label text-white">E-mail</span>
                <input class="input" type="email" name="email" placeholder="Introduza o seu e-mail" required />
              </label>
              <label class="grid gap-1.5">
                <span class="label text-white">Telefone</span>
            ...
            <div class="grid gap-3">
              ...
              <p class="text-xs text-white">
                Ao introduzir os seus dados pessoais e clicar no botão, aceita a
                <a class="link-underline" href="privacy.php">Política de Privacidade</a>
                e as
                <a class="link-underline" href="conditions.php">Condições de Utilização</a>
                do website.
              </p>
            </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-3 md:grid-cols-2 md:gap-6 xl:grid-cols-4">
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      ...
      <p class="h3">Moedas disponíveis</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
    ...
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      ...
      <p class="h3">Volume de negociação</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 max-lg:order-2 md:gap-10">
      <h2>Porquê escolher a <?= $site_name ?>?</h2>
      <p class="md:text-lg">
        Com a confiança dos traders de cripto modernos, esta plataforma define um novo padrão. Combinamos segurança robusta, transparência total, algoritmos avançados e uma interface fluida para lhe dar tudo o que precisa para negociar com confiança e ter sucesso.
      </p>
        ...
        <div class="grid grid-cols-2 gap-x-8 gap-y-6 max-sm:flex">
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Segurança em que pode confiar</p>
              <p>Protecção de topo para os seus dados e investimentos em cada passo.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Experiência personalizada</p>
              <p>Personalize as suas estratégias de trading de acordo com os seus objectivos e estilo.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Estratégias inteligentes com IA</p>
              <p>Informação de trading precisa para o ajudar a tomar decisões com confiança.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              ...
              <p>Bots com IA activos 24 horas por dia para operações eficientes orientadas ao lucro.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              ...
              <p>Design limpo e intuitivo que torna o trading simples desde o primeiro dia.</p>
            </div>
          </div>
        </div>
      </div>
      <p class="h3">
        Transforme a sua experiência financeira com a <?= $site_name ?> ™.
      </p>
      <a class="btn btn-black" href="sign.php">Registar</a>
    </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      ...
      <p class="text-lg">
        Negocie criptomoedas como Bitcoin, Ethereum e Dogecoin com facilidade e confiança.
      </p>
      <a class="btn btn-black max-md:hidden" href="sign.php">Começar</a>
    </div>
    <div class="grid gap-3 md:gap-6" data-trading></div>
    <a class="btn btn-black md:hidden" href="sign.php">Começar</a>
  </div>
</div>
<section class="feature-section">
  <div class="container">
    <div class="feature-header">
      <h2>
        Plataforma de trading global <span>construída para escalar</span>
      </h2>
      <p>
        Aceda a vários mercados financeiros através de uma infraestrutura unificada concebida para desempenho, precisão e fiabilidade global.
      </p>
    </div>
    <div class="feature-grid">
      <div class="feature-card">
        ...
        <p>
          Negocie cripto, forex, acções e matérias-primas num único ambiente integrado sem mudar de plataforma.
        </p>
      </div>
      <div class="feature-card featured">
        ...
        <p>
          Infraestrutura optimizada que garante latência mínima e execução estável de ordens nos mercados globais.
        </p>
      </div>
      <div class="feature-card">
        <div class="accent"></div>
        ...
        <p>
          Dados em directo, indicadores avançados e informação de mercado ajudam-no a reagir mais depressa e a tomar decisões mais informadas.
        </p>
      </div>
    </div>
  </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10">
    <div class="grid items-center gap-6 lg:grid-cols-2">
      <h2>Como funciona a <?= $site_name ?>: o seu guia de início rápido</h2>
      <p class="rounded-custom sm:border sm:p-8">
        Comece a sua jornada no trading de cripto sem esforço na nossa plataforma. Guiamo-lo passo a passo — desde o registo rápido ao primeiro depósito e à primeira operação.
      </p>
    </div>
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Crie a sua conta</p>
          <p>Registe-se em minutos, preencha os seus dados e obtenha acesso seguro à plataforma oficial.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Confirme o seu acesso</p>
          <p>Verifique o seu e-mail e desbloqueie o acesso completo para começar a negociar de imediato.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Login <?= $site_name ?></p>
          <p>Abra a sua conta de trading com um depósito mínimo de <?= $app_price ?> <?= $app_currency ?>. Investimentos maiores podem aumentar os rendimentos potenciais, mas também o risco.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Deposite fundos na conta</p>
          <p>Escolha o método preferido — transferência bancária, carteira electrónica ou cartão de crédito — e comece já.*</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Defina a sua estratégia</p>
          <p>Ajuste a conta aos seus objectivos. Defina o nível de risco, preferências de trading e configure a estratégia. Os nossos brokers especialistas estão aqui para apoiar — automático ou manual, à sua escolha.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Comece a negociar</p>
          <p>Está tudo pronto. Entre no mercado de cripto com confiança e explore novas oportunidades hoje.</p>
        </div>
      </div>
    </div>
    <div class="grid gap-6 md:grid-cols-2">
      <a class="btn btn-black" href="sign.php">Começar a negociar</a>
    </div>
  </div>
</div>
    <!-- payments -->
    <div class="py-8 md:py-10">
      <div class="container-base grid items-center gap-6 lg:grid-cols-2">
        <p class="text-lg">
          A <?= $site_name ?> aceita diversos métodos de pagamento em todo o mundo.
        </p>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
    <div class="flex items-center justify-between gap-6 mb-6 reviews-flex-block">
      <h2 class="text-2xl font-bold">Avaliações <?= $site_name ?> ™</h2>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
            <p>
              A <?= $site_name ?> surpreendeu-me positivamente. O registo foi rápido, as comissões são claras e a equipa de suporte responde e ajuda mesmo. A experiência completa é fluida e fiável — sem dúvida uma plataforma onde fico.
            </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Investidor privado') ?></div>
              <p class="font-bold">Investidor privado</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Finalmente experimentei as criptomoedas com a <?= $site_name ?> — por agora sem arrependimentos. Começar demorou apenas alguns minutos e tudo foi explicado com clareza. Parece uma opção sólida, especialmente se é novo no trading.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Trader independente') ?></div>
              <p class="font-bold">Trader independente</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  A <?= $site_name ?> parece uma plataforma estável e fiável. A criação de conta foi fácil, as condições são claras e o suporte sabe o que faz. Negociar aqui foi uma experiência surpreendentemente confortável.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Trader de ativos digitais') ?></div>
              <p class="font-bold">Trader de ativos digitais</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Com a <?= $site_name ?>, o trading de cripto já não parece avassalador. O registo foi simples, as comissões são transparentes e há suporte quando precisa. Como principiante, isso faz mesmo a diferença.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Procura rendimento passivo') ?></div>
              <p class="font-bold">Procura rendimento passivo</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
      <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Como começo?</span>
        ...
        <div id="content-1" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Pode estar operacional em apenas alguns minutos. Crie uma conta com os seus dados básicos, complete um breve passo de verificação e deposite um mínimo de <?= $app_price ?> <?= $app_currency ?>. Depois desbloqueia a plataforma completa — gráficos em tempo real, ferramentas de trading e funcionalidades para começar com confiança.</p>
          </div>
        </div>
      </div>
      <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">O meu dinheiro e os meus dados estão seguros? A <?= $site_name ?> é fiável?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-2" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Sem dúvida. Protegemos a sua conta com encriptação SSL avançada, verificação 2FA e armazenamento a frio seguro para fundos. As transacções são processadas através de fornecedores de confiança e os dados pessoais são tratados com políticas de segurança rigorosas. Segurança e fiabilidade estão integradas em cada parte da plataforma.</p>
          </div>
        </div>
      </div>
      <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Quando posso levantar os meus lucros?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-3" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Os levantamentos podem ser solicitados a qualquer momento através do painel da conta. O processamento demora normalmente 1–3 dias úteis, consoante o método escolhido. Verá sempre comissões e prazos aplicáveis antecipadamente — sem surpresas.</p>
          </div>
        </div>
      </div>
      <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Como sei se esta plataforma é adequada para mim?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-4" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>A melhor forma é experimentar. Comece com o depósito mínimo e explore as funcionalidades passo a passo. A plataforma é pensada para principiantes e oferece ferramentas potentes, com suporte 24/7 quando necessário. Mantém o controlo em todo o momento.</p>
          </div>
        </div>
      </div>
      <div id="accordion-5" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Preciso de experiência em trading para começar?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-5" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>De todo. Tudo é concebido para ser acessível desde o primeiro dia — com orientação de integração, tutoriais simples e ferramentas assistidas por IA. Quer esteja a começar agora ou já tenha experiência, pode avançar ao seu ritmo com suporte sempre disponível.</p>
          </div>
        </div>
      </div>
      <div id="accordion-6" class="group border-primary rounded-custom border transition-all">
        ...
        <div id="content-6" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p style="margin-bottom:16px;">A <?= $site_name ?> é uma plataforma de trading global construída para utilizadores que esperam desempenho consistente, execução rápida e controlo total sobre o ambiente de trading. Em vez de depender de várias ferramentas desligadas ou serviços regionais, a plataforma oferece um único sistema estruturado onde todas as funções principais estão integradas num fluxo de trabalho.</p>
            <p style="margin-bottom:16px;">Do acesso ao mercado à execução de ordens e análise, cada componente é concebido para funcionar em conjunto sem fricção desnecessária. Os utilizadores podem focar-se na tomada de decisões em vez de sistemas complexos ou mudanças de plataforma.</p>
            <p style="margin-bottom:10px; font-weight:500;">Numa única interface, os utilizadores podem operar em vários mercados financeiros:</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Criptomoedas, incluindo activos digitais principais e emergentes</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Mercados cambiais com preços em tempo real</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Acções e instrumentos bolsistas globais</li>
              <li><span style="color:#6D5DF6;">•</span> Matérias-primas para maior diversificação de carteira</li>
            </ul>
            <p style="margin-bottom:16px;">O desempenho é uma prioridade central da plataforma. A infraestrutura está optimizada para execução de baixa latência e operação estável mesmo em períodos de alta actividade de mercado.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Execução rápida e consistente de ordens em todos os mercados</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Dados e actualizações de preços em tempo real contínuos</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Ferramentas analíticas e indicadores de mercado integrados</li>
              <li><span style="color:#6D5DF6;">•</span> Suporte para estratégias manuais e automatizadas</li>
            </ul>
            <p style="margin-bottom:16px;">Segurança e fiabilidade operacional estão integradas em cada camada do sistema. A plataforma segue padrões da indústria e aplica salvaguardas internas para que dados e operações financeiras permaneçam protegidos.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Transmissão de dados encriptada em todas as interacções</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Verificação e autenticação de conta em várias camadas</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Processamento e monitorização de transacções verificados</li>
              <li><span style="color:#6D5DF6;">•</span> Infraestrutura concebida para acessibilidade global estável</li>
            </ul>
            <p style="margin-bottom:16px;">Ao mesmo tempo, a usabilidade permanece um foco chave. A interface é intencionalmente limpa e previsível, reduzindo complexidade desnecessária para se focar nas estratégias de trading.</p>
            <p style="margin-bottom:16px;">Este equilíbrio entre desempenho e simplicidade torna a plataforma adequada tanto para novos utilizadores como para traders experientes.</p>
            <p>A <?= $site_name ?> combina escalabilidade, fiabilidade e eficiência num único ambiente, oferecendo uma forma estruturada e fiável de aceder aos mercados financeiros globais com confiança.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h2>Isto é trading com a plataforma oficial™</h2>
          <p>
            Somos a plataforma de confiança para particulares e empresas comprarem, venderem e gerirem criptomoedas.
          </p>
        </div>
        <form name="form" method="post"
          class="leadform rf-form js-rf-form group bg-primary rounded-custom relative overflow-hidden px-4 py-8 md:px-8" action="../integration/send.php" data-form>
  ...
  <section style="padding:60px 0;" class="md:!py-[100px]">
    ...
    ">
      ...
      ">
        ...
        ">
          Capacidades principais da <span style='color:#6B5FA7;'>plataforma de trading <?= $site_name ?></span>
        </h2>
      <p style="margin-top:14px;color:#6b7280;font-size:17px;">
        Tudo o que precisa para negociar de forma mais inteligente, rápida e com confiança.
      </p>
    </div>
    <div style="
      border-radius:16px;
    ...
    ">
      ...
      " onmouseover="this.style.background='#f9f9fb'" class="row-block" onmouseout="this.style.background='transparent'">
        ...
        <div class="row-text" style="color:#6b7280;">
          Motor de trading avançado com IA
        </div>
      </div>
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Cartões de crédito, transferências bancárias, PayPal
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Forex, acções, cripto, matérias-primas e mais
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
  ...
  <div class="border-primary-light grid justify-items-center gap-6 rounded-[20px] border px-4 py-5 md:gap-4 md:px-8 md:py-6 text-center md:text-left">
    ...
    <div class="flex flex-wrap items-center justify-center md:justify-start gap-2.5 text-center md:text-left">
      ...
      <span class="leading-none text-amber-500" role="img"
        aria-label="<?= $rating_value ?> Pontuação de 5">
        <?= $stars ?>
      </span>
      <span class="flex flex-wrap justify-center md:justify-start gap-1 text-sm text-gray-400">
        <span>
          <strong>318</strong> avaliações ·
        </span>
        <span>
          Com base em <strong><?= $rating_count ?></strong> classificações ·
        </span>
        <span>
          Pontuação de 5
        </span>
    ...
    <p class="text-center md:text-left">
      Uma plataforma de trading poderosa e fácil de usar, com automação robusta e recursos educativos completos.
    </p>
  </div>
</div>
      </div>
        ...
        <div class="grid gap-5">
          <nav class="flex flex-col flex-wrap justify-between gap-x-10 gap-y-5 text-white md:flex-row">
            <a class="font-special inline-flex max-w-60 gap-1.5 text-xl leading-none text-white uppercase max-md:pr-[120px] footer-nav-logo"
              href="<?= $site_url ?>/lander/<?= $site_domain ?>/pt/">
            ...
            <ul class="flex flex-col gap-x-5 gap-y-4 md:flex-row">
              ...
              <li>
                <a href="conditions.php">Condições de Utilização</a>
              </li>
              <li>
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p style="color:#6B5FA7;">O seu parceiro de trading de confiança</p>
  ...
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ja/" hreflang="ja" title="日本語">
    🇯🇵
        ...
        <div class="grid gap-2.5 text-sm text-gray-500">
            <p>
                A <?= $site_name ?> não é responsável por perdas ou danos que possam resultar da utilização da informação fornecida neste website, incluindo conteúdo educativo, cotações, gráficos e análises. Negociar nos mercados financeiros envolve risco; é importante considerar as suas circunstâncias pessoais e, se necessário, procurar o conselho de um profissional qualificado antes de começar. Só deve investir dinheiro que pode permitir-se perder, e tenha em conta que instrumentos como FX, CFDs e criptomoedas podem não ser adequados para todos.
            </p>
        </div>
        <div class="text-center text-white">
          Copyright 2026 © <?= $site_name ?>, Todos os direitos reservados
        </div>
      </div>
    </div>
  </footer>
