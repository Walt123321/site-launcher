...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 Análise digital <?= $site_name ?> ™ 💸",
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Produto | <?= $site_name ?></title>
    <meta name="description" content="Ferramentas para gerir cripto e activos com análise e automatização." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/pt/">Início</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="product.php" data-active>Produto</a>
    </li>
    <li>
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/pt/" class="breadcrumb-item">Início</a>
      <span class="breadcrumb-item">Produto</span>
    </nav>
  </div>
</div>
      <!-- analytics -->
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20">Análise digital <?= $site_name ?> ™</h1>
      <p class="relative z-20">
        Obtenha informação valiosa e impulsione o crescimento com a nossa plataforma de análise avançada. Tome decisões informadas baseadas em dados com confiança. Refine a estratégia e alcance resultados mensuráveis.
      </p>
    </div>
    <div class="relative grid min-h-[230px] content-end">
      ...
      <div class="relative z-20 grid grid-cols-2 gap-3 md:gap-6">
        <a class="btn btn-black col-span-full" href="sign.php">Registar</a>
  ...
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
      ...
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Mercado de capitais</p>
            <p>Tudo ao alcance de um clique</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Estatísticas</p>
            <p>Aceda a todos os seus dados</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Vista móvel</p>
            <p>Acesso via telemóvel</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
    ...
    <div class="flex items-center justify-center">
      <img
        ...
        alt="Interface móvel de acompanhamento de carteira"
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10">
    <h2>Funcionalidades digitais</h2>
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Carteira</p>
          <p>Aqui apresento a minha carreira profissional através de projectos de destaque e soluções criativas.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Comprar criptomoedas</p>
          <p>Uma plataforma segura e simples para comprar criptomoedas. Transacções rápidas com comissões mínimas. Comece a negociar hoje.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Análise cripto</p>
          <p>Saiba mais sobre valores e tendências de mercado para decisões de investimento e negócio informadas.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Explore o futuro das finanças com as principais criptomoedas. Descubra, invista, cresça.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">Vamos lá!</p>
<p>
  Explore o mundo das criptomoedas com a <?= $site_name ?>. Os traders portugueses podem aceder a uma plataforma que combina inovação, eficiência e oportunidades de lucro.
</p>
          </div>
        ...
        <div class="grid gap-5">
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p>O seu parceiro de trading de confiança</p>
