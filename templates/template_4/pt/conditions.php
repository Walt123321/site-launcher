...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Condições de Utilização | <?= $site_name ?></title>
    <meta name="description" content="Leia os termos e condições de utilização da <?= $site_name ?>." />
    <meta charset="UTF-8" />
  ...
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <div class="grid gap-5 md:gap-7">
        <nav aria-label="breadcrumb" class="flex flex-wrap items-center text-sm text-gray-500 md:text-lg">
            ...
            <span class="breadcrumb-item">Condições de Utilização</span>
        </nav>
        <h1>Condições de Utilização</h1>
    </div>
<div class="grid gap-6 md:gap-8">
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Geral</h2>
    <p>Este website fornece informação sobre plataformas de trading de terceiros e serviços relacionados. Ao utilizar o website, aceita estes Termos e a nossa Política de Privacidade. Os termos podem ser actualizados a qualquer momento.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Elegibilidade</h2>
    <p>Deve ter pelo menos 18 anos, poder aceitar estes Termos e não estar restrito pelas leis locais. Não somos responsáveis pelo uso ilícito do website.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Acesso restrito</h2>
    <p>Podemos restringir o acesso a utilizadores de certas regiões ou onde existam riscos legais ou regulamentares. Os serviços podem não estar disponíveis em locais restritos.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Uso proibido</h2>
    <p>Não deve fazer uso indevido do website, incluindo violar leis, infringir direitos, difundir conteúdo prejudicial ou usar sistemas automatizados. Podemos restringir o acesso se os Termos forem violados.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Propriedade intelectual</h2>
    <p>Todo o conteúdo, marcas e materiais pertencem a nós ou a terceiros. Só pode usar o website para uso pessoal e não deve copiar ou modificar conteúdo.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Responsabilidade</h2>
    <p>O website e os serviços são fornecidos «tal como estão». Não somos responsáveis por erros, perdas ou danos resultantes do uso do website.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Serviços de terceiros</h2>
    <p>Podemos exibir conteúdo ou ligações de terceiros. Não somos responsáveis pela sua exactidão ou serviços. Verifique a informação antes de tomar decisões.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Ligações</h2>
    <p>Ligações a websites externos são fornecidas apenas por conveniência. Não os endossamos nem controlamos e não somos responsáveis pelo seu conteúdo.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">9. Diversos</h2>
    <p>Podemos actualizar ou modificar serviços e Termos a qualquer momento. Estes Termos constituem o acordo completo entre si e nós. Direitos não exercidos não constituem renúncia.</p>
  </div>
</div>
      </div>
    </main>
