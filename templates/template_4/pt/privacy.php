...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="Saiba como a <?= $site_name ?> recolhe e protege os seus dados." />
    <!-- Favicon -->
...
<div class="grid gap-6 md:gap-8">
  ...
  <div class="grid gap-2">
    <p class="text-sm">Última actualização: <?= $privacy_last_update ?></p>
    <p>Nós («Nós») respeitamos a sua privacidade e comprometemo-nos a proteger os seus dados pessoais. Esta política explica como a <?= $site_name ?> recolhe, utiliza e protege as suas informações.</p>
  </div>
  <!-- PRINCIPLES -->
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Transparência</p>
    <p>
      Explicamos claramente como os seus dados são utilizados. Contacte-nos em 
      <a href="mailto:info@<?= $site_domain ?>">info@<?= $site_domain ?></a>
    </p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Utilização de dados</p>
    <p>Os seus dados são utilizados para prestar serviços, melhorar a plataforma e cumprir obrigações legais.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Os seus direitos</p>
    <p>Pode solicitar acesso, rectificação ou eliminação dos seus dados a qualquer momento.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Segurança</p>
    <p>Protegemos os seus dados, mas não podemos garantir segurança absoluta.</p>
  </div>
  <!-- SECTIONS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Recolha de dados</h2>
    <p>Recolhemos dados de utilização (IP, dispositivo, browser) e quaisquer dados que nos forneça.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Base legal</h2>
    <p>O tratamento baseia-se em consentimento, interesse legítimo e obrigações legais.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Partilha de dados</h2>
    <p>Podemos partilhar dados com parceiros, fornecedores e autoridades se necessário.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Cookies</h2>
    <p>Utilizamos cookies para funcionalidade e análise. Pode desactivá-los.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Conservação de dados</h2>
    <p>Os dados são conservados apenas o tempo necessário.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Transferências internacionais</h2>
    <p>Os dados podem ser transferidos com garantias adequadas.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Ligações de terceiros</h2>
    <p>Não somos responsáveis por websites externos.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Actualizações</h2>
    <p>Esta política pode ser actualizada.</p>
  </div>
  <!-- RIGHTS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">Os seus direitos</h2>
    <p>Tem o direito de aceder, rectificar, eliminar, limitar ou transferir os seus dados, retirar consentimento e apresentar reclamação.</p>
  </div>
</div>
          </div>
        </div>
