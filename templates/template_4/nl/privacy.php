...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Privacybeleid | <?= $site_name ?></title>
    <meta name="description" content="Ontdek hoe <?= $site_name ?> uw gegevens verzamelt en beschermt." />
    <!-- Favicon -->
...
<div class="grid gap-6 md:gap-8">
  ...
  <div class="grid gap-2">
    <p class="text-sm">Laatste update: <?= $privacy_last_update ?></p>
    <p>Wij («Wij») respecteren uw privacy en zetten ons in voor de bescherming van uw persoonsgegevens. Dit beleid legt uit hoe <?= $site_name ?> uw informatie verzamelt, gebruikt en beschermt.</p>
  </div>
  <!-- PRINCIPLES -->
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Transparantie</p>
    <p>
      We leggen duidelijk uit hoe uw gegevens worden gebruikt. Neem contact op via 
      <a href="mailto:info@<?= $site_domain ?>">info@<?= $site_domain ?></a>
    </p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Gegevensgebruik</p>
    <p>Uw gegevens worden gebruikt om diensten te leveren, het platform te verbeteren en aan wettelijke verplichtingen te voldoen.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Uw rechten</p>
    <p>U kunt op elk moment toegang, correctie of verwijdering van uw gegevens aanvragen.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Beveiliging</p>
    <p>We beschermen uw gegevens maar kunnen geen absolute veiligheid garanderen.</p>
  </div>
  <!-- SECTIONS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Gegevensverzameling</h2>
    <p>We verzamelen gebruiksgegevens (IP, apparaat, browser) en alle gegevens die u verstrekt.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Rechtsgrond</h2>
    <p>Verwerking is gebaseerd op toestemming, gerechtvaardigd belang en wettelijke verplichtingen.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Gegevensdeling</h2>
    <p>We kunnen gegevens delen met partners, providers en autoriteiten indien vereist.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Cookies</h2>
    <p>We gebruiken cookies voor functionaliteit en analytics. U kunt ze uitschakelen.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Gegevensbewaring</h2>
    <p>Gegevens worden alleen bewaard zolang nodig.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Internationale overdrachten</h2>
    <p>Gegevens kunnen worden overgedragen met passende waarborgen.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Links van derden</h2>
    <p>We zijn niet verantwoordelijk voor externe websites.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Updates</h2>
    <p>Dit beleid kan worden bijgewerkt.</p>
  </div>
  <!-- RIGHTS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">Uw rechten</h2>
    <p>U heeft het recht op toegang, correctie, verwijdering, beperking of overdracht van uw gegevens, intrekking van toestemming en het indienen van een klacht.</p>
  </div>
</div>
          </div>
        </div>
