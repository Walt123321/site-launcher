...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 Digitale analytics <?= $site_name ?> ™ 💸",
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Product | <?= $site_name ?></title>
    <meta name="description" content="Tools voor het beheren van crypto en activa met analytics en automatisering." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/nl/">Home</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="product.php" data-active>Product</a>
    </li>
    <li>
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/nl/" class="breadcrumb-item">Home</a>
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20">Digitale analytics <?= $site_name ?> ™</h1>
      <p class="relative z-20">
        Verkrijg waardevolle inzichten en stimuleer groei met ons geavanceerde analyticsplatform. Neem met vertrouwen datagedreven beslissingen. Verfijn uw strategie en behaal meetbare resultaten.
      </p>
    </div>
    <div class="relative grid min-h-[230px] content-end">
      ...
      <div class="relative z-20 grid grid-cols-2 gap-3 md:gap-6">
        <a class="btn btn-black col-span-full" href="sign.php">Registreren</a>
  ...
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
      ...
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Kapitaalmarkt</p>
            <p>Alles met één druk op de knop</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Statistieken</p>
            <p>Toegang tot al uw gegevens</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Mobiele weergave</p>
            <p>Toegang via uw mobiel</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
    ...
    <div class="flex items-center justify-center">
      <img
        ...
        alt="Mobiele interface voor portefeuilletracking"
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Hier toon ik mijn professionele loopbaan via indrukwekkende projecten en creatieve oplossingen.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Cryptovaluta kopen</p>
          <p>Een veilig en eenvoudig platform om cryptovaluta te kopen. Snelle transacties met minimale kosten. Begin vandaag met handelen.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Crypto-analytics</p>
          <p>Leer meer over marktwaarden en trends voor weloverwogen investerings- en zakelijke beslissingen.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Crypto-activa</p>
          <p>Ontdek de toekomst van finance met toonaangevende cryptovaluta. Ontdek, investeer, groei.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">Laten we gaan!</p>
<p>
  Ontdek de wereld van cryptovaluta met <?= $site_name ?>. Nederlandse traders krijgen toegang tot een platform dat innovatie, efficiëntie en winstkansen combineert.
</p>
          </div>
        ...
        <div class="grid gap-5">
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p>Uw betrouwbare tradingpartner</p>
