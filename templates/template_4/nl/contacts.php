...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="Neem contact op met de support van <?= $site_name ?> of ons zakelijke team." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="contacts.php" data-active>Contact</a>
    </li>
    <li>
...
<div class="grid gap-4 text-center md:gap-6">
  <h3>Heeft u nog vragen? Neem contact op via e-mail</h3>
</div>
            <a
