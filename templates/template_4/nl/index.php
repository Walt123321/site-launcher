...
?>
<!DOCTYPE html>
<html class="scroll-smooth" lang="nl" data-theme="orange">
<!-- head -->
<head>
  ...
  "itemListElement": [
    {
      ...
      "position": 1,
      "name": "<?= $site_name ?>",
      "item": "<?= $site_url ?>/lander/<?= $site_domain ?>/nl/"
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 <?= $site_name ?> 💸",
      "item": "<?= $site_url ?>/lander/<?= $site_domain ?>/nl/#heading-style-h1"
    }
  ]
}
</script>
<script type="application/ld+json">
{
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css" />
    ...
    <meta name="description" content="<?= $site_name ?> ⭐ — intelligent AI-handelsplatform voor realtime marktanalyse en duidelijke handelssignalen ⚡ Probeer slimme tools en begeleide inzichten." />
        ...
        "mainEntity": [
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "U bent binnen enkele minuten operationeel. Maak een account aan met uw basisgegevens, voltooi een korte verificatiestap en stort minimaal <?= $app_price ?> <?= $app_currency ?>. Daarna ontgrendelt u het volledige platform — live grafieken, handelstools en functies om met vertrouwen te starten."
            }
          },
          {
            "@type": "Question",
            "name": "Zijn mijn geld en gegevens veilig? Is <?= $site_name ?> betrouwbaar?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Absoluut. We beschermen uw account met geavanceerde SSL-versleuteling, 2FA-verificatie en veilige cold storage voor fondsen. Transacties verlopen via vertrouwde providers en uw persoonsgegevens worden verwerkt volgens strikte beveiligingsbeleid. Veiligheid en betrouwbaarheid zitten in elk onderdeel van het platform."
            }
          },
          {
            "@type": "Question",
            "name": "Wanneer kan ik mijn winst opnemen?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Opnames kunnen op elk moment via uw accountdashboard worden aangevraagd. Verwerking duurt meestal 1–3 werkdagen, afhankelijk van de gekozen methode. U ziet altijd vooraf de van toepassing zijnde kosten en termijnen — geen verrassingen."
            }
          },
          {
            "@type": "Question",
            "name": "Hoe weet ik of dit platform bij mij past?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "De beste manier is het zelf te proberen. Begin met de minimale storting en ontdek de functies stap voor stap. Het platform is gebruiksvriendelijk voor beginners en biedt krachtige tools, met 24/7-support wanneer nodig. U behoudt te allen tijde de controle."
            }
          },
          {
            "@type": "Question",
            "name": "Heb ik handelservaring nodig om te beginnen?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Helemaal niet. Alles is toegankelijk vanaf dag één — met onboarding, eenvoudige tutorials en AI-ondersteunde tools. Of u nu net begint of al ervaring heeft, u gaat in uw eigen tempo verder met altijd beschikbare support."
            }
          }
        ]
      }
  ...
  <header class="relative z-50 pt-3.5 md:pt-6">
    <div class="container-base">
      <div
        ...
        <a class="font-special inline-flex max-w-60 gap-1.5 text-xl leading-none uppercase header-nav-logo" href="<?= $site_url ?>/lander/<?= $site_domain ?>/nl/">
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/nl/" data-active>Home</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="product.php">Product</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="offer.php">Aanbod</a>
    </li>
    <li>
      ...
      <a class="data-active:text-primary" href="faq.php">FAQ</a>
        ...
        <div class="flex items-center gap-4 max-md:hidden mobmenu">
          <a class="group inline-flex h-[50px] items-center justify-between rounded-full border-2" href="sign.php">
            <span class="inline-block p-3.5 text-sm">Registreren</span>
            <span
    ...
    <nav class="mobile-menu" data-mobile-menu>
      <ul class="flex flex-col flex-wrap items-center justify-center gap-y-8">
        <li>
          <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/nl/">Home</a>
        </li>
        <li>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h1><?= $site_name ?></h1>
            <p>Beleef een nieuw tijdperk van trading met ons geavanceerde crypto-handelsplatform. Met de AI-technologie van <?= $site_name ?> kunt u uw rendement optimaliseren en weloverwogen investeringsbeslissingen nemen.</p>
        </div>
        <form name="form" method="post"
          ...
          <input type="hidden" name="phone_country" value="nl">
          <input type="hidden" name="only_countries" value='["nl"]'>
          ...
          <div class="grid gap-6">
            <div class="grid gap-2 md:gap-3.5">
              <label class="grid gap-1.5">
                <span class="label text-white">Voornaam</span>
                <input class="input" type="text" name="fname" placeholder="Voer uw voornaam in" required />
              </label>
              <label class="grid gap-1.5">
                <span class="label text-white">Achternaam</span>
                <input class="input" type="text" name="lname" placeholder="Voer uw achternaam in" required />
              </label>
              <label class="grid gap-1.5">
                <span class="label text-white">E-mail</span>
                <input class="input" type="email" name="email" placeholder="Voer uw e-mailadres in" required />
              </label>
              <label class="grid gap-1.5">
                <span class="label text-white">Telefoon</span>
            ...
            <div class="grid gap-3">
              ...
              <p class="text-xs text-white">
                Door uw persoonlijke gegevens in te voeren en op de knop te klikken, accepteert u het
                <a class="link-underline" href="privacy.php">Privacybeleid</a>
                en de
                <a class="link-underline" href="conditions.php">Gebruiksvoorwaarden</a>
                van de website.
              </p>
            </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-3 md:grid-cols-2 md:gap-6 xl:grid-cols-4">
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      ...
      <p class="h3">Beschikbare valuta's</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 max-lg:order-2 md:gap-10">
      <h2>Waarom kiezen voor <?= $site_name ?>?</h2>
      <p class="md:text-lg">
        Vertrouwd door moderne crypto-traders, zet dit platform een nieuwe standaard. We combineren sterke beveiliging, volledige transparantie, geavanceerde algoritmen en een naadloze interface om u alles te bieden wat u nodig heeft om met vertrouwen te handelen en te slagen.
      </p>
        ...
        <div class="grid grid-cols-2 gap-x-8 gap-y-6 max-sm:flex">
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Beveiliging waar u op kunt vertrouwen</p>
              <p>Bescherming van topniveau voor uw gegevens en investeringen bij elke stap.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Persoonlijke ervaring</p>
              <p>Pas uw handelsstrategieën aan op uw unieke doelen en stijl.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Slimme AI-strategieën</p>
              <p>Nauwkeurige trading-inzichten om u te helpen beslissingen met vertrouwen te nemen.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Geautomatiseerd handelen</p>
              <p>AI-gestuurde bots die 24/7 werken voor efficiënte, winstgerichte trades.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Moeiteloze interface</p>
              <p>Een strak, intuïtief ontwerp dat trading vanaf het begin eenvoudig maakt.</p>
            </div>
          </div>
        </div>
      </div>
      <p class="h3">
        Transformeer uw financiële ervaring met <?= $site_name ?> ™.
      </p>
      <a class="btn btn-black" href="sign.php">Registreren</a>
    </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Efficiënt handelen!</h2>
      <p class="text-lg">
        Handel in cryptovaluta zoals Bitcoin, Ethereum en Dogecoin met gemak en vertrouwen.
      </p>
      <a class="btn btn-black max-md:hidden" href="sign.php">Aan de slag</a>
    </div>
    <div class="grid gap-3 md:gap-6" data-trading></div>
    <a class="btn btn-black md:hidden" href="sign.php">Aan de slag</a>
  </div>
</div>
<section class="feature-section">
  <div class="container">
    <div class="feature-header">
      <h2>
        Wereldwijd handelsplatform <span>gebouwd voor schaal</span>
      </h2>
      <p>
        Krijg toegang tot meerdere financiële markten via een uniforme infrastructuur ontworpen voor prestaties, precisie en wereldwijde betrouwbaarheid.
      </p>
    </div>
    <div class="feature-grid">
      <div class="feature-card">
        ...
        <p>
          Handel in crypto, forex, aandelen en grondstoffen vanuit één geïntegreerde omgeving zonder tussen platforms te wisselen.
        </p>
      </div>
      <div class="feature-card featured">
        <div class="accent"></div>
        <h3>Snelle uitvoering</h3>
        <p>
          Geoptimaliseerde infrastructuur zorgt voor minimale latentie en stabiele orderuitvoering op wereldwijde markten.
        </p>
      </div>
      <div class="feature-card">
        <div class="accent"></div>
        ...
        <p>
          Live data, geavanceerde indicatoren en marktinzichten helpen u sneller te reageren en beter geïnformeerde beslissingen te nemen.
        </p>
      </div>
    </div>
  </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10">
    <div class="grid items-center gap-6 lg:grid-cols-2">
      <h2>Hoe <?= $site_name ?> werkt: uw snelle startgids</h2>
      <p class="rounded-custom sm:border sm:p-8">
        Begin moeiteloos met crypto-trading op ons platform. We begeleiden u stap voor stap — van snelle registratie tot uw eerste storting en uw eerste trade.
      </p>
    </div>
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Maak uw account aan</p>
          <p>Registreer u in enkele minuten, vul uw gegevens in en krijg veilig toegang tot het officiële platform.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Bevestig uw toegang</p>
          <p>Verifieer uw e-mail en ontgrendel volledige toegang om direct te kunnen handelen.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3"><?= $site_name ?>-login</p>
          <p>Open uw handelsaccount met een minimale storting van <?= $app_price ?> <?= $app_currency ?>. Hogere investeringen kunnen het potentiële rendement verhogen, maar ook het risico.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Stort geld op uw account</p>
          <p>Kies uw voorkeursmethode — bankoverschrijving, e-wallet of creditcard — en begin direct.*</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Stel uw strategie in</p>
          <p>Pas uw account aan op uw doelen. Bepaal uw risiconiveau, handelsvoorkeuren en configureer uw strategie. Onze expertbrokers staan klaar — geautomatiseerd of handmatig, u beslist.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Begin met handelen</p>
          <p>U bent klaar. Stap met vertrouwen de cryptomarkt in en ontdek vandaag nog nieuwe kansen.</p>
        </div>
      </div>
    </div>
    <div class="grid gap-6 md:grid-cols-2">
      <a class="btn btn-black" href="sign.php">Begin met handelen</a>
    </div>
  </div>
</div>
    <!-- payments -->
    <div class="py-8 md:py-10">
      <div class="container-base grid items-center gap-6 lg:grid-cols-2">
        <p class="text-lg">
          <?= $site_name ?> accepteert wereldwijd diverse betaalmethoden.
        </p>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
    <div class="flex items-center justify-between gap-6 mb-6 reviews-flex-block">
      <h2 class="text-2xl font-bold"><?= $site_name ?> ™-reviews</h2>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
            <p>
              <?= $site_name ?> heeft me aangenaam verrast. Registratie ging snel, de kosten zijn duidelijk en het supportteam reageert echt en helpt. De hele ervaring voelt soepel en betrouwbaar — zeker een platform waar ik graag blijf.
            </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Particuliere belegger') ?></div>
              <p class="font-bold">Particuliere belegger</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Ik heb eindelijk crypto geprobeerd en gekozen voor <?= $site_name ?> — tot nu toe geen spijt. Opstarten duurde maar een paar minuten en alles werd duidelijk uitgelegd. Het voelt als een solide optie, vooral als u nieuw bent in trading.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Onafhankelijke trader') ?></div>
              <p class="font-bold">Onafhankelijke trader</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  <?= $site_name ?> voelt als een stabiel en betrouwbaar platform. Account aanmaken was eenvoudig, de voorwaarden zijn helder en support weet wat het doet. Handelen hier was een verrassend comfortabele ervaring.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Digitale-activatrader') ?></div>
              <p class="font-bold">Digitale-activatrader</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Met <?= $site_name ?> voelt crypto-trading niet meer overweldigend. Registratie was simpel, de kosten zijn transparant en er is support wanneer u die nodig heeft. Als beginner maakt dat echt het verschil.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Passief-inkomenzoeker') ?></div>
              <p class="font-bold">Passief-inkomenzoeker</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
      <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Hoe begin ik?</span>
        ...
        <div id="content-1" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>U bent binnen enkele minuten operationeel. Maak een account aan met uw basisgegevens, voltooi een korte verificatiestap en stort minimaal <?= $app_price ?> <?= $app_currency ?>. Daarna ontgrendelt u het volledige platform — live grafieken, handelstools en functies om met vertrouwen te starten.</p>
          </div>
        </div>
      </div>
      <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Zijn mijn geld en gegevens veilig? Is <?= $site_name ?> betrouwbaar?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-2" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Absoluut. We beschermen uw account met geavanceerde SSL-versleuteling, 2FA-verificatie en veilige cold storage voor fondsen. Transacties verlopen via vertrouwde providers en uw persoonsgegevens worden verwerkt volgens strikte beveiligingsbeleid. Veiligheid en betrouwbaarheid zitten in elk onderdeel van het platform.</p>
          </div>
        </div>
      </div>
      <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Wanneer kan ik mijn winst opnemen?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-3" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Opnames kunnen op elk moment via uw accountdashboard worden aangevraagd. Verwerking duurt meestal 1–3 werkdagen, afhankelijk van de gekozen methode. U ziet altijd vooraf de van toepassing zijnde kosten en termijnen — geen verrassingen.</p>
          </div>
        </div>
      </div>
      <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Hoe weet ik of dit platform bij mij past?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-4" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>De beste manier is het zelf te proberen. Begin met de minimale storting en ontdek de functies stap voor stap. Het platform is gebruiksvriendelijk voor beginners en biedt krachtige tools, met 24/7-support wanneer nodig. U behoudt te allen tijde de controle.</p>
          </div>
        </div>
      </div>
      <div id="accordion-5" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Heb ik handelservaring nodig om te beginnen?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-5" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Helemaal niet. Alles is toegankelijk vanaf dag één — met onboarding, eenvoudige tutorials en AI-ondersteunde tools. Of u nu net begint of al ervaring heeft, u gaat in uw eigen tempo verder met altijd beschikbare support.</p>
          </div>
        </div>
      </div>
      <div id="accordion-6" class="group border-primary rounded-custom border transition-all">
        ...
        <div id="content-6" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p style="margin-bottom:16px;"><?= $site_name ?> is een wereldwijd handelsplatform gebouwd voor gebruikers die consistente prestaties, snelle uitvoering en volledige controle over hun handelsomgeving verwachten. In plaats van meerdere losse tools of regionale diensten biedt het platform één gestructureerd systeem waarin alle kernfuncties in één workflow zijn geïntegreerd.</p>
            <p style="margin-bottom:16px;">Van markttoegang tot orderuitvoering en analytics — elk onderdeel is ontworpen om samen te werken zonder onnodige frictie. Zo kunt u zich richten op besluitvorming in plaats van complexe systemen of platformwissels.</p>
            <p style="margin-bottom:10px; font-weight:500;">Binnen één interface kunnen gebruikers op meerdere financiële markten opereren:</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Cryptovaluta, inclusief grote en opkomende digitale activa</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Valutamarkten met realtime prijzen</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Wereldwijde aandelen en beursinstrumenten</li>
              <li><span style="color:#6D5DF6;">•</span> Grondstoffen voor bredere portefeuillediversificatie</li>
            </ul>
            <p style="margin-bottom:16px;">Prestaties zijn een kernprioriteit. De infrastructuur is geoptimaliseerd voor lage latentie en stabiele werking, ook tijdens perioden van hoge marktactiviteit.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Snelle en consistente orderuitvoering op alle markten</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Continue realtime data en prijsupdates</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Ingebouwde analytische tools en marktindicatoren</li>
              <li><span style="color:#6D5DF6;">•</span> Ondersteuning voor handmatige en geautomatiseerde strategieën</li>
            </ul>
            <p style="margin-bottom:16px;">Beveiliging en operationele betrouwbaarheid zijn in elke laag van het systeem verwerkt. Het platform volgt industriestandaarden en past interne waarborgen toe zodat gebruikersdata en financiële operaties te allen tijde beschermd blijven.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Versleutelde gegevensoverdracht bij alle interacties</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Meerlaagse accountverificatie en authenticatie</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Geverifieerde transactieverwerking en monitoring</li>
              <li><span style="color:#6D5DF6;">•</span> Infrastructuur ontworpen voor stabiele wereldwijde toegankelijkheid</li>
            </ul>
            <p style="margin-bottom:16px;">Tegelijk blijft gebruiksvriendelijkheid een belangrijke focus. De interface is bewust overzichtelijk en voorspelbaar, met minder onnodige complexiteit zodat u zich op handelsstrategieën kunt richten.</p>
            <p style="margin-bottom:16px;">Deze balans tussen prestaties en eenvoud maakt het platform geschikt voor zowel nieuwe als ervaren traders.</p>
            <p><?= $site_name ?> combineert schaalbaarheid, betrouwbaarheid en efficiëntie in één omgeving en biedt een gestructureerde, betrouwbare manier om met vertrouwen toegang te krijgen tot wereldwijde financiële markten.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h2>Dit is handelen met het officiële platform™</h2>
          <p>
            Wij zijn het vertrouwde platform voor particulieren en bedrijven om cryptovaluta te kopen, verkopen en beheren.
          </p>
        </div>
        <form name="form" method="post"
          class="leadform rf-form js-rf-form group bg-primary rounded-custom relative overflow-hidden px-4 py-8 md:px-8" action="../integration/send.php" data-form>
  ...
  <section style="padding:60px 0;" class="md:!py-[100px]">
    ...
    ">
      ...
      ">
        ...
        ">
          Kernmogelijkheden van het <span style='color:#6B5FA7;'>handelsplatform <?= $site_name ?></span>
        </h2>
      <p style="margin-top:14px;color:#6b7280;font-size:17px;">
        Alles wat u nodig heeft om slimmer, sneller en met vertrouwen te handelen.
      </p>
    </div>
    <div style="
      border-radius:16px;
    ...
    ">
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Creditcards, bankoverschrijvingen, PayPal
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Forex, aandelen, crypto, grondstoffen en meer
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Snelle en efficiënte onboarding
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        <div class="customer-block" style="display:flex;gap:10px;font-weight:600;">
          ...
          <span style="font-weight:400;color:#6b7280;margin-left:10px;">
            Professionele assistentie 24/7
          </span>
        </div>
  ...
  <div class="border-primary-light grid justify-items-center gap-6 rounded-[20px] border px-4 py-5 md:gap-4 md:px-8 md:py-6 text-center md:text-left">
    ...
    <div class="flex flex-wrap items-center justify-center md:justify-start gap-2.5 text-center md:text-left">
      ...
      <span class="leading-none text-amber-500" role="img"
        aria-label="<?= $rating_value ?> Score van 5">
        <?= $stars ?>
      </span>
      <span class="flex flex-wrap justify-center md:justify-start gap-1 text-sm text-gray-400">
        <span>
          <strong>318</strong> reviews ·
        </span>
        <span>
          Gebaseerd op <strong><?= $rating_count ?></strong> beoordelingen ·
        </span>
        <span>
          Score van 5
        </span>
    ...
    <p class="text-center md:text-left">
      Een krachtig en gebruiksvriendelijk handelsplatform met robuuste automatisering en uitgebreide educatieve resources.
    </p>
  </div>
</div>
      </div>
        ...
        <div class="grid gap-5">
          <nav class="flex flex-col flex-wrap justify-between gap-x-10 gap-y-5 text-white md:flex-row">
            <a class="font-special inline-flex max-w-60 gap-1.5 text-xl leading-none text-white uppercase max-md:pr-[120px] footer-nav-logo"
              href="<?= $site_url ?>/lander/<?= $site_domain ?>/nl/">
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p style="color:#6B5FA7;">Uw betrouwbare tradingpartner</p>
  ...
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ja/" hreflang="ja" title="日本語">
    🇯🇵
        ...
        <div class="grid gap-2.5 text-sm text-gray-500">
            <p>
                <?= $site_name ?> is niet verantwoordelijk voor verliezen of schade die kunnen voortvloeien uit het gebruik van de informatie op deze website, inclusief educatieve content, koersen, grafieken en analyses. Handelen op financiële markten brengt risico's met zich mee; het is belangrijk uw persoonlijke omstandigheden te overwegen en indien nodig advies in te winnen bij een gekwalificeerde professional voordat u begint. Investeer alleen geld dat u zich kunt veroorloven te verliezen, en houd er rekening mee dat instrumenten zoals FX, CFD's en cryptovaluta niet voor iedereen geschikt zijn.
            </p>
        </div>
        <div class="text-center text-white">
          Copyright 2026 © <?= $site_name ?>, Alle rechten voorbehouden
        </div>
      </div>
    </div>
  </footer>
