...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Aanbod | <?= $site_name ?></title>
    <meta name="description" content="Kies een plan met <?= $site_name ?> dat past bij uw handelsbehoeften." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="offer.php" data-active>Aanbod</a>
    </li>
    <li>
...
<span class="breadcrumb-item">Aanbod</span>
          </nav>
        </div>
      </div>
      <!-- tracker -->
      <div class="py-8 md:py-10">
        <div class="container-base grid gap-6 lg:grid-cols-2">
          ...
          >
 <h1 class="relative z-20">Krijg Portfolio Tracker</h1>
<p class="relative z-20">
  Begin binnen enkele minuten: registreer, stort en start met handelen in slechts 5 minuten. Begin nu.
</p>
          </div>
...
<div class="relative z-40 py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10">
    ...
    <div class="border-primary h3 rounded-custom relative z-10 flex items-center justify-center border bg-white p-4 text-center md:p-6">
      Voeg geld toe aan uw account
    </div>
    <div class="border-primary h3 rounded-custom relative z-10 flex items-center justify-center border bg-white p-4 text-center md:p-6">
      Begin met kopen en verkopen
    </div>
        </div>
      </div>
    </div>
