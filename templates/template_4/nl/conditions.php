...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Gebruiksvoorwaarden | <?= $site_name ?></title>
    <meta name="description" content="Lees de gebruiksvoorwaarden van <?= $site_name ?>." />
    <meta charset="UTF-8" />
  ...
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <div class="grid gap-5 md:gap-7">
        <nav aria-label="breadcrumb" class="flex flex-wrap items-center text-sm text-gray-500 md:text-lg">
            ...
            <span class="breadcrumb-item">Gebruiksvoorwaarden</span>
        </nav>
        <h1>Gebruiksvoorwaarden</h1>
    </div>
<div class="grid gap-6 md:gap-8">
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Algemeen</h2>
    <p>Deze website biedt informatie over handelsplatforms van derden en gerelateerde diensten. Door de website te gebruiken, gaat u akkoord met deze Voorwaarden en ons Privacybeleid. Voorwaarden kunnen op elk moment worden bijgewerkt.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Geschiktheid</h2>
    <p>U moet minimaal 18 jaar oud zijn, deze Voorwaarden kunnen accepteren en niet beperkt zijn door lokale wetgeving. Wij zijn niet verantwoordelijk voor onrechtmatig gebruik van de website.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Beperkte toegang</h2>
    <p>We kunnen toegang beperken voor gebruikers uit bepaalde regio's of waar juridische of regelgevende risico's gelden. Diensten zijn mogelijk niet beschikbaar op beperkte locaties.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Verboden gebruik</h2>
    <p>U mag de website niet misbruiken, waaronder het overtreden van wetten, schenden van rechten, verspreiden van schadelijke content of gebruik van geautomatiseerde systemen. We kunnen toegang beperken bij schending van de Voorwaarden.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Intellectueel eigendom</h2>
    <p>Alle content, handelsmerken en materialen behoren ons of derden toe. U mag de website alleen voor persoonlijk gebruik gebruiken en geen content kopiëren of wijzigen.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Aansprakelijkheid</h2>
    <p>De website en diensten worden geleverd «as is». Wij zijn niet aansprakelijk voor fouten, verliezen of schade door gebruik van de website.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Diensten van derden</h2>
    <p>We kunnen content of links van derden tonen. Wij zijn niet verantwoordelijk voor de juistheid of diensten. Controleer informatie voordat u beslissingen neemt.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Links</h2>
    <p>Links naar externe websites worden alleen voor het gemak aangeboden. We onderschrijven of controleren ze niet en zijn niet verantwoordelijk voor hun content.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">9. Overig</h2>
    <p>We kunnen diensten en Voorwaarden op elk moment bijwerken of wijzigen. Deze Voorwaarden vormen de volledige overeenkomst tussen u en ons. Niet-uitgeoefende rechten worden niet geacht te zijn vervallen.</p>
  </div>
</div>
      </div>
    </main>
