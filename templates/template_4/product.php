...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="product.php" data-active><?= $mobnav_product ?></a>
    </li>
    <li>
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      <a href="<?= $site_url ?>" class="breadcrumb-item"><?= $breadcrumb_home ?></a>
      <span class="breadcrumb-item"><?= $breadcrumb_product ?></span>
    </nav>
  </div>
</div>
      <!-- analytics -->
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20"><?= $analytics_heading ?></h1>
    ...
    <div class="relative grid min-h-[230px] content-end">
      ...
      <div class="relative z-20 grid grid-cols-2 gap-3 md:gap-6">
        <a class="btn btn-black col-span-full" href="sign.php"><?= $analytics_btn_signup ?></a>
      ...
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3"><?= $app_feature_1_title ?></p>
        ...
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3"><?= $app_feature_2_title ?></p>
        ...
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3"><?= $app_feature_3_title ?></p>
        ...
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3"><?= $app_feature_4_title ?></p>
...
<div class="py-8 md:py-10">
  ...
  >
    ...
    >
      <p class="h2 lowercase"><?= $products_stats_currencies_v ?></p>
      <p class="h3"><?= $products_stats_currencies_l ?></p>
    </div>
    <div
      class="rounded-custom grid content-start gap-5 border p-4 md:p-6"
    >
      <p class="h2 lowercase"><?= $products_stats_users_v ?></p>
      <p class="h3"><?= $products_stats_users_l ?></p>
    </div>
    <div
      class="rounded-custom grid content-start gap-5 border p-4 md:p-6"
    >
      <p class="h2 lowercase"><?= $products_stats_volume_v ?></p>
      <p class="h3"><?= $products_stats_volume_l ?></p>
    </div>
    <div
      class="rounded-custom grid content-start gap-5 border p-4 md:p-6"
    >
      <p class="h2 lowercase"><?= $products_stats_countries_v ?></p>
      <p class="h3"><?= $products_stats_countries_l ?></p>
    </div>
  </div>
</div>
      <!-- capabilities -->
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3"><?= $capabilities_feature_1_title ?></p>
      ...
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3"><?= $capabilities_feature_2_title ?></p>
      ...
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3"><?= $capabilities_feature_3_title ?></p>
      ...
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3"><?= $capabilities_feature_4_title ?></p>
...
<p class="h2"><?= $capabilities_cta_heading ?></p>
<p>
  <?= $capabilities_cta_text ?>
</p>
          </div>
