...
?>
<!DOCTYPE html>
<html class="scroll-smooth" lang="ro" data-theme="orange">
<!-- head -->
<head>
  ...
  "itemListElement": [
    {
      ...
      "position": 1,
      "name": "<?= $site_name ?>",
      "item": "<?= $site_url ?>/lander/<?= $site_domain ?>/ro/"
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 <?= $site_name ?> 💸",
      "item": "<?= $site_url ?>/lander/<?= $site_domain ?>/ro/#heading-style-h1"
    }
  ]
}
</script>
<script type="application/ld+json">
{
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css" />
    <title><?= $site_name ?> | Platformă de trading AI</title>
    <meta name="description" content="<?= $site_name ?> ⭐ — platformă de trading AI inteligentă pentru analiză de piață în timp real și semnale de trading clare ⚡ Încearcă instrumente smart și informații ghidate." />
        ...
        "mainEntity": [
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Poți fi operațional în doar câteva minute. Creează un cont cu datele de bază, finalizează un scurt pas de verificare și depune minimum <?= $app_price ?> <?= $app_currency ?>. Apoi deblochezi platforma completă — grafice live, instrumente de trading și funcții pentru un start cu încredere."
            }
          },
          {
            "@type": "Question",
            "name": "Sunt banii și datele mele în siguranță? Este <?= $site_name ?> de încredere?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Absolut. Îți protejăm contul cu criptare SSL avansată, verificare 2FA și stocare la rece securizată pentru fonduri. Tranzacțiile sunt procesate prin furnizori de încredere, iar datele personale sunt gestionate conform politicilor stricte de securitate. Siguranța și fiabilitatea sunt integrate în fiecare parte a platformei."
            }
          },
          {
            "@type": "Question",
            "name": "Când pot retrage profitul?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Retragerile pot fi solicitate oricând din panoul contului. Procesarea durează de obicei 1–3 zile lucrătoare, în funcție de metoda aleasă. Vei vedea întotdeauna comisioanele și termenele aplicabile din timp — fără surprize."
            }
          },
          {
            "@type": "Question",
            "name": "Cum știu dacă această platformă este potrivită pentru mine?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Cea mai bună metodă este să o încerci singur. Începe cu depozitul minim și explorează funcțiile pas cu pas. Platforma este prietenoasă pentru începători, dar oferă instrumente puternice, cu suport 24/7 când ai nevoie. Păstrezi controlul tot timpul."
            }
          },
          {
            "@type": "Question",
            "name": "Am nevoie de experiență în trading pentru a începe?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Deloc. Totul este construit să fie accesibil din prima zi — cu ghid de onboarding, tutoriale simple și instrumente asistate de AI. Fie că abia începi sau ai deja experiență, poți avansa în ritmul tău cu suport mereu disponibil."
            }
          }
        ]
      }
  ...
  <header class="relative z-50 pt-3.5 md:pt-6">
    <div class="container-base">
      <div
        ...
        <a class="font-special inline-flex max-w-60 gap-1.5 text-xl leading-none uppercase header-nav-logo" href="<?= $site_url ?>/lander/<?= $site_domain ?>/ro/">
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/ro/" data-active>Acasă</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="product.php">Produs</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="offer.php">Ofertă</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="contacts.php">Contact</a>
    </li>
    <li>
    ...
    <nav class="mobile-menu" data-mobile-menu>
      <ul class="flex flex-col flex-wrap items-center justify-center gap-y-8">
        <li>
          <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ro/">Acasă</a>
        </li>
        <li>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h1><?= $site_name ?></h1>
            <p>Trăiește o nouă eră a tradingului cu platforma noastră avansată de tranzacționare cripto. Cu tehnologia AI a <?= $site_name ?>, poți optimiza randamentele și lua decizii de investiții informate.</p>
        </div>
        <form name="form" method="post"
          ...
          <input type="hidden" name="phone_country" value="ro">
          <input type="hidden" name="only_countries" value='["ro"]'>
          ...
          <div class="grid gap-6">
            <div class="grid gap-2 md:gap-3.5">
              <label class="grid gap-1.5">
                <span class="label text-white">Prenume</span>
                <input class="input" type="text" name="fname" placeholder="Introdu prenumele" required />
              </label>
              <label class="grid gap-1.5">
                <span class="label text-white">Nume</span>
                <input class="input" type="text" name="lname" placeholder="Introdu numele de familie" required />
              </label>
              <label class="grid gap-1.5">
                <span class="label text-white">E-mail</span>
                <input class="input" type="email" name="email" placeholder="Introdu adresa de e-mail" required />
              </label>
              <label class="grid gap-1.5">
            ...
            <div class="grid gap-3">
              ...
              <p class="text-xs text-white">
                Prin introducerea datelor personale și apăsarea butonului, accepti
                <a class="link-underline" href="privacy.php">Politica de confidențialitate</a>
                și
                <a class="link-underline" href="conditions.php">Condițiile de utilizare</a>
                ale site-ului.
              </p>
            </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-3 md:grid-cols-2 md:gap-6 xl:grid-cols-4">
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      ...
      <p class="h3">Monede disponibile</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
    ...
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      ...
      <p class="h3">Volum de tranzacționare</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">100+</p>
      <p class="h3">Țări suportate</p>
    </div>
  </div>
</div>
    <!-- features -->
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 max-lg:order-2 md:gap-10">
      <h2>De ce să alegi <?= $site_name ?>?</h2>
      <p class="md:text-lg">
        De încredere pentru traderii crypto moderni, această platformă stabilește un nou standard. Combinăm securitate puternică, transparență totală, algoritmi avansați și o interfață fluidă pentru tot ce ai nevoie ca să tranzacționezi cu încredere și să reușești.
      </p>
        ...
        <div class="grid grid-cols-2 gap-x-8 gap-y-6 max-sm:flex">
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Securitate în care poți avea încredere</p>
              <p>Protecție de top pentru datele și investițiile tale la fiecare pas.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Experiență personalizată</p>
              <p>Personalizează strategiile de trading după obiectivele și stilul tău unic.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Strategii AI inteligente</p>
              <p>Informații precise de trading care te ajută să iei decizii cu încredere.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Trading automatizat</p>
              <p>Boți alimentați de AI activi non-stop pentru tranzacții eficiente, orientate spre profit.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              ...
              <p>Design curat și intuitiv care face tradingul simplu de la început.</p>
            </div>
          </div>
        </div>
      </div>
      <p class="h3">
        Transformă-ți experiența financiară cu <?= $site_name ?> ™.
      </p>
      <a class="btn btn-black" href="sign.php">Înregistrare</a>
    </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Trading eficient!</h2>
      <p class="text-lg">
        Tranzacționează criptomonede precum Bitcoin, Ethereum și Dogecoin cu ușurință și încredere.
      </p>
      <a class="btn btn-black max-md:hidden" href="sign.php">Începe</a>
    </div>
    <div class="grid gap-3 md:gap-6" data-trading></div>
    <a class="btn btn-black md:hidden" href="sign.php">Începe</a>
  </div>
</div>
<section class="feature-section">
  <div class="container">
    <div class="feature-header">
      <h2>
        Platformă globală de trading <span>construită pentru scalare</span>
      </h2>
      <p>
        Accesează mai multe piețe financiare printr-o infrastructură unificată concepută pentru performanță, precizie și fiabilitate globală.
      </p>
    </div>
    <div class="feature-grid">
      <div class="feature-card">
        ...
        <p>
          Tranzacționează crypto, forex, acțiuni și mărfuri dintr-un singur mediu integrat, fără să schimbi platforma.
        </p>
      </div>
      <div class="feature-card featured">
        <div class="accent"></div>
        <h3>Execuție rapidă</h3>
        <p>
          Infrastructură optimizată care asigură latență minimă și execuție stabilă a ordinelor pe piețele globale.
        </p>
      </div>
      <div class="feature-card">
        <div class="accent"></div>
        <h3>Analiză în timp real</h3>
        <p>
          Date live, indicatori avansați și informații de piață te ajută să reacționezi mai repede și să iei decizii mai bine informate.
        </p>
      </div>
    </div>
  </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10">
    <div class="grid items-center gap-6 lg:grid-cols-2">
      <h2>Cum funcționează <?= $site_name ?>: ghidul tău de start rapid</h2>
      <p class="rounded-custom sm:border sm:p-8">
        Începe călătoria ta în trading crypto fără efort pe platforma noastră. Te ghidăm pas cu pas — de la înregistrarea rapidă la primul depozit și prima tranzacție.
      </p>
    </div>
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Creează-ți contul</p>
          <p>Înregistrează-te în câteva minute, completează datele și obține acces securizat la platforma oficială.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Confirmă accesul</p>
          <p>Verifică e-mailul și deblochează accesul complet pentru a începe să tranzacționezi imediat.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Autentificare <?= $site_name ?></p>
          <p>Deschide contul de trading cu un depozit minim de <?= $app_price ?> <?= $app_currency ?>. Investițiile mai mari pot crește randamentul potențial, dar și riscul.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Alimentează contul</p>
          <p>Alege metoda preferată — transfer bancar, portofel electronic sau card de credit — și începe imediat.*</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Setează strategia</p>
          <p>Adaptează contul la obiectivele tale. Definește nivelul de risc, preferințele de trading și configurează strategia. Brokerii noștri experți sunt aici să te sprijine — automat sau manual, tu decizi.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Începe să tranzacționezi</p>
          <p>Ești gata. Intră pe piața crypto cu încredere și explorează noi oportunități chiar azi.</p>
        </div>
      </div>
    </div>
    <div class="grid gap-6 md:grid-cols-2">
      <a class="btn btn-black" href="sign.php">Începe să tranzacționezi</a>
    </div>
  </div>
</div>
    <!-- payments -->
    <div class="py-8 md:py-10">
      <div class="container-base grid items-center gap-6 lg:grid-cols-2">
        <p class="text-lg">
          <?= $site_name ?> acceptă o gamă largă de metode de plată la nivel global.
        </p>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
    <div class="flex items-center justify-between gap-6 mb-6 reviews-flex-block">
      <h2 class="text-2xl font-bold">Recenzii <?= $site_name ?> ™</h2>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
            <p>
              <?= $site_name ?> m-a surprins plăcut. Înregistrarea a fost rapidă, comisioanele sunt clare, iar echipa de suport răspunde și chiar ajută. Experiența completă este fluidă și de încredere — cu siguranță o platformă la care rămân.
            </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Investitor privat') ?></div>
              <p class="font-bold">Investitor privat</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  În sfârșit am încercat crypto cu <?= $site_name ?> — deocamdată fără regrete. Pornirea a durat doar câteva minute și totul a fost explicat clar. Pare o opțiune solidă, mai ales dacă ești nou în trading.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Trader independent') ?></div>
              <p class="font-bold">Trader independent</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  <?= $site_name ?> pare o platformă stabilă și de încredere. Configurarea contului a fost ușoară, condițiile sunt clare, iar suportul știe ce face. Tradingul aici a fost o experiență surprinzător de confortabilă.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Trader de active digitale') ?></div>
              <p class="font-bold">Trader de active digitale</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Cu <?= $site_name ?>, tradingul crypto nu mai pare copleșitor. Înregistrarea a fost simplă, comisioanele sunt transparente și există suport când ai nevoie. Ca începător, asta chiar contează.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Căutător de venit pasiv') ?></div>
              <p class="font-bold">Căutător de venit pasiv</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
      <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Cum încep?</span>
        ...
        <div id="content-1" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Poți fi operațional în doar câteva minute. Creează un cont cu datele de bază, finalizează un scurt pas de verificare și depune minimum <?= $app_price ?> <?= $app_currency ?>. Apoi deblochezi platforma completă — grafice live, instrumente de trading și funcții pentru un start cu încredere.</p>
          </div>
        </div>
      </div>
      <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Sunt banii și datele mele în siguranță? Este <?= $site_name ?> de încredere?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-2" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Absolut. Îți protejăm contul cu criptare SSL avansată, verificare 2FA și stocare la rece securizată pentru fonduri. Tranzacțiile sunt procesate prin furnizori de încredere, iar datele personale sunt gestionate conform politicilor stricte de securitate. Siguranța și fiabilitatea sunt integrate în fiecare parte a platformei.</p>
          </div>
        </div>
      </div>
      <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Când pot retrage profitul?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-3" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Retragerile pot fi solicitate oricând din panoul contului. Procesarea durează de obicei 1–3 zile lucrătoare, în funcție de metoda aleasă. Vei vedea întotdeauna comisioanele și termenele aplicabile din timp — fără surprize.</p>
          </div>
        </div>
      </div>
      <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Cum știu dacă această platformă este potrivită pentru mine?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-4" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Cea mai bună metodă este să o încerci singur. Începe cu depozitul minim și explorează funcțiile pas cu pas. Platforma este prietenoasă pentru începători, dar oferă instrumente puternice, cu suport 24/7 când ai nevoie. Păstrezi controlul tot timpul.</p>
          </div>
        </div>
      </div>
      <div id="accordion-5" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Am nevoie de experiență în trading pentru a începe?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-5" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Deloc. Totul este construit să fie accesibil din prima zi — cu ghid de onboarding, tutoriale simple și instrumente asistate de AI. Fie că abia începi sau ai deja experiență, poți avansa în ritmul tău cu suport mereu disponibil.</p>
          </div>
        </div>
      </div>
      <div id="accordion-6" class="group border-primary rounded-custom border transition-all">
        ...
        <div id="content-6" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p style="margin-bottom:16px;"><?= $site_name ?> este o platformă globală de trading construită pentru utilizatori care așteaptă performanță constantă, execuție rapidă și control complet asupra mediului de trading. În loc să te bazezi pe mai multe instrumente deconectate sau servicii regionale, platforma oferă un singur sistem structurat în care toate funcțiile principale sunt integrate într-un singur flux de lucru.</p>
            <p style="margin-bottom:16px;">De la accesul la piață la execuția ordinelor și analiză, fiecare componentă este concepută să funcționeze împreună fără fricțiuni inutile. Utilizatorii se pot concentra pe decizii în loc de sisteme complexe sau schimbări de platformă.</p>
            <p style="margin-bottom:10px; font-weight:500;">Într-o singură interfață, utilizatorii pot opera pe mai multe piețe financiare:</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Criptomonede, inclusiv active digitale majore și emergente</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Piețe valutare cu prețuri în timp real</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Acțiuni și instrumente bursiere globale</li>
              <li><span style="color:#6D5DF6;">•</span> Mărfuri pentru o diversificare mai largă a portofoliului</li>
            </ul>
            <p style="margin-bottom:16px;">Performanța este o prioritate centrală. Infrastructura este optimizată pentru execuție cu latență redusă și funcționare stabilă chiar și în perioade de activitate ridicată pe piață.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Execuție rapidă și consistentă a ordinelor pe toate piețele</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Date și actualizări de preț în timp real continue</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Instrumente analitice și indicatori de piață integrate</li>
              <li><span style="color:#6D5DF6;">•</span> Suport pentru strategii manuale și automate</li>
            </ul>
            <p style="margin-bottom:16px;">Securitatea și fiabilitatea operațională sunt integrate în fiecare strat al sistemului. Platforma urmează standardele industriei și aplică măsuri interne pentru ca datele utilizatorilor și operațiunile financiare să rămână protejate.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Transmitere criptată a datelor în toate interacțiunile</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Verificare și autentificare a contului pe mai multe niveluri</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Procesare și monitorizare verificate ale tranzacțiilor</li>
              <li><span style="color:#6D5DF6;">•</span> Infrastructură concepută pentru accesibilitate globală stabilă</li>
            </ul>
            <p style="margin-bottom:16px;">În același timp, ușurința în utilizare rămâne un focus cheie. Interfața este concepută să fie curată și previzibilă, reducând complexitatea inutilă pentru a te concentra pe strategii de trading.</p>
            <p style="margin-bottom:16px;">Acest echilibru între performanță și simplitate face platforma potrivită atât pentru utilizatori noi, cât și pentru traderi experimentați.</p>
            <p><?= $site_name ?> combină scalabilitate, fiabilitate și eficiență într-un singur mediu, oferind o modalitate structurată și de încredere de a accesa piețele financiare globale cu încredere.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h2>Acesta este tradingul cu platforma oficială™</h2>
          <p>
            Suntem platforma de încredere pentru persoane fizice și companii care cumpără, vând și gestionează criptomonede.
          </p>
        </div>
        <form name="form" method="post"
          class="leadform rf-form js-rf-form group bg-primary rounded-custom relative overflow-hidden px-4 py-8 md:px-8" action="../integration/send.php" data-form>
  ...
  <section style="padding:60px 0;" class="md:!py-[100px]">
    ...
    ">
      ...
      ">
        ...
        ">
          Capabilități principale ale <span style='color:#6B5FA7;'>platformei de trading <?= $site_name ?></span>
        </h2>
      <p style="margin-top:14px;color:#6b7280;font-size:17px;">
        Tot ce ai nevoie pentru a tranzacționa mai inteligent, mai rapid și cu încredere.
      </p>
    </div>
    <div style="
      border-radius:16px;
    ...
    ">
      ...
      " onmouseover="this.style.background='#f9f9fb'" class="row-block" onmouseout="this.style.background='transparent'">
        ...
        <div class="row-text" style="color:#6b7280;">
          Motor de trading avansat cu AI
        </div>
      </div>
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Carduri de credit, transferuri bancare, PayPal
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Compatibilitate multi-dispozitiv
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        <div style="display:flex;gap:10px;font-weight:600;">
          <span style="color:#6B5FA7;">📊</span>
          Instrumente de trading
        </div>
        <div class="row-text" style="color:#6b7280;">
          Forex, acțiuni, crypto, mărfuri și altele
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
  ...
  <div class="border-primary-light grid justify-items-center gap-6 rounded-[20px] border px-4 py-5 md:gap-4 md:px-8 md:py-6 text-center md:text-left">
    ...
    <div class="flex flex-wrap items-center justify-center md:justify-start gap-2.5 text-center md:text-left">
      ...
      <span class="leading-none text-amber-500" role="img"
        aria-label="<?= $rating_value ?> Scor din 5">
        <?= $stars ?>
      </span>
      <span class="flex flex-wrap justify-center md:justify-start gap-1 text-sm text-gray-400">
        <span>
          <strong>318</strong> recenzii ·
        </span>
        <span>
          Bazat pe <strong><?= $rating_count ?></strong> evaluări ·
        </span>
        <span>
          Scor din 5
        </span>
    ...
    <p class="text-center md:text-left">
      O platformă de trading puternică și ușor de folosit, cu automatizare robustă și resurse educaționale complete.
    </p>
  </div>
</div>
      </div>
        ...
        <div class="grid gap-5">
          <nav class="flex flex-col flex-wrap justify-between gap-x-10 gap-y-5 text-white md:flex-row">
            <a class="font-special inline-flex max-w-60 gap-1.5 text-xl leading-none text-white uppercase max-md:pr-[120px] footer-nav-logo"
              href="<?= $site_url ?>/lander/<?= $site_domain ?>/ro/">
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p style="color:#6B5FA7;">Partenerul tău de trading de încredere</p>
  ...
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ja/" hreflang="ja" title="日本語">
    🇯🇵
        ...
        <div class="grid gap-2.5 text-sm text-gray-500">
            <p>
                <?= $site_name ?> nu este responsabil pentru pierderi sau daune care pot rezulta din utilizarea informațiilor furnizate pe acest site web, inclusiv conținut educațional, cotații, grafice și analize. Tranzacționarea pe piețele financiare implică risc; este important să îți consideri circumstanțele personale și, dacă este necesar, să consulți un profesionist calificat înainte de a începe. Investește doar bani pe care îți permiți să îi pierzi și reține că instrumente precum FX, CFD-uri și criptomonede pot să nu fie potrivite pentru toată lumea.
            </p>
        </div>
        <div class="text-center text-white">
          Copyright 2026 © <?= $site_name ?>, Toate drepturile rezervate
        </div>
      </div>
    </div>
  </footer>
