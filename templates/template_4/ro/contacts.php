...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="Contactează suportul <?= $site_name ?> sau echipa noastră de business." />
    <!-- Favicon -->
...
<div class="grid gap-4 text-center md:gap-6">
  <h3>Dacă ai întrebări suplimentare, contactează-ne prin e-mail</h3>
</div>
            <a
