...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Politica de confidențialitate | <?= $site_name ?></title>
    <meta name="description" content="Află cum <?= $site_name ?> colectează și protejează datele tale." />
    <!-- Favicon -->
...
<div class="grid gap-6 md:gap-8">
  ...
  <div class="grid gap-2">
    <p class="text-sm">Ultima actualizare: <?= $privacy_last_update ?></p>
    <p>Noi («Noi») respectăm confidențialitatea ta și ne angajăm să îți protejăm datele personale. Această politică explică modul în care <?= $site_name ?> colectează, utilizează și protejează informațiile tale.</p>
  </div>
  <!-- PRINCIPLES -->
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Transparență</p>
    <p>
      Explicăm clar cum sunt folosite datele tale. Contactează-ne la 
      <a href="mailto:info@<?= $site_domain ?>">info@<?= $site_domain ?></a>
    </p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Utilizarea datelor</p>
    <p>Datele tale sunt folosite pentru a furniza servicii, îmbunătăți platforma și îndeplini obligațiile legale.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Drepturile tale</p>
    <p>Poți solicita acces, rectificare sau ștergerea datelor tale oricând.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Securitate</p>
    <p>Îți protejăm datele, dar nu putem garanta securitate absolută.</p>
  </div>
  <!-- SECTIONS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Colectarea datelor</h2>
    <p>Colectăm date de utilizare (IP, dispozitiv, browser) și orice date pe care le furnizezi.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Temei legal</h2>
    <p>Prelucrarea se bazează pe consimțământ, interes legitim și obligații legale.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Partajarea datelor</h2>
    <p>Putem partaja date cu parteneri, furnizori și autorități dacă este necesar.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Cookie-uri</h2>
    <p>Folosim cookie-uri pentru funcționalitate și analiză. Le poți dezactiva.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Păstrarea datelor</h2>
    <p>Datele sunt păstrate doar atât timp cât este necesar.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Transferuri internaționale</h2>
    <p>Datele pot fi transferate cu garanții adecvate.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Linkuri către terți</h2>
    <p>Nu suntem responsabili pentru site-uri externe.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Actualizări</h2>
    <p>Această politică poate fi actualizată.</p>
  </div>
  <!-- RIGHTS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">Drepturile tale</h2>
    <p>Ai dreptul la acces, rectificare, ștergere, restricționare sau transfer al datelor, retragerea consimțământului și depunerea unei plângeri.</p>
  </div>
</div>
          </div>
        </div>
