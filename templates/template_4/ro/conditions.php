...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Condiții de utilizare | <?= $site_name ?></title>
    <meta name="description" content="Citește termenii și condițiile de utilizare ale <?= $site_name ?>." />
    <meta charset="UTF-8" />
  ...
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <div class="grid gap-5 md:gap-7">
        <nav aria-label="breadcrumb" class="flex flex-wrap items-center text-sm text-gray-500 md:text-lg">
            ...
            <span class="breadcrumb-item">Condiții de utilizare</span>
        </nav>
        <h1>Condiții de utilizare</h1>
    </div>
<div class="grid gap-6 md:gap-8">
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. General</h2>
    <p>Acest site web oferă informații despre platforme de trading terțe și servicii conexe. Prin utilizarea site-ului, accepți acești Termeni și Politica noastră de confidențialitate. Termenii pot fi actualizați oricând.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Eligibilitate</h2>
    <p>Trebuie să ai cel puțin 18 ani, să poți accepta acești Termeni și să nu fii restricționat de legile locale. Nu suntem responsabili pentru utilizarea ilegală a site-ului.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Acces restricționat</h2>
    <p>Putem restricționa accesul pentru utilizatori din anumite regiuni sau unde există riscuri legale sau de reglementare. Serviciile pot fi indisponibile în locații restricționate.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Utilizare interzisă</h2>
    <p>Nu trebuie să folosești site-ul abuziv, inclusiv încălcarea legilor, încălcarea drepturilor, răspândirea de conținut dăunător sau utilizarea de sisteme automate. Putem restricționa accesul dacă Termenii sunt încălcate.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Proprietate intelectuală</h2>
    <p>Tot conținutul, mărcile și materialele ne aparțin nouă sau terților. Poți folosi site-ul doar pentru uz personal și nu trebuie să copiezi sau să modifici conținutul.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Răspundere</h2>
    <p>Site-ul și serviciile sunt furnizate «ca atare». Nu suntem responsabili pentru erori, pierderi sau daune rezultate din utilizarea site-ului.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Servicii terțe</h2>
    <p>Putem afișa conținut sau linkuri de la terți. Nu suntem responsabili pentru acuratețea sau serviciile lor. Verifică informațiile înainte de a lua decizii.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Linkuri</h2>
    <p>Linkurile către site-uri externe sunt oferite doar pentru comoditate. Nu le susținem sau controlăm și nu suntem responsabili pentru conținutul lor.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">9. Diverse</h2>
    <p>Putem actualiza sau modifica serviciile și Termenii oricând. Acești Termeni constituie întregul acord între tine și noi. Drepturile neexercitate nu constituie renunțare.</p>
  </div>
</div>
      </div>
    </main>
