...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 Analiză digitală <?= $site_name ?> ™ 💸",
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Produs | <?= $site_name ?></title>
    <meta name="description" content="Instrumente pentru gestionarea crypto și activelor cu analiză și automatizare." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/ro/">Acasă</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="product.php" data-active>Produs</a>
    </li>
    <li>
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ro/" class="breadcrumb-item">Acasă</a>
      <span class="breadcrumb-item">Produs</span>
    </nav>
  </div>
</div>
      <!-- analytics -->
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20">Analiză digitală <?= $site_name ?> ™</h1>
      <p class="relative z-20">
        Obține informații valoroase și stimulează creșterea cu platforma noastră avansată de analiză. Ia decizii informate bazate pe date cu încredere. Rafinează strategia și obține rezultate măsurabile.
      </p>
    </div>
    <div class="relative grid min-h-[230px] content-end">
      ...
      <div class="relative z-20 grid grid-cols-2 gap-3 md:gap-6">
        <a class="btn btn-black col-span-full" href="sign.php">Înregistrare</a>
  ...
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
      ...
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Piața de capital</p>
            <p>Totul la un click distanță</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Statistici</p>
            <p>Acces la toate datele tale</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Vizualizare mobilă</p>
            <p>Acces de pe telefon</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Gestionare criptomonede</p>
            <p>Acces la fiecare activ</p>
          </div>
        </div>
      </div>
    </div>
    <div class="flex items-center justify-center">
      <img
        ...
        alt="Interfață mobilă pentru urmărirea portofoliului"
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Portofoliu</p>
          <p>Aici îmi prezint cariera profesională prin proiecte impresionante și soluții creative.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Cumpără criptomonede</p>
          <p>O platformă sigură și simplă pentru cumpărarea criptomonedelor. Tranzacții rapide cu comisioane minime. Începe să tranzacționezi azi.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Analiză crypto</p>
          <p>Află mai multe despre valorile și tendințele pieței pentru decizii de investiții și business informate.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Active crypto</p>
          <p>Explorează viitorul finanțelor cu principalele criptomonede. Descoperă, investește, crește.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">Hai să începem!</p>
<p>
  Explorează lumea criptomonedelor cu <?= $site_name ?>. Traderii români pot accesa o platformă care combină inovație, eficiență și oportunități de profit.
</p>
          </div>
        ...
        <div class="grid gap-5">
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p>Partenerul tău de trading de încredere</p>
