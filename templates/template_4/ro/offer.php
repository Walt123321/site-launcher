...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Ofertă | <?= $site_name ?></title>
    <meta name="description" content="Alege un plan cu <?= $site_name ?> potrivit nevoilor tale de trading." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="offer.php" data-active>Ofertă</a>
    </li>
    <li>
...
<span class="breadcrumb-item">Ofertă</span>
          </nav>
        </div>
      </div>
      <!-- tracker -->
      <div class="py-8 md:py-10">
        <div class="container-base grid gap-6 lg:grid-cols-2">
          ...
          >
 <h1 class="relative z-20">Obține Portfolio Tracker</h1>
<p class="relative z-20">
  Începe în câteva minute: înregistrează-te, depune fonduri și începe să tranzacționezi în doar 5 minute. Începe acum.
</p>
          </div>
