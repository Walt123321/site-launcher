...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="<?= $site_name ?> に参加し、取引目標に合ったプランをお選びください。" />
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      ...
      <span class="breadcrumb-item">ログイン/新規登録</span>
    </nav>
  </div>
</div>
      <!-- registration-1 -->
...
<h2>これは公式プラットフォーム™での取引です</h2>
<p>
  当社は、個人および法人が暗号資産を購入、売却、管理するための信頼できるプラットフォームです。
</p>
          </div>
