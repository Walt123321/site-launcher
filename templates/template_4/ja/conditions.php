...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="<?= $site_name ?> の利用規約をご確認ください。" />
    <meta charset="UTF-8" />
...
<div class="grid gap-6 md:gap-8">
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. 総則</h2>
    <p>本ウェブサイトは、第三者の取引プラットフォームおよび関連サービスに関する情報を提供します。本ウェブサイトを利用することにより、お客様は本規約およびプライバシーポリシーに同意したものとみなされます。規約はいつでも更新される場合があります。</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. 利用資格</h2>
    <p>お客様は満18歳以上であり、本規約に同意する能力を有し、現地法によって制限されていない必要があります。当社は本ウェブサイトの違法な利用について責任を負いません。</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. アクセス制限</h2>
    <p>当社は、特定の地域のユーザー、または法的もしくは規制上のリスクが存在する地域からのアクセスを制限する場合があります。制限地域ではサービスをご利用いただけない場合があります。</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. 禁止事項</h2>
    <p>お客様は、法律違反、権利侵害、有害コンテンツの拡散、自動化システムの使用を含め、本ウェブサイトを悪用してはなりません。違反があった場合、当社はアクセスを制限することがあります。</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. 知的財産</h2>
    <p>すべてのコンテンツ、商標、素材は当社または第三者に帰属します。お客様は個人的な目的でのみ本ウェブサイトを利用でき、コンテンツを複製または改変することはできません。</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. 責任</h2>
    <p>本ウェブサイトおよびサービスは「現状有姿」で提供されます。当社は、本ウェブサイトの利用に起因する誤り、損失、損害について責任を負いません。</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. 第三者サービス</h2>
    <p>当社は第三者のコンテンツやリンクを表示する場合があります。当社はそれらの正確性やサービスについて責任を負いません。判断を下す前に情報をご確認ください。</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. リンク</h2>
    <p>外部ウェブサイトへのリンクはサービスとしてのみ提供されます。当社はこれらを支持または管理するものではなく、そのコンテンツについて責任を負いません。</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">9. その他</h2>
    <p>当社はいつでもサービスおよび規約を更新または変更することがあります。本規約は、お客様と当社との間の完全な合意を構成します。権利の不行使は、その権利の放棄を意味するものではありません。</p>
  </div>
</div>
      </div>
    </main>
