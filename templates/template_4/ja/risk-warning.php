  ...
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <div class="grid gap-5 md:gap-7">
        <nav aria-label="breadcrumb" class="flex flex-wrap items-center text-sm text-gray-500 md:text-lg">
            <a href="<?= $site_url ?>" class="breadcrumb-item"><?= $risk_warning_breadcrumb_home ?></a>
            <span class="breadcrumb-item"><?= $risk_warning_breadcrumb_current ?></span>
        </nav>
...
<div class="grid gap-6 md:gap-8">
  ...
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3"><?= $risk_warning_ai_heading ?></h2>
    <ul class="grid gap-2">
  ...
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3"><?= $risk_warning_s1_heading ?></h2>
  ...
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3"><?= $risk_warning_s2_heading ?></h2>
    <ul class="grid gap-2">
  ...
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3"><?= $risk_warning_s3_heading ?></h2>
    <ul class="grid gap-2">
  ...
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3"><?= $risk_warning_s4_heading ?></h2>
    <ul class="grid gap-2">
...
<div class="lang-switcher">
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/es/risk-warning.php" hreflang="es" title="Español">
    🇪🇸
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/cs/risk-warning.php" hreflang="cs" title="Čeština">
    🇨🇿
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/de/risk-warning.php" hreflang="de" title="Deutsch">
    🇩🇪
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/en/risk-warning.php" hreflang="en" title="English">
    🇬🇧
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/it/risk-warning.php" hreflang="it" title="Italiano">
    🇮🇹
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/fr/risk-warning.php" hreflang="fr" title="Français">
    🇫🇷
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/nl/risk-warning.php" hreflang="nl" title="Nederlands">
    🇳🇱
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/pl/risk-warning.php" hreflang="pl" title="Polski">
    🇵🇱
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/pt/risk-warning.php" hreflang="pt" title="Português">
    🇵🇹
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ro/risk-warning.php" hreflang="ro" title="Română">
    🇷🇴
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/sv/risk-warning.php" hreflang="sv" title="Svenska">
    🇸🇪
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/tr/risk-warning.php" hreflang="tr" title="Türkçe">
    🇹🇷
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/hr/risk-warning.php" hreflang="hr" title="Hrvatski">
    🇭🇷
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/no/risk-warning.php" hreflang="no" title="Norsk">
    🇳🇴
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/da/risk-warning.php" hreflang="da" title="Dansk">
    🇩🇰
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/fi/risk-warning.php" hreflang="fi" title="Suomi">
    🇫🇮
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/hu/risk-warning.php" hreflang="hu" title="Magyar">
    🇭🇺
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/sk/risk-warning.php" hreflang="sk" title="Slovenčina">
    🇸🇰
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/bg/risk-warning.php" hreflang="bg" title="Български">
    🇧🇬
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ms/risk-warning.php" hreflang="ms" title="Bahasa Melayu">
    🇲🇾
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ru/risk-warning.php" hreflang="ru" title="Русский">
    🇷🇺
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/nb/risk-warning.php" hreflang="nb" title="Norsk bokmål">
    🇳🇴
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/el/risk-warning.php" hreflang="el" title="Ελληνικά">
    🇬🇷
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ja/risk-warning.php" hreflang="ja" title="日本語">
    🇯🇵
  </a>
</div>
</div>
