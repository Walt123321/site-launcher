...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>製品 | <?= $site_name ?></title>
    <meta name="description" content="分析と自動化を備えた暗号資産・資産管理ツール。" />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/ja/">ホーム</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="product.php" data-active>製品</a>
    </li>
    <li>
      ...
      <a class="data-active:text-primary" href="faq.php">FAQ</a>
        ...
        <div class="flex items-center gap-4 max-md:hidden mobmenu">
          <a class="group inline-flex h-[50px] items-center justify-between rounded-full border-2" href="sign.php">
            <span class="inline-block p-3.5 text-sm">新規登録</span>
            <span
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ja/" class="breadcrumb-item">ホーム</a>
      <span class="breadcrumb-item">製品</span>
    </nav>
  </div>
</div>
      <!-- analytics -->
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20"><?= $site_name ?> デジタル分析™</h1>
      <p class="relative z-20">
        高度な分析プラットフォームで貴重なインサイトを得て、成長を促進しましょう。自信を持って、データに基づいた的確な意思決定を行いましょう。戦略を洗練させ、測定可能な成果を達成しましょう。
      </p>
    </div>
    <div class="relative grid min-h-[230px] content-end">
      ...
      <div class="relative z-20 grid grid-cols-2 gap-3 md:gap-6">
        <a class="btn btn-black col-span-full" href="sign.php">新規登録</a>
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>ここでは、印象的なプロジェクトと創造的なソリューションを通じて、私のキャリアをご紹介します。</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">暗号資産を購入</p>
          <p>暗号資産を購入するための安全でシンプルなプラットフォーム。最小限の手数料で迅速な取引。今日から取引を始めましょう。</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">暗号資産分析</p>
          <p>市場価値とトレンドについて学び、十分な情報に基づいた投資・取引判断を行いましょう。</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">暗号資産</p>
          <p>主要な暗号資産で金融の未来を発見しましょう。発見し、投資し、成長する。</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">さあ、始めましょう!</p>
<p>
  <?= $site_name ?> で暗号資産の世界を探索しましょう。トレーダーは、イノベーション、効率性、収益機会を兼ね備えた取引プラットフォームにアクセスできます。
</p>
          </div>
        <form name="form" method="post"
          ...
          <div class="grid gap-6">
            <div class="grid gap-2 md:gap-3.5">
              ...
              <label class="grid gap-1.5">
                <span class="label text-white">メール</span>
  ...
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ja/product.php" hreflang="ja" title="日本語">
    🇯🇵
        ...
        <div class="grid gap-2.5 text-sm text-gray-500">
            <p>
                <?= $site_name ?> は、教育コンテンツ、価格情報、チャート、分析を含む本ウェブサイトで提供される情報への依拠に起因する損失または損害について、一切の責任を負いません。金融市場での取引にはリスクが伴います。そのため、開始前にご自身の個人的な状況を考慮し、必要に応じて専門家の助言を求めることが重要です。失っても構わない資金のみを投資し、外国為替(FX)、CFD、暗号資産などの商品がすべての人に適しているわけではないことにご留意ください。
            </p>
        </div>
