...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>連絡先 | <?= $site_name ?></title>
    <meta name="description" content="<?= $site_name ?> のサポートまたは営業チームまでお問い合わせください。" />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="contacts.php" data-active>お問い合わせ</a>
    </li>
    <li>
...
<div class="grid gap-4 text-center md:gap-6">
  <h3>ご不明な点がございましたら、メールにてお問い合わせください</h3>
</div>
            <a
