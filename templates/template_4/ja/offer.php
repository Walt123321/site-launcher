...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>オファー | <?= $site_name ?></title>
    <meta name="description" content="<?= $site_name ?> で、取引ニーズに合ったプランをお選びください。" />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="offer.php" data-active>オファー</a>
    </li>
    <li>
...
<span class="breadcrumb-item">オファー</span>
          </nav>
        </div>
      </div>
      <!-- tracker -->
      <div class="py-8 md:py-10">
        <div class="container-base grid gap-6 lg:grid-cols-2">
          ...
          >
 <h1 class="relative z-20">ポートフォリオ追跡を利用する</h1>
<p class="relative z-20">
  数分で開始できます:登録し、残高を入金して、わずか5分で取引を開始しましょう。今すぐ始める。
</p>
          </div>
