...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="<?= $site_name ?> がお客様のデータをどのように収集し保護しているかをご確認ください。" />
    <!-- Favicon -->
...
<div class="grid gap-6 md:gap-8">
  ...
  <div class="grid gap-2">
    <p class="text-sm">最終更新日: <?= $privacy_last_update ?></p>
    <p>当社(「当社」)は、お客様のプライバシーを尊重し、個人データの保護に努めます。本プライバシーポリシーでは、<?= $site_name ?> がお客様の情報をどのように収集、利用、保護するかについて説明します。</p>
  </div>
  <!-- PRINCIPLES -->
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">透明性</p>
    <p>
      お客様のデータがどのように使用されるかを明確に説明します。お問い合わせは以下まで: 
      <a href="mailto:info@<?= $site_domain ?>">info@<?= $site_domain ?></a>
    </p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">データの利用</p>
    <p>お客様のデータは、サービスの提供、プラットフォームの改善、法的義務の履行のために使用されます。</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">お客様の権利</p>
    <p>お客様はいつでも自身のデータに関する情報開示、訂正、削除を要求することができます。</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">セキュリティ</p>
    <p>当社はお客様のデータを保護しますが、絶対的な安全性を保証することはできません。</p>
  </div>
  <!-- SECTIONS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. データ収集</h2>
    <p>当社は利用データ(IPアドレス、デバイス、ブラウザ)およびお客様が提供するすべてのデータを収集します。</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. 法的根拠</h2>
    <p>データ処理は、お客様の同意、正当な利益、法的義務に基づいて行われます。</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. データの第三者提供</h2>
    <p>必要に応じて、当社はパートナー、サービス提供者、および当局とデータを共有する場合があります。</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Cookie(クッキー)</h2>
    <p>当社は機能性と分析のためにCookieを使用します。これらは無効にすることができます。</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. データの保存</h2>
    <p>データは絶対に必要な期間のみ保存されます。</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. 国際的なデータ移転</h2>
    <p>データは適切な保護措置のもとで移転される場合があります。</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. 第三者へのリンク</h2>
    <p>当社は外部ウェブサイトについて責任を負いません。</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. 更新</h2>
    <p>本プライバシーポリシーは更新される場合があります。</p>
  </div>
  <!-- RIGHTS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">お客様の権利</h2>
    <p>お客様は、データへのアクセス、訂正、削除、制限、またはデータポータビリティを求める権利、同意を撤回する権利、および苦情を申し立てる権利を有します。</p>
  </div>
</div>
          </div>
        </div>
