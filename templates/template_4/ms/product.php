...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 <?= $site_name ?> Analisis Digital ™ 💸",
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="Alat untuk menguruskan mata wang kripto dan aset dengan analitik dan automasi." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/ms/">Laman Utama</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="product.php" data-active>Produk</a>
    </li>
    <li>
      ...
      <a class="data-active:text-primary" href="faq.php">FAQ</a>
        ...
        <div class="flex items-center gap-4 max-md:hidden mobmenu">
          ...
          <a class="inline-flex h-[50px] w-[50px] shrink-0 items-center justify-center rounded-full border-2"
            href="sign.php" aria-label="Log Masuk">
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ms/" class="breadcrumb-item">Laman Utama</a>
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20"><?= $site_name ?> Analisis Digital ™</h1>
      <p class="relative z-20">
        Perolehi wawasan bernilai dan pacu pertumbuhan dengan platform analitik termaju kami. Buat keputusan yang berasaskan data dengan yakin. Perhalusi strategi anda dan capai hasil yang boleh diukur.
      </p>
    </div>
    <div class="relative grid min-h-[230px] content-end">
      ...
      <div class="relative z-20 grid grid-cols-2 gap-3 md:gap-6">
        <a class="btn btn-black col-span-full" href="sign.php">Daftar</a>
  ...
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
      ...
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Pasaran Modal</p>
            <p>Segalanya dengan satu klik</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            ...
            <p>Akses kepada semua data anda</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Paparan Mudah Alih</p>
            <p>Akses melalui telefon bimbit anda</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Pengurusan Kripto</p>
            <p>Akses kepada setiap aset</p>
          </div>
        </div>
      </div>
    </div>
    <div class="flex items-center justify-center">
      <img
        ...
        alt="Antara Muka Mudah Alih untuk Penjejakan Portfolio"
...
<div class="py-8 md:py-10">
  ...
  >
    ...
    <div
      class="rounded-custom grid content-start gap-5 border p-4 md:p-6"
    >
      <p class="h2 lowercase">42 juta</p>
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Di sini saya membentangkan kerjaya profesional saya melalui projek-projek yang mengagumkan dan penyelesaian kreatif.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Beli Kripto</p>
          <p>Platform yang selamat dan mudah untuk membeli mata wang kripto. Transaksi pantas dengan yuran minimum. Mula berdagang hari ini.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Analisis Kripto</p>
          <p>Ketahui lebih lanjut mengenai nilai pasaran dan trend untuk membuat keputusan pelaburan dan dagangan yang berasaskan maklumat.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Aset Kripto</p>
          <p>Terokai masa depan kewangan dengan mata wang kripto terkemuka. Terokai, labur, berkembang.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">Mari mula!</p>
<p>
  Terokai dunia mata wang kripto dengan <?= $site_name ?>. Peniaga boleh mengakses platform dagangan yang menggabungkan inovasi, kecekapan dan peluang keuntungan.
</p>
          </div>
          ...
          <div class="grid gap-6">
            ...
            <div class="grid gap-3">
              ...
              <p class="text-xs text-white">
                Dengan memasukkan data peribadi anda dan mengklik butang, anda bersetuju dengan
        ...
        <div class="grid gap-5">
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p>Rakan Dagangan Anda Yang Dipercayai</p>
  ...
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ja/product.php" hreflang="ja" title="日本語">
    🇯🇵
        ...
        <div class="grid gap-2.5 text-sm text-gray-500">
            <p>
                <?= $site_name ?> tidak bertanggungjawab atas sebarang kerugian atau kerosakan yang timbul daripada pergantungan kepada maklumat yang disediakan di laman web ini, termasuk kandungan pendidikan, sebut harga harga, carta dan analisis. Dagangan di pasaran kewangan melibatkan risiko. Oleh itu, penting untuk mempertimbangkan keadaan peribadi anda sebelum bermula dan mendapatkan nasihat daripada profesional yang layak jika perlu. Anda hanya boleh melabur wang yang anda mampu untuk kehilangan, dan ambil perhatian bahawa instrumen seperti pertukaran mata wang (FX), CFD dan mata wang kripto tidak sesuai untuk semua orang.
            </p>
        </div>
        <div class="text-center text-white">
          Hak Cipta 2026 © <?= $site_name ?>, Hak cipta terpelihara
        </div>
      </div>
    </div>
  </footer>
