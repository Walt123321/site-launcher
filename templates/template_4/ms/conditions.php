...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Terma Penggunaan | <?= $site_name ?></title>
    <meta name="description" content="Baca Terma Penggunaan <?= $site_name ?>." />
    <meta charset="UTF-8" />
  ...
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <div class="grid gap-5 md:gap-7">
        <nav aria-label="breadcrumb" class="flex flex-wrap items-center text-sm text-gray-500 md:text-lg">
            ...
            <span class="breadcrumb-item">Terma Penggunaan</span>
        </nav>
...
<div class="grid gap-6 md:gap-8">
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Am</h2>
    <p>Laman web ini menyediakan maklumat tentang platform dagangan pihak ketiga dan perkhidmatan berkaitan. Dengan menggunakan laman web ini, anda bersetuju dengan terma ini dan dasar privasi kami. Terma boleh dikemas kini pada bila-bila masa.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Kelayakan</h2>
    <p>Anda mestilah berumur sekurang-kurangnya 18 tahun, mampu menerima terma ini dan tidak dihadkan oleh undang-undang tempatan. Kami tidak bertanggungjawab atas penggunaan haram laman web ini.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Akses Terhad</h2>
    <p>Kami boleh mengehadkan akses untuk pengguna dari wilayah tertentu atau di mana terdapat risiko undang-undang atau peraturan. Perkhidmatan mungkin tidak tersedia di kawasan terhad.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Penggunaan Tidak Dibenarkan</h2>
    <p>Anda tidak boleh menyalahgunakan laman web, termasuk melanggar undang-undang, melanggar hak, menyebarkan kandungan berbahaya atau menggunakan sistem automatik. Sekiranya berlaku pelanggaran, kami boleh mengehadkan akses.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Harta Intelek</h2>
    <p>Semua kandungan, jenama dan bahan adalah milik kami atau pihak ketiga. Anda hanya boleh menggunakan laman web untuk tujuan peribadi dan tidak boleh menyalin atau mengubah kandungan.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Liabiliti</h2>
    <p>Laman web dan perkhidmatan disediakan "sebagaimana adanya". Kami tidak bertanggungjawab atas sebarang kesilapan, kerugian atau kerosakan yang timbul daripada penggunaan laman web ini.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Perkhidmatan Pihak Ketiga</h2>
    <p>Kami mungkin memaparkan kandungan atau pautan pihak ketiga. Kami tidak bertanggungjawab atas ketepatan atau perkhidmatan mereka. Sahkan maklumat sebelum membuat keputusan.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Pautan</h2>
    <p>Pautan ke laman web luar hanya disediakan sebagai perkhidmatan. Kami tidak menyokong atau mengawal pautan tersebut dan tidak bertanggungjawab atas kandungannya.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">9. Lain-lain</h2>
    <p>Kami boleh mengemas kini atau mengubah perkhidmatan dan terma pada bila-bila masa. Terma ini merupakan keseluruhan perjanjian antara anda dan kami. Kegagalan menguatkuasakan hak tidak bermakna pelepasan hak tersebut.</p>
  </div>
</div>
      </div>
    </main>
