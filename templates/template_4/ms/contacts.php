...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Hubungi | <?= $site_name ?></title>
    <meta name="description" content="Hubungi sokongan <?= $site_name ?> atau pasukan jualan kami." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="contacts.php" data-active>Hubungi Kami</a>
    </li>
    <li>
...
<div class="grid gap-4 text-center md:gap-6">
  <h3>Jika anda mempunyai sebarang soalan lanjut, sila hubungi kami melalui e-mel</h3>
</div>
            <a
