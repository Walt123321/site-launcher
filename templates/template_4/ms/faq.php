...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Soalan Lazim (FAQ) | <?= $site_name ?></title>
    <meta name="description" content="Jawapan kepada soalan mengenai dagangan, ciri-ciri, keselamatan dan yuran." />
    <!-- Favicon -->
  ...
  <div class="container-base grid gap-6 md:gap-10">
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
        <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
          ...
          <div id="content-1" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Anda boleh bersedia dalam beberapa minit. Cipta akaun dengan data asas anda, lengkapkan langkah pengesahan ringkas dan deposit sekurang-kurangnya <?= $app_price ?> <?= $app_currency ?> . Selepas itu, seluruh platform akan dibuka untuk anda — termasuk carta masa nyata, alat dagangan dan ciri-ciri yang membantu anda bermula dengan yakin.</p>
            </div>
          </div>
        </div>
        <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
          ...
          >
            <span class="h3 text-left transition-colors">Adakah wang dan data saya selamat? Adakah <?= $site_name ?> boleh dipercayai?</span>
            <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
              <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1" transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
                <rect x="19.5176" y="35.9287" width="4.62857" height="23.1428" rx="1" transform="rotate(-135 19.5176 35.9287)" fill="currentColor" />
          ...
          <div id="content-2" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Sudah tentu. Kami melindungi akaun anda dengan penyulitan SSL termaju, pengesahan dua faktor (2FA) dan penyimpanan cold storage yang selamat untuk dana. Transaksi dikendalikan melalui penyedia yang dipercayai, dan data peribadi anda dikendalikan mengikut dasar keselamatan yang ketat. Keselamatan dan kebolehpercayaan tertanam kukuh dalam setiap bahagian platform.</p>
            </div>
          </div>
        </div>
        <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
          ...
          <div id="content-3" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Anda boleh meminta pengeluaran pada bila-bila masa melalui papan pemuka anda. Pemprosesan biasanya mengambil masa 1–3 hari bekerja, bergantung pada kaedah yang dipilih. Sebarang yuran dan jangka masa sentiasa dilihat terlebih dahulu — tiada kejutan.</p>
            </div>
          </div>
        </div>
        <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
          ...
          <div id="content-4" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Cara terbaik ialah mencubanya sendiri. Mula dengan deposit minimum dan terokai ciri-ciri langkah demi langkah. Platform ini direka untuk mesra pengguna bagi pemula sambil menawarkan alat yang berkuasa serta sokongan 24/7 yang membantu anda pada bila-bila masa. Anda mengekalkan kawalan penuh.</p>
            </div>
          </div>
        </div>
