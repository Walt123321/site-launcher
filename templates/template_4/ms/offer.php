...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 Dapatkan Penjejakan Portfolio 💸",
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Tawaran | <?= $site_name ?></title>
    <meta name="description" content="Pilih pelan dengan <?= $site_name ?> yang sesuai dengan keperluan dagangan anda." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="offer.php" data-active>Tawaran</a>
    </li>
    <li>
...
<span class="breadcrumb-item">Tawaran</span>
          </nav>
        </div>
      </div>
      <!-- tracker -->
      <div class="py-8 md:py-10">
        <div class="container-base grid gap-6 lg:grid-cols-2">
          ...
          >
 <h1 class="relative z-20">Dapatkan Penjejakan Portfolio</h1>
<p class="relative z-20">
  Mula dalam beberapa minit: daftar, deposit baki dan mula berdagang hanya dalam 5 minit. Mula sekarang.
</p>
          </div>
