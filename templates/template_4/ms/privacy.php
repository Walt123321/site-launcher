...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Dasar Privasi | <?= $site_name ?></title>
    <meta name="description" content="Baca bagaimana <?= $site_name ?> mengumpul dan melindungi data anda." />
    <!-- Favicon -->
...
<div class="grid gap-6 md:gap-8">
  ...
  <div class="grid gap-2">
    <p class="text-sm">Kemas kini terakhir: <?= $privacy_last_update ?></p>
    <p>Kami ("Kami") menghormati privasi anda dan komited untuk melindungi data peribadi anda. Dasar privasi ini menerangkan bagaimana <?= $site_name ?> mengumpul, menggunakan dan melindungi maklumat anda.</p>
  </div>
  <!-- PRINCIPLES -->
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Ketelusan</p>
    <p>
      Kami menerangkan dengan jelas bagaimana data anda digunakan. Hubungi kami di 
      <a href="mailto:info@<?= $site_domain ?>">info@<?= $site_domain ?></a>
    </p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Penggunaan Data</p>
    <p>Data anda digunakan untuk menyediakan perkhidmatan, menambah baik platform dan memenuhi kewajipan undang-undang.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Hak Anda</p>
    <p>Anda boleh meminta maklumat tentang data anda pada bila-bila masa, serta meminta pembetulan atau pemadaman.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Keselamatan</p>
    <p>Kami melindungi data anda, tetapi tidak dapat menjamin keselamatan mutlak.</p>
  </div>
  <!-- SECTIONS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Pengumpulan Data</h2>
    <p>Kami mengumpul data penggunaan (alamat IP, peranti, pelayar) dan semua data yang anda berikan kepada kami.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Asas Undang-undang</h2>
    <p>Pemprosesan adalah berdasarkan kebenaran anda, kepentingan sah dan kewajipan undang-undang.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Perkongsian Data</h2>
    <p>Jika perlu, kami boleh berkongsi data dengan rakan kongsi, penyedia perkhidmatan dan pihak berkuasa.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Cookies</h2>
    <p>Kami menggunakan cookies untuk fungsi dan analitik. Anda boleh melumpuhkannya.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Penyimpanan Data</h2>
    <p>Data disimpan hanya selagi benar-benar diperlukan.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Pemindahan Antarabangsa</h2>
    <p>Data boleh dipindahkan dengan jaminan yang sewajarnya.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Pautan Pihak Ketiga</h2>
    <p>Kami tidak bertanggungjawab atas laman web luar.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Kemas Kini</h2>
    <p>Dasar privasi ini boleh dikemas kini.</p>
  </div>
  <!-- RIGHTS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">Hak Anda</h2>
    <p>Anda mempunyai hak untuk mengakses, membetulkan, memadam, mengehadkan atau memindahkan data anda, menarik balik kebenaran dan mengemukakan aduan.</p>
  </div>
</div>
          </div>
        </div>
