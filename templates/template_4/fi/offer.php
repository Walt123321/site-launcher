...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Tarjous | <?= $site_name ?></title>
    <meta name="description" content="Valitse <?= $site_name ?>:n kanssa suunnitelma, joka vastaa kaupankäyntitarpeitasi." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="offer.php" data-active>Tarjous</a>
    </li>
    <li>
...
<span class="breadcrumb-item">Tarjous</span>
          </nav>
        </div>
      </div>
      <!-- tracker -->
      <div class="py-8 md:py-10">
        <div class="container-base grid gap-6 lg:grid-cols-2">
          ...
          >
 <h1 class="relative z-20">Hanki salkun seuranta</h1>
<p class="relative z-20">
  Aloita muutamassa minuutissa: rekisteröidy, tallenna varoja ja aloita kaupankäynti vain 5 minuutissa. Aloita nyt.
</p>
          </div>
