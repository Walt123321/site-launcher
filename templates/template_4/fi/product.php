...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 <?= $site_name ?> Digitaalinen analyysi ™ 💸",
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Tuote | <?= $site_name ?></title>
    <meta name="description" content="Työkalut kryptovaluuttojen ja omaisuuserien hallintaan analytiikan ja automaation avulla." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/fi/">Etusivu</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="product.php" data-active>Tuote</a>
    </li>
    <li>
      ...
      <a class="data-active:text-primary" href="faq.php">FAQ</a>
        ...
        <div class="flex items-center gap-4 max-md:hidden mobmenu">
          ...
          <a class="inline-flex h-[50px] w-[50px] shrink-0 items-center justify-center rounded-full border-2"
            href="sign.php" aria-label="Kirjaudu sisään">
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/fi/" class="breadcrumb-item">Etusivu</a>
      <span class="breadcrumb-item">Tuote</span>
    </nav>
  </div>
</div>
      <!-- analytics -->
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20"><?= $site_name ?> Digitaalinen analyysi ™</h1>
      <p class="relative z-20">
        Hanki arvokkaita oivalluksia ja edistä kasvua edistyneen analyysialustamme avulla. Tee perusteltuja, tietoon perustuvia päätöksiä luottavaisin mielin. Hio strategiaasi ja saavuta mitattavia tuloksia.
      </p>
    </div>
    <div class="relative grid min-h-[230px] content-end">
      ...
      <div class="relative z-20 grid grid-cols-2 gap-3 md:gap-6">
        <a class="btn btn-black col-span-full" href="sign.php">Rekisteröidy</a>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Digitaalinen verkkosovellus</h2>
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Pääomamarkkinat</p>
            <p>Kaikki napin painalluksella</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Tilastot</p>
            <p>Pääsy kaikkiin tietoihisi</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Mobiilinäkymä</p>
            <p>Pääsy matkapuhelimesi kautta</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Kryptohallinta</p>
            <p>Pääse käsiksi mihin tahansa omaisuuserään</p>
          </div>
        </div>
      </div>
    </div>
    <div class="flex items-center justify-center">
      <img
        ...
        alt="Mobiililiittymä salkun seurantaan"
...
<div class="py-8 md:py-10">
  ...
  >
    ...
    <div
      class="rounded-custom grid content-start gap-5 border p-4 md:p-6"
    >
      <p class="h2 lowercase">42 milj.</p>
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Tässä esittelen ammatillista uraani vaikuttavien projektien ja luovien ratkaisujen kautta.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Osta kryptoa</p>
          <p>Turvallinen ja helppo alusta kryptovaluuttojen ostamiseen. Nopeat tapahtumat minimimaksuilla. Aloita kaupankäynti jo tänään.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Kryptoanalyysi</p>
          <p>Opi lisää markkina-arvoista ja trendeistä tehdäksesi perusteltuja sijoitus- ja kaupankäyntipäätöksiä.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Kryptovarat</p>
          <p>Löydä rahoituksen tulevaisuus johtavien kryptovaluuttojen kanssa. Löydä, sijoita, kasva.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">Aloitetaan!</p>
<p>
  Tutustu kryptovaluuttojen maailmaan <?= $site_name ?>:n kanssa. Kauppiaat pääsevät käsiksi kaupankäyntialustaan, joka yhdistää innovaation, tehokkuuden ja voittomahdollisuudet.
</p>
          </div>
          ...
          <div class="grid gap-6">
            ...
            <div class="grid gap-3">
              ...
              <p class="text-xs text-white">
                Antamalla henkilötietosi ja napsauttamalla painiketta hyväksyt
                <a class="link-underline" href="privacy.php">Tietosuojakäytäntö</a>
                ja
                <a class="link-underline" href="conditions.php">Käyttöehdot</a>
                tälle verkkosivustolle.
              </p>
            </div>
        ...
        <div class="grid gap-5">
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p>Luotettava kaupankäyntikumppanisi</p>
  ...
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ja/product.php" hreflang="ja" title="日本語">
    🇯🇵
        ...
        <div class="grid gap-2.5 text-sm text-gray-500">
            <p>
                <?= $site_name ?> ei ota vastuuta tappioista tai vahingoista, jotka aiheutuvat tällä verkkosivustolla annettuihin tietoihin luottamisesta, mukaan lukien koulutussisältö, hintanoteeraukset, kaaviot ja analyysit. Kaupankäyntiin rahoitusmarkkinoilla liittyy riskejä. Siksi on tärkeää ottaa huomioon henkilökohtainen tilanteesi ennen aloittamista ja tarvittaessa hankkia neuvoja pätevältä asiantuntijalta. Sinun tulisi sijoittaa vain rahaa, jonka menettämiseen sinulla on varaa, ja huomioida, että instrumentit kuten valuutat (FX), CFD:t ja kryptovaluutat eivät sovi kaikille.
            </p>
        </div>
