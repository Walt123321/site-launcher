...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Yhteystiedot | <?= $site_name ?></title>
    <meta name="description" content="Ota yhteyttä <?= $site_name ?>:n tukeen tai myyntitiimiimme." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="contacts.php" data-active>Ota yhteyttä</a>
    </li>
    <li>
      ...
      <div class="pt-5">
        <div class="container-base">
          ...
          >
            ...
            <span class="breadcrumb-item">Ota yhteyttä</span>
          </nav>
        </div>
      </div>
      <!-- contact -->
...
<div class="grid gap-4 text-center md:gap-6">
  <h3>Jos sinulla on lisäkysymyksiä, ota meihin yhteyttä sähköpostitse</h3>
</div>
            <a
      ...
      <div class="py-8 md:py-10">
        <div class="container-base grid gap-6 lg:grid-cols-2">
          ...
          >
            ...
            <h2>Kuinka voimme auttaa sinua?</h2>
          </div>
