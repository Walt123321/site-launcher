...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Käyttöehdot | <?= $site_name ?></title>
    <meta name="description" content="Lue <?= $site_name ?>:n käyttöehdot." />
    <meta charset="UTF-8" />
  ...
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <div class="grid gap-5 md:gap-7">
        <nav aria-label="breadcrumb" class="flex flex-wrap items-center text-sm text-gray-500 md:text-lg">
            ...
            <span class="breadcrumb-item">Käyttöehdot</span>
        </nav>
        <h1>Käyttöehdot</h1>
    </div>
<div class="grid gap-6 md:gap-8">
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Yleistä</h2>
    <p>Tämä verkkosivusto tarjoaa tietoa kolmansien osapuolten kaupankäyntialustoista ja niihin liittyvistä palveluista. Käyttämällä tätä verkkosivustoa hyväksyt nämä ehdot ja tietosuojakäytäntömme. Ehtoja voidaan päivittää milloin tahansa.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Kelpoisuus</h2>
    <p>Sinun on oltava vähintään 18-vuotias, kyettävä hyväksymään nämä ehdot etkä saa olla paikallisten lakien rajoittama. Emme ole vastuussa tämän verkkosivuston laittomasta käytöstä.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Rajoitettu pääsy</h2>
    <p>Voimme rajoittaa pääsyä käyttäjiltä, jotka ovat tietyiltä alueilta tai joilla on oikeudellisia tai sääntelyllisiä riskejä. Palvelut eivät välttämättä ole saatavilla rajoitetuilla alueilla.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Kielletty käyttö</h2>
    <p>Et saa väärinkäyttää verkkosivustoa, mukaan lukien lakien rikkominen, oikeuksien loukkaaminen, haitallisen sisällön levittäminen tai automatisoitujen järjestelmien käyttö. Rikkomusten yhteydessä voimme rajoittaa pääsyä.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Immateriaalioikeudet</h2>
    <p>Kaikki sisältö, tavaramerkit ja materiaalit kuuluvat meille tai kolmansille osapuolille. Voit käyttää verkkosivustoa vain henkilökohtaisiin tarkoituksiin, etkä saa kopioida tai muokata sisältöä.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Vastuu</h2>
    <p>Verkkosivusto ja palvelut tarjotaan "sellaisenaan". Emme ole vastuussa virheistä, tappioista tai vahingoista, jotka johtuvat tämän verkkosivuston käytöstä.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Kolmansien osapuolten palvelut</h2>
    <p>Voimme näyttää kolmansien osapuolten sisältöä tai linkkejä. Emme ole vastuussa niiden tarkkuudesta tai palveluista. Tarkista tiedot ennen päätöksen tekemistä.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Linkit</h2>
    <p>Linkit ulkoisille verkkosivustoille tarjotaan vain palveluna. Emme tue tai valvo niitä emmekä ole vastuussa niiden sisällöstä.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">9. Sekalaista</h2>
    <p>Voimme päivittää tai muuttaa palveluita ja ehtoja milloin tahansa. Nämä ehdot muodostavat koko sopimuksen sinun ja meidän välillämme. Oikeuksien täytäntöönpanon laiminlyönti ei tarkoita niistä luopumista.</p>
  </div>
</div>
      </div>
    </main>
