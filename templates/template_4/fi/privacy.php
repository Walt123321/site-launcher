...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Tietosuojakäytäntö | <?= $site_name ?></title>
    <meta name="description" content="Lue, miten <?= $site_name ?> kerää ja suojaa tietojasi." />
    <!-- Favicon -->
...
<div class="grid gap-6 md:gap-8">
  ...
  <div class="grid gap-2">
    <p class="text-sm">Viimeksi päivitetty: <?= $privacy_last_update ?></p>
    <p>Me ("Me", "Meille") kunnioitamme yksityisyyttäsi ja sitoudumme suojaamaan henkilötietojasi. Tämä tietosuojakäytäntö selittää, miten <?= $site_name ?> kerää, käyttää ja suojaa tietojasi.</p>
  </div>
  <!-- PRINCIPLES -->
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Läpinäkyvyys</p>
    <p>
      Selitämme selkeästi, miten tietojasi käytetään. Ota meihin yhteyttä osoitteessa 
      <a href="mailto:info@<?= $site_domain ?>">info@<?= $site_domain ?></a>
    </p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Tietojen käyttö</p>
    <p>Tietojasi käytetään palveluiden tarjoamiseen, alustan parantamiseen ja lakisääteisten velvoitteiden täyttämiseen.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Oikeutesi</p>
    <p>Voit milloin tahansa pyytää tietoja tiedoistasi sekä niiden korjaamista tai poistamista.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Turvallisuus</p>
    <p>Suojaamme tietojasi, mutta emme voi taata täydellistä turvallisuutta.</p>
  </div>
  <!-- SECTIONS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Tietojen kerääminen</h2>
    <p>Keräämme käyttötietoja (IP-osoite, laite, selain) ja kaikki tiedot, jotka annat meille.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Oikeusperusta</h2>
    <p>Käsittely perustuu suostumukseesi, oikeutettuihin etuihin ja lakisääteisiin velvoitteisiin.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Tietojen luovuttaminen</h2>
    <p>Tarvittaessa voimme jakaa tietoja kumppaneiden, palveluntarjoajien ja viranomaisten kanssa.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Evästeet</h2>
    <p>Käytämme evästeitä toiminnallisuutta ja analytiikkaa varten. Voit poistaa ne käytöstä.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Tietojen säilyttäminen</h2>
    <p>Tietoja säilytetään vain niin kauan kuin se on ehdottoman välttämätöntä.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Kansainväliset siirrot</h2>
    <p>Tietoja voidaan siirtää asianmukaisilla suojatoimilla.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Kolmansien osapuolten linkit</h2>
    <p>Emme ole vastuussa ulkoisista verkkosivustoista.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Päivitykset</h2>
    <p>Tätä tietosuojakäytäntöä voidaan päivittää.</p>
  </div>
  <!-- RIGHTS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">Oikeutesi</h2>
    <p>Sinulla on oikeus tietojesi saantiin, korjaamiseen, poistamiseen, rajoittamiseen tai siirtämiseen, suostumuksen peruuttamiseen ja valituksen tekemiseen.</p>
  </div>
</div>
          </div>
        </div>
