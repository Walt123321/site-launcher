...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Usein kysytyt kysymykset (UKK) | <?= $site_name ?></title>
    <meta name="description" content="Vastauksia kysymyksiin kaupankäynnistä, ominaisuuksista, turvallisuudesta ja maksuista." />
    <!-- Favicon -->
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
        <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
          ...
          <div id="content-1" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Voit olla valmis muutamassa minuutissa. Luo tili perustiedoillasi, suorita lyhyt vahvistusvaihe ja tallenna vähintään <?= $app_price ?> <?= $app_currency ?> talletettava. Sen jälkeen koko alusta avautuu käyttöösi — mukaan lukien reaaliaikaiset kaaviot, kaupankäyntityökalut ja ominaisuudet, jotka auttavat sinua aloittamaan itsevarmasti.</p>
            </div>
          </div>
        </div>
        <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
          ...
          <div id="content-2" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Ehdottomasti. Suojaamme tilisi edistyneellä SSL-salauksella, kaksivaiheisella todennuksella (2FA) ja turvallisella cold storage -säilytyksellä varoille. Tapahtumat käsitellään luotettujen palveluntarjoajien kautta, ja henkilötietojasi käsitellään tiukkojen turvallisuusohjeiden mukaisesti. Turvallisuus ja luotettavuus ovat kiinteä osa alustan joka osa-aluetta.</p>
            </div>
          </div>
        </div>
        <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
          ...
          <div id="content-3" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Voit pyytää nostoa milloin tahansa hallintapaneelisi kautta. Käsittely kestää yleensä 1–3 arkipäivää valitusta menetelmästä riippuen. Mahdolliset maksut ja aikataulu näkyvät aina etukäteen — ei yllätyksiä.</p>
            </div>
          </div>
        </div>
        <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
          ...
          <div id="content-4" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Paras tapa on kokeilla itse. Aloita vähimmäistalletuksella ja tutustu ominaisuuksiin askel askeleelta. Alusta on suunniteltu käyttäjäystävälliseksi aloittelijoille tarjoten samalla tehokkaita työkaluja ja 24/7-tukea, joka auttaa sinua milloin tahansa. Säilytät täyden hallinnan.</p>
            </div>
          </div>
        </div>
        <div id="accordion-5" class="group border-primary rounded-custom border transition-all">
          ...
          <div id="content-5" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Ei lainkaan. Kaikki on suunniteltu saavutettavaksi ensimmäisestä päivästä lähtien — ohjatun rekisteröinnin, yksinkertaisten ohjeiden ja tekoälypohjaisten työkalujen avulla, jotka auttavat sinua kaupankäynnissä. Aloitatpa juuri tai sinulla on jo kokemusta, voit edetä omaan tahtiisi, ja tuki on aina käytettävissäsi.</p>
            </div>
          </div>
        </div>
    </div>
