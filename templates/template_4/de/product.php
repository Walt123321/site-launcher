...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 <?= $site_name ?> Digitale Analyse ™ 💸",
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="Tools zur Verwaltung von Kryptowährungen und Vermögenswerten mit Analysen und Automatisierung." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/de/">Startseite</a>
    </li>
    <li>
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/de/" class="breadcrumb-item">Startseite</a>
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20"><?= $site_name ?> Digitale Analyse ™</h1>
      <p class="relative z-20">
        Gewinnen Sie wertvolle Erkenntnisse und fördern Sie das Wachstum mit unserer fortschrittlichen Analyseplattform. Treffen Sie fundierte, datenbasierte Entscheidungen mit Vertrauen. Verfeinern Sie Ihre Strategie und erzielen Sie messbare Ergebnisse.
      </p>
    </div>
    <div class="relative grid min-h-[230px] content-end">
      ...
      <div class="relative z-20 grid grid-cols-2 gap-3 md:gap-6">
        <a class="btn btn-black col-span-full" href="sign.php">Registrierung</a>
  ...
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
      ...
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Kapitalmarkt</p>
            <p>Alles auf Knopfdruck</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Statistiken</p>
            <p>Zugriff auf alle Ihre Daten</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Mobile Ansicht</p>
            <p>Zugriff über Ihr Mobiltelefon</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            ...
            <p>Greifen Sie auf jeden Vermögenswert zu</p>
          </div>
        </div>
      </div>
    </div>
    <div class="flex items-center justify-center">
      <img
        ...
        alt="Mobile Schnittstelle zur Portfolio-Verfolgung"
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Hier präsentiere ich meine berufliche Laufbahn durch beeindruckende Projekte und kreative Lösungen.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Krypto kaufen</p>
          <p>Sichere und einfache Plattform zum Kauf von Kryptowährungen. Schnelle Transaktionen mit minimalen Gebühren. Starten Sie noch heute mit dem Handel.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Krypto-Analyse</p>
          <p>Erfahren Sie mehr über Marktwerte und Trends, um fundierte Investitions- und Handelsentscheidungen zu treffen.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Krypto-Vermögenswerte</p>
          <p>Entdecken Sie die Zukunft des Finanzwesens mit führenden Kryptowährungen. Entdecken, investieren, wachsen.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">Los geht's!</p>
<p>
  Entdecken Sie die Welt der Kryptowährungen mit <?= $site_name ?>. Händler können auf eine Handelsplattform zugreifen, die Innovation, Effizienz und Gewinnchancen vereint.
</p>
          </div>
        ...
        <div class="grid gap-5">
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p>Ihr vertrauenswürdiger Handelspartner</p>
