...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 Portfolio-Verfolgung erhalten 💸",
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Angebot | <?= $site_name ?></title>
    <meta name="description" content="Wählen Sie mit <?= $site_name ?> einen Plan, der Ihren Handelsbedürfnissen entspricht." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="offer.php" data-active>Angebot</a>
    </li>
    <li>
...
<span class="breadcrumb-item">Angebot</span>
          </nav>
        </div>
      </div>
      <!-- tracker -->
      <div class="py-8 md:py-10">
        <div class="container-base grid gap-6 lg:grid-cols-2">
          ...
          >
 <h1 class="relative z-20">Portfolio-Verfolgung erhalten</h1>
<p class="relative z-20">
  Starten Sie in wenigen Minuten: Registrieren Sie sich, zahlen Sie Guthaben ein und beginnen Sie in nur 5 Minuten mit dem Handel. Jetzt starten.
</p>
          </div>
