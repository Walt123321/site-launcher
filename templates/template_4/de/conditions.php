...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Nutzungsbedingungen | <?= $site_name ?></title>
    <meta name="description" content="Lesen Sie die Nutzungsbedingungen von <?= $site_name ?>." />
    <meta charset="UTF-8" />
  ...
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <div class="grid gap-5 md:gap-7">
        <nav aria-label="breadcrumb" class="flex flex-wrap items-center text-sm text-gray-500 md:text-lg">
            ...
            <span class="breadcrumb-item">Nutzungsbedingungen</span>
        </nav>
        <h1>Nutzungsbedingungen</h1>
    </div>
<div class="grid gap-6 md:gap-8">
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Allgemeines</h2>
    <p>Diese Website bietet Informationen über Handelsplattformen von Drittanbietern und damit verbundene Dienstleistungen. Durch die Nutzung dieser Website stimmen Sie diesen Bedingungen und unserer Datenschutzerklärung zu. Die Bedingungen können jederzeit aktualisiert werden.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Teilnahmeberechtigung</h2>
    <p>Sie müssen mindestens 18 Jahre alt sein, diese Bedingungen akzeptieren können und dürfen nicht durch lokale Gesetze eingeschränkt sein. Wir sind nicht für eine illegale Nutzung dieser Website verantwortlich.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Eingeschränkter Zugang</h2>
    <p>Wir können den Zugang für Nutzer aus bestimmten Regionen oder dort, wo rechtliche oder regulatorische Risiken bestehen, einschränken. Dienstleistungen können in eingeschränkten Gebieten nicht verfügbar sein.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Unzulässige Nutzung</h2>
    <p>Sie dürfen die Website nicht missbrauchen, einschließlich des Verstoßes gegen Gesetze, der Verletzung von Rechten, der Verbreitung schädlicher Inhalte oder der Nutzung automatisierter Systeme. Bei Verstößen können wir den Zugang einschränken.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Geistiges Eigentum</h2>
    <p>Alle Inhalte, Marken und Materialien gehören uns oder Dritten. Sie dürfen die Website nur für persönliche Zwecke nutzen und keine Inhalte kopieren oder verändern.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Haftung</h2>
    <p>Die Website und die Dienstleistungen werden „wie besehen“ bereitgestellt. Wir haften nicht für Fehler, Verluste oder Schäden, die durch die Nutzung dieser Website entstehen.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Dienste von Drittanbietern</h2>
    <p>Wir können Inhalte oder Links von Drittanbietern anzeigen. Wir sind nicht für deren Genauigkeit oder Dienste verantwortlich. Überprüfen Sie die Informationen, bevor Sie eine Entscheidung treffen.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Links</h2>
    <p>Links zu externen Websites werden nur als Service zur Verfügung gestellt. Wir unterstützen oder kontrollieren diese nicht und sind nicht für deren Inhalte verantwortlich.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">9. Verschiedenes</h2>
    <p>Wir können die Dienstleistungen und Bedingungen jederzeit aktualisieren oder ändern. Diese Bedingungen stellen die gesamte Vereinbarung zwischen Ihnen und uns dar. Die Nichtdurchsetzung von Rechten bedeutet keinen Verzicht auf diese.</p>
  </div>
</div>
      </div>
    </main>
