...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="Lesen Sie, wie <?= $site_name ?> Ihre Daten sammelt und schützt." />
    <!-- Favicon -->
...
<div class="grid gap-6 md:gap-8">
  ...
  <div class="grid gap-2">
    <p class="text-sm">Letzte Aktualisierung: <?= $privacy_last_update ?></p>
    <p>Wir („Wir“, „Uns“) respektieren Ihre Privatsphäre und verpflichten uns zum Schutz Ihrer personenbezogenen Daten. Diese Datenschutzerklärung erklärt, wie <?= $site_name ?> Ihre Informationen sammelt, verwendet und schützt.</p>
  </div>
  <!-- PRINCIPLES -->
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Transparenz</p>
    <p>
      Wir erklären klar, wie Ihre Daten verwendet werden. Kontaktieren Sie uns unter 
      <a href="mailto:info@<?= $site_domain ?>">info@<?= $site_domain ?></a>
    </p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Datennutzung</p>
    <p>Ihre Daten werden verwendet, um Dienstleistungen bereitzustellen, die Plattform zu verbessern und gesetzliche Verpflichtungen zu erfüllen.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Ihre Rechte</p>
    <p>Sie können jederzeit Auskunft über Ihre Daten verlangen sowie deren Berichtigung oder Löschung fordern.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Sicherheit</p>
    <p>Wir schützen Ihre Daten, können jedoch keine absolute Sicherheit garantieren.</p>
  </div>
  <!-- SECTIONS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Datenerfassung</h2>
    <p>Wir erfassen Nutzungsdaten (IP-Adresse, Gerät, Browser) und alle Daten, die Sie uns zur Verfügung stellen.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Rechtsgrundlage</h2>
    <p>Die Verarbeitung basiert auf Ihrer Einwilligung, berechtigten Interessen und gesetzlichen Verpflichtungen.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Weitergabe von Daten</h2>
    <p>Bei Bedarf können wir Daten an Partner, Dienstleister und Behörden weitergeben.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Cookies</h2>
    <p>Wir verwenden Cookies für Funktionalität und Analysen. Sie können diese deaktivieren.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Datenspeicherung</h2>
    <p>Daten werden nur so lange wie absolut notwendig aufbewahrt.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Internationale Übertragungen</h2>
    <p>Daten können mit angemessenen Garantien übertragen werden.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Links von Drittanbietern</h2>
    <p>Wir sind nicht für externe Websites verantwortlich.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Aktualisierungen</h2>
    <p>Diese Datenschutzerklärung kann aktualisiert werden.</p>
  </div>
  <!-- RIGHTS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">Ihre Rechte</h2>
    <p>Sie haben das Recht auf Auskunft, Berichtigung, Löschung, Einschränkung oder Übertragung Ihrer Daten, auf Widerruf der Einwilligung und auf Einreichung einer Beschwerde.</p>
  </div>
</div>
          </div>
        </div>
