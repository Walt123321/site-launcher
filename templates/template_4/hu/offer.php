...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 Portfóliókövetés igénylése 💸",
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Ajánlat | <?= $site_name ?></title>
    <meta name="description" content="Válasszon a <?= $site_name ?>-nál egy tervet, amely megfelel kereskedési igényeinek." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="offer.php" data-active>Ajánlat</a>
    </li>
    <li>
...
<span class="breadcrumb-item">Ajánlat</span>
          </nav>
        </div>
      </div>
      <!-- tracker -->
      <div class="py-8 md:py-10">
        <div class="container-base grid gap-6 lg:grid-cols-2">
          ...
          >
 <h1 class="relative z-20">Portfóliókövetés igénylése</h1>
<p class="relative z-20">
  Kezdje el néhány perc alatt: regisztráljon, fizessen be egyenleget, és mindössze 5 perc alatt kezdje el a kereskedést. Kezdje el most.
</p>
          </div>
