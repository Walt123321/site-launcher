...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 <?= $site_name ?> Digitális Elemzés ™ 💸",
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Termék | <?= $site_name ?></title>
    <meta name="description" content="Eszközök kriptovaluták és vagyontárgyak kezelésére elemzéssel és automatizálással." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/hu/">Kezdőlap</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="product.php" data-active>Termék</a>
    </li>
    <li>
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/hu/" class="breadcrumb-item">Kezdőlap</a>
      <span class="breadcrumb-item">Termék</span>
    </nav>
  </div>
</div>
      <!-- analytics -->
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20"><?= $site_name ?> Digitális Elemzés ™</h1>
      <p class="relative z-20">
        Szerezzen értékes betekintést, és ösztönözze a növekedést fejlett elemzési platformunkkal. Hozzon megalapozott, adatalapú döntéseket magabiztosan. Finomítsa stratégiáját, és érjen el mérhető eredményeket.
      </p>
    </div>
    <div class="relative grid min-h-[230px] content-end">
      ...
      <div class="relative z-20 grid grid-cols-2 gap-3 md:gap-6">
        <a class="btn btn-black col-span-full" href="sign.php">Regisztráció</a>
  ...
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
      ...
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Tőkepiac</p>
            <p>Minden egy gombnyomásra</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Statisztikák</p>
            <p>Hozzáférés az összes adatához</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Mobilnézet</p>
            <p>Hozzáférés mobiltelefonján keresztül</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Kriptokezelés</p>
            <p>Férjen hozzá bármely eszközhöz</p>
          </div>
        </div>
      </div>
    </div>
    <div class="flex items-center justify-center">
      <img
        ...
        alt="Mobil felület a portfóliókövetéshez"
...
<div class="py-8 md:py-10">
  ...
  >
    ...
    >
      ...
      <p class="h3">Elérhető devizanemek</p>
    </div>
    <div
      class="rounded-custom grid content-start gap-5 border p-4 md:p-6"
    >
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Itt mutatom be szakmai pályafutásomat lenyűgöző projekteken és kreatív megoldásokon keresztül.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Kripto vásárlása</p>
          <p>Biztonságos és egyszerű platform kriptovaluták vásárlásához. Gyors tranzakciók minimális díjakkal. Kezdje el a kereskedést még ma.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Kriptoelemzés</p>
          <p>Tudjon meg többet a piaci értékekről és trendekről, hogy megalapozott befektetési és kereskedési döntéseket hozhasson.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Kriptoeszközök</p>
          <p>Fedezze fel a pénzügyek jövőjét a vezető kriptovalutákkal. Fedezzen fel, fektessen be, növekedjen.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">Kezdjük!</p>
<p>
  Fedezze fel a kriptovaluták világát a <?= $site_name ?> segítségével. A kereskedők hozzáférhetnek egy olyan kereskedési platformhoz, amely egyesíti az innovációt, a hatékonyságot és a nyereséglehetőségeket.
</p>
          </div>
          ...
          <div class="grid gap-6">
            <div class="grid gap-2 md:gap-3.5">
              <label class="grid gap-1.5">
                ...
                <input class="input" type="text" name="fname" placeholder="Adja meg keresztnevét" required />
              </label>
              <label class="grid gap-1.5">
                <span class="label text-white">Vezetéknév</span>
                <input class="input" type="text" name="lname" placeholder="Adja meg vezetéknevét" required />
              </label>
              <label class="grid gap-1.5">
                <span class="label text-white">E-mail</span>
                <input class="input" type="email" name="email" placeholder="Adja meg e-mail címét" required />
              </label>
              <label class="grid gap-1.5">
            ...
            <div class="grid gap-3">
              ...
              <p class="text-xs text-white">
                Személyes adatai megadásával és a gombra kattintással Ön elfogadja a
                <a class="link-underline" href="privacy.php">Adatvédelmi irányelvek</a>
                és a
                <a class="link-underline" href="conditions.php">Felhasználási feltételek</a>
                ezen weboldal esetében.
              </p>
            </div>
        ...
        <div class="grid gap-5">
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p>Az Ön megbízható kereskedési partnere</p>
