...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="Vegye fel a kapcsolatot a <?= $site_name ?> ügyfélszolgálatával vagy értékesítési csapatunkkal." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="contacts.php" data-active>Kapcsolat</a>
    </li>
    <li>
...
<div class="grid gap-4 text-center md:gap-6">
  <h3>Ha további kérdései vannak, kérjük, vegye fel velünk a kapcsolatot e-mailben</h3>
</div>
            <a
