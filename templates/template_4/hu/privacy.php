...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Adatvédelmi irányelvek | <?= $site_name ?></title>
    <meta name="description" content="Olvassa el, hogyan gyűjti és védi adatait a <?= $site_name ?>." />
    <!-- Favicon -->
...
<div class="grid gap-6 md:gap-8">
  ...
  <div class="grid gap-2">
    <p class="text-sm">Utolsó frissítés: <?= $privacy_last_update ?></p>
    <p>Mi ("Mi", "Minket") tiszteletben tartjuk az Ön magánéletét, és elkötelezettek vagyunk személyes adatainak védelme mellett. Ez az adatvédelmi irányelv elmagyarázza, hogyan gyűjti, használja és védi adatait a <?= $site_name ?>.</p>
  </div>
  <!-- PRINCIPLES -->
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Átláthatóság</p>
    <p>
      Világosan elmagyarázzuk, hogyan használjuk fel az adatait. Vegye fel velünk a kapcsolatot itt: 
      <a href="mailto:info@<?= $site_domain ?>">info@<?= $site_domain ?></a>
    </p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Adathasználat</p>
    <p>Az Ön adatait szolgáltatások nyújtására, a platform fejlesztésére és jogi kötelezettségek teljesítésére használjuk fel.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Az Ön jogai</p>
    <p>Bármikor kérhet tájékoztatást adatairól, valamint kérheti azok helyesbítését vagy törlését.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Biztonság</p>
    <p>Védjük adatait, de nem tudunk teljes biztonságot garantálni.</p>
  </div>
  <!-- SECTIONS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Adatgyűjtés</h2>
    <p>Használati adatokat (IP-cím, eszköz, böngésző) és minden Ön által megadott adatot gyűjtünk.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Jogalap</h2>
    <p>Az adatkezelés az Ön hozzájárulásán, jogos érdekeken és jogi kötelezettségeken alapul.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Adattovábbítás</h2>
    <p>Szükség esetén adatokat továbbíthatunk partnereknek, szolgáltatóknak és hatóságoknak.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Sütik (Cookie-k)</h2>
    <p>Sütiket használunk a funkcionalitás és az elemzés érdekében. Ezeket letilthatja.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Adattárolás</h2>
    <p>Az adatokat csak a feltétlenül szükséges ideig tároljuk.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Nemzetközi adattovábbítás</h2>
    <p>Az adatok megfelelő garanciákkal továbbíthatók.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Harmadik féltől származó linkek</h2>
    <p>Nem vagyunk felelősek a külső weboldalakért.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Frissítések</h2>
    <p>Ez az adatvédelmi irányelv frissülhet.</p>
  </div>
  <!-- RIGHTS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">Az Ön jogai</h2>
    <p>Önnek joga van adatai megismeréséhez, helyesbítéséhez, törléséhez, korlátozásához vagy hordozhatóságához, a hozzájárulás visszavonásához és panasz benyújtásához.</p>
  </div>
</div>
          </div>
        </div>
