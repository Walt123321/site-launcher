...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Gyakran Ismételt Kérdések (GYIK) | <?= $site_name ?></title>
    <meta name="description" content="Válaszok a kereskedéssel, funkciókkal, biztonsággal és díjakkal kapcsolatos kérdésekre." />
    <!-- Favicon -->
  ...
  <div class="container-base grid gap-6 md:gap-10">
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
        <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
          ...
          <div id="content-1" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Néhány perc alatt készen állhat. Hozzon létre egy fiókot alapadataival, végezze el a rövid ellenőrzési lépést, és fizessen be legalább <?= $app_price ?> <?= $app_currency ?> be. Ezt követően a teljes platform megnyílik Ön előtt — beleértve a valós idejű grafikonokat, kereskedési eszközöket és funkciókat, amelyek segítenek magabiztosan elkezdeni.</p>
            </div>
          </div>
        </div>
        <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
          ...
          >
            <span class="h3 text-left transition-colors">Biztonságban van a pénzem és az adataim? Megbízható a <?= $site_name ?> megbízható?</span>
            <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
              <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1" transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
                <rect x="19.5176" y="35.9287" width="4.62857" height="23.1428" rx="1" transform="rotate(-135 19.5176 35.9287)" fill="currentColor" />
          ...
          <div id="content-2" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Teljes mértékben. Fiókját fejlett SSL-titkosítással, kétfaktoros hitelesítéssel (2FA) és biztonságos cold storage tárolással védjük. A tranzakciókat megbízható szolgáltatókon keresztül bonyolítjuk, és személyes adatait szigorú biztonsági irányelvek szerint kezeljük. A biztonság és a megbízhatóság a platform minden részébe be van építve.</p>
            </div>
          </div>
        </div>
        <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
          ...
          <div id="content-3" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Bármikor kérhet kifizetést az irányítópultján keresztül. A feldolgozás általában 1–3 munkanapot vesz igénybe, a választott módszertől függően. Az esetleges díjakat és az időkeretet mindig előre látja — nincsenek meglepetések.</p>
            </div>
          </div>
        </div>
        <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
          ...
          <div id="content-4" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>A legjobb módja, ha kipróbálja saját maga. Kezdje a minimális befizetéssel, és fedezze fel a funkciókat lépésről lépésre. A platformot úgy tervezték, hogy felhasználóbarát legyen kezdők számára, ugyanakkor erőteljes eszközöket és 24/7 támogatást is kínáljon, amely bármikor segít. Ön megtartja a teljes irányítást.</p>
            </div>
          </div>
        </div>
        <div id="accordion-5" class="group border-primary rounded-custom border transition-all">
          ...
          >
            <span class="h3 text-left transition-colors">Szükségem van kereskedési tapasztalatra a kezdéshez?</span>
            <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
              <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1" transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
                <rect x="19.5176" y="35.9287" width="4.62857" height="23.1428" rx="1" transform="rotate(-135 19.5176 35.9287)" fill="currentColor" />
          ...
          <div id="content-5" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Egyáltalán nem. Minden úgy van kialakítva, hogy az első naptól kezdve elérhető legyen — irányított regisztrációval, egyszerű útmutatókkal és AI-alapú eszközökkel, amelyek segítenek eligazodni a kereskedésben. Akár most kezdi, akár már van tapasztalata, saját tempójában haladhat, és a támogatás mindig elérhető az Ön számára.</p>
            </div>
          </div>
        </div>
    </div>
