...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Felhasználási feltételek | <?= $site_name ?></title>
    <meta name="description" content="Olvassa el a <?= $site_name ?> felhasználási feltételeit." />
    <meta charset="UTF-8" />
  ...
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <div class="grid gap-5 md:gap-7">
        <nav aria-label="breadcrumb" class="flex flex-wrap items-center text-sm text-gray-500 md:text-lg">
            ...
            <span class="breadcrumb-item">Felhasználási feltételek</span>
        </nav>
        <h1>Felhasználási feltételek</h1>
    </div>
<div class="grid gap-6 md:gap-8">
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Általános rendelkezések</h2>
    <p>Ez a weboldal információkat nyújt harmadik féltől származó kereskedési platformokról és kapcsolódó szolgáltatásokról. A weboldal használatával Ön elfogadja ezeket a feltételeket és adatvédelmi irányelveinket. A feltételek bármikor frissíthetők.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Jogosultság</h2>
    <p>Legalább 18 évesnek kell lennie, el kell tudnia fogadni ezeket a feltételeket, és a helyi törvények nem korlátozhatják Önt. Nem vagyunk felelősek a weboldal jogellenes használatáért.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Korlátozott hozzáférés</h2>
    <p>Korlátozhatjuk a hozzáférést bizonyos régiókból származó felhasználók számára, vagy ahol jogi vagy szabályozási kockázatok állnak fenn. A szolgáltatások korlátozott területeken nem lehetnek elérhetők.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Tiltott felhasználás</h2>
    <p>Nem visszaélhet a weboldallal, beleértve a törvények megsértését, jogok megsértését, káros tartalom terjesztését vagy automatizált rendszerek használatát. Szabálysértés esetén korlátozhatjuk a hozzáférést.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Szellemi tulajdon</h2>
    <p>Minden tartalom, védjegy és anyag a mienk vagy harmadik felek tulajdona. A weboldalt csak személyes célokra használhatja, és nem másolhatja vagy módosíthatja a tartalmat.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Felelősség</h2>
    <p>A weboldalt és a szolgáltatásokat "jelenlegi állapotukban" biztosítjuk. Nem vagyunk felelősek a weboldal használatából eredő hibákért, veszteségekért vagy károkért.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Harmadik féltől származó szolgáltatások</h2>
    <p>Harmadik féltől származó tartalmakat vagy linkeket jeleníthetünk meg. Nem vagyunk felelősek azok pontosságáért vagy szolgáltatásaiért. Ellenőrizze az információkat, mielőtt döntést hozna.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Linkek</h2>
    <p>A külső weboldalakra mutató linkeket csak szolgáltatásként biztosítjuk. Nem támogatjuk vagy ellenőrizzük ezeket, és nem vagyunk felelősek azok tartalmáért.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">9. Egyéb rendelkezések</h2>
    <p>Bármikor frissíthetjük vagy módosíthatjuk a szolgáltatásokat és a feltételeket. Ezek a feltételek alkotják az Ön és köztünk létrejött teljes megállapodást. A jogok érvényesítésének elmulasztása nem jelenti azok feladását.</p>
  </div>
</div>
      </div>
    </main>
