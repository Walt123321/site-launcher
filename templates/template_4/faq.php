...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="faq.php" data-active><?= $mobnav_faq ?></a>
    </li>
  </ul>
</nav>
    ...
    <main class="flex grow flex-col overflow-hidden">
      ...
      <div class="pt-5">
        <div class="container-base">
          ...
          >
<a href="<?= $site_url ?>" class="breadcrumb-item"><?= $faq_page_breadcrumb_home ?></a>
<span class="breadcrumb-item"><?= $faq_page_breadcrumb_current ?></span>
          </nav>
        </div>
      </div>
      <!-- contact -->
