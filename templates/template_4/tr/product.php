...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Ürün | <?= $site_name ?></title>
    <meta name="description" content="Analiz ve otomasyonla kripto ve varlık yönetimi araçları." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/tr/">Ana Sayfa</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="product.php" data-active>Ürün</a>
    </li>
    <li>
...
<div class="pt-5">
  <div class="container-base">
    ...
    >
      <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/tr/" class="breadcrumb-item">Ana Sayfa</a>
      <span class="breadcrumb-item">Ürün</span>
    </nav>
  </div>
</div>
      <!-- analytics -->
  ...
  <div class="container-base grid gap-6 lg:grid-cols-2">
    ...
    >
      <h1 class="relative z-20">Dijital analiz <?= $site_name ?> ™</h1>
      <p class="relative z-20">
        Gelişmiş analiz platformumuzla değerli içgörüler edinin ve büyümeyi hızlandırın. Veriye dayalı bilinçli kararlar alın. Stratejinizi iyileştirin ve ölçülebilir sonuçlar elde edin.
      </p>
    </div>
    <div class="relative grid min-h-[230px] content-end">
      ...
      <div class="relative z-20 grid grid-cols-2 gap-3 md:gap-6">
        <a class="btn btn-black col-span-full" href="sign.php">Kayıt Ol</a>
  ...
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
      ...
      <div class="grid grid-cols-2 gap-x-8 gap-y-6">
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Sermaye piyasası</p>
            <p>Her şey tek tıkla</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">İstatistikler</p>
            <p>Tüm verilerinize erişin</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
          ...
          <div class="grid gap-2 md:gap-3">
            <p class="h3">Mobil görünüm</p>
            <p>Telefondan erişim</p>
          </div>
        </div>
        <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
          <div class="w-20 sm:w-[104px]">
    ...
    <div class="flex items-center justify-center">
      <img
        ...
        alt="Portföy takibi mobil arayüzü"
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Portföy</p>
          <p>Burada etkileyici projeler ve yaratıcı çözümlerle profesyonel kariyerimi sergiliyorum.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Kripto satın alın</p>
          <p>Kripto satın almak için güvenli ve basit platform. Minimum ücretlerle hızlı işlemler. Bugün işlem yapmaya başlayın.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Kripto analizi</p>
          <p>Bilinçli yatırım ve iş kararları için piyasa değerleri ve trendleri hakkında daha fazla bilgi edinin.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div class="border-primary inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[5px] border md:h-[60px] md:w-[60px] md:rounded-[10px]">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Kripto varlıklar</p>
          <p>Önde gelen kripto paralarla finansın geleceğini keşfedin. Keşfedin, yatırım yapın, büyüyün.</p>
        </div>
      </div>
    </div>
  </div>
...
<p class="h2">Hadi başlayalım!</p>
<p>
  <?= $site_name ?> ile kripto dünyasını keşfedin. Türk traderlar inovasyon, verimlilik ve kâr fırsatlarını birleştiren bir platforma erişebilir.
</p>
          </div>
        ...
        <div class="grid gap-5">
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p>Güvenilir trading ortağınız</p>
