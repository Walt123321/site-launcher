...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Gizlilik Politikası | <?= $site_name ?></title>
    <meta name="description" content="<?= $site_name ?>nin verilerinizi nasıl topladığını ve koruduğunu öğrenin." />
    <!-- Favicon -->
...
<div class="grid gap-6 md:gap-8">
  ...
  <div class="grid gap-2">
    <p class="text-sm">Son güncelleme: <?= $privacy_last_update ?></p>
    <p>Biz («Biz») gizliliğinize saygı duyuyor ve kişisel verilerinizi korumaya kararlıyız. Bu politika, <?= $site_name ?>nin bilgilerinizi nasıl topladığını, kullandığını ve koruduğunu açıklar.</p>
  </div>
  <!-- PRINCIPLES -->
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Şeffaflık</p>
    <p>
      Verilerinizin nasıl kullanıldığını açıkça açıklıyoruz. Bize şu adresten ulaşın: 
      <a href="mailto:info@<?= $site_domain ?>">info@<?= $site_domain ?></a>
    </p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Veri kullanımı</p>
    <p>Verileriniz hizmet sunmak, platformu iyileştirmek ve yasal yükümlülükleri yerine getirmek için kullanılır.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Haklarınız</p>
    <p>Verilerinize erişim, düzeltme veya silme talebinde istediğiniz zaman bulunabilirsiniz.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Güvenlik</p>
    <p>Verilerinizi koruyoruz ancak mutlak güvenlik garanti edemeyiz.</p>
  </div>
  <!-- SECTIONS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Veri toplama</h2>
    <p>Kullanım verileri (IP, cihaz, tarayıcı) ve sağladığınız tüm verileri topluyoruz.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Hukuki dayanak</h2>
    <p>İşleme rıza, meşru menfaat ve yasal yükümlülüklere dayanır.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Veri paylaşımı</h2>
    <p>Gerekirse verileri ortaklar, sağlayıcılar ve yetkililerle paylaşabiliriz.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Çerezler</h2>
    <p>İşlevsellik ve analiz için çerez kullanıyoruz. Devre dışı bırakabilirsiniz.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Veri saklama</h2>
    <p>Veriler yalnızca gerekli olduğu sürece saklanır.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Uluslararası aktarımlar</h2>
    <p>Veriler uygun güvencelerle aktarılabilir.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Üçüncü taraf bağlantıları</h2>
    <p>Harici web sitelerinden sorumlu değiliz.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Güncellemeler</h2>
    <p>Bu politika güncellenebilir.</p>
  </div>
  <!-- RIGHTS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">Haklarınız</h2>
    <p>Verilerinize erişim, düzeltme, silme, kısıtlama veya aktarma, rızayı geri çekme ve şikâyet hakkınız vardır.</p>
  </div>
</div>
          </div>
        </div>
