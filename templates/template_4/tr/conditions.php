...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Kullanım Koşulları | <?= $site_name ?></title>
    <meta name="description" content="<?= $site_name ?> kullanım koşullarını okuyun." />
    <meta charset="UTF-8" />
  ...
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <div class="grid gap-5 md:gap-7">
        <nav aria-label="breadcrumb" class="flex flex-wrap items-center text-sm text-gray-500 md:text-lg">
            ...
            <span class="breadcrumb-item">Kullanım Koşulları</span>
        </nav>
        <h1>Kullanım Koşulları</h1>
    </div>
<div class="grid gap-6 md:gap-8">
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Genel</h2>
    <p>Bu web sitesi üçüncü taraf trading platformları ve ilgili hizmetler hakkında bilgi sağlar. Siteyi kullanarak bu Koşulları ve Gizlilik Politikamızı kabul etmiş olursunuz. Koşullar her zaman güncellenebilir.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Uygunluk</h2>
    <p>En az 18 yaşında olmalı, bu Koşulları kabul edebilmeli ve yerel yasalarla kısıtlanmamış olmalısınız. Sitenin yasadışı kullanımından sorumlu değiliz.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Kısıtlı erişim</h2>
    <p>Belirli bölgelerdeki kullanıcıların veya yasal/düzenleyici risklerin geçerli olduğu durumlarda erişimi kısıtlayabiliriz. Hizmetler kısıtlı konumlarda kullanılamayabilir.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Yasak kullanım</h2>
    <p>Siteyi kötüye kullanmamalısınız; yasaları ihlal, hakları ihlal, zararlı içerik yayma veya otomatik sistem kullanma dahil. Koşullar ihlal edilirse erişimi kısıtlayabiliriz.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Fikri mülkiyet</h2>
    <p>Tüm içerik, markalar ve materyaller bize veya üçüncü taraflara aittir. Siteyi yalnızca kişisel kullanım için kullanabilirsiniz; içerik kopyalanamaz veya değiştirilemez.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Sorumluluk</h2>
    <p>Site ve hizmetler «olduğu gibi» sunulur. Sitenin kullanımından kaynaklanan hatalar, kayıplar veya zararlardan sorumlu değiliz.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Üçüncü taraf hizmetleri</h2>
    <p>Üçüncü taraf içerik veya bağlantılar gösterebiliriz. Doğruluk veya hizmetlerinden sorumlu değiliz. Karar vermeden önce bilgiyi doğrulayın.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Bağlantılar</h2>
    <p>Harici sitelere bağlantılar yalnızca kolaylık için sağlanır. Onaylamaz veya kontrol etmeyiz; içeriklerinden sorumlu değiliz.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">9. Çeşitli</h2>
    <p>Hizmetleri ve Koşulları istediğimiz zaman güncelleyebilir veya değiştirebiliriz. Bu Koşullar sizinle aramızdaki tüm anlaşmayı oluşturur. Kullanılmayan haklar feragat sayılmaz.</p>
  </div>
</div>
      </div>
    </main>
