...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>SSS | <?= $site_name ?></title>
    <meta name="description" content="Trading, özellikler, güvenlik ve ücretler hakkında yanıtlar." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="faq.php" data-active>SSS</a>
    </li>
  </ul>
</nav>
