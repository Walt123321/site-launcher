...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <meta name="description" content="İşlem ihtiyaçlarınıza uygun <?= $site_name ?> planı seçin." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="offer.php" data-active>Teklif</a>
    </li>
    <li>
...
<span class="breadcrumb-item">Teklif</span>
          </nav>
        </div>
      </div>
      <!-- tracker -->
      <div class="py-8 md:py-10">
        <div class="container-base grid gap-6 lg:grid-cols-2">
          ...
          >
 <h1 class="relative z-20">Portfolio Tracker edinin</h1>
<p class="relative z-20">
  Dakikalar içinde başlayın: kayıt olun, yatırın ve sadece 5 dakikada işlem yapmaya başlayın. Hemen başlayın.
</p>
          </div>
