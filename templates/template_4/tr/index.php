...
?>
<!DOCTYPE html>
<html class="scroll-smooth" lang="tr" data-theme="orange">
<!-- head -->
<head>
  ...
  "itemListElement": [
    {
      ...
      "position": 1,
      "name": "<?= $site_name ?>",
      "item": "<?= $site_url ?>/lander/<?= $site_domain ?>/tr/"
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 <?= $site_name ?> 💸",
      "item": "<?= $site_url ?>/lander/<?= $site_domain ?>/tr/#heading-style-h1"
    }
  ]
}
</script>
<script type="application/ld+json">
{
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css" />
    <title><?= $site_name ?> | Yapay zeka destekli trading platformu</title>
    <meta name="description" content="<?= $site_name ?> ⭐ — gerçek zamanlı piyasa analizi ve net işlem sinyalleri için akıllı yapay zeka trading platformu ⚡ Akıllı araçları ve rehberli içgörüleri deneyin." />
        ...
        "mainEntity": [
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Birkaç dakika içinde hazır olabilirsiniz. Temel bilgilerle hesap oluşturun, kısa doğrulama adımını tamamlayın ve en az <?= $app_price ?> <?= $app_currency ?> yatırın. Ardından tüm platformun kilidini açarsınız — canlı grafikler, işlem araçları ve güvenle başlamanıza yardımcı özellikler."
            }
          },
          {
            "@type": "Question",
            "name": "Param ve verilerim güvende mi? <?= $site_name ?> güvenilir mi?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Kesinlikle. Hesabınızı gelişmiş SSL şifreleme, 2FA doğrulama ve fonlar için güvenli soğuk depolama ile koruyoruz. İşlemler güvenilir sağlayıcılar üzerinden işlenir ve kişisel veriler katı güvenlik politikalarına göre yönetilir. Güvenlik ve güvenilirlik platformun her yerine entegre edilmiştir."
            }
          },
          {
            "@type": "Question",
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Çekimler hesap panelinizden istediğiniz zaman talep edilebilir. İşlem genellikle seçilen yönteme bağlı olarak 1–3 iş günü sürer. Geçerli ücretleri ve süreleri her zaman önceden görürsünüz — sürpriz yok."
            }
          },
          {
            "@type": "Question",
            "name": "Bu platformun bana uygun olup olmadığını nasıl anlarım?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "En iyi yol kendiniz denemektir. Minimum depozitoyla başlayın ve özellikleri adım adım keşfedin. Platform yeni başlayanlar için tasarlanmışken güçlü araçlar da sunar; gerektiğinde 7/24 destek vardır. Kontrol her zaman sizde kalır."
            }
          },
          {
            "@type": "Question",
            "name": "Başlamak için trading deneyimi gerekir mi?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Hiç değil. Her şey ilk günden erişilebilir olacak şekilde tasarlandı — onboarding, basit eğitimler ve yapay zeka destekli araçlarla. Yeni başlıyor olsanız da deneyiminiz olsun da kendi hızınızda ilerleyebilirsiniz; destek her zaman hazırdır."
            }
          }
        ]
      }
  ...
  <header class="relative z-50 pt-3.5 md:pt-6">
    <div class="container-base">
      <div
        ...
        <a class="font-special inline-flex max-w-60 gap-1.5 text-xl leading-none uppercase header-nav-logo" href="<?= $site_url ?>/lander/<?= $site_domain ?>/tr/">
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/tr/" data-active>Ana Sayfa</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="product.php">Ürün</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="offer.php">Teklif</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="contacts.php">İletişim</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="faq.php">SSS</a>
    </li>
  </ul>
</nav>
    ...
    <nav class="mobile-menu" data-mobile-menu>
      <ul class="flex flex-col flex-wrap items-center justify-center gap-y-8">
        <li>
          <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/tr/">Ana Sayfa</a>
        </li>
        <li>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h1><?= $site_name ?></h1>
            <p>Gelişmiş kripto işlem platformumuzla yeni bir trading çağına adım atın. <?= $site_name ?> yapay zeka teknolojisiyle getirilerinizi optimize edebilir ve bilinçli yatırım kararları alabilirsiniz.</p>
        </div>
        <form name="form" method="post"
          ...
          <input type="hidden" name="only_countries" value='["tr"]'>
          ...
          <div class="grid gap-6">
            <div class="grid gap-2 md:gap-3.5">
              <label class="grid gap-1.5">
                <span class="label text-white">Ad</span>
                <input class="input" type="text" name="fname" placeholder="Adınızı girin" required />
              </label>
              <label class="grid gap-1.5">
                <span class="label text-white">Soyad</span>
                <input class="input" type="text" name="lname" placeholder="Soyadınızı girin" required />
              </label>
              <label class="grid gap-1.5">
                <span class="label text-white">E-posta</span>
                <input class="input" type="email" name="email" placeholder="E-posta adresinizi girin" required />
              </label>
              <label class="grid gap-1.5">
            ...
            <div class="grid gap-3">
              ...
              <p class="text-xs text-white">
                Kişisel bilgilerinizi girerek ve düğmeye tıklayarak
                <a class="link-underline" href="privacy.php">Gizlilik Politikasını</a>
                ve
                <a class="link-underline" href="conditions.php">Kullanım Koşullarını</a>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-3 md:grid-cols-2 md:gap-6 xl:grid-cols-4">
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      ...
      <p class="h3">Kullanılabilir para birimi</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">42m</p>
      <p class="h3">Doğrulanmış kullanıcı</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 max-lg:order-2 md:gap-10">
      <h2>Neden <?= $site_name ?>?</h2>
      <p class="md:text-lg">
        Modern kripto traderların güvendiği bu platform yeni bir standart belirliyor. Güçlü güvenlik, tam şeffaflık, gelişmiş algoritmalar ve sorunsuz bir arayüzü bir araya getirerek güvenle işlem yapmanız ve başarılı olmanız için ihtiyacınız olan her şeyi sunuyoruz.
      </p>
        ...
        <div class="grid grid-cols-2 gap-x-8 gap-y-6 max-sm:flex">
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Güvenebileceğiniz güvenlik</p>
              <p>Verileriniz ve yatırımlarınız için her adımda üst düzey koruma.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Kişiselleştirilmiş deneyim</p>
              <p>İşlem stratejilerinizi benzersiz hedeflerinize ve tarzınıza göre uyarlayın.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Akıllı yapay zeka stratejileri</p>
              <p>Güvenle karar vermenize yardımcı olan doğru trading içgörüleri.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Otomatik işlem</p>
              <p>Verimli ve kâr odaklı işlemler için 7/24 çalışan yapay zeka destekli botlar.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Kolay arayüz</p>
              <p>Tradingi en baştan kolaylaştıran temiz ve sezgisel tasarım.</p>
            </div>
          </div>
        </div>
      </div>
      <p class="h3">
        Finansal deneyiminizi <?= $site_name ?> ™ ile dönüştürün.
      </p>
      <a class="btn btn-black" href="sign.php">Kayıt Ol</a>
    </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Verimli trading!</h2>
      <p class="text-lg">
        Bitcoin, Ethereum ve Dogecoin gibi kripto paralarla kolaylıkla ve güvenle işlem yapın.
      </p>
      <a class="btn btn-black max-md:hidden" href="sign.php">Başlayın</a>
    </div>
    <div class="grid gap-3 md:gap-6" data-trading></div>
    <a class="btn btn-black md:hidden" href="sign.php">Başlayın</a>
  </div>
</div>
<section class="feature-section">
  <div class="container">
    <div class="feature-header">
      <h2>
        Ölçek için tasarlanmış <span>küresel trading platformu</span>
      </h2>
      <p>
        Performans, hassasiyet ve küresel güvenilirlik için tasarlanmış birleşik altyapı üzerinden birden fazla finans piyasasına erişin.
      </p>
    </div>
    <div class="feature-grid">
      <div class="feature-card">
        ...
        <p>
          Platform değiştirmeden tek entegre ortamdan kripto, forex, hisse ve emtia işlemleri yapın.
        </p>
      </div>
      <div class="feature-card featured">
        ...
        <h3>Hızlı işlem</h3>
        <p>
          Optimize altyapı, küresel piyasalarda minimum gecikme ve istikrarlı emir gerçekleştirme sağlar.
        </p>
      </div>
      <div class="feature-card">
        <div class="accent"></div>
        ...
        <p>
          Canlı veriler, gelişmiş göstergeler ve piyasa içgörüleri daha hızlı tepki vermenize ve daha bilinçli kararlar almanıza yardımcı olur.
        </p>
      </div>
    </div>
  </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10">
    <div class="grid items-center gap-6 lg:grid-cols-2">
      <h2><?= $site_name ?> nasıl çalışır: hızlı başlangıç rehberiniz</h2>
      <p class="rounded-custom sm:border sm:p-8">
        Platformumuzda kripto yolculuğunuza zahmetsizce başlayın. Hızlı kayıttan ilk yatırıma ve ilk işleme kadar adım adım rehberlik ediyoruz.
      </p>
    </div>
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Dakikalar içinde kayıt olun, bilgilerinizi doldurun ve resmi platforma güvenli erişim elde edin.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Erişiminizi onaylayın</p>
          <p>E-postanızı doğrulayın ve hemen işlem yapmaya başlamak için tam erişimi açın.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3"><?= $site_name ?> girişi</p>
          <p>Minimum <?= $app_price ?> <?= $app_currency ?> yatırımla işlem hesabınızı açın. Daha yüksek yatırımlar potansiyel getiriyi artırabilir ancak riski de yükseltir.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Hesabınıza para yatırın</p>
          <p>Tercih ettiğiniz yöntemi seçin — banka havalesi, e-cüzdan veya kredi kartı — ve hemen başlayın.*</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          ...
          <p>Hesabınızı hedeflerinize göre ayarlayın. Risk seviyenizi, işlem tercihlerinizi belirleyin ve stratejinizi yapılandırın. Uzman brokerlarımız yanınızda — otomatik veya manuel, karar sizin.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">İşlem yapmaya başlayın</p>
          <p>Her şey hazır. Güvenle kripto piyasasına girin ve bugün yeni fırsatları keşfedin.</p>
        </div>
      </div>
    </div>
    <div class="grid gap-6 md:grid-cols-2">
      <a class="btn btn-black" href="sign.php">İşlem yapmaya başlayın</a>
    </div>
  </div>
</div>
    <!-- payments -->
    <div class="py-8 md:py-10">
      <div class="container-base grid items-center gap-6 lg:grid-cols-2">
        <p class="text-lg">
          <?= $site_name ?> dünya genelinde çeşitli ödeme yöntemlerini kabul eder.
        </p>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
    <div class="flex items-center justify-between gap-6 mb-6 reviews-flex-block">
      <h2 class="text-2xl font-bold"><?= $site_name ?> ™ yorumları</h2>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
            <p>
              <?= $site_name ?> beni hoş şekilde şaşırttı. Kayıt hızlıydı, ücretler net ve destek ekibi gerçekten yanıt veriyor ve yardımcı oluyor. Tüm deneyim akıcı ve güvenilir — kesinlikle kalmak istediğim bir platform.
            </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Özel yatırımcı') ?></div>
              <p class="font-bold">Özel yatırımcı</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Sonunda kriptoyu denedim ve <?= $site_name ?> seçtim — şimdilik pişman değilim. Başlamak sadece birkaç dakika sürdü ve her şey açıkça anlatıldı. Özellikle tradinge yeniyseniz sağlam bir seçenek gibi görünüyor.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Bağımsız trader') ?></div>
              <p class="font-bold">Bağımsız trader</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  <?= $site_name ?> istikrarlı ve güvenilir bir platform gibi hissettiriyor. Hesap kurulumu kolaydı, koşullar anlaşılır ve destek ne yaptığını biliyor. Burada işlem yapmak şaşırtıcı derecede rahat bir deneyimdi.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Dijital varlık traderı') ?></div>
              <p class="font-bold">Dijital varlık traderı</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  <?= $site_name ?> ile kripto trading artık bunaltıcı değil. Kayıt basitti, ücretler şeffaf ve ihtiyaç duyduğunuzda destek var. Yeni başlayan biri olarak bu gerçekten fark yaratıyor.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials('Pasif gelir arayan') ?></div>
              <p class="font-bold">Pasif gelir arayan</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
      <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Nasıl başlarım?</span>
        ...
        <div id="content-1" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Birkaç dakika içinde hazır olabilirsiniz. Temel bilgilerle hesap oluşturun, kısa doğrulama adımını tamamlayın ve en az <?= $app_price ?> <?= $app_currency ?> yatırın. Ardından tüm platformun kilidini açarsınız — canlı grafikler, işlem araçları ve güvenle başlamanıza yardımcı özellikler.</p>
          </div>
        </div>
      </div>
      <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Param ve verilerim güvende mi? <?= $site_name ?> güvenilir mi?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-2" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Kesinlikle. Hesabınızı gelişmiş SSL şifreleme, 2FA doğrulama ve fonlar için güvenli soğuk depolama ile koruyoruz. İşlemler güvenilir sağlayıcılar üzerinden işlenir ve kişisel veriler katı güvenlik politikalarına göre yönetilir. Güvenlik ve güvenilirlik platformun her yerine entegre edilmiştir.</p>
          </div>
        </div>
      </div>
      <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Kârımı ne zaman çekebilirim?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-3" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Çekimler hesap panelinizden istediğiniz zaman talep edilebilir. İşlem genellikle seçilen yönteme bağlı olarak 1–3 iş günü sürer. Geçerli ücretleri ve süreleri her zaman önceden görürsünüz — sürpriz yok.</p>
          </div>
        </div>
      </div>
      <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Bu platformun bana uygun olup olmadığını nasıl anlarım?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-4" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>En iyi yol kendiniz denemektir. Minimum depozitoyla başlayın ve özellikleri adım adım keşfedin. Platform yeni başlayanlar için tasarlanmışken güçlü araçlar da sunar; gerektiğinde 7/24 destek vardır. Kontrol her zaman sizde kalır.</p>
          </div>
        </div>
      </div>
      <div id="accordion-5" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Başlamak için trading deneyimi gerekir mi?</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-5" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Hiç değil. Her şey ilk günden erişilebilir olacak şekilde tasarlandı — onboarding, basit eğitimler ve yapay zeka destekli araçlarla. Yeni başlıyor olsanız da deneyiminiz olsun da kendi hızınızda ilerleyebilirsiniz; destek her zaman hazırdır.</p>
          </div>
        </div>
      </div>
      <div id="accordion-6" class="group border-primary rounded-custom border transition-all">
        ...
        <div id="content-6" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p style="margin-bottom:16px;"><?= $site_name ?>, tutarlı performans, hızlı işlem ve işlem ortamı üzerinde tam kontrol bekleyen kullanıcılar için oluşturulmuş küresel bir trading platformudur. Birden fazla bağlantısız araç veya bölgesel hizmet yerine, tüm temel işlevlerin tek bir iş akışına entegre edildiği yapılandırılmış bir sistem sunar.</p>
            <p style="margin-bottom:16px;">Piyasa erişiminden emir gerçekleştirmeye ve analize kadar her bileşen gereksiz sürtünme olmadan birlikte çalışacak şekilde tasarlanmıştır. Kullanıcılar karmaşık sistemler veya platform değişiklikleri yerine karar vermeye odaklanabilir.</p>
            <p style="margin-bottom:10px; font-weight:500;">Tek bir arayüzde kullanıcılar birden fazla finans piyasasında işlem yapabilir:</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Büyük ve yeni dijital varlıklar dahil kripto paralar</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Gerçek zamanlı fiyatlandırmalı döviz piyasaları</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Küresel hisse senetleri ve borsa araçları</li>
              <li><span style="color:#6D5DF6;">•</span> Daha geniş portföy çeşitlendirmesi için emtialar</li>
            </ul>
            <p style="margin-bottom:16px;">Performans platformun temel önceliğidir. Altyapı, yüksek piyasa aktivitesi dönemlerinde bile düşük gecikmeli işlem ve istikrarlı çalışma için optimize edilmiştir.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Tüm piyasalarda hızlı ve tutarlı emir gerçekleştirme</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Sürekli gerçek zamanlı veri ve fiyat güncellemeleri</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Entegre analitik araçlar ve piyasa göstergeleri</li>
              <li><span style="color:#6D5DF6;">•</span> Manuel ve otomatik stratejiler için destek</li>
            </ul>
            <p style="margin-bottom:16px;">Güvenlik ve operasyonel güvenilirlik sistemin her katmanına entegre edilmiştir. Platform sektör standartlarını izler ve kullanıcı verileri ile finansal işlemlerin korunması için iç önlemler uygular.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Tüm etkileşimlerde şifreli veri iletimi</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Çok katmanlı hesap doğrulama ve kimlik doğrulama</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Doğrulanmış işlem işleme ve izleme sistemleri</li>
              <li><span style="color:#6D5DF6;">•</span> İstikrarlı küresel erişim için tasarlanmış altyapı</li>
            </ul>
            <p style="margin-bottom:16px;">Aynı zamanda kullanılabilirlik önemli bir odak noktasıdır. Arayüz kasıtlı olarak sade ve öngörülebilir tasarlanmıştır; gereksiz karmaşıklığı azaltarak işlem stratejilerine odaklanmanızı sağlar.</p>
            <p style="margin-bottom:16px;">Performans ile sadelik arasındaki bu denge, platformu hem yeni hem de deneyimli traderlar için uygun kılar.</p>
            <p><?= $site_name ?>, ölçeklenebilirlik, güvenilirlik ve verimliliği tek bir ortamda birleştirerek küresel finans piyasalarına güvenle yapılandırılmış ve güvenilir erişim sunar.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h2>Bu, resmi platformla trading™</h2>
          <p>
            Bireylerin ve işletmelerin kripto para satın alması, satması ve yönetmesi için güvenilir platformuz.
          </p>
        </div>
        <form name="form" method="post"
          class="leadform rf-form js-rf-form group bg-primary rounded-custom relative overflow-hidden px-4 py-8 md:px-8" action="../integration/send.php" data-form>
  ...
  <section style="padding:60px 0;" class="md:!py-[100px]">
    ...
    ">
      ...
      ">
        ...
        ">
          <span style='color:#6B5FA7;'><?= $site_name ?> trading platformunun</span> temel yetenekleri
        </h2>
      <p style="margin-top:14px;color:#6b7280;font-size:17px;">
        Daha akıllı, daha hızlı ve güvenle işlem yapmak için ihtiyacınız olan her şey.
      </p>
    </div>
    <div style="
      border-radius:16px;
    ...
    ">
      ...
      " onmouseover="this.style.background='#f9f9fb'" class="row-block" onmouseout="this.style.background='transparent'">
        ...
        <div class="row-text" style="color:#6b7280;">
          Gelişmiş yapay zeka destekli işlem motoru
        </div>
      </div>
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Kredi kartları, banka havaleleri, PayPal
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Forex, hisse, kripto, emtia ve daha fazlası
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
  ...
  <div class="border-primary-light grid justify-items-center gap-6 rounded-[20px] border px-4 py-5 md:gap-4 md:px-8 md:py-6 text-center md:text-left">
    ...
    <div class="flex flex-wrap items-center justify-center md:justify-start gap-2.5 text-center md:text-left">
      ...
      <span class="leading-none text-amber-500" role="img"
        aria-label="<?= $rating_value ?> 5 üzerinden puan">
        <?= $stars ?>
      </span>
      <span class="flex flex-wrap justify-center md:justify-start gap-1 text-sm text-gray-400">
        <span>
          <strong>318</strong> yorum ·
        </span>
        <span>
          Dayanak <strong><?= $rating_count ?></strong> değerlendirme ·
        </span>
        <span>
          5 üzerinden puan
        </span>
    ...
    <p class="text-center md:text-left">
      Güçlü otomasyon ve kapsamlı eğitim kaynaklarıyla güçlü ve kullanıcı dostu bir trading platformu.
    </p>
  </div>
</div>
      </div>
        ...
        <div class="grid gap-5">
          <nav class="flex flex-col flex-wrap justify-between gap-x-10 gap-y-5 text-white md:flex-row">
            <a class="font-special inline-flex max-w-60 gap-1.5 text-xl leading-none text-white uppercase max-md:pr-[120px] footer-nav-logo"
              href="<?= $site_url ?>/lander/<?= $site_domain ?>/tr/">
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p style="color:#6B5FA7;">Güvenilir trading ortağınız</p>
  ...
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ja/" hreflang="ja" title="日本語">
    🇯🇵
        ...
        <div class="grid gap-2.5 text-sm text-gray-500">
            <p>
                <?= $site_name ?>, bu web sitesinde sunulan bilgilerin (eğitim içeriği, fiyat teklifleri, grafikler ve analizler dahil) kullanımından kaynaklanabilecek kayıp veya zararlardan sorumlu değildir. Finans piyasalarında işlem risk içerir; başlamadan önce kişisel durumunuzu değerlendirmeniz ve gerekirse nitelikli bir uzmandan görüş almanız önemlidir. Yalnızca kaybetmeyi göze alabileceğiniz parayı yatırın; FX, CFD ve kripto paraların herkes için uygun olmayabileceğini unutmayın.
            </p>
        </div>
        <div class="text-center text-white">
          Copyright 2026 © <?= $site_name ?>, Tüm hakları saklıdır
        </div>
      </div>
    </div>
  </footer>
