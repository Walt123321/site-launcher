...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Επικοινωνία | <?= $site_name ?></title>
    <meta name="description" content="Επικοινωνήστε με την υποστήριξη του <?= $site_name ?> ή με την ομάδα πωλήσεών μας." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="contacts.php" data-active>Επικοινωνήστε μαζί μας</a>
    </li>
    <li>
      ...
      <div class="pt-5">
        <div class="container-base">
          ...
          >
            ...
            <span class="breadcrumb-item">Επικοινωνήστε μαζί μας</span>
          </nav>
        </div>
      </div>
      <!-- contact -->
...
<div class="grid gap-4 text-center md:gap-6">
  <h3>Εάν έχετε περαιτέρω ερωτήσεις, επικοινωνήστε μαζί μας μέσω email</h3>
</div>
            <a
