...
?>
<!DOCTYPE html>
<html class="scroll-smooth" lang="el" data-theme="orange">
<!-- head -->
<head>
  ...
  "itemListElement": [
    {
      ...
      "position": 1,
      "name": "<?= $site_name ?>",
      "item": "<?= $site_url ?>/lander/<?= $site_domain ?>/el/"
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 <?= $site_name ?> 💸",
      "item": "<?= $site_url ?>/lander/<?= $site_domain ?>/el/#heading-style-h1"
    }
  ]
}
</script>
<script type="application/ld+json">
{
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css" />
    <title><?= $site_name ?> | Πλατφόρμα Συναλλαγών AI</title>
    <meta name="description" content="<?= $site_name ?> ⭐ — Έξυπνη πλατφόρμα συναλλαγών AI για ανάλυση αγοράς σε πραγματικό χρόνο και ξεκάθαρα σήματα συναλλαγών ⚡ Δοκιμάστε έξυπνα εργαλεία και καθοδηγούμενες πληροφορίες." />
        ...
        "mainEntity": [
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Μπορείτε να είστε έτοιμοι μέσα σε λίγα λεπτά. Δημιουργήστε λογαριασμό με τα βασικά σας στοιχεία, ολοκληρώστε το σύντομο βήμα επαλήθευσης και καταθέστε τουλάχιστον <?= $app_price ?> <?= $app_currency ?>. Στη συνέχεια ξεκλειδώνεται ολόκληρη η πλατφόρμα για εσάς — συμπεριλαμβανομένων γραφημάτων σε πραγματικό χρόνο, εργαλείων συναλλαγών και λειτουργιών που σας βοηθούν να ξεκινήσετε με αυτοπεποίθηση."
            }
          },
          {
            "@type": "Question",
            "name": "Είναι ασφαλή τα χρήματα και τα δεδομένα μου; Είναι αξιόπιστη η <?= $site_name ?>;",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Απολύτως. Προστατεύουμε τον λογαριασμό σας με προηγμένη κρυπτογράφηση SSL, έλεγχο ταυτότητας δύο παραγόντων (2FA) και ασφαλή αποθήκευση κεφαλαίων τύπου cold storage. Οι συναλλαγές διεκπεραιώνονται μέσω αξιόπιστων παρόχων και τα προσωπικά σας δεδομένα αντιμετωπίζονται σύμφωνα με αυστηρές πολιτικές ασφαλείας. Η ασφάλεια και η αξιοπιστία είναι εδραιωμένες σε κάθε τμήμα της πλατφόρμας."
            }
          },
          {
            "@type": "Question",
            "name": "Πότε μπορώ να αποσύρω τα κέρδη μου;",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Μπορείτε να ζητήσετε ανάληψη οποιαδήποτε στιγμή μέσω του πίνακα ελέγχου σας. Η επεξεργασία διαρκεί συνήθως 1–3 εργάσιμες ημέρες, ανάλογα με τη μέθοδο που επιλέξατε. Τυχόν χρεώσεις και το χρονικό πλαίσιο εμφανίζονται πάντα εκ των προτέρων — χωρίς εκπλήξεις."
            }
          },
          {
            "@type": "Question",
            "name": "Πώς θα ξέρω αν αυτή η πλατφόρμα είναι κατάλληλη για εμένα;",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Ο καλύτερος τρόπος είναι να τη δοκιμάσετε μόνοι σας. Ξεκινήστε με την ελάχιστη κατάθεση και εξερευνήστε τις λειτουργίες βήμα προς βήμα. Η πλατφόρμα έχει σχεδιαστεί ώστε να είναι φιλική προς τους αρχάριους, προσφέροντας παράλληλα ισχυρά εργαλεία και υποστήριξη 24/7 που σας βοηθά ανά πάσα στιγμή. Διατηρείτε τον πλήρη έλεγχο."
            }
          },
          {
            "@type": "Question",
            "name": "Χρειάζομαι εμπειρία συναλλαγών για να ξεκινήσω;",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Καθόλου. Όλα είναι σχεδιασμένα ώστε να είναι προσβάσιμα από την πρώτη ημέρα — με καθοδηγούμενη εγγραφή, απλούς οδηγούς και εργαλεία με τεχνολογία AI που σας βοηθούν να προσανατολιστείτε στις συναλλαγές. Είτε ξεκινάτε τώρα είτε έχετε ήδη εμπειρία, μπορείτε να προχωρήσετε με τον δικό σας ρυθμό, με την υποστήριξη πάντα διαθέσιμη."
            }
          }
        ]
      }
  ...
  <header class="relative z-50 pt-3.5 md:pt-6">
    <div class="container-base">
      <div
        ...
        <a class="font-special inline-flex max-w-60 gap-1.5 text-xl leading-none uppercase header-nav-logo" href="<?= $site_url ?>/lander/<?= $site_domain ?>/el/">
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    <li>
      <a class="data-active:text-primary" href="<?= $site_url ?>/lander/<?= $site_domain ?>/el/" data-active>Αρχική</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="product.php">Προϊόν</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="offer.php">Προσφορά</a>
    </li>
    <li>
      <a class="data-active:text-primary" href="contacts.php">Επικοινωνήστε μαζί μας</a>
    </li>
    <li>
    ...
    <nav class="mobile-menu" data-mobile-menu>
      <ul class="flex flex-col flex-wrap items-center justify-center gap-y-8">
        <li>
          <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/el/">Αρχική</a>
        </li>
        <li>
      ...
      <a href="/team">Our team</a>
        ...
        <li>
          <a href="contacts.php">Επικοινωνήστε μαζί μας</a>
        </li>
        <li>
    ...
    <div class="py-8 md:py-10">
      <div class="container-base grid gap-6 lg:grid-cols-2">
        <div
          ...
          <h1><?= $site_name ?></h1>
            <p>Ζήστε μια νέα εποχή συναλλαγών με την προηγμένη πλατφόρμα συναλλαγών κρυπτονομισμάτων μας. Με την τεχνολογία AI της <?= $site_name ?> μπορείτε να βελτιστοποιήσετε τις αποδόσεις σας και να λαμβάνετε τεκμηριωμένες επενδυτικές αποφάσεις.</p>
        </div>
        <form name="form" method="post"
          ...
          <input type="hidden" name="phone_country" value="gr">
          <input type="hidden" name="only_countries" value='["gr"]'>
          ...
          <div class="grid gap-6">
            <div class="grid gap-2 md:gap-3.5">
              <label class="grid gap-1.5">
                <span class="label text-white">Όνομα</span>
                <input class="input" type="text" name="fname" placeholder="Εισαγάγετε το όνομά σας" required />
              </label>
              <label class="grid gap-1.5">
                <span class="label text-white">Επώνυμο</span>
                <input class="input" type="text" name="lname" placeholder="Εισαγάγετε το επώνυμό σας" required />
              </label>
              <label class="grid gap-1.5">
                <span class="label text-white">Email</span>
                <input class="input" type="email" name="email" placeholder="Εισαγάγετε τη διεύθυνση email σας" required />
              </label>
              <label class="grid gap-1.5">
                <span class="label text-white">Αριθμός τηλεφώνου</span>
            ...
            <div class="grid gap-3">
              ...
              <p class="text-xs text-white">
                Εισάγοντας τα προσωπικά σας στοιχεία και πατώντας το κουμπί, συμφωνείτε με την
                <a class="link-underline" href="privacy.php">Πολιτική Απορρήτου</a>
                και τους
                <a class="link-underline" href="conditions.php">Όρους Χρήσης</a>
                αυτού του ιστότοπου.
              </p>
            </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-3 md:grid-cols-2 md:gap-6 xl:grid-cols-4">
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">70+</p>
      <p class="h3">Διαθέσιμα νομίσματα</p>
    </div>
    <div class="rounded-custom grid content-start gap-5 border p-4 md:p-6">
      <p class="h2 lowercase">42 Mio.</p>
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-3 md:gap-6 lg:grid-cols-2">
    <div class="grid gap-6 max-lg:order-2 md:gap-10">
      <h2>Γιατί να επιλέξετε την <?= $site_name ?>;</h2>
      <p class="md:text-lg">
        Αυτή η πλατφόρμα, στην οποία εμπιστεύονται οι έμποροι κρυπτονομισμάτων, θέτει νέα πρότυπα. Συνδυάζουμε ισχυρή ασφάλεια, απόλυτη διαφάνεια, προηγμένους αλγορίθμους και ένα απρόσκοπτο περιβάλλον χρήσης, για να σας προσφέρουμε ό,τι χρειάζεστε για σίγουρες και επιτυχημένες συναλλαγές.
      </p>
        ...
        <div class="grid grid-cols-2 gap-x-8 gap-y-6 max-sm:flex">
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Ασφάλεια που μπορείτε να εμπιστευτείτε</p>
              <p>Κορυφαία προστασία για τα δεδομένα και τις επενδύσεις σας σε κάθε βήμα.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Εξατομικευμένη εμπειρία</p>
              <p>Προσαρμόστε τις στρατηγικές συναλλαγών σας στους μοναδικούς στόχους και το στυλ σας.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Έξυπνες στρατηγικές AI</p>
              <p>Ακριβείς αναλύσεις συναλλαγών που σας βοηθούν να παίρνετε σίγουρες αποφάσεις.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Αυτοματοποιημένες συναλλαγές</p>
              <p>Bots με τεχνητή νοημοσύνη λειτουργούν όλο το εικοσιτετράωρο για αποδοτικές συναλλαγές προσανατολισμένες στο κέρδος.</p>
            </div>
          </div>
          <div class="grid content-start gap-4 max-sm:w-[170px] max-sm:shrink-0 md:gap-6">
            <div class="w-20 sm:w-[104px]">
            ...
            <div class="grid gap-2 md:gap-3">
              <p class="h3">Εύχρηστο περιβάλλον</p>
              <p>Ένας ξεκάθαρος, διαισθητικός σχεδιασμός που διευκολύνει την είσοδο στις συναλλαγές από την αρχή.</p>
            </div>
          </div>
        </div>
      </div>
      <p class="h3">
        Μεταμορφώστε την οικονομική σας εμπειρία με την <?= $site_name ?> ™.
      </p>
      <a class="btn btn-black" href="sign.php">Εγγραφή</a>
    </div>
      <div class="flex items-center justify-center max-lg:order-1">
        <img 
          src="../assets/img/responsive/orange/phone-1-1280.avif"
...
<div class="py-8 md:py-10">
  <div class="container-base grid items-center gap-6 lg:grid-cols-2">
    <div class="grid gap-6 md:gap-10">
      <h2>Αποτελεσματικές συναλλαγές!</h2>
      <p class="text-lg">
        Κάντε συναλλαγές με ευκολία και εμπιστοσύνη σε κρυπτονομίσματα όπως το Bitcoin, το Ethereum και το Dogecoin.
      </p>
      <a class="btn btn-black max-md:hidden" href="sign.php">Ξεκινήστε</a>
    </div>
    <div class="grid gap-3 md:gap-6" data-trading></div>
    <a class="btn btn-black md:hidden" href="sign.php">Ξεκινήστε</a>
  </div>
</div>
<section class="feature-section">
  <div class="container">
    <div class="feature-header">
      <h2>
        Παγκόσμια πλατφόρμα συναλλαγών, <span>σχεδιασμένη για ανάπτυξη</span>
      </h2>
      <p>
        Αποκτήστε πρόσβαση σε πολλαπλές χρηματοοικονομικές αγορές μέσω μιας ενιαίας υποδομής σχεδιασμένης για απόδοση, ακρίβεια και παγκόσμια αξιοπιστία.
      </p>
    </div>
    <div class="feature-grid">
      <div class="feature-card">
        ...
        <p>
          Κάντε συναλλαγές σε κρυπτονομίσματα, forex, μετοχές και εμπορεύματα από ένα ενιαίο ολοκληρωμένο περιβάλλον, χωρίς να χρειάζεται να αλλάζετε πλατφόρμες.
        </p>
      </div>
      <div class="feature-card featured">
        <div class="accent"></div>
        <h3>Γρήγορη εκτέλεση</h3>
        <p>
          Η βελτιστοποιημένη υποδομή διασφαλίζει ελάχιστη καθυστέρηση και σταθερή εκτέλεση εντολών στις παγκόσμιες αγορές.
        </p>
      </div>
      <div class="feature-card">
        <div class="accent"></div>
        <h3>Αναλύσεις σε πραγματικό χρόνο</h3>
        <p>
          Ενημερωμένα δεδομένα, προηγμένοι δείκτες και αναλύσεις αγοράς σας βοηθούν να αντιδράτε γρηγορότερα και να λαμβάνετε πιο τεκμηριωμένες αποφάσεις συναλλαγών.
        </p>
      </div>
    </div>
  </div>
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10">
    <div class="grid items-center gap-6 lg:grid-cols-2">
      <h2>Πώς λειτουργεί η <?= $site_name ?>: Το γρήγορο σας ξεκίνημα</h2>
      <p class="rounded-custom sm:border sm:p-8">
        Ξεκινήστε το ταξίδι σας στις συναλλαγές κρυπτονομισμάτων χωρίς κόπο στην πλατφόρμα μας. Σας συνοδεύουμε βήμα προς βήμα — από τη γρήγορη εγγραφή, μέχρι την πρώτη σας κατάθεση και το άνοιγμα της πρώτης σας συναλλαγής.
      </p>
    </div>
    <div class="grid gap-6 lg:grid-cols-2">
      <div class="flex gap-3 md:gap-6">
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Δημιουργήστε λογαριασμό</p>
          <p>Εγγραφείτε μέσα σε λίγα λεπτά, καταχωρίστε τα στοιχεία σας και αποκτήστε ασφαλή πρόσβαση στην επίσημη πλατφόρμα.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Επιβεβαιώστε την πρόσβαση</p>
          <p>Επαληθεύστε τη διεύθυνση email σας για να ξεκλειδώσετε την πλήρη πρόσβαση και να αρχίσετε αμέσως τις συναλλαγές.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Συνδεθείτε στην <?= $site_name ?></p>
          <p>Ανοίξτε τον λογαριασμό συναλλαγών σας με ελάχιστη κατάθεση <?= $app_price ?> <?= $app_currency ?>. Μεγαλύτερες επενδύσεις μπορούν να αυξήσουν τις πιθανές αποδόσεις, αλλά ενέχουν και μεγαλύτερο κίνδυνο.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Χρηματοδοτήστε τον λογαριασμό</p>
          <p>Επιλέξτε τη μέθοδο που προτιμάτε — τραπεζικό έμβασμα, ηλεκτρονικό πορτοφόλι ή πιστωτική κάρτα — και ξεκινήστε αμέσως.*</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Ρυθμίστε τη στρατηγική σας</p>
          <p>Προσαρμόστε τον λογαριασμό σας στους στόχους σας. Καθορίστε το επίπεδο κινδύνου σας, ορίστε προτιμήσεις συναλλαγών και ρυθμίστε τη στρατηγική σας. Οι επαγγελματίες μεσίτες μας σας υποστηρίζουν — είτε αυτοματοποιημένα είτε χειροκίνητα, η επιλογή είναι δική σας.</p>
        </div>
      </div>
      <div class="flex gap-3 md:gap-6">
        <div
        ...
        <div class="grid content-start gap-2 md:gap-4">
          <p class="h3">Ξεκινήστε συναλλαγές</p>
          <p>Όλα είναι έτοιμα. Μπείτε στην αγορά κρυπτονομισμάτων με αυτοπεποίθηση και εξερευνήστε νέες ευκαιρίες σήμερα κιόλας.</p>
        </div>
      </div>
    </div>
    <div class="grid gap-6 md:grid-cols-2">
      <a class="btn btn-black" href="sign.php">Ξεκινήστε συναλλαγές</a>
    </div>
  </div>
</div>
    <!-- payments -->
    <div class="py-8 md:py-10">
      <div class="container-base grid items-center gap-6 lg:grid-cols-2">
        <p class="text-lg">
          Η <?= $site_name ?> δέχεται ένα ευρύ φάσμα μεθόδων πληρωμής παγκοσμίως.
        </p>
        <div class="flex flex-wrap justify-center gap-3 md:gap-6">
          <div class="max-sm:w-[74px]">
            <img class="aspect-135/94" src="../assets/img/svg/payment-1.svg" alt="payment 1" width="135" height="94"
              data-lazy />
          </div>
          <div class="max-sm:w-[74px]">
            <img class="aspect-135/94" src="../assets/img/svg/payment-2.svg" alt="payment 2" width="135" height="94"
              data-lazy />
          </div>
          <div class="max-sm:w-[74px]">
            <img class="aspect-135/94" src="../assets/img/svg/payment-3.svg" alt="payment 3" width="135" height="94"
              data-lazy />
          </div>
          <div class="max-sm:w-[74px]">
            <img class="aspect-135/94" src="../assets/img/svg/payment-4.svg" alt="payment 4" width="135" height="94"
              data-lazy />
          </div>
        </div>
      </div>
          ...
          <div class="-ml-6">
            <div class="basis-full pl-6 md:basis-1/2">
              <div
                ...
                <p>
                  A fantastic trading platform is <?= $site_name ?>! The
            ...
            <div class="basis-full pl-6 md:basis-1/2">
              <div
                class="border-primary rounded-custom flex h-full flex-col justify-between gap-4 border px-4 py-6 md:gap-6 md:px-8 md:py-10">
                <p>
                  Finally decided to try cryptocurrency and chose <?= $site_name ?>
                  — very pleased with the choice. Registration was
            ...
            <div class="basis-full pl-6 md:basis-1/2">
              <div
                class="border-primary rounded-custom flex h-full flex-col justify-between gap-4 border px-4 py-6 md:gap-6 md:px-8 md:py-10">
                <p>
                  Thanks to <?= $site_name ?>, I've found crypto trading
...
<div class="py-8 md:py-10">
  <div class="container-base grid gap-6 md:gap-10" style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
    <div class="flex items-center justify-between gap-6 mb-6 reviews-flex-block">
      <h2 class="text-2xl font-bold">Αξιολογήσεις <?= $site_name ?> ™</h2>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
            <p>
              Η <?= $site_name ?> με εξέπληξε ευχάριστα. Η εγγραφή ήταν γρήγορη, οι χρεώσεις είναι διαφανείς και η ομάδα υποστήριξης πράγματι απαντά και βοηθά. Όλη η εμπειρία είναι ομαλή και αξιόπιστη — σίγουρα μια πλατφόρμα στην οποία θα παραμείνω.
            </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials($review_1_author) ?></div>
              <p class="font-bold">Ιδιώτης επενδυτής</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Επιτέλους δοκίμασα τα κρυπτονομίσματα και επέλεξα την <?= $site_name ?> — καμία μεταμέλεια μέχρι στιγμής. Η έναρξη διήρκεσε μόνο λίγα λεπτά και όλα εξηγήθηκαν καθαρά. Μοιάζει με μια σταθερή επιλογή, ειδικά αν είστε νέος στις συναλλαγές.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials($review_2_author) ?></div>
              <p class="font-bold">Ανεξάρτητος επενδυτής</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Η <?= $site_name ?> μοιάζει με μια σταθερή και αξιόπιστη πλατφόρμα. Η δημιουργία λογαριασμού ήταν εύκολη, οι όροι είναι κατανοητοί και η υποστήριξη ξέρει τι κάνει. Οι συναλλαγές εδώ ήταν για εμένα μια απροσδόκητα άνετη εμπειρία.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials($review_3_author) ?></div>
              <p class="font-bold">Επενδυτής ψηφιακών περιουσιακών στοιχείων</p>
            </div>
          </div>
        </div>
        <div class="swiper-slide">
          <div class="border flex flex-col justify-between gap-6 p-6 md:p-10 w-full swiper-border" style="border: 1px solid #ddd; border-radius: 20px;">
                <p>
                  Με την <?= $site_name ?> οι συναλλαγές κρυπτονομισμάτων δεν φαίνονται πια τόσο περίπλοκες. Η εγγραφή ήταν εύκολη, οι χρεώσεις είναι διαφανείς και μου αρέσει που η υποστήριξη είναι διαθέσιμη όταν τη χρειάζεσαι. Ως αρχάριος, αυτό κάνει πραγματικά μεγάλη διαφορά.
                </p>
            <div class="flex items-center gap-4">
              <div class="initials"><?= initials($review_4_author) ?></div>
              <p class="font-bold">Αναζητητής παθητικού εισοδήματος</p>
            </div>
          </div>
        </div>
      </div>
...
<script>
  (function() {
    const init = () => {
      console.log('Попытка инициализации Swiper...');
      const sliderEl = document.querySelector('[data-slider="reviews"]');
      if (!sliderEl) {
        console.error('Ошибка: Селектор [data-slider="reviews"] не найден!');
        return;
      }
      ...
      console.log('Swiper успешно запущен:', swiper);
    };
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
      <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Πώς μπορώ να ξεκινήσω;</span>
        ...
        <div id="content-1" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Μπορείτε να είστε έτοιμοι μέσα σε λίγα λεπτά. Δημιουργήστε λογαριασμό με τα βασικά σας στοιχεία, ολοκληρώστε το σύντομο βήμα επαλήθευσης και καταθέστε τουλάχιστον <?= $app_price ?> <?= $app_currency ?>. Στη συνέχεια ξεκλειδώνεται ολόκληρη η πλατφόρμα για εσάς — συμπεριλαμβανομένων γραφημάτων σε πραγματικό χρόνο, εργαλείων συναλλαγών και λειτουργιών που σας βοηθούν να ξεκινήσετε με αυτοπεποίθηση.</p>
          </div>
        </div>
      </div>
      <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Είναι ασφαλή τα χρήματα και τα δεδομένα μου; Είναι αξιόπιστη η <?= $site_name ?>;</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
      ...
      <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Πότε μπορώ να αποσύρω τα κέρδη μου;</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-3" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Μπορείτε να ζητήσετε ανάληψη οποιαδήποτε στιγμή μέσω του πίνακα ελέγχου σας. Η επεξεργασία διαρκεί συνήθως 1–3 εργάσιμες ημέρες, ανάλογα με τη μέθοδο που επιλέξατε. Τυχόν χρεώσεις και το χρονικό πλαίσιο εμφανίζονται πάντα εκ των προτέρων — χωρίς εκπλήξεις.</p>
          </div>
        </div>
      </div>
      <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Πώς θα ξέρω αν αυτή η πλατφόρμα είναι κατάλληλη για εμένα;</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-4" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Ο καλύτερος τρόπος είναι να τη δοκιμάσετε μόνοι σας. Ξεκινήστε με την ελάχιστη κατάθεση και εξερευνήστε τις λειτουργίες βήμα προς βήμα. Η πλατφόρμα έχει σχεδιαστεί ώστε να είναι φιλική προς τους αρχάριους, προσφέροντας παράλληλα ισχυρά εργαλεία και υποστήριξη 24/7 που σας βοηθά ανά πάσα στιγμή. Διατηρείτε τον πλήρη έλεγχο.</p>
          </div>
        </div>
      </div>
      <div id="accordion-5" class="group border-primary rounded-custom border transition-all">
        <button
          ...
          <span class="h3 text-left transition-colors">Χρειάζομαι εμπειρία συναλλαγών για να ξεκινήσω;</span>
          <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
            <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1"
                transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
        ...
        <div id="content-5" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p>Καθόλου. Όλα είναι σχεδιασμένα ώστε να είναι προσβάσιμα από την πρώτη ημέρα — με καθοδηγούμενη εγγραφή, απλούς οδηγούς και εργαλεία με τεχνολογία AI που σας βοηθούν να προσανατολιστείτε στις συναλλαγές. Είτε ξεκινάτε τώρα είτε έχετε ήδη εμπειρία, μπορείτε να προχωρήσετε με τον δικό σας ρυθμό, με την υποστήριξη πάντα διαθέσιμη.</p>
          </div>
        </div>
      </div>
      <div id="accordion-6" class="group border-primary rounded-custom border transition-all">
        ...
        <div id="content-6" class="max-h-0 overflow-hidden transition-all">
          <div class="px-4 pb-5 md:px-8 md:pb-8">
            <p style="margin-bottom:16px;">Η <?= $site_name ?> είναι μια παγκόσμια πλατφόρμα συναλλαγών, σχεδιασμένη για χρήστες που αναμένουν σταθερή απόδοση, γρήγορη εκτέλεση και πλήρη έλεγχο του περιβάλλοντος συναλλαγών τους. Αντί να βασίζεται σε πολλαπλά ασύνδετα εργαλεία ή περιφερειακές υπηρεσίες, η πλατφόρμα προσφέρει ένα ενιαίο, δομημένο σύστημα όπου όλες οι βασικές λειτουργίες είναι ενσωματωμένες σε μία ροή εργασίας.</p>
            <p style="margin-bottom:16px;">Από την πρόσβαση στην αγορά και την εκτέλεση εντολών έως τις αναλύσεις — κάθε στοιχείο έχει σχεδιαστεί για να συνεργάζεται απρόσκοπτα. Αυτό επιτρέπει στους χρήστες να επικεντρώνονται στη λήψη αποφάσεων, αντί να πλοηγούνται σε πολύπλοκα συστήματα ή να αλλάζουν πλατφόρμες.</p>
            <p style="margin-bottom:10px; font-weight:500;">Μέσα από μία ενιαία διεπαφή, οι χρήστες μπορούν να δραστηριοποιούνται σε πολλαπλές χρηματοοικονομικές αγορές:</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Κρυπτονομίσματα, συμπεριλαμβανομένων κορυφαίων και αναδυόμενων ψηφιακών περιουσιακών στοιχείων</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Αγορές συναλλάγματος (Forex) με τιμολόγηση σε πραγματικό χρόνο</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Παγκόσμιες μετοχές και μετοχικά μέσα</li>
              <li><span style="color:#6D5DF6;">•</span> Εμπορεύματα για ευρύτερη διαφοροποίηση χαρτοφυλακίου</li>
            </ul>
            <p style="margin-bottom:16px;">Η απόδοση αποτελεί την ύψιστη προτεραιότητα της πλατφόρμας. Η υποδομή είναι βελτιστοποιημένη για εκτέλεση χαμηλής καθυστέρησης και σταθερή λειτουργία, ακόμη και σε περιόδους υψηλής δραστηριότητας της αγοράς. Αυτό διασφαλίζει ότι οι χρήστες μπορούν να αντιδρούν σε κινήσεις τιμών χωρίς καθυστερήσεις ή τεχνικές διακοπές.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Γρήγορη και συνεπής εκτέλεση εντολών σε όλες τις αγορές</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Συνεχή δεδομένα και ενημερώσεις τιμών σε πραγματικό χρόνο</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Ενσωματωμένα εργαλεία ανάλυσης και δείκτες αγοράς</li>
              <li><span style="color:#6D5DF6;">•</span> Υποστήριξη τόσο χειροκίνητων όσο και αυτοματοποιημένων στρατηγικών</li>
            </ul>
            <p style="margin-bottom:16px;">Η ασφάλεια και η λειτουργική αξιοπιστία είναι ενσωματωμένες σε κάθε επίπεδο του συστήματος. Η πλατφόρμα ακολουθεί καθιερωμένα βιομηχανικά πρότυπα και εφαρμόζει εσωτερικά μέτρα ασφαλείας, ώστε τόσο τα δεδομένα των χρηστών όσο και οι χρηματοοικονομικές συναλλαγές να προστατεύονται ανά πάσα στιγμή.</p>
            <ul class="pl-5" style="margin-bottom:22px;">
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Κρυπτογραφημένη μεταφορά δεδομένων σε όλες τις αλληλεπιδράσεις</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Πολυεπίπεδη επαλήθευση και έλεγχος ταυτότητας λογαριασμού</li>
              <li style="margin-bottom:8px;"><span style="color:#6D5DF6;">•</span> Επαληθευμένα συστήματα διεκπεραίωσης συναλλαγών και παρακολούθησης</li>
              <li><span style="color:#6D5DF6;">•</span> Υποδομή σχεδιασμένη για σταθερή, παγκόσμια διαθεσιμότητα</li>
            </ul>
            <p style="margin-bottom:16px;">Παράλληλα, η ευχρηστία παραμένει κεντρικό μέλημα. Το περιβάλλον χρήσης είναι σκόπιμα σαφές και προβλέψιμο, μειώνοντας την περιττή πολυπλοκότητα και επιτρέποντας στους χρήστες να επικεντρώνονται στις στρατηγικές συναλλαγών τους αντί στο ίδιο το σύστημα.</p>
            <p style="margin-bottom:16px;">Αυτή η ισορροπία μεταξύ απόδοσης και απλότητας καθιστά την πλατφόρμα κατάλληλη τόσο για νέους χρήστες όσο και για έμπειρους επενδυτές. Οι αρχάριοι μπορούν να προσαρμοστούν γρήγορα χωρίς απότομη καμπύλη εκμάθησης, ενώ οι προχωρημένοι χρήστες διατηρούν την ευελιξία που απαιτείται για τη διαχείριση πιο σύνθετων στρατηγικών.</p>
            <p>Η <?= $site_name ?> συνδυάζει επεκτασιμότητα, αξιοπιστία και αποδοτικότητα σε ένα ενιαίο περιβάλλον, προσφέροντας έναν δομημένο και αξιόπιστο τρόπο πρόσβασης στις παγκόσμιες χρηματοοικονομικές αγορές με αυτοπεποίθηση.</p>
          </div>
        </div>
      </div>
    </div>
            ...
            <svg width="729" height="419" viewBox="0 0 729 419" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <defs>
                ...
                <linearGradient id="paint1_linear_4024_13698" x1="644.373" y1="25.0002" x2="644.373" y2="160.521"
                  gradientUnits="userSpaceOnUse">
                  <stop stop-color="currentColor" />
                  <stop offset="1" stop-color="curre ntColor" />
                </linearGradient>
              </defs>
            </svg>
          </div>
          <h2>Αυτές είναι συναλλαγές στην επίσημη πλατφόρμα™</h2>
          <p>
            Είμαστε μια αξιόπιστη πλατφόρμα για ιδιώτες και επιχειρήσεις για την αγορά, πώληση και διαχείριση κρυπτονομισμάτων.
          </p>
        </div>
        <form name="form" method="post"
          class="leadform rf-form js-rf-form group bg-primary rounded-custom relative overflow-hidden px-4 py-8 md:px-8" action="../integration/send.php" data-form>
  ...
  <section style="padding:60px 0;" class="md:!py-[100px]">
    ...
    ">
      ...
      ">
        ...
        ">
          Κύρια χαρακτηριστικά της <span style='color:#6B5FA7;'>πλατφόρμας συναλλαγών <?= $site_name ?></span>
        </h2>
      <p style="margin-top:14px;color:#6b7280;font-size:17px;">
        Ό,τι χρειάζεστε για πιο έξυπνες, πιο γρήγορες και πιο σίγουρες συναλλαγές.
      </p>
    </div>
    <div style="
      border-radius:16px;
    ...
    ">
      ...
      " onmouseover="this.style.background='#f9f9fb'" class="row-block" onmouseout="this.style.background='transparent'">
        ...
        <div class="row-text" style="color:#6b7280;">
          Προηγμένη μηχανή συναλλαγών με τεχνολογία AI
        </div>
      </div>
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Πιστωτικές κάρτες, τραπεζικά εμβάσματα, PayPal
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Forex, μετοχές, κρυπτονομίσματα, εμπορεύματα και άλλα
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        ...
        <div class="row-text" style="color:#6b7280;">
          Γρήγορη και αποτελεσματική εγγραφή
        </div>
      </div>
      <div class="row-block" style="
        display:grid;
      ...
      ">
        <div class="customer-block" style="display:flex;gap:10px;font-weight:600;">
          ...
          <span style="font-weight:400;color:#6b7280;margin-left:10px;">
            Επαγγελματική υποστήριξη 24/7
          </span>
        </div>
        <a href="contacts.php" class="row-contact-btn" style="
          background:#6B5FA7;
          color:#fff;
          padding:10px 20px;
          border-radius:8px;
          ...
          transition:.2s;
        "
        onmouseover="this.style.background='#5A4F91'"
        onmouseout="this.style.background='#6B5FA7'">
          Επικοινωνία
        </a>
      </div>
    </div>
...
<?php
$stars = str_repeat('★', (int) round($rating_value));
?>
  ...
  <div class="border-primary-light grid justify-items-center gap-6 rounded-[20px] border px-4 py-5 md:gap-4 md:px-8 md:py-6 text-center md:text-left">
    ...
    <div class="flex flex-wrap items-center justify-center md:justify-start gap-2.5 text-center md:text-left">
      ...
      <span class="leading-none text-amber-500" role="img"
        aria-label="<?= $rating_value ?> βαθμολογία από 5">
        <?= $stars ?>
      </span>
      <span class="flex flex-wrap justify-center md:justify-start gap-1 text-sm text-gray-400">
        <span>
          <strong>318</strong> αξιολογήσεις ·
        </span>
        <span>
          Με βάση <strong><?= $rating_count ?></strong> αξιολογήσεις ·
        </span>
        <span>
          βαθμολογία από 5
        </span>
    ...
    <p class="text-center md:text-left">
      Μια ισχυρή και φιλική προς τον χρήστη πλατφόρμα συναλλαγών με ισχυρή αυτοματοποίηση και εκτενείς εκπαιδευτικούς πόρους.
    </p>
  </div>
</div>
      </div>
        ...
        <div class="grid gap-5">
          <nav class="flex flex-col flex-wrap justify-between gap-x-10 gap-y-5 text-white md:flex-row">
            <a class="font-special inline-flex max-w-60 gap-1.5 text-xl leading-none text-white uppercase max-md:pr-[120px] footer-nav-logo"
              href="<?= $site_url ?>/lander/<?= $site_domain ?>/el/">
          ...
          <div class="flex justify-between gap-5">
            <div class="grid gap-5 text-white">
              <p style="color:#6B5FA7;">Ο αξιόπιστος συνεργάτης σας στις συναλλαγές</p>
...
<div class="lang-switcher">
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/es/" hreflang="es" title="Español">
    🇪🇸
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/cs/" hreflang="cs" title="Čeština">
    🇨🇿
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/de/" hreflang="de" title="Deutsch">
    🇩🇪
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/en/" hreflang="en" title="English">
    🇬🇧
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/it/" hreflang="it" title="Italiano">
    🇮🇹
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/fr/" hreflang="fr" title="Français">
    🇫🇷
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/nl/" hreflang="nl" title="Nederlands">
    🇳🇱
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/pl/" hreflang="pl" title="Polski">
    🇵🇱
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/pt/" hreflang="pt" title="Português">
    🇵🇹
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ro/" hreflang="ro" title="Română">
    🇷🇴
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/sv/" hreflang="sv" title="Svenska">
    🇸🇪
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/tr/" hreflang="tr" title="Türkçe">
    🇹🇷
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/hr/" hreflang="hr" title="Hrvatski">
    🇭🇷
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/no/" hreflang="no" title="Norsk">
    🇳🇴
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/da/" hreflang="da" title="Dansk">
    🇩🇰
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/fi/" hreflang="fi" title="Suomi">
    🇫🇮
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/hu/" hreflang="hu" title="Magyar">
    🇭🇺
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/sk/" hreflang="sk" title="Slovenčina">
    🇸🇰
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/bg/" hreflang="bg" title="Български">
    🇧🇬
  </a>
  ...
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/el/" hreflang="el" title="Ελληνικά">
    🇬🇷
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ja/" hreflang="ja" title="日本語">
    🇯🇵
  </a>
</div>
</div>
        ...
        <div class="grid gap-2.5 text-sm text-gray-500">
            <p>
                Η <?= $site_name ?> δεν φέρει ευθύνη για τυχόν απώλειες ή ζημίες που προκύπτουν από την εξάρτηση από τις πληροφορίες που παρέχονται σε αυτόν τον ιστότοπο, συμπεριλαμβανομένου εκπαιδευτικού περιεχομένου, τιμών, γραφημάτων και αναλύσεων. Οι συναλλαγές στις χρηματοοικονομικές αγορές ενέχουν κίνδυνο. Επομένως, είναι σημαντικό να λάβετε υπόψη τις προσωπικές σας συνθήκες πριν ξεκινήσετε και, εάν χρειάζεται, να ζητήσετε τη συμβουλή ειδικού. Θα πρέπει να επενδύετε μόνο χρήματα των οποίων την απώλεια μπορείτε να αντέξετε, λαμβάνοντας υπόψη ότι μέσα όπως το συνάλλαγμα (FX), τα CFD και τα κρυπτονομίσματα δεν είναι κατάλληλα για όλους.
            </p>
        </div>
        <div class="text-center text-white">
          Copyright 2026 © <?= $site_name ?>, Με επιφύλαξη παντός δικαιώματος
        </div>
      </div>
    </div>
  </footer>
...
<script>
  document.addEventListener('DOMContentLoaded', () => {
    const swiper = new Swiper('[data-slider="reviews"]', {
      slidesPerView: 1,
      spaceBetween: 20,
      loop: true,
      breakpoints: {
