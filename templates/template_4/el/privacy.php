...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Πολιτική απορρήτου | <?= $site_name ?></title>
    <meta name="description" content="Διαβάστε πώς το <?= $site_name ?> συλλέγει και προστατεύει τα δεδομένα σας." />
    <!-- Favicon -->
...
<div class="grid gap-6 md:gap-8">
  ...
  <div class="grid gap-2">
    <p class="text-sm">Τελευταία ενημέρωση: <?= $privacy_last_update ?></p>
    <p>Εμείς ("Εμείς") σεβόμαστε το απόρρητό σας και δεσμευόμαστε να προστατεύουμε τα προσωπικά σας δεδομένα. Αυτή η πολιτική απορρήτου εξηγεί πώς το <?= $site_name ?> συλλέγει, χρησιμοποιεί και προστατεύει τις πληροφορίες σας.</p>
  </div>
  <!-- PRINCIPLES -->
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Διαφάνεια</p>
    <p>
      Εξηγούμε με σαφήνεια πώς χρησιμοποιούνται τα δεδομένα σας. Επικοινωνήστε μαζί μας στο 
      <a href="mailto:info@<?= $site_domain ?>">info@<?= $site_domain ?></a>
    </p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Χρήση δεδομένων</p>
    <p>Τα δεδομένα σας χρησιμοποιούνται για την παροχή υπηρεσιών, τη βελτίωση της πλατφόρμας και την εκπλήρωση νομικών υποχρεώσεων.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Τα δικαιώματά σας</p>
    <p>Μπορείτε ανά πάσα στιγμή να ζητήσετε πληροφορίες σχετικά με τα δεδομένα σας, καθώς και τη διόρθωση ή τη διαγραφή τους.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <p class="h3 disc">Ασφάλεια</p>
    <p>Προστατεύουμε τα δεδομένα σας, αλλά δεν μπορούμε να εγγυηθούμε απόλυτη ασφάλεια.</p>
  </div>
  <!-- SECTIONS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Συλλογή δεδομένων</h2>
    <p>Συλλέγουμε δεδομένα χρήσης (διεύθυνση IP, συσκευή, πρόγραμμα περιήγησης) και όλα τα δεδομένα που μας παρέχετε.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Νομική βάση</h2>
    <p>Η επεξεργασία βασίζεται στη συγκατάθεσή σας, σε έννομα συμφέροντα και νομικές υποχρεώσεις.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Κοινοποίηση δεδομένων</h2>
    <p>Εάν χρειαστεί, ενδέχεται να κοινοποιήσουμε δεδομένα σε συνεργάτες, παρόχους υπηρεσιών και αρχές.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Cookies</h2>
    <p>Χρησιμοποιούμε cookies για λειτουργικότητα και αναλύσεις. Μπορείτε να τα απενεργοποιήσετε.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Αποθήκευση δεδομένων</h2>
    <p>Τα δεδομένα διατηρούνται μόνο για όσο διάστημα είναι απολύτως απαραίτητο.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Διεθνείς μεταφορές</h2>
    <p>Τα δεδομένα μπορούν να μεταφερθούν με κατάλληλες εγγυήσεις.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Σύνδεσμοι τρίτων</h2>
    <p>Δεν φέρουμε ευθύνη για εξωτερικές ιστοσελίδες.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Ενημερώσεις</h2>
    <p>Αυτή η πολιτική απορρήτου ενδέχεται να ενημερωθεί.</p>
  </div>
  <!-- RIGHTS -->
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">Τα δικαιώματά σας</h2>
    <p>Έχετε δικαίωμα πρόσβασης, διόρθωσης, διαγραφής, περιορισμού ή φορητότητας των δεδομένων σας, ανάκλησης της συγκατάθεσης και υποβολής καταγγελίας.</p>
  </div>
</div>
          </div>
        </div>
