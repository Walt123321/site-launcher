...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Συχνές Ερωτήσεις (FAQ) | <?= $site_name ?></title>
    <meta name="description" content="Απαντήσεις σε ερωτήσεις σχετικά με συναλλαγές, λειτουργίες, ασφάλεια και χρεώσεις." />
    <!-- Favicon -->
...
<link rel="alternate" hreflang="en" href="<?= $site_url ?>/lander/<?= $site_domain ?>/en/faq.php" />
  ...
  <div class="container-base grid gap-6 md:gap-10">
    ...
    <div class="grid gap-3 md:gap-6" data-accordion>
        <div id="accordion-1" class="group border-primary rounded-custom border transition-all">
          ...
          <div id="content-1" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Μπορείτε να είστε έτοιμοι σε λίγα λεπτά. Δημιουργήστε έναν λογαριασμό με τα βασικά σας στοιχεία, ολοκληρώστε το σύντομο βήμα επαλήθευσης και καταθέστε τουλάχιστον <?= $app_price ?> <?= $app_currency ?> . Στη συνέχεια, ξεκλειδώνεται ολόκληρη η πλατφόρμα για εσάς — συμπεριλαμβανομένων γραφημάτων σε πραγματικό χρόνο, εργαλείων συναλλαγών και λειτουργιών που σας βοηθούν να ξεκινήσετε με αυτοπεποίθηση.</p>
            </div>
          </div>
        </div>
        <div id="accordion-2" class="group border-primary rounded-custom border transition-all">
          ...
          >
            <span class="h3 text-left transition-colors">Είναι ασφαλή τα χρήματα και τα δεδομένα μου; Είναι <?= $site_name ?> αξιόπιστο;</span>
            <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
              <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1" transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
                <rect x="19.5176" y="35.9287" width="4.62857" height="23.1428" rx="1" transform="rotate(-135 19.5176 35.9287)" fill="currentColor" />
          ...
          <div id="content-2" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Απολύτως. Προστατεύουμε τον λογαριασμό σας με προηγμένη κρυπτογράφηση SSL, έλεγχο ταυτότητας δύο παραγόντων (2FA) και ασφαλή αποθήκευση κεφαλαίων cold storage. Οι συναλλαγές διεκπεραιώνονται μέσω αξιόπιστων παρόχων και τα προσωπικά σας δεδομένα αντιμετωπίζονται σύμφωνα με αυστηρές πολιτικές ασφαλείας. Η ασφάλεια και η αξιοπιστία είναι βαθιά ριζωμένες σε κάθε τμήμα της πλατφόρμας.</p>
            </div>
          </div>
        </div>
        <div id="accordion-3" class="group border-primary rounded-custom border transition-all">
          ...
          <div id="content-3" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Μπορείτε να ζητήσετε ανάληψη ανά πάσα στιγμή μέσω του πίνακα ελέγχου σας. Η επεξεργασία διαρκεί συνήθως 1–3 εργάσιμες ημέρες, ανάλογα με την επιλεγμένη μέθοδο. Τυχόν χρεώσεις και το χρονικό πλαίσιο εμφανίζονται πάντα εκ των προτέρων — καμία έκπληξη.</p>
            </div>
          </div>
        </div>
        <div id="accordion-4" class="group border-primary rounded-custom border transition-all">
          ...
          >
            <span class="h3 text-left transition-colors">Πώς μπορώ να ξέρω αν αυτή η πλατφόρμα είναι κατάλληλη για εμένα;</span>
            <span class="w-[26px] shrink-0 transition-transform group-data-active:rotate-180 md:w-10">
              <svg viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="22.7905" y="32.6563" width="4.62857" height="23.1428" rx="1" transform="rotate(135 22.7905 32.6563)" fill="currentColor" />
                <rect x="19.5176" y="35.9287" width="4.62857" height="23.1428" rx="1" transform="rotate(-135 19.5176 35.9287)" fill="currentColor" />
        ...
        <div id="accordion-5" class="group border-primary rounded-custom border transition-all">
          ...
          <div id="content-5" class="max-h-0 overflow-hidden transition-all">
            <div class="px-4 pb-5 md:px-8 md:pb-8">
              <p>Καθόλου. Όλα είναι σχεδιασμένα ώστε να είναι προσβάσιμα από την πρώτη ημέρα — με καθοδηγούμενη εγγραφή, απλές οδηγίες και εργαλεία με τεχνητή νοημοσύνη που σας βοηθούν να προσανατολιστείτε στις συναλλαγές. Είτε μόλις ξεκινάτε είτε έχετε ήδη εμπειρία, μπορείτε να προχωρήσετε με τον δικό σας ρυθμό, και η υποστήριξη είναι πάντα διαθέσιμη για εσάς.</p>
            </div>
          </div>
        </div>
    </div>
...
<div class="lang-switcher">
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/es/faq.php" hreflang="es" title="Español">
    🇪🇸
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/cs/faq.php" hreflang="cs" title="Čeština">
    🇨🇿
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/de/faq.php" hreflang="de" title="Deutsch">
    🇩🇪
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/en/faq.php" hreflang="en" title="English">
    🇬🇧
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/it/faq.php" hreflang="it" title="Italiano">
    🇮🇹
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/fr/faq.php" hreflang="fr" title="Français">
    🇫🇷
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/nl/faq.php" hreflang="nl" title="Nederlands">
    🇳🇱
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/pl/faq.php" hreflang="pl" title="Polski">
    🇵🇱
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/pt/faq.php" hreflang="pt" title="Português">
    🇵🇹
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ro/faq.php" hreflang="ro" title="Română">
    🇷🇴
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/sv/faq.php" hreflang="sv" title="Svenska">
    🇸🇪
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/tr/faq.php" hreflang="tr" title="Türkçe">
    🇹🇷
  </a>
  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/hr/faq.php" hreflang="hr" title="Hrvatski">
    🇭🇷
  </a>
