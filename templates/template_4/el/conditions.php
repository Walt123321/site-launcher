...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Όροι χρήσης | <?= $site_name ?></title>
    <meta name="description" content="Διαβάστε τους όρους χρήσης του <?= $site_name ?>." />
    <meta charset="UTF-8" />
  ...
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <div class="grid gap-5 md:gap-7">
        <nav aria-label="breadcrumb" class="flex flex-wrap items-center text-sm text-gray-500 md:text-lg">
            ...
            <span class="breadcrumb-item">Όροι χρήσης</span>
        </nav>
        <h1>Όροι χρήσης</h1>
    </div>
<div class="grid gap-6 md:gap-8">
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">1. Γενικά</h2>
    <p>Αυτή η ιστοσελίδα παρέχει πληροφορίες σχετικά με πλατφόρμες συναλλαγών τρίτων και συναφείς υπηρεσίες. Χρησιμοποιώντας αυτή την ιστοσελίδα, αποδέχεστε αυτούς τους όρους και την πολιτική απορρήτου μας. Οι όροι ενδέχεται να ενημερώνονται ανά πάσα στιγμή.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">2. Καταλληλότητα</h2>
    <p>Πρέπει να είστε τουλάχιστον 18 ετών, να μπορείτε να αποδεχτείτε αυτούς τους όρους και να μην περιορίζεστε από την τοπική νομοθεσία. Δεν φέρουμε ευθύνη για παράνομη χρήση αυτής της ιστοσελίδας.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">3. Περιορισμένη πρόσβαση</h2>
    <p>Ενδέχεται να περιορίσουμε την πρόσβαση για χρήστες από ορισμένες περιοχές ή όπου υπάρχουν νομικοί ή κανονιστικοί κίνδυνοι. Οι υπηρεσίες ενδέχεται να μην είναι διαθέσιμες σε περιορισμένες περιοχές.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">4. Απαγορευμένη χρήση</h2>
    <p>Δεν επιτρέπεται να καταχραστείτε την ιστοσελίδα, συμπεριλαμβανομένης της παραβίασης νόμων, της παραβίασης δικαιωμάτων, της διάδοσης επιβλαβούς περιεχομένου ή της χρήσης αυτοματοποιημένων συστημάτων. Σε περίπτωση παραβίασης, ενδέχεται να περιορίσουμε την πρόσβαση.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">5. Πνευματική ιδιοκτησία</h2>
    <p>Όλο το περιεχόμενο, τα εμπορικά σήματα και τα υλικά ανήκουν σε εμάς ή σε τρίτους. Μπορείτε να χρησιμοποιήσετε την ιστοσελίδα μόνο για προσωπικούς σκοπούς και δεν επιτρέπεται να αντιγράψετε ή να τροποποιήσετε το περιεχόμενο.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">6. Ευθύνη</h2>
    <p>Η ιστοσελίδα και οι υπηρεσίες παρέχονται "ως έχουν". Δεν φέρουμε ευθύνη για σφάλματα, απώλειες ή ζημίες που προκύπτουν από τη χρήση αυτής της ιστοσελίδας.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">7. Υπηρεσίες τρίτων</h2>
    <p>Ενδέχεται να εμφανίζουμε περιεχόμενο ή συνδέσμους τρίτων. Δεν φέρουμε ευθύνη για την ακρίβεια ή τις υπηρεσίες τους. Επαληθεύστε τις πληροφορίες πριν λάβετε μια απόφαση.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">8. Σύνδεσμοι</h2>
    <p>Οι σύνδεσμοι προς εξωτερικές ιστοσελίδες παρέχονται μόνο ως υπηρεσία. Δεν τις υποστηρίζουμε ούτε τις ελέγχουμε και δεν φέρουμε ευθύνη για το περιεχόμενό τους.</p>
  </div>
  <div class="grid gap-2 md:gap-4">
    <h2 class="h3">9. Διάφορα</h2>
    <p>Ενδέχεται να ενημερώνουμε ή να τροποποιούμε τις υπηρεσίες και τους όρους ανά πάσα στιγμή. Αυτοί οι όροι αποτελούν την πλήρη συμφωνία μεταξύ εσάς και εμάς. Η μη επιβολή δικαιωμάτων δεν σημαίνει παραίτηση από αυτά.</p>
  </div>
</div>
      </div>
    </main>
