...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "💸 Αποκτήστε παρακολούθηση χαρτοφυλακίου 💸",
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    <title>Προσφορά | <?= $site_name ?></title>
    <meta name="description" content="Επιλέξτε με το <?= $site_name ?> ένα πλάνο που ταιριάζει στις ανάγκες συναλλαγών σας." />
    <!-- Favicon -->
...
<nav class="hiddens grow justify-center lg:flex">
  <ul class="flex flex-row flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-5 lg:gap-x-7">
    ...
    <li>
      <a class="data-active:text-primary" href="offer.php" data-active>Προσφορά</a>
    </li>
    <li>
...
<span class="breadcrumb-item">Προσφορά</span>
          </nav>
        </div>
      </div>
      <!-- tracker -->
      <div class="py-8 md:py-10">
        <div class="container-base grid gap-6 lg:grid-cols-2">
          ...
          >
 <h1 class="relative z-20">Αποκτήστε παρακολούθηση χαρτοφυλακίου</h1>
<p class="relative z-20">
  Ξεκινήστε σε λίγα λεπτά: εγγραφείτε, καταθέστε κεφάλαια και ξεκινήστε τις συναλλαγές σε μόλις 5 λεπτά. Ξεκινήστε τώρα.
</p>
          </div>
