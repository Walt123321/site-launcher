...
<link rel="stylesheet" href="custom-styles.css?v=<?= @filemtime(__DIR__ . '/custom-styles.css') ?: time() ?>">
</head>
  ...
  <div class="footer__main">
    <div class="footer__top">
      ...
      <div class="footer__lang-switcher">
        <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/" hreflang="en" title="English">🇬🇧</a>
...
<dialog class="places" data-js-dialog="">
  ...
  <script src="js/swiper-bundle.min.js?v=<?= @filemtime(__DIR__ . '/js/swiper-bundle.min.js') ?: time() ?>" defer></script>
...
<script src="js/chat-quiz.js?v=<?= @filemtime(__DIR__ . '/js/chat-quiz.js') ?: time() ?>" defer></script>
