...
<script type="application/ld+json">
{
  ...
  <meta property="og:title" content="<?= $page_title_conditions ?>">
  <meta property="og:description" content="<?= $page_description_conditions ?>">
...
<link rel="stylesheet" href="css/conditions-styles.css?v=<?= @filemtime(__DIR__ . '/css/conditions-styles.css') ?: time() ?>">
