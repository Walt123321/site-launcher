...
<script type="application/ld+json">
{
  ...
  <meta property="og:title" content="<?= $page_title_contact ?>">
  <meta property="og:description" content="<?= $page_description_contact ?>">
...
<link rel="stylesheet" href="css/contact-styles.css?v=<?= @filemtime(__DIR__ . '/css/contact-styles.css') ?: time() ?>">
