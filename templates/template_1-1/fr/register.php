...
$country_name = '';
include '../lang.php';
if (strtolower(substr($site_lang, 0, 2)) === 'fr') {
...
<form action="../integration/send.php" class="leadform S’inscrire-form bottom form-reg c-form form1 rf-form js-rf-form" id="registrationForm" method="post" style="padding-bottom: 0px">
  ...
  <div class="form-img">
    ...
    <img alt="sécurité SSL" src="../sslsecure.svg"/>
  </div>
...
<footer class="footer_component">
  ...
  <div style="height: 0; overflow: hidden; position: absolute; width: 0">
    <a href="#">Accueil</a>
    <a href="<?= $site_url ?>#why-invest">Pourquoi investir ?</a>
    <a href="<?= $site_url ?>#pricing">Comment investir</a>
    <a href="about.php">À propos</a>
    <a href="<?= $site_url ?>#minimization">Risques d'investissement</a>
    <a href="<?= $site_url ?>#Beneficios">Avantages</a>
    <a href="<?= $site_url ?>#faq">FAQ</a>
    <a href="contact.php">Contact</a>
    <a href="private-policy.php">Politique de confidentialité</a>
  ...
  <noscript>
    ...
    <div>Pour envoyer le formulaire, veuillez activer JavaScript.</div>
  </noscript>
