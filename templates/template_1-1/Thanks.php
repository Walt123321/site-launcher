...
<body>
  <div class="thx">
    <div class="thx__container">
      <div class="thx__box">
        <h2 class="thx-left__title">Gratulerer med vellykket registrering i systemet.</h2>
        <div class="thx-right">
          <div id="parallax">
        ...
        <div class="thx-left">
          <p style="font-size: 16px;" class="thx-left__text">
            Du vil motta en telefon innen 24 timer – ikke gå glipp av den, ellers kan interessen gå til en annen bruker!
          </p>
        </div>
      </div>
    </div>
  ...
  <script>
    ...
    const translations = {
      ...
      el: {
        ...
        text: "Θα λάβετε μια κλήση εντός 24 ωρών — μην τη χάσετε, διαφορετικά η προσφορά μπορεί να μεταφερθεί σε άλλον χρήστη!"
      },
      hr: {
        title: "Gratulujemy pomyślnej rejestracji w systemie.",
        text: "Otrzymasz telefon w ciągu 24 godzin - nie przegap go, w przeciwnym razie możesz zainteresować innego uczestnika!"
      },
      lv: {
        title: "Apsveicam ar veiksmīgu reģistrāciju sistēmā!",
        text: "Jūs saņemsiet zvanu 24 stundu laikā. Lūdzu, nepalaidiet to garām, lai mūsu pārstāvis varētu jums palīdzēt sākt darbu."
      },
      no: {
        title: "Gratulerer med vellykket registrering i systemet.",
        text: "Du vil motta en telefon innen 24 timer – ikke gå glipp av den, ellers kan interessen gå til en annen bruker!"
      },
      de: {
      ...
      fr: {
        title: "Félicitations pour votre inscription réussie.",
        text: "Vous recevrez un appel dans les 24 heures – ne le manquez pas, sinon l’attention pourrait se tourner vers un autre participant !"
      },
      tr: {
