...
<header class="navbar_component w-nav" data-animation="default" data-collapse="medium" data-duration="400" data-easing="ease" data-easing2="ease" data-w-id="8e40c4b5-461f-531e-f642-15e88be2e74a" fs-scrolldisable-element="smart-nav" role="banner">
  <div class="navbar_container">
    <div class="navbar_logo-wrapper">
      <a href="<?= $site_url ?>">
        <img loading="lazy" alt="Logo <?= $source ?>" src="../favicon.svg?v=<?= @filemtime(__DIR__ . '/../favicon.svg') ?: time() ?>" style="width: 25px; margin: 5px"/>
...
<img alt="Fondo de cuadrícula de la sección principal" class="hero-pattern" fetchpriority="high" src="../Hero-Grid.svg"/>
</div>
...
<img alt="Imagen principal de la plataforma de inversión" src="../investor.webp" style="border-radius: 15px;">
</img></div>
...
<div class="layout1-image-gradient-wrapper" data-w-id="30a34707-6eb3-a0bc-2b4d-b6131c4f1081" style="
                          ...
                          transform-style: preserve-3d;
                        ">
<img alt="Análisis bursátil con trading de IA" class="flex-image" loading="lazy" src="../investor1.webp">
</img></div>
</div>
</div>
</div>
...
<img alt="Inversión en línea" class="layout1_image feature-2 flex-image" loading="lazy" sizes="(max-width: 479px) 82vw, (max-width: 767px) 85vw, (max-width: 991px) 39vw, 38vw" src="../investathome.webp">
</img></div>
</div>
</div>
</div>
...
<div class="layout1-image-gradient-wrapper" data-w-id="2f80477f-23b3-153b-6ac3-96fff2ff8cd0" style="
                      ...
                      ">
<div class="layout1_image-wrapper">
<img alt="Concepto de crecimiento financiero e inversión" class="layout1_image feature-3" loading="lazy" sizes="(max-width: 479px) 82vw, (max-width: 767px) 85vw, (max-width: 991px) 39vw, 38vw" src="../investgrowth.webp">
</img></div>
</div>
</div>
</div>
...
<img alt="Patrón decorativo de la sección de testimonios" class="testimonial-pattern-image" loading="lazy" src="../testimonial-pattern.svg">
</img></div>
</div>
</div>
</div>
...
<div class="layout1-image-gradient-wrapper" data-w-id="30a34707-6eb3-a0bc-2b4d-b6131c4f1081" style="
                    ...
                    ">
<div class="layout1_image-wrapper">
<img alt="Análisis de mercado con trading de IA" class="layout1_image feature-1" loading="lazy" src="../Kiintell.webp">
</img></div>
</div>
</div>
</div>
...
<div class="layout1-image-gradient-wrapper" data-w-id="ad008d0b-ca72-3722-c6cd-77686dc346ca" style="
                    ...
                    ">
<div class="layout1_image-wrapper">
<img alt="Gráfico bursátil al alza" class="layout1_image feature-2" loading="lazy" sizes="(max-width: 479px) 82vw, (max-width: 767px) 85vw, (max-width: 991px) 39vw, 38vw" src="../charts.webp">
</img></div>
</div>
</div>
</div>
...
<div class="layout1-image-gradient-wrapper" data-w-id="2f80477f-23b3-153b-6ac3-96fff2ff8cd0" style="
                    ...
                    ">
<div class="layout1_image-wrapper">
<img alt="Hombre consultando sus inversiones con IA" class="layout1_image feature-3" loading="lazy" sizes="(max-width: 479px) 82vw, (max-width: 767px) 85vw, (max-width: 991px) 39vw, 38vw" src="../happyinvestor.webp">
</img></div>
</div>
</div>
</div>
...
<div class="layout1-image-gradient-wrapper" data-w-id="58b3e01c-d462-a6d1-a3e6-4b1761832b38" style="
                    ...
                    ">
<div class="layout1_image-wrapper">
<img alt="Gráfico financiero de trading con IA" class="layout1_image feature-1" loading="lazy" src="../charts2.webp"/>
</div>
</div>
</div>
</div>
...
<div class="layout1-image-gradient-wrapper" data-w-id="58b3e01c-d462-a6d1-a3e6-4b1761832b47" style="
                    ...
                    ">
<div class="layout1_image-wrapper">
<img alt="Análisis de mercado de un inversor" class="layout1_image feature-2" loading="lazy" sizes="(max-width: 479px) 82vw, (max-width: 767px) 85vw, (max-width: 991px) 39vw, 38vw" src="../charts3.webp"/>
</div>
</div>
</div>
</div>
...
<div class="layout1_image-wrapper">
<img alt="Inversores satisfechos utilizando el trading con IA" class="layout1_image feature-3" loading="lazy" sizes="(max-width: 479px) 82vw, (max-width: 767px) 85vw, (max-width: 991px) 39vw, 38vw" src="../happyinvestors.webp"/>
</div>
</div>
</div>
</div>
...
<img alt="Patrón decorativo superior de la sección de opiniones" class="review-pattern-image" loading="lazy" src="../review-top-pattern.svg"/>
</div>
<div class="review-pattern-bottom-wrapper">
<img alt="Patrón decorativo inferior de la sección de opiniones" class="review-pattern-image" loading="lazy" src="../review-bottom-pattern.svg"/>
</div>
...
<img alt="Icono de valoración con estrellas" class="testimonial18_rating-icon" loading="lazy" src="../star.svg"/>
<img alt="Icono de valoración con estrellas" class="testimonial18_rating-icon" loading="lazy" src="../star.svg"/>
<img alt="Icono de valoración con estrellas" class="testimonial18_rating-icon" loading="lazy" src="../star.svg"/>
<img alt="Icono de valoración con estrellas" class="testimonial18_rating-icon" loading="lazy" src="../star.svg"/>
<img alt="Icono de valoración con estrellas" class="testimonial18_rating-icon" loading="lazy" src="../star.svg"/>
...
<img alt="Patrón decorativo de fondo" class="cta_background-image" loading="lazy" src="../pattern-background.svg">
</img></div>
</div>
</div>
</div>
              ...
              <div class="footer_link-list" style="display: flex; flex-direction: column; gap: 10px">
                <div>
                  <a class="navbar_link w-nav-link footer-logo-link" href="<?= $site_url ?>/#" style="background-color: transparent">
                    <img alt="Logo <?= $source ?>" class="navbar1_logo" loading="lazy" src="../favicon.svg?v=<?= @filemtime(__DIR__ . '/../favicon.svg') ?: time() ?>" style="width: 50px; margin: 5px">
