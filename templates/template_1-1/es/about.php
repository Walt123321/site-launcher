...
if (strtolower(substr($site_lang, 0, 2)) === 'es') {
    ...
    header('Location: ' . $site_url . '/lander/' . $site_domain . '/about.php');
    exit();
}
?>
<?php
...
<meta content="<?= $page_title_about ?>" property="og:title"/>
<meta content="<?= $page_description_about ?>" property="og:description"/>
...
<meta name="description" content="<?= $page_description_about ?>">
  ...
  <link rel="alternate" hreflang="x-default" href="<?= $site_url ?>/lander/<?= $site_domain ?>/about.php" />
            ...
            <div class="footer_left-wrapper footer-flex">
              ...
              <div class="footer-list-right footer-lang-switcher-wrapper">
                ...
                <div class="lang-switcher">
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/about.php" hreflang="en" title="English">🇬🇧</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/de/about.php" hreflang="de" title="Deutsch">🇩🇪</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/fr/about.php" hreflang="fr" title="Français">🇫🇷</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/es/about.php" hreflang="es" title="Español">🇪🇸</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/it/about.php" hreflang="it" title="Italiano">🇮🇹</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/bg/about.php" hreflang="bg" title="Български">🇧🇬</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/cs/about.php" hreflang="cs" title="Čeština">🇨🇿</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/da/about.php" hreflang="da" title="Dansk">🇩🇰</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/el/about.php" hreflang="el" title="Ελληνικά">🇬🇷</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/fi/about.php" hreflang="fi" title="Suomi">🇫🇮</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/hr/about.php" hreflang="hr" title="Hrvatski">🇭🇷</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/hu/about.php" hreflang="hu" title="Magyar">🇭🇺</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ja/about.php" hreflang="ja" title="日本語">🇯🇵</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ms/about.php" hreflang="ms" title="Bahasa Melayu">🇲🇾</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/nb/about.php" hreflang="nb" title="Norsk Bokmål">🇳🇴</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/nl/about.php" hreflang="nl" title="Nederlands">🇳🇱</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/no/about.php" hreflang="no" title="Norsk">🇳🇴</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/pl/about.php" hreflang="pl" title="Polski">🇵🇱</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/pt/about.php" hreflang="pt" title="Português">🇵🇹</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ro/about.php" hreflang="ro" title="Română">🇷🇴</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ru/about.php" hreflang="ru" title="Русский">🇷🇺</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/sk/about.php" hreflang="sk" title="Slovenčina">🇸🇰</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/sv/about.php" hreflang="sv" title="Svenska">🇸🇪</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/tr/about.php" hreflang="tr" title="Türkçe">🇹🇷</a>
                </div>
              </div>
            </div>
          </div>
