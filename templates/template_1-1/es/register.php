...
$country_name = '';
include '../lang.php';
if (strtolower(substr($site_lang, 0, 2)) === 'es') {
    header('HTTP/1.1 301 Moved Permanently');
    header('Location: ' . $site_url . '/lander/' . $site_domain . '/register.php');
    exit();
}
?>
<?php
...
<meta content="<?= $page_title_register ?>" property="og:title"/>
<meta content="<?= $page_description_register ?>" property="og:description"/>
...
<meta name="description" content="<?= $page_description_register ?>">
  ...
  <link rel="alternate" hreflang="x-default" href="<?= $site_url ?>/lander/<?= $site_domain ?>/register.php" />
  <link rel="alternate" hreflang="en" href="<?= $site_url ?>/lander/<?= $site_domain ?>/register.php" />
  <link rel="alternate" hreflang="de" href="<?= $site_url ?>/lander/<?= $site_domain ?>/de/register.php" />
  <link rel="alternate" hreflang="fr" href="<?= $site_url ?>/lander/<?= $site_domain ?>/fr/register.php" />
  <link rel="alternate" hreflang="es" href="<?= $site_url ?>/lander/<?= $site_domain ?>/es/register.php" />
  <link rel="alternate" hreflang="it" href="<?= $site_url ?>/lander/<?= $site_domain ?>/it/register.php" />
<link rel="alternate" hreflang="bg" href="<?= $site_url ?>/lander/<?= $site_domain ?>/bg/register.php" />
<link rel="alternate" hreflang="cs" href="<?= $site_url ?>/lander/<?= $site_domain ?>/cs/register.php" />
<link rel="alternate" hreflang="da" href="<?= $site_url ?>/lander/<?= $site_domain ?>/da/register.php" />
<link rel="alternate" hreflang="el" href="<?= $site_url ?>/lander/<?= $site_domain ?>/el/register.php" />
<link rel="alternate" hreflang="fi" href="<?= $site_url ?>/lander/<?= $site_domain ?>/fi/register.php" />
<link rel="alternate" hreflang="hr" href="<?= $site_url ?>/lander/<?= $site_domain ?>/hr/register.php" />
<link rel="alternate" hreflang="hu" href="<?= $site_url ?>/lander/<?= $site_domain ?>/hu/register.php" />
<link rel="alternate" hreflang="ja" href="<?= $site_url ?>/lander/<?= $site_domain ?>/ja/register.php" />
<link rel="alternate" hreflang="ms" href="<?= $site_url ?>/lander/<?= $site_domain ?>/ms/register.php" />
<link rel="alternate" hreflang="nb" href="<?= $site_url ?>/lander/<?= $site_domain ?>/nb/register.php" />
<link rel="alternate" hreflang="nl" href="<?= $site_url ?>/lander/<?= $site_domain ?>/nl/register.php" />
<link rel="alternate" hreflang="no" href="<?= $site_url ?>/lander/<?= $site_domain ?>/no/register.php" />
<link rel="alternate" hreflang="pl" href="<?= $site_url ?>/lander/<?= $site_domain ?>/pl/register.php" />
<link rel="alternate" hreflang="pt" href="<?= $site_url ?>/lander/<?= $site_domain ?>/pt/register.php" />
<link rel="alternate" hreflang="ro" href="<?= $site_url ?>/lander/<?= $site_domain ?>/ro/register.php" />
<link rel="alternate" hreflang="ru" href="<?= $site_url ?>/lander/<?= $site_domain ?>/ru/register.php" />
<link rel="alternate" hreflang="sk" href="<?= $site_url ?>/lander/<?= $site_domain ?>/sk/register.php" />
<link rel="alternate" hreflang="sv" href="<?= $site_url ?>/lander/<?= $site_domain ?>/sv/register.php" />
<link rel="alternate" hreflang="tr" href="<?= $site_url ?>/lander/<?= $site_domain ?>/tr/register.php" />
...
<header class="navbar_component w-nav" data-animation="default" data-collapse="medium" data-duration="400" data-easing="ease" data-easing2="ease" data-w-id="8e40c4b5-461f-531e-f642-15e88be2e74a" fs-scrolldisable-element="smart-nav" role="banner">
  <div class="navbar_container">
    ...
    <div aria-controls="w-nav-overlay-0" aria-expanded="false" aria-haspopup="menu" aria-label="menú" class="navbar_menu-button w-nav-button" role="button" style="-webkit-user-select: text" tabindex="0">
...
<form action="../integration/send.php" class="leadform S’inscrire-form bottom form-reg c-form form1 rf-form js-rf-form" id="registrationForm" method="post" style="padding-bottom: 0px">
  ...
  <div class="form-img">
    ...
    <img alt="seguridad SSL" src="../sslsecure.svg"/>
  </div>
...
<footer class="footer_component">
            ...
            <div class="footer_left-wrapper footer-flex">
              ...
              <div class="footer-list-right footer-lang-switcher-wrapper">
                ...
                <div class="lang-switcher">
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/register.php" hreflang="en" title="English">🇬🇧</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/de/register.php" hreflang="de" title="Deutsch">🇩🇪</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/fr/register.php" hreflang="fr" title="Français">🇫🇷</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/es/register.php" hreflang="es" title="Español">🇪🇸</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/it/register.php" hreflang="it" title="Italiano">🇮🇹</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/bg/register.php" hreflang="bg" title="Български">🇧🇬</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/cs/register.php" hreflang="cs" title="Čeština">🇨🇿</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/da/register.php" hreflang="da" title="Dansk">🇩🇰</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/el/register.php" hreflang="el" title="Ελληνικά">🇬🇷</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/fi/register.php" hreflang="fi" title="Suomi">🇫🇮</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/hr/register.php" hreflang="hr" title="Hrvatski">🇭🇷</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/hu/register.php" hreflang="hu" title="Magyar">🇭🇺</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ja/register.php" hreflang="ja" title="日本語">🇯🇵</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ms/register.php" hreflang="ms" title="Bahasa Melayu">🇲🇾</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/nb/register.php" hreflang="nb" title="Norsk Bokmål">🇳🇴</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/nl/register.php" hreflang="nl" title="Nederlands">🇳🇱</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/no/register.php" hreflang="no" title="Norsk">🇳🇴</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/pl/register.php" hreflang="pl" title="Polski">🇵🇱</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/pt/register.php" hreflang="pt" title="Português">🇵🇹</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ro/register.php" hreflang="ro" title="Română">🇷🇴</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/ru/register.php" hreflang="ru" title="Русский">🇷🇺</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/sk/register.php" hreflang="sk" title="Slovenčina">🇸🇰</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/sv/register.php" hreflang="sv" title="Svenska">🇸🇪</a>
                  <a href="<?= $site_url ?>/lander/<?= $site_domain ?>/tr/register.php" hreflang="tr" title="Türkçe">🇹🇷</a>
                </div>
              </div>
            </div>
          </div>
  ...
  <div style="height: 0; overflow: hidden; position: absolute; width: 0">
    <a href="#">Inicio</a>
    <a href="<?= $site_url ?>#why-invest">¿Por qué invertir?</a>
    <a href="<?= $site_url ?>#pricing">Cómo invertir</a>
    <a href="about.php">Sobre nosotros</a>
    <a href="<?= $site_url ?>#minimization">Riesgos de inversión</a>
    <a href="<?= $site_url ?>#Beneficios">Ventajas</a>
    <a href="<?= $site_url ?>#faq">Preguntas frecuentes</a>
    <a href="contact.php">Contacto</a>
    <a href="private-policy.php">Política de privacidad</a>
    <a href="conditions.php">Términos y condiciones</a>
  </div>
  <noscript>
    <style>
        .leadform { display:none; }
    </style>
    <div>Para enviar el formulario, active JavaScript.</div>
  </noscript>
