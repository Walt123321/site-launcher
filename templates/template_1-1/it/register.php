...
$country_name = '';
include '../lang.php';
if (strtolower(substr($site_lang, 0, 2)) === 'it') {
...
<form action="../integration/send.php" class="leadform S’inscrire-form bottom form-reg c-form form1 rf-form js-rf-form" id="registrationForm" method="post" style="padding-bottom: 0px">
  ...
  <div class="form-img">
    ...
    <img alt="Sicurezza SSL" src="../sslsecure.svg"/>
  </div>
...
<footer class="footer_component">
  ...
  <div style="height: 0; overflow: hidden; position: absolute; width: 0">
    <a href="#">Home</a>
    <a href="<?= $site_url ?>#why-invest">Perché investire?</a>
    <a href="<?= $site_url ?>#pricing">Come investire</a>
    <a href="about.php">Chi siamo</a>
    <a href="<?= $site_url ?>#minimization">Rischi d'investimento</a>
    <a href="<?= $site_url ?>#Beneficios">Vantaggi</a>
    <a href="<?= $site_url ?>#faq">FAQ</a>
    <a href="contact.php">Contatti</a>
    <a href="private-policy.php">Informativa sulla privacy</a>
    <a href="conditions.php">Termini e Condizioni</a>
  </div>
  <noscript>
    <style>
        .leadform { display:none; }
    </style>
    <div>Per inviare il modulo, abilita JavaScript.</div>
  </noscript>
