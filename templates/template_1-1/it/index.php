...
<img alt="Immagine principale della piattaforma di investimento" src="../investor.webp" style="border-radius: 15px;">
</img></div>
...
<div class="layout1-image-gradient-wrapper" data-w-id="30a34707-6eb3-a0bc-2b4d-b6131c4f1081" style="
                          ...
                          transform-style: preserve-3d;
                        ">
<img alt="Analisi azionaria con trading basato sull'IA" class="flex-image" loading="lazy" src="../investor1.webp">
</img></div>
</div>
</div>
</div>
...
<img alt="Investimenti online" class="layout1_image feature-2 flex-image" loading="lazy" sizes="(max-width: 479px) 82vw, (max-width: 767px) 85vw, (max-width: 991px) 39vw, 38vw" src="../investathome.webp">
</img></div>
</div>
</div>
</div>
...
<div class="layout1-image-gradient-wrapper" data-w-id="2f80477f-23b3-153b-6ac3-96fff2ff8cd0" style="
                      ...
                      ">
<div class="layout1_image-wrapper">
<img alt="Concetto di crescita finanziaria e investimento" class="layout1_image feature-3" loading="lazy" sizes="(max-width: 479px) 82vw, (max-width: 767px) 85vw, (max-width: 991px) 39vw, 38vw" src="../investgrowth.webp">
</img></div>
</div>
</div>
</div>
...
<img alt="Motivo decorativo della sezione testimonianze" class="testimonial-pattern-image" loading="lazy" src="../testimonial-pattern.svg">
</img></div>
</div>
</div>
</div>
...
<div class="layout1-image-gradient-wrapper" data-w-id="30a34707-6eb3-a0bc-2b4d-b6131c4f1081" style="
                    ...
                    ">
<div class="layout1_image-wrapper">
<img alt="Analisi di mercato con trading basato sull'IA" class="layout1_image feature-1" loading="lazy" src="../Kiintell.webp">
</img></div>
</div>
</div>
</div>
...
<div class="layout1-image-gradient-wrapper" data-w-id="ad008d0b-ca72-3722-c6cd-77686dc346ca" style="
                    ...
                    ">
<div class="layout1_image-wrapper">
<img alt="Grafico azionario in crescita" class="layout1_image feature-2" loading="lazy" sizes="(max-width: 479px) 82vw, (max-width: 767px) 85vw, (max-width: 991px) 39vw, 38vw" src="../charts.webp">
</img></div>
</div>
</div>
</div>
...
<div class="layout1-image-gradient-wrapper" data-w-id="2f80477f-23b3-153b-6ac3-96fff2ff8cd0" style="
                    ...
                    ">
<div class="layout1_image-wrapper">
<img alt="Uomo che controlla i propri investimenti gestiti dall'IA" class="layout1_image feature-3" loading="lazy" sizes="(max-width: 479px) 82vw, (max-width: 767px) 85vw, (max-width: 991px) 39vw, 38vw" src="../happyinvestor.webp">
</img></div>
</div>
</div>
</div>
...
<div class="layout1-image-gradient-wrapper" data-w-id="58b3e01c-d462-a6d1-a3e6-4b1761832b38" style="
                    ...
                    ">
<div class="layout1_image-wrapper">
<img alt="Grafico finanziario del trading basato sull'IA" class="layout1_image feature-1" loading="lazy" src="../charts2.webp"/>
</div>
</div>
</div>
</div>
...
<div class="layout1-image-gradient-wrapper" data-w-id="58b3e01c-d462-a6d1-a3e6-4b1761832b47" style="
                    ...
                    ">
<div class="layout1_image-wrapper">
<img alt="Analisi di mercato di un investitore" class="layout1_image feature-2" loading="lazy" sizes="(max-width: 479px) 82vw, (max-width: 767px) 85vw, (max-width: 991px) 39vw, 38vw" src="../charts3.webp"/>
</div>
</div>
</div>
</div>
...
<div class="layout1_image-wrapper">
<img alt="Investitori soddisfatti che utilizzano il trading basato sull'IA" class="layout1_image feature-3" loading="lazy" sizes="(max-width: 479px) 82vw, (max-width: 767px) 85vw, (max-width: 991px) 39vw, 38vw" src="../happyinvestors.webp"/>
</div>
</div>
</div>
</div>
...
<img alt="Motivo decorativo superiore della sezione recensioni" class="review-pattern-image" loading="lazy" src="../review-top-pattern.svg"/>
</div>
<div class="review-pattern-bottom-wrapper">
<img alt="Motivo decorativo inferiore della sezione recensioni" class="review-pattern-image" loading="lazy" src="../review-bottom-pattern.svg"/>
</div>
...
<img alt="Icona a stella per la valutazione" class="testimonial18_rating-icon" loading="lazy" src="../star.svg"/>
<img alt="Icona a stella per la valutazione" class="testimonial18_rating-icon" loading="lazy" src="../star.svg"/>
<img alt="Icona a stella per la valutazione" class="testimonial18_rating-icon" loading="lazy" src="../star.svg"/>
<img alt="Icona a stella per la valutazione" class="testimonial18_rating-icon" loading="lazy" src="../star.svg"/>
<img alt="Icona a stella per la valutazione" class="testimonial18_rating-icon" loading="lazy" src="../star.svg"/>
...
<img alt="Motivo decorativo di sfondo" class="cta_background-image" loading="lazy" src="../pattern-background.svg">
</img></div>
</div>
</div>
</div>
