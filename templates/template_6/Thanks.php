...
// Same copy as the client-side `translations` dict below, rendered
// server-side so the page shows the offer's language on first paint
// instead of flashing the hardcoded fallback text before JS runs.
$thanks_translations = [
    'en' => ['title' => "Congratulations on your successful registration in the system.", 'text' => "You will receive a call within 24 hours - don't miss it, otherwise you might be interesting for another subscriber!"],
    'de' => ['title' => "Herzlichen Glückwunsch zur erfolgreichen Registrierung im System.", 'text' => "Sie erhalten innerhalb von 24 Stunden einen Anruf - verpassen Sie ihn nicht, sonst könnte es für einen anderen Abonnenten interessant sein!"],
    ...
    'ae' => ['title' => "تهانينا على تسجيلك الناجح في النظام.", 'text' => "ستتلقى مكالمة في غضون 24 ساعة - لا تفوتها، وإلا فقد تكون مثيرة للاهتمام بالنسبة لمشترك آخر!"],
    'jp' => ['title' => "システムへのご成功登録おめでとうございます。", 'text' => "24時間以内にお電話を差し上げますので、お見逃しなく。それ以外の場合、他の加入者にとって興味深いかもしれません！"],
    'br' => ['title' => "Parabéns pelo seu registro bem-sucedido no sistema.", 'text' => "Você receberá uma ligação dentro de 24 horas - não perca, caso contrário, você pode ser interessante para outro assinante!"],
    'ca' => ['title' => "Congratulations on your successful registration in the system.", 'text' => "You will receive a call within 24 hours - don't miss it, otherwise you might be interesting for another subscriber!"],
    'sg' => ['title' => "Sistemde başarılı kaydınız için tebrikler.", 'text' => "24 saat içinde bir çağrı alacaksınız - kaçırmayın, aksi takdirde başka bir abone için ilginç olabilirsiniz!"],
    'hk' => ['title' => "系統中的成功註冊，恭喜.", 'text' => "您將在24小時內收到一通電話 - 請勿錯過，否則您可能對其他訂閱者有興趣！"],
    'in' => ['title' => "सिस्टम में आपके सफल पंजीकरण के लिए बधाई.", 'text' => "आपको 24 घंटे के भीतर एक कॉल मिलेगा - इसे मत छोड़िए, अन्यथा आपके लिए कोई और सदस्य रोमांचक हो सकता है!"],
    'mx' => ['title' => "Felicidades por su exitoso registro en el sistema.", 'text' => "Recibirá una llamada dentro de las 24 horas. No la pierda, de lo contrario podría ser interesante para otro suscriptor."],
    'pe' => ['title' => "Felicitaciones por su exitoso registro en el sistema.", 'text' => "Recibirá una llamada dentro de las 24 horas. No la pierda, de lo contrario podría ser interesante para otro suscriptor."],
...
<?php include 'lang.php'; ?>
    ...
    <link rel="alternate" hreflang="en" href="<?= $site_url ?>/Thanks.php" />
    ...
    <link rel="alternate" hreflang="da" href="<?= $site_url ?>/lander/<?= $site_domain ?>/da/Thanks.php" />
    ...
    <link rel="alternate" hreflang="no" href="<?= $site_url ?>/lander/<?= $site_domain ?>/no/Thanks.php" />
...
<body>
    <div class="thx">
        <div class="thx__container">
            <div class="thx__box">
                <h2 class="thx-left__title"><?= htmlspecialchars($active_translation['title']) ?></h2>
                <div class="thx-right">
                    <div id="parallax">
                ...
                <div class="thx-left">
                    <p style="font-size: 16px;" class="thx-left__text">
                        <?= htmlspecialchars($active_translation['text']) ?>
                    </p>
                </div>
            </div>
        </div>
