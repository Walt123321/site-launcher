...
if ($extractLang === $currentLang) {
    ...
    header('Location: ' . $site_url . '/lander/' . $site_domain . '/risk-disclosure.php');
    exit();
}
?>
...
<link rel="alternate" hreflang="x-default" href="<?= $site_url ?>/lander/<?= $site_domain ?>/risk-disclosure.php" />
...
<link rel="alternate" hreflang="ru" href="<?= $site_url ?>/lander/<?= $site_domain ?>/ru/risk-disclosure.php" />
