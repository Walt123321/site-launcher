...
#cq-custom-submit-btn {
    ...
    min-height: 48px !important;
    box-sizing: border-box !important;
    background: linear-gradient(135deg, #8175be, #10b981) !important;
    color: #ffffff !important;
    font-size: 14px !important;
...
.cq-pulse-button::before {
    content: ''; position: absolute; width: 100%; height: 100%; background-color: #10b981; border-radius: 50%; z-index: -1; opacity: 0.35; animation: cq-ripple 2.2s infinite ease-out;
}
@keyframes cq-ripple {
