...
<main id="main-content">
    <section class="thanks-wrap">
      <div class="thanks-card">
        ...
        <h1><?= $thanks_h1 ?></h1>
        <p><?= $thanks_text ?></p>
        <a class="btn form-button form-btn" href="<?= $site_url ?>/" style="display:inline-flex;width:auto;padding:0 32px;"><?= $thanks_btn ?></a>
      </div>
    </section>
</main>
