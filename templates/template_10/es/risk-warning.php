...
<link rel="alternate" hreflang="en" href="<?= $site_url ?>/risk-warning.php" />
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "name": <?= json_encode($bc_risk) ?>, "item": <?= json_encode($canonical) ?> }
  ]
}
</script>
<!-- Fonts & Styles -->
...
<main id="main-content">
    <section class="page-hero">
      <div class="container">
        <div class="page-hero__eyebrow">
          ...
          <span class="sep">/</span>
          <span class="current"><?= $bc_risk ?></span>
        </div>
        <h1><?= $risk_title ?></h1>
        <p><?= $risk_intro ?></p>
      </div>
    ...
    <section class="inner-content">
      <div class="container">
        <div class="inner-narrow legal-block">
          <div class="dark-panel">
            <h2><?= $risk_ai_title ?></h2>
            <ul style="margin-top:14px;">
              <li><strong><?= $risk_ai_1_title ?></strong> <?= $risk_ai_1_text ?></li>
              <li><strong><?= $risk_ai_2_title ?></strong> <?= $risk_ai_2_text ?></li>
              <li><strong><?= $risk_ai_3_title ?></strong> <?= $risk_ai_3_text ?></li>
            </ul>
          </div>
          <div class="legal-disclaimer"><p><?= $risk_disclaimer ?></p></div>
          ...
          <div>
            <h2><?= $risk_s2_title ?></h2>
            <ul>
              <li><strong><?= $risk_s2_li1_title ?></strong> <?= $risk_s2_li1_text ?></li>
              <li><strong><?= $risk_s2_li2_title ?></strong> <?= $risk_s2_li2_text ?></li>
            </ul>
          </div>
          ...
          <div>
            <h2><?= $risk_s3_title ?></h2>
            <ul>
              <li><strong><?= $risk_s3_li1_title ?></strong> <?= $risk_s3_li1_text ?></li>
              <li><strong><?= $risk_s3_li2_title ?></strong> <?= $risk_s3_li2_text ?></li>
              <li><strong><?= $risk_s3_li3_title ?></strong> <?= $risk_s3_li3_text ?></li>
            </ul>
          </div>
          ...
          <div>
            <h2><?= $risk_s4_title ?></h2>
            <ul>
              <li><strong><?= $risk_s4_li1_title ?></strong> <?= $risk_s4_li1_text ?></li>
              <li><strong><?= $risk_s4_li2_title ?></strong> <?= $risk_s4_li2_text ?></li>
              <li><strong><?= $risk_s4_li3_title ?></strong> <?= $risk_s4_li3_text ?></li>
            </ul>
          </div>
