...
<meta name="twitter:title" content="<?= $sitemap_meta_title ?>">
<meta name="twitter:description" content="<?= $sitemap_meta_description ?>">
...
<link rel="alternate" hreflang="en" href="<?= $site_url ?>/sitemap.php" />
...
<link rel="alternate" hreflang="ja" href="<?= $site_url ?>/lander/<?= $site_domain ?>/ja/sitemap.php" />
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "name": <?= json_encode($bc_sitemap) ?>, "item": <?= json_encode($canonical) ?> }
  ]
}
</script>
<!-- Fonts & Styles -->
    ...
    <section class="page-hero">
      <div class="container">
        <div class="page-hero__eyebrow">
          ...
          <span class="sep">/</span>
          <span class="current"><?= $bc_sitemap ?></span>
        </div>
        <h1><?= $sitemap_h1 ?></h1>
        <p><?= $sitemap_lead ?></p>
      </div>
    ...
    <section class="inner-content">
      <div class="container">
        <div class="sitemap-grid">
          <a href="<?= $site_url ?>/"><?= $bc_home ?></a>
          <a href="../about.php"><?= $bc_about ?></a>
          <a href="product.php"><?= $bc_product ?></a>
          <a href="offer.php"><?= $bc_offer ?></a>
          <a href="contacts.php"><?= $bc_contacts ?></a>
          <a href="faq.php"><?= $bc_faq ?></a>
          <a href="privacy.php"><?= $bc_privacy ?></a>
          <a href="conditions.php"><?= $bc_conditions ?></a>
          <a href="risk-warning.php"><?= $bc_risk ?></a>
          <a href="sign.php"><?= $bc_sign ?></a>
        </div>
      </div>
    </section>
</main>
