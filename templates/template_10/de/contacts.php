      ...
      <div class="container">
        <div class="contact-grid">
          <div class="contact-card contact-card--dark">
            <h3><?= $contacts_form_title ?></h3>
            <p style="margin-bottom:20px;"><?= $contacts_form_desc ?></p>
            <div class="contact-row"><span class="ic">@</span><div><span class="lbl"><?= $contacts_email_label ?></span><a href="mailto:info@<?= $site_domain ?>">info@<?= $site_domain ?></a></div></div>
            <div class="contact-row"><span class="ic">&#9200;</span><div><span class="lbl"><?= $contacts_hours_label ?></span><span class="val"><?= $contacts_hours_value ?></span></div></div>
            <div class="contact-row"><span class="ic">&#9993;</span><div><span class="lbl"><?= $contacts_response_label ?></span><span class="val"><?= $contacts_response_value ?></span></div></div>
          </div>
