...
<link rel="alternate" hreflang="en" href="<?= $site_url ?>/about.php" />
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "name": <?= json_encode($bc_about) ?>, "item": <?= json_encode($canonical) ?> }
  ]
}
</script>
<!-- Fonts & Styles -->
    ...
    <section class="page-hero">
      <div class="container">
        <div class="page-hero__eyebrow">
          ...
          <span class="sep">/</span>
          <span class="current"><?= $bc_about ?></span>
        </div>
        <h1><?= $about_h1 ?></h1>
        <p><?= $about_lead ?></p>
      </div>
    ...
    <section class="inner-content">
      <div class="container">
        ...
        <div class="info-grid cols-3">
          <div class="info-card"><h3><?= $hl1_emoji ?> <?= $hl1_title ?></h3><p><?= $hl1_desc ?></p></div>
          <div class="info-card"><h3><?= $hl3_emoji ?> <?= $hl3_title ?></h3><p><?= $hl3_desc ?></p></div>
          <div class="info-card"><h3><?= $hl4_emoji ?> <?= $hl4_title ?></h3><p><?= $hl4_desc ?></p></div>
        </div>
      </div>
    </section>
</main>
