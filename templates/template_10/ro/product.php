    ...
    <section class="inner-content">
      <div class="container">
        <div class="info-grid cols-3">
          <div class="info-card"><h3><?= $s3_card1_title ?></h3><p><?= $s3_card1_text ?></p></div>
          <div class="info-card"><h3><?= $s3_card2_title ?></h3><p><?= $s3_card2_text ?></p></div>
          <div class="info-card"><h3><?= $s3_card3_title ?></h3><p><?= $s3_card3_text ?></p></div>
        </div>
        <div class="info-grid" style="margin-top:20px;">
          <div class="info-card"><h3><?= $s6_item1_title ?></h3><p><?= $s6_item1_text ?></p></div>
          <div class="info-card"><h3><?= $s6_item2_title ?></h3><p><?= $s6_item2_text ?></p></div>
          <div class="info-card"><h3><?= $s6_item3_title ?></h3><p><?= $s6_item3_text ?></p></div>
          <div class="info-card"><h3><?= $s6_item4_title ?></h3><p><?= $s6_item4_text ?></p></div>
        </div>
      </div>
    </section>
</main>
