...
<link rel="alternate" hreflang="en" href="<?= $site_url ?>/sign.php" />
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "name": <?= json_encode($bc_sign) ?>, "item": <?= json_encode($canonical) ?> }
  ]
}
</script>
<script type="application/ld+json">
...
<body class="flex min-h-screen flex-col">
  ...
  <main class="flex grow flex-col">
    <section class="page-hero">
      <div class="container-base">
        <div class="page-hero__eyebrow">
          ...
          <span class="sep">/</span>
          <span class="current"><?= $bc_sign ?></span>
        </div>
        <h1><?= $sign_h1 ?></h1>
        <p><?= $sign_lead ?></p>
      </div>
    ...
    <section class="inner-content">
      <div class="container-base">
        <div class="max-w-[560px] mx-auto bg-linear-to-r from-brand-start to-brand-end rounded-[24px] p-8 md:p-10 text-black">
          <form name="form" method="post" class="flex flex-col gap-5 leadform rf-form js-rf-form" action="./integration/send.php">
            ...
            <button class="flex items-center justify-center rounded-full py-5 font-bold bg-black text-white" type="submit"><?= $form_btn_submit ?></button>
