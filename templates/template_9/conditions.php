...
<meta name="twitter:title" content="<?= $conditions_meta_title ?>">
<meta name="twitter:description" content="<?= $conditions_meta_description ?>">
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "name": <?= json_encode($bc_conditions) ?>, "item": <?= json_encode($canonical) ?> }
  ]
}
</script>
<script type="application/ld+json">
    ...
    <section class="page-hero">
      <div class="container-base">
        <div class="page-hero__eyebrow">
          ...
          <span class="sep">/</span>
          <span class="current"><?= $bc_conditions ?></span>
        </div>
        <h1><?= $bc_conditions ?></h1>
        <p><?= $conditions_meta_description ?></p>
      </div>
    </section>
    ...
    <section class="inner-content">
      <div class="container-base inner-narrow">
        ...
        <div class="legal-block mt-6">
          <?php foreach ($conditions_sections as $sec): ?>
          <div>
            <h2><?= $sec['title'] ?></h2>
            <p><?= $sec['body'] ?></p>
          </div>
