...
<meta property="og:title" content="<?= $faq_meta_title ?>">
  ...
  <main class="flex grow flex-col">
    ...
    <section class="inner-content">
      <div class="container-base">
        ...
        <div class="py-[60px] px-8 mt-20 flex flex-col lg:flex-row items-center justify-between bg-linear-to-r from-brand-start to-brand-end rounded-3xl text-black gap-[30px] text-center lg:text-left max-w-[800px] mx-auto">
          <div class="flex flex-col gap-4">
            <p class="font-black text-[28px] md:text-[32px]"><?= $cta_title ?></p>
            <p class="font-medium text-[16px]"><?= $cta_desc ?></p>
          </div>
