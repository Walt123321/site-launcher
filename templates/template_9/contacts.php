...
<meta name="twitter:title" content="<?= $contacts_meta_title ?>">
<meta name="twitter:description" content="<?= $contacts_meta_description ?>">
...
<link rel="alternate" hreflang="en" href="<?= $site_url ?>/contacts.php" />
...
<link rel="alternate" hreflang="ja" href="<?= $site_url ?>/lander/<?= $site_domain ?>/ja/contacts.php" />
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "name": <?= json_encode($bc_contacts) ?>, "item": <?= json_encode($canonical) ?> }
  ]
}
</script>
<script type="application/ld+json">
    ...
    <section class="page-hero">
      <div class="container-base">
        <div class="page-hero__eyebrow">
          ...
          <span class="sep">/</span>
          <span class="current"><?= $bc_contacts ?></span>
        </div>
        <h1><?= $contacts_h1 ?></h1>
        <p><?= $contacts_lead ?></p>
      </div>
        ...
        <div class="contact-grid">
          <div class="contact-card">
            ...
            <div class="contact-row">
              <span class="ic"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 4h16v16H4z" opacity="0"/><path d="M3 6l9 6 9-6M4 4h16v16H4z" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
              <div>
                <span class="lbl"><?= $contacts_email_label ?></span>
                <a href="mailto:info@<?= $site_domain ?>">info@<?= $site_domain ?></a>
              </div>
            </div>
            <div class="contact-row">
              <span class="ic"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 3" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
              <div>
                <span class="lbl"><?= $contacts_hours_label ?></span>
                <span class="val"><?= $contacts_hours_value ?></span>
              </div>
            </div>
            <div class="contact-row">
              <span class="ic"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
              <div>
                <span class="lbl"><?= $contacts_response_label ?></span>
                <span class="val"><?= $contacts_response_value ?></span>
              </div>
            </div>
          </div>

          <div class="bg-linear-to-r from-brand-start to-brand-end rounded-[24px] p-8 md:p-10 text-black">
            <p class="font-black text-[26px] md:text-[30px] mb-2"><?= $contacts_form_title ?></p>
            <p class="font-medium mb-6"><?= $contacts_form_desc ?></p>
            <form name="form" method="post" class="flex flex-col gap-4 leadform rf-form js-rf-form" action="./integration/send.php">
              ...
              <div class="flex gap-4 flex-col md:flex-row">
                <input class="input focus:outline-primary-dark min-h-[56px] w-full bg-white p-[16px_28px]" type="text" name="fname" placeholder="<?= $form_fname_placeholder ?>" required data-should-validate="">
                <input class="input focus:outline-primary-dark min-h-[56px] w-full bg-white p-[16px_28px]" type="text" name="lname" placeholder="<?= $form_lname_placeholder ?>" required data-should-validate="">
              </div>
              <input class="input focus:outline-primary-dark min-h-[56px] w-full bg-white p-[16px_28px]" type="email" name="email" placeholder="<?= $form_email_placeholder ?>" required data-should-validate="">
              <div class="relative w-full">
                <input class="input focus:outline-primary-dark min-h-[56px] w-full bg-white p-[16px_28px] iti__tel-input" type="tel" name="fullphone" placeholder="" required data-should-validate="" autocomplete="tel">
                <span class="error-msg hide"></span>
              </div>
              <button class="flex items-center justify-center rounded-full py-4 font-bold bg-black text-white" type="submit"><?= $form_btn_submit ?></button>
              <p class="text-[12px]"><?= $form_disclaimer_text ?></p>
