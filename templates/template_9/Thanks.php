...
<meta property="og:title" content="<?= $thanks_meta_title ?>">
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "name": <?= json_encode($bc_thanks) ?>, "item": <?= json_encode($canonical) ?> }
  ]
}
</script>
<script type="application/ld+json">
    ...
    <section class="thanks-wrap">
      <div class="thanks-card">
        <div class="thanks-icon">
          <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12" stroke-linecap="round" stroke-linejoin="round"/></svg>
        </div>
        <h1><?= $thanks_h1 ?></h1>
        <p><?= $thanks_text ?></p>
        <a class="flex items-center justify-center rounded-full py-5 px-10 font-bold text-black bg-linear-to-r from-brand-start to-brand-end mx-auto max-w-[320px]" href="<?= $site_url ?>/"><?= $thanks_btn ?></a>
      </div>
    </section>
</main>
