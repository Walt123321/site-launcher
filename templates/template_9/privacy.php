...
<link rel="alternate" hreflang="en" href="<?= $site_url ?>/privacy.php" />
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "name": <?= json_encode($bc_privacy) ?>, "item": <?= json_encode($canonical) ?> }
  ]
}
</script>
<script type="application/ld+json">
    ...
    <section class="page-hero">
      <div class="container-base">
        <div class="page-hero__eyebrow">
          ...
          <span class="sep">/</span>
          <span class="current"><?= $bc_privacy ?></span>
        </div>
        <h1><?= $bc_privacy ?></h1>
        <p><?= $privacy_meta_description ?></p>
      </div>
    </section>

    <section class="inner-content">
      <div class="container-base inner-narrow">
        <span class="legal-updated">Last updated: <?= $privacy_last_update ?></span>
        <div class="legal-block mt-6">
          <?php foreach ($privacy_sections as $sec): ?>
          <div>
            <h2><?= $sec['title'] ?></h2>
            <p><?= $sec['body'] ?></p>
          </div>
