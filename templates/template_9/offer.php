    ...
    <section class="inner-content">
      <div class="container-base">
        <div class="max-w-[700px] mx-auto text-center">
          ...
          <div class="pay-badges pay-badges-on-dark mb-8">
          ...
          <a class="flex items-center justify-center rounded-full py-5 px-10 font-bold text-black bg-linear-to-r from-brand-start to-brand-end mx-auto max-w-[320px]" href="sign.php"><?= $form_btn_submit ?></a>
          <p class="text-[13px] text-grey-light mt-6"><?= $offer_note ?></p>
        </div>
      </div>
    </section>
</main>
