...
initMobuleMenu();
initConnectors();
// Кожен символ у initTrading() -- окремий iframe-віджет TradingView зі своїм
// набором CSS/JS та WebSocket для live-цін; викликаний одразу при завантаженні
// сторінки, він домінує в критичному шляху рендера (виміряно живим PageSpeed:
// ~5.2с) і піднімає TBT до ~480мс. Секція розташована далеко нижче першого
// екрану (рядок ~717 з 1865 в index.php), тож відкладаємо ініціалізацію до
// повного завантаження сторінки -- функціонал не втрачається, просто більше
// не бере участь у метриках першого рендеру.
