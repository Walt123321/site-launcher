...
# qoooqle.com is not one of the per-launch source templates above -- it's a
# single, standalone Keitaro "local_file" offer deployed via deploy_serp.py,
# which handles its specific requirements (domain-name folder wrapping,
# renaming google.php to index.php since Keitaro's local_file offers only
# ever serve /index.php). Use that script for this domain, not this one.
...
def main():
    ...
    print("(qoooqle.com is deployed separately via deploy_serp.py.)")
